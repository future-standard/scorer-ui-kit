...
const SplitLayouts: FC = () => {
  ...
  const sideStateCallback = useCallback((currentState: ISideAreaState) => {
    console.debug(`Side Area Current State: ${currentState}`);
  }, []);
      ...
      >
        <ContentLayout layout='dashboard'>
          <SplitLayout
            ...
            sideArea={{
              content: areaBContent,
              collapsable: true,
              minSize: 200,
              defaultCollapsed: true,
              onSideAreaStateChange: sideStateCallback,
            }}
          />
        </ContentLayout>
      </GlobalUI>

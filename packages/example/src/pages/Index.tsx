        ...
        <List>
          ...
          <Item>
            <Link to={`/linehls`}>
              ...
              <Description>
                The Line tool over an HLS (.m3u8) stream. Uses Safari's native HLS when available,
                falls back to dynamically-imported hls.js otherwise.
              </Description>
          ...
          <Item>
            <Link to={`/webrtc-strictmode-test`}>
              ...
              <Description>
                Verifies WebRTCPlayer mounts without WebSocket errors in StrictMode.
              </Description>

...
export const colorVariables = css`
  ...
  .light-theme {
    ...
    --shadows-primary-sink: var(--black-5);
  ...
  .dark-theme {
    ...
    --shadows-primary-sink: var(--grey-1);
  ...
  .light-theme, .dark-theme {
    ...
    --button-hover-background-color: var(--primary-11);
    --button-hover-border-color: var(--primary-12);
    ...
    --button-active-background-color: var(--primary-8);
    --button-active-border-color: var(--primary-a8);
    --button-active-inner-shadow-color: var(--button-hover-inner-shadow-color);
    --button-active-drop-shadow-color: var(--shadows-primary-sink);
    --button-active-text-color: var(--primary-a12);
    --button-active-divider-color: var(--primary-a3);
    --button-active-icon-area-background-color: var(--primary-a3);

    --button-loading-text-color: var(--white-a11);
    --button-disabled-text-color: var(--white-12);

    --button-gradient-deg: 135deg;
    --button-gradient-start: #72C3EE;
    --button-gradient-end: #5CACEE;
    ...
    .button-design-secondary {
      ...
      --button-hover-text-color: var(--grey-12);

...
const PreviewArea = styled.div<{ canvasHeight?: number, canvasWidth?: number }>`
  ...
  border-radius: 5px;
  background-color: var(--grey-3);
  background-image: repeating-linear-gradient(45deg, transparent, transparent 35px, var(--white-a12) 35px, var(--white-a12) 70px);
`;
...
const SelectedArea = styled.div<{ cropLeft: number, cropTop: number, cropWidth: number, cropHeight: number }>`
  position: absolute;
  border: dashed 1px var(--success-12);
  box-shadow: 0 0 0 9999em var(--grey-11);

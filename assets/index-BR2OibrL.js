...
`,mj=b.g`
  ${Nb};
`,Se=({icon:e,size:r=24,weight:a="regular",color:o="grey-12",forSvgUsage:s=!1})=>{const u=Rd.icons.weights[a],f=sb[e];return f!=null?s?c.jsx(mj,{children:f({size:r,weight:u,color:`var(--${o}, var(--grey-12))`})}):c.jsx(Me,{children:f({size:r,weight:u,color:`var(--${o}, var(--grey-12))`})}):null},zu=b.div`
  position: absolute;
  width: 10px;
  height: 10px;
...
`,yj={error:"Critical",warning:"BigWarning",success:"Success",info:"Information",neutral:"Information"},bj=b.div`
  ...
  flex: 1;
`,fa=({type:e="info",message:r,hideCloseButton:a=!1})=>{const[o,s]=h.useState(!1);return h.useEffect(()=>{s(!1)},[r]),r&&!o?c.jsxs(Hb,{type:e,children:[c.jsx(Se,{icon:yj[e],color:"inverse"}),c.jsx(bj,{children:r}),!a&&c.jsx(xj,{onClick:()=>s(!0),children:c.jsx(Se,{icon:"CloseCompact",color:"inverse"})})]}):null},wj=pr`
  0% {
...
`,Lj=(e,r)=>{const{left:a,top:o,width:s,height:u}=r,f=o+window.scrollY,p=a+window.scrollX;switch(e){case"bottom-right":return`
  ...
  &:active:enabled {
    ...
    ${({$shadow:e})=>R`
      animation: var(--speed-normal) var(--easing-primary-in-out) ${()=>_j(e)} forwards;
    `};
  }
...
`,gt=({design:e="primary",size:r="normal",shadow:a=!1,noPadding:o=!1,loading:s=!1,children:u,formAction:f,...p})=>(e==="danger"&&console.warn("Button.tsx - Warning, the design prop value danger is being deprecated. Use warning instead."),c.jsx(Dj,{type:"button",$isOutline:e==="outline",className:`button-design-${e} button-size-${r}`,design:e,size:r,$noPadding:o,$shadow:a,$loading:s,...p,children:c.jsx(c.Fragment,{children:u})})),Bb=e=>2*3.1416*e,Rj=e=>{const r=Bb(e);return pr`
    0% {
...
`,Ib=({icon:e,size:r=20,weight:a="regular",color:o="dimmed",hoverColor:s="mono",children:u,formAction:f,...p})=>c.jsx(Vj,{type:"button",color:o,hoverColor:s,...p,children:c.jsx(Se,{icon:e,size:r,weight:a})}),ly=b(Ib)``;b.div`
  display: flex;
  ${ly} {
    margin-left: 15px;
  }
...
`,Kg=({indeterminate:e=!1,disabled:r,checked:a=!1,onChangeCallback:o})=>{const[s,u]=h.useState(a),[f,p]=h.useState(a?"on":"off"),m=y=>{const v=y.target.checked;u(v),o&&o(v)};h.useEffect(()=>{p(a?"on":"off")},[a,s,p]),h.useEffect(()=>{u(a)},[a,u]);const x=Rd.icons.weights.regular;return c.jsxs(gT,{onChange:m,indeterminate:e,disabled:r,visualState:f,children:[c.jsx(cr,{children:c.jsx(hT,{children:f==="on"?c.jsx(rg,{color:"input-toggle-icon-color",children:c.jsx(Wb,{color:"input-toggle-icon-color",stroke:"inverse",size:12,weight:x})}):null})}),c.jsx(fT,{type:"checkbox",checked:s,readOnly:!0,disabled:r})," "]})},_u=b.div`
  width: 10px;
  height: 10px;
  border-radius: 50%;
  user-select: none;
...
`,t5=({buttons:e})=>c.jsx(iM,{children:e.map(({id:r,buttonType:a,icon:o,text:s,iconPosition:u,size:f,...p})=>a==="icon-button"?c.jsx(Zg,{size:f||"small",icon:o||"",position:u,...p,children:s},r||`button-stack-${r}`):c.jsx(gt,{size:f||"small",...p,children:s},r||`button-stack-${r}`))}),oM=b.div`
  display: flex;
  flex-direction: column;
...
`,EM=["S","M","T","W","T","F","S"],jM=["日","月","火","水","木","金","土"],TM=({dateMode:e="interval",timeMode:r="interval",dateTimeTextUpper:a="From",dateTimeTextLower:o="To",timeZoneTitle:s="Timezone",timeZoneValueTitle:u="JST",hasEmptyValue:f=!1,updateCallback:p=()=>{},initialValue:m,availableRange:x,contentDays:y,lang:v="en",cancelText:k="Cancel",applyText:C="Apply",hasApply:S=!1,disableApply:E=!1,applyCallback:T=()=>{},cancelCallback:$=()=>{}})=>{const[L,N]=h.useState($M(f,m)),[z,D]=h.useState(L===null?sM:L.start),[H,j]=h.useState("start"),[A,P]=h.useState([]),X=h.useRef(!0),[B,V]=h.useState(!0),F=v==="ja"?jM:EM;h.useEffect(()=>{if(X.current)X.current=!1;else{const q=new Date;N(gd(oi(q))),D(q)}},[e,r]),h.useEffect(()=>{P(D9({start:R9(z),end:gb(z)}))},[z]),h.useEffect(()=>{L!==null&&p(e==="interval"||r==="interval"?L:L.start)},[e,L,r,p]);const se=h.useCallback(q=>{const ee=L||Qo;if(e==="single"){const ne=ms(ee.start,q),ae=ms(ee.end,q);N({start:ne,end:ae})}else if(H==="end"&&zx(q,ee.start)){const ne=ms(ee.end,q);N({...ee,end:ne}),j("done")}else if(H==="start"||H==="end"||H==="done"){const ne=ms(ee.start,q),ae=ms(ee.end,q);N({start:ne,end:ae}),j("end")}},[e,L,H]);h.useEffect(()=>{const{start:q,end:ee}=L||Qo;r==="interval"&&zx(Wi(q,{minutes:1}),ee)?Ns(ee,rl(q))&&ee.getSeconds()>0?V(!0):V(!1):V(!0)},[L,r]);const oe=h.useCallback(q=>{const{end:ee}=L||Qo;N({start:q,end:ee})},[L]),U=h.useCallback(q=>{const{start:ee}=L||Qo;N({start:ee,end:q})},[L]);return c.jsxs(cM,{children:[c.jsxs(uM,{children:[c.jsx(gy,{isTimeRangeValid:B,title:a,hasDate:!0,hasTime:r!=="off",date:L?L.start:Qo.start,setDateCallback:oe}),c.jsx(gy,{isTimeRangeValid:B,title:o,hasDate:e==="interval",hasTime:r==="interval",date:L?L.end:Qo.end,allowAfterMidnight:!0,setDateCallback:U}),c.jsxs(dM,{children:[c.jsx(fM,{children:s}),c.jsx(hM,{children:u})]})]}),c.jsxs(gM,{children:[c.jsxs(pM,{children:[c.jsxs(py,{type:"button",disabled:AM(z,x),onClick:()=>D(Ms(z,-1)),children:[c.jsx(pd,{children:c.jsx(Se,{icon:"Left",color:"dimmed",size:10})}),qt(Ms(z,-1),"MMM",{locale:v==="ja"?h0:Xu})]}),c.jsxs(mM,{children:[c.jsx("span",{children:qt(z,"yyyy")}),qt(z,"MMMM",{locale:v==="ja"?h0:Xu})]}),c.jsxs(py,{type:"button",disabled:LM(z,x),onClick:()=>D(Ms(z,1)),children:[qt(Ms(z,1),"MMM",{locale:v==="ja"?h0:Xu}),c.jsx(pd,{children:c.jsx(Se,{icon:"Right",color:"dimmed",size:10})})]})]}),c.jsx(bM,{children:F.map((q,ee)=>c.jsx(wM,{children:q},ee))}),c.jsx(vM,{children:A.map((q,ee)=>{const ne=_9({start:q,end:H9(q)});return c.jsx(r5,{children:ne.map((ae,O)=>{const Z=MM(ae,L),re=HC(ae);return c.jsxs(kM,{disabled:OM(ae,x),onClick:()=>se(ae),state:Z,thisMonth:NC(ae,z),isToday:re,children:[c.jsx(CM,{children:qt(ae,"d")}),c.jsx(SM,{hasContent:zM(ae,y),state:Z,isToday:re})]},O)})},ee)})}),S&&c.jsx(xM,{children:S&&c.jsxs(yM,{children:[c.jsx(gt,{design:"secondary",onClick:$,children:k}),c.jsx(gt,{onClick:T,disabled:!B||L===null||E,children:C})]})})]})]})},MM=(e,r,a)=>{let o="off",s=!1;if(r===null)return o;const u=RC(r).days===0;try{s=BC(e,r)}catch{s=!1}return(s||Vi(r.start,e))&&(u?o="single":Vi(r.start,e)?o="start":Vi(r.end,e)?o="end":o="inside"),o},ms=(e,r)=>ud(r,{hours:e.getHours(),minutes:e.getMinutes(),seconds:e.getSeconds(),milliseconds:e.getMilliseconds()}),$M=(e,r)=>{if(e&&r===void 0)return null;const a=r||gd(oi(new Date));return a instanceof Date?gd(a):a},AM=(e,r)=>{if(!r?.start)return!1;try{const a=r.start.getFullYear(),o=r.start.getMonth();if(e.getFullYear()<a||e.getFullYear()===a&&e.getMonth()<=o)return!0}catch(a){console.warn("Invalid available range:",r,a)}return!1},LM=(e,r)=>{if(!r?.end)return!1;try{const a=r.end.getFullYear(),o=r.end.getMonth();if(e.getFullYear()>a||e.getFullYear()===a&&e.getMonth()>=o)return!0}catch(a){console.warn("Invalid available range:",r,a)}return!1},OM=(e,r)=>{if(!r)return!1;const{start:a,end:o}=r;try{if(a&&e<a&&!Vi(e,a)||o&&e>o&&!Vi(e,o))return!0}catch(s){console.warn("Invalid available range:",r,s)}return!1},zM=(e,r)=>r?r.some(a=>Vi(e,a)):!1,_M=b.div`
...
`,DM=b.div`
  display: inline-flex;
  flex-direction: column;
`,i5=({children:e,...r})=>c.jsx(_M,{...r,children:c.jsx(DM,{children:c.jsx(c.Fragment,{children:e})})}),RM=b.div`
...
`,GM=b.div`
  ...
  `};
`,l5=({title:e,value:r,optionType:a="text",selected:o=!1,disabled:s=!1,onClick:u=()=>{},...f})=>{const p=Rd.icons.weights.regular;return c.jsxs(GM,{onClick:u,disabled:s,selected:o,...f,children:[a==="checkbox"&&c.jsx(tl,{children:c.jsx(ed,{children:o&&c.jsx(UM,{children:c.jsx(Wb,{color:"inverse",stroke:"inverse",size:12,weight:p})})})}),a==="radio"&&c.jsx(nl,{children:c.jsx(Ls,{})}),c.jsx(As,{children:e})]})},s5=b.div`
  padding: 0 2px;
`,PM=b.div`
...
`,FM=({color:e="subtle",hasBorder:r=!0,iconSize:a=12,disabled:o=!1,noBackground:s=!1,hasCrossButton:u=!1,onCrossClick:f=()=>{},width:p,children:m,formAction:x,...y})=>c.jsxs(PM,{hasBorder:r,disabled:o,noBackground:s,width:p,children:[c.jsx(s5,{children:c.jsx(Se,{color:e,icon:"Search",weight:"regular",size:a})}),c.jsx(WM,{color:e,disabled:o,...y}),u&&c.jsxs(qM,{onClick:f,children:[" ",c.jsx(Se,{icon:"CloseCompact",color:"dimmed",size:12})]})]}),Vs=e=>e==null||e.value===void 0||e.value===null||e.text===null?!1:(typeof e.value=="number"||typeof e.value=="string")&&typeof e.text=="string",YM=b.div`
  position: relative;
`,VM=b.div`
  display: inline-block;
`,ZM=b.div`
  ...
  `};
`,XM=(e,r,a)=>{let o="bottom-right";const s=e.left+r>window.innerWidth,u=e.bottom+a>window.innerHeight,f=e.bottom>a;return s&&u&&f&&(o="top-left"),u&&!s&&f&&(o="top-right"),!u&&s&&(o="bottom-left"),o},c5=h.forwardRef(({buttonIcon:e,buttonText:r,disabled:a=!1,minWidth:o=270,minHeight:s=190,isSortAscending:u,design:f="default",noCloseOnClickOutside:p,children:m,onToggleOpenCallback:x=()=>{},onCloseCallback:y=()=>{},...v},k)=>{const[C,S]=h.useState({isOpen:!1,position:"bottom-right"}),E=h.useRef(null),T=h.useRef(null),$=h.useCallback(()=>{p||(C.isOpen&&y(),S(z=>({...z,isOpen:!1})))},[p,y,C.isOpen]);np(T,$);const L=h.useCallback((z,D)=>{if(!E.current)return;const H=E.current.getBoundingClientRect();if(!H)return;const j=XM(H,z,D);x(!C.isOpen),S(A=>{const P=!A.isOpen;return{...A,isOpen:P,position:j}})},[x,C.isOpen]),N=h.useCallback(()=>{S(z=>({...z,isOpen:!1}))},[]);return h.useImperativeHandle(k,()=>({imperativeClose:N})),c.jsxs(YM,{ref:T,...v,children:[c.jsx(VM,{ref:E,children:c.jsx(o5,{icon:e,isOpen:C.isOpen,onClick:()=>L(o,s),disabled:a,isSortAscending:u,design:f,hasFlipArrow:!0,children:r})}),c.jsx(ZM,{openState:C,disabled:a,minWidth:o,children:c.jsx(c.Fragment,{children:m})})]})}),QM=b.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,n$=b.div`
  ...
  align-items: center;
  gap: 8px;
`,r$=({resetText:e="Reset",cancelText:r="Cancel",closeText:a="Close",applyText:o="Apply",hasReset:s=!1,hasApply:u=!1,disableApply:f=!1,disableReset:p=!0,onReset:m=()=>{},onCancel:x=()=>{},onApply:y=()=>{}})=>c.jsxs(e$,{children:[c.jsx(t$,{children:s&&c.jsx(gt,{size:"small",design:"text-only",disabled:p,onClick:m,children:e})}),u&&c.jsxs(n$,{children:[c.jsx(gt,{size:"small",design:"secondary",onClick:x,children:f?a:r}),c.jsx(gt,{size:"small",onClick:y,disabled:f,children:o})]})]}),a$=b.div`
  display: inline-block;
  position: relative;
`,u5=b(l5)`
  letter-spacing: 0.2px;
...
`,f$=b.div`
  ...
  transform: translateX(-50%);
  pointer-events: none;
`,h$=(e,r)=>{let a=!1;return Array.isArray(r)?r.forEach(o=>{o.value===e.value&&(a=!0)}):Vs(r)&&(a=e.value===r.value),a},g$=(e,r,a)=>{let o=!1;if(a==="checkbox"){const s=Array.isArray(r)?r:Vs(r)?[r]:[],u=[];return s.forEach(f=>{e.value===f.value?o=!0:u.push(f)}),o||u.push(e),u.length===0?null:u}return e},vs=(e,r)=>{if(e.length<=1)return e;const a=[...e],o=document.documentElement.lang||"en";return a.sort((s,u)=>{const f=s.text.localeCompare(u.text,o);return r?f:-f}),a},oa=(e,r,a,o)=>{if(e.length<=r||a===null)return vs(e,o);if(Vs(a)){const s=e.findIndex(p=>p.value===a.value);if(s===-1||s<r)return vs(e,o);const u=e.filter(p=>p.value!==a.value),f=vs(u,o);return f.unshift(e[s]),f}if(Array.isArray(a)){const s=new Set(a.map(x=>x.value)),u=[],f=[];for(const x of e)s.has(x.value)?u.push(x):f.push(x);const p=vs(u,o),m=vs(f,o);return[...p,...m]}return e},p$=(e,r)=>e.filter(a=>a.text.toLowerCase().includes(r.toLowerCase())),m$=(e,r,a)=>e.replace("[TOTAL]",`${a}`).replace("[VISIBLE]",`${r}`),v$=(e,r)=>e===null&&r===null?!0:e===null||r===null?!1:Array.isArray(e)&&Array.isArray(r)?e.length!==r.length?!1:e.every(a=>r.some(o=>o.value===a.value)):Array.isArray(e)||Array.isArray(r)?!1:e.value===r.value,x$=({buttonIcon:e,buttonText:r,list:a,selected:o=null,disabled:s=!1,isLoading:u=!1,loadingText:f,optionType:p="text",hasOptionsFilter:m,searchPlaceholder:x,maxDisplayedItems:y=5,searchResultText:v="Showing [VISIBLE] of [TOTAL]",emptyResultText:k,design:C="default",resetText:S,cancelText:E,closeText:T,applyText:$,hasReset:L,hasApply:N,descendingText:z="Descending",ascendingText:D="Ascending",isListAscending:H=!0,onSelect:j=()=>{},onResetCallback:A=()=>{},onCancelCallback:P=()=>{},...X})=>{const[B,V]=h.useState(H),[F,se]=h.useState(oa(a,y,o,B)),[oe,U]=h.useState(""),[q,ee]=h.useState(o),ne=h.useRef(null),ae=h.useCallback(()=>{se(oa(a,y,q,B))},[B,a,y,q]),O=h.useCallback(()=>{U(""),ee(o),V(H),se(oa(a,y,o,H))},[H,a,y,o]),Z=h.useCallback(pe=>{const Te=g$(pe,q,p);N||j(Te),ee(Te),se(oa(a,y,Te,B)),U("")},[q,p,N,a,y,B,j]),re=h.useCallback(pe=>{const Te=pe.target.value.replace(/<[^>]*>/g,"").trim();if(U(Te),Te===""){se(oa(a,y,q,B));return}const pt=p$(a,Te);se(oa(pt,y,null,B))},[B,a,y,q]),ue=h.useCallback(()=>{ee(o),P(),ne.current?.imperativeClose()},[P,o]),fe=h.useCallback(()=>{j(q),ne.current?.imperativeClose()},[j,q]),me=h.useCallback(()=>{N||j(null),U(""),se(oa(a,y,null,H)),ee(null),V(H),A()},[N,a,y,H,A,j]),he=h.useCallback(()=>{V(pe=>(se(oa(a,y,q,!pe)),!pe))},[a,y,q]);h.useEffect(()=>{let pe=!0;return pe&&(U(""),se(oa(a,y,q,B))),()=>{pe=!1}},[B,a,y,q]),h.useEffect(()=>{ee(o)},[o]);const xe=h.useMemo(()=>v$(q,o),[o,q]);return c.jsx(a$,{...X,children:c.jsx(c5,{ref:ne,buttonIcon:e,buttonText:r,disabled:s,design:C,onCloseCallback:ae,onToggleOpenCallback:O,noCloseOnClickOutside:N,children:c.jsxs(i5,{children:[m&&c.jsx(u$,{children:c.jsx(FM,{type:"text",hasBorder:!1,placeholder:x,color:"dimmed",iconSize:12,value:oe,onChange:re,noBackground:!0})}),u||!a?c.jsx(JM,{loadingText:f}):c.jsxs(o$,{children:[m&&c.jsxs(s$,{children:[c.jsx(c$,{children:m$(v,F.length,a.length)}),c.jsx(l$,{children:c.jsx(Zg,{design:"text-only",position:"left",size:"xsmall",weight:"light",onClick:he,icon:B?"FilterAscending":"FilterDescending",children:B?D:z})})]}),c.jsx(i$,{moreItem:a.length>5,children:F.length>0?F.map((pe,Te)=>{const pt=pe.value,ut=pe.text;return c.jsx(u5,{title:ut,onClick:()=>Z(pe),selected:h$(pe,q),optionType:p,value:pt},Te)}):c.jsx(d$,{children:k})}),a.length>5&&c.jsx(f$,{})]}),(N||L)&&c.jsx(r$,{hasApply:N,hasReset:L,resetText:S,cancelText:E,closeText:T,applyText:$,onCancel:ue,onApply:fe,disableApply:xe,onReset:me,disableReset:q===null&&B===H&&oe===""})]})})})};b.div`
  display: inline-block;
  position: relative;
`;const y$=b(l5)`
  letter-spacing: 0.2px;
...
`;const w$=470,S$=360,C$=b.div``,k$=({buttonIcon:e,buttonText:r,disabled:a,initialValue:o,dateMode:s,timeMode:u,selected:f,dateTimeTextUpper:p,dateTimeTextLower:m,timeZoneTitle:x,timeZoneValueTitle:y,lang:v,hasEmptyValue:k,availableRange:C,contentDays:S,cancelText:E="Cancel",applyText:T="Apply",hasApply:$=!0,onCloseCallback:L=()=>{},onUpdateCallback:N=()=>{},onToggleCallback:z=()=>{},onCancelCallback:D=()=>{},onApplyCallback:H=()=>{},...j})=>{const A=h.useRef(null),[P,X]=h.useState({initialValue:o,isMount:!0}),[B,V]=h.useState(!1),F=h.useRef(null),se=h.useCallback(ne=>{A.current=ne,N(ne),V(bT(f,ne))},[N,f]),oe=h.useCallback(()=>{A.current&&A.current!==f&&L(A.current)},[L,f]),U=h.useCallback(ne=>{!$&&A.current&&A.current!==f&&z(A.current,ne),ne&&!P.isMount&&X(ae=>({...ae,isMount:!0}))},[$,P.isMount,z,f]),q=h.useCallback(()=>{A.current&&A.current!==f&&(A.current=f===void 0?null:f,X({initialValue:f===null?void 0:f,isMount:!1})),D(),F.current?.imperativeClose()},[D,f]),ee=h.useCallback(()=>{A.current&&A.current!==f&&H(A.current),F.current?.imperativeClose()},[H,f]);return h.useEffect(()=>{let ne=!0;return ne&&f===null&&A.current!==null&&(A.current=f,X({initialValue:void 0,isMount:!1})),()=>{ne=!1}},[f]),c.jsx(C$,{...j,children:c.jsx(c5,{ref:F,minWidth:w$,minHeight:S$,onCloseCallback:oe,onToggleOpenCallback:U,noCloseOnClickOutside:$,buttonIcon:e,buttonText:r,disabled:a,children:c.jsx(i5,{children:P.isMount&&c.jsx(TM,{dateMode:s,timeMode:u,dateTimeTextUpper:p,dateTimeTextLower:m,timeZoneTitle:x,timeZoneValueTitle:y,lang:v,availableRange:C,contentDays:S,cancelText:E,applyText:T,hasApply:$,updateCallback:se,cancelCallback:q,applyCallback:ee,hasEmptyValue:!0,initialValue:P.initialValue,disableApply:B})})})})},E$=pr`
  0% {
    width: 50%;
    opacity: .5;
  }
...
`,I$=b.div`
  ...
  transition: background-color var(--speed-slow) var(--easing-primary-in-out);
  background-color: ${({theme:e,color:r})=>r?e.colors.status[r]:"var(--grey-5)"};
`,f5=({icon:e,status:r,counter:a,maxCounter:o=999})=>c.jsxs(H$,{children:[r&&a===void 0?c.jsx(I$,{color:r}):a===void 0?null:c.jsx(B$,{color:r,children:a>o?`${o}+`:a}),c.jsx(Se,{icon:e,size:18,color:"dimmed"})]}),U$=pr`
 0% {
    transform: scale(1);
 }
...
`,tA=e=>{const{index:r,useAngles:a,angle:o,unit:s,size:u,lineSetId:f,x:p,y:m,moveCallback:x,moveEndCB:y=()=>{},Icon:v,rotate:k=0,options:C,readOnlyHandle:S=!1,styling:E="primary"}=e,T=qe.createRef(),[$,L]=h.useState(!1),[N,z]=h.useState(!1),[D,H]=h.useState(null),j=h.useCallback(ee=>{if(ee.preventDefault(),!S)for(let ne=0;ne<ee.touches.length;ne++){const ae=ee.touches[ne];(ae.target.parentNode.parentElement===T||ae.target.parentNode.parentElement.parentElement)&&(L(!0),H(ne))}},[T,S]),A=h.useCallback(()=>{S||(L(!1),H(null),y())},[y,S]),P=h.useCallback(ee=>{if(!S)for(let ne=0;ne<ee.touches.length;ne++)ne===D&&x({x:ee.touches[ne].pageX,y:ee.touches[ne].pageY},r)},[r,x,S,D]),X=h.useCallback(ee=>{ee.preventDefault(),!S&&x({x:ee.pageX,y:ee.pageY},r)},[r,x,S]),B=h.useCallback(ee=>{ee.preventDefault(),!S&&(z(!1),window.removeEventListener("mousemove",X),window.removeEventListener("mouseup",B),x({x:ee.pageX,y:ee.pageY},r),setTimeout(y))},[X,r,x,y,S]),V=h.useCallback(ee=>{ee.preventDefault(),!S&&(z(!0),window.addEventListener("mousemove",X),window.addEventListener("mouseup",B))},[X,B,S]),F=a?"mask-"+f+"-"+r:"",se="shadowGradient-"+f+"-"+r,{showPointHandle:oe=!0,showPointLabel:U=!1,pointIndexOffset:q}=C;return c.jsxs(P$,{ref:T,styling:E,x:p,y:m,mouseDragging:N,onTouchStart:j,onTouchEnd:A,onTouchMove:P,onMouseDown:V,children:[c.jsxs("defs",{children:[c.jsxs("mask",{id:F,children:[c.jsx("rect",{width:"100%",height:"100%",x:"-50%",y:"-50%",fill:"white"}),c.jsx("rect",{width:u/3,height:u/.9,x:-(u/3/2),y:-(u/.9+5),fill:"black",transform:`rotate(${o||0} 0 0)`})]}),c.jsxs("radialGradient",{id:se,children:[c.jsx(Q$,{styling:E,offset:"0%"}),c.jsx(K$,{styling:E,offset:"80%"})]})]}),v?c.jsx(eA,{transform:`scale(${s*1.5}) translate(-21 -21) rotate(${k}, 21, 21 )`,children:c.jsx(v,{height:"42",width:"42"})}):oe&&c.jsxs("g",{transform:`scale(${s})`,children:[c.jsx(Z$,{r:u*1,fillID:se}),c.jsx(V$,{styling:E,r:u/2.4,strokeWidth:u/3}),c.jsxs(W$,{touchDragging:$,mouseDragging:N,children:[c.jsx(F$,{styling:E,r:u/1.8}),c.jsx(Y$,{styling:E,r:u/2.25,strokeWidth:u/3})]}),c.jsx(q$,{styling:E,r:u/2,strokeWidth:u/6,maskID:F}),U&&c.jsx(X$,{showIndex:!0,children:c.jsx(J$,{styling:E,transform:"translate(-5,6)",fontSize:"20px",showIndex:!0,children:r+q})})]})]})},nA=b.line`
...
`,yy=b(Se)`
  cursor: pointer;
`,lA=e=>{const{x1:r,y1:a,x2:o,y2:s,unit:u,lineMoveCallback:f,lineMoveStartCallback:p,options:m,lineSetId:x,label:y,styling:v="primary",moveEndCB:k=()=>{},lineClickCallback:C=()=>{},showSmallDirectionMark:S=!1,overrideShowMoveHandle:E=!0}=e,{handleFinderActive:T,revealSetIndex:$,showMoveHandle:L,setIndexOffset:N,showDirectionMark:z,showLabelShadow:D=!1}=m,[H,j]=h.useState(),A=!L||!E,P=parseInt(e.lineClickSensingBorder),X=ae=>{for(let O=0;O<ae.touches.length;O++)f({x:ae.touches[O].pageX,y:ae.touches[O].pageY});k()},B=ae=>{for(let O=0;O<ae.touches.length;O++)p({x:ae.touches[O].pageX,y:ae.touches[O].pageY})},V=ae=>{p({x:ae.pageX,y:ae.pageY}),window.addEventListener("mousemove",se),window.addEventListener("mouseup",F),ae.preventDefault()},F=ae=>{window.removeEventListener("mousemove",se),window.removeEventListener("mouseup",F),f({x:ae.pageX,y:ae.pageY}),k(),ae.preventDefault()},se=ae=>{f({x:ae.pageX,y:ae.pageY}),ae.preventDefault()},oe={x:(o+r)/2,y:(s+a)/2},U=()=>{const ae=Math.atan2(s-a,o-r),O=Math.PI/2-ae,Z=oe.x+Math.sin(O)-5,re=oe.y+Math.cos(O),ue=180/Math.PI*Math.atan2(s-a,o-r),fe=-ue;return{x:Z,y:re,rotate:ue,labelRotate:fe}},q=()=>{const ae=U();return c.jsxs("g",{transform:`translate(${ae.x},${ae.y}) rotate(${ae.rotate}) scale(${u*1})`,style:{cursor:"pointer"},children:[c.jsxs("g",{onClick:()=>C(x),transform:"translate(-3,-30) scale(0.8)",children:[c.jsx(xy,{r:12,cx:6,cy:7}),c.jsx(yy,{color:"inverse",icon:"Up",size:12,weight:"heavy",forSvgUsage:!0})]}),S&&c.jsxs("g",{onClick:()=>C(x),transform:"translate(5,25) rotate(-180) scale(0.8)",children:[c.jsx(xy,{r:8,cx:3.5,cy:4.5}),c.jsx(yy,{color:"inverse",icon:"Up",size:7,weight:"heavy",forSvgUsage:!0})]}),y&&c.jsx("g",{transform:`translate(0,${S?45:30}) rotate(${ae.labelRotate})`,children:c.jsx(vy,{onClick:()=>C(x),textAnchor:S?ae.labelRotate<0?"end":"start":"middle",dominantBaseline:"middle",styling:v,fontSize:"14px",x:0,y:0,showIndex:$||T,showLabelShadow:D,children:y})})]})},ee=h.useCallback(()=>{e.hasClickSensingBorder&&j(!0)},[e.hasClickSensingBorder]),ne=h.useCallback(()=>{e.hasClickSensingBorder&&j(!1)},[e.hasClickSensingBorder]);return c.jsxs("g",{children:[c.jsx(nA,{onMouseOver:ee,onMouseOut:ne,lineClickSensing:P,showLineBorder:H,onClick:()=>C(x),styling:v,strokeLinecap:"round",x1:r,y1:a,x2:o,y2:s,strokeWidth:4*u}),c.jsx(rA,{styling:v,x1:r,y1:a,x2:o,y2:s,strokeWidth:2*u}),c.jsxs(oA,{styling:v,showIndex:T&&$,originalRadius:8*u,children:[c.jsx(lg,{styling:v,r:8*u,strokeWidth:4*u,cx:oe.x,cy:oe.y,hide:A}),c.jsx(md,{styling:v,textAnchor:"middle",r:8*u,strokeWidth:1*u,cx:oe.x,cy:oe.y,hide:A,onTouchMove:X,onTouchStart:B,onMouseDown:V})]}),c.jsx(aA,{showIndex:!A&&(T||$),children:c.jsx(iA,{styling:v,fontSize:`${u*10}px`,x:oe.x-3*u,y:oe.y+4*u,showIndex:$||T,children:x+N})}),z?q():y&&c.jsx(vy,{styling:v,fontSize:`${u*14}px`,x:oe.x-16*u,y:oe.y-15*u,showIndex:$||T,showLabelShadow:D,children:y})]})},ro=h.createContext({}),sA=b.polygon`
  fill: ${({color:e})=>e};
  opacity: ${({opacity:e})=>e};
`,cA=b.circle`
...
`,uA=b.text`
  ...
  ${({showAreaLabelShadow:e})=>e&&R`
    text-shadow:
      ...
      1px 1px 0 #000;
  `}
`,dA=({lineSetData:e,unit:r,showAreaLabelShadow:a})=>{const o=e.points.length;if(o<3)return null;let s={x:0,y:0};e.points.map(({x:f,y:p})=>(s.x+=f,s.y+=p,null)),s={x:s.x/o,y:s.y/o};const u=e.areaName?.length||1;return c.jsx(uA,{fontSize:`${r*14}px`,styling:e.styling||"primary",x:s.x-4*u*r,y:s.y+6*r,showAreaLabelShadow:a,children:e.areaName})},ip=({getCTM:e,boundaries:r,unit:a,size:o,lineSetId:s,options:u,onLineMoveEnd:f,onLineClick:p,lineClickSensingBorder:m,hasClickSensingBorder:x})=>{const{state:y,dispatch:v}=h.useContext(ro),k=y[s],{showLabelShadow:C=!1}=u,[S,E]=h.useState([]),T=h.useRef([]),$=o/2,L=k.points.length===2,N=h.useCallback(F=>(F.x<r.x.min?F.x=r.x.min:F.x>r.x.max&&(F.x=r.x.max),F.y<r.y.min?F.y=r.y.min:F.y>r.y.max&&(F.y=r.y.max),F),[r]),z=h.useCallback((F,se)=>{const oe=e();if(!oe)return;const U=N({x:(F.x-window.scrollX-oe.e)/oe.a,y:(F.y-window.scrollY-oe.f)/oe.d}),q={x:Math.round(U.x),y:Math.round(U.y)},ee=la(k,{points:{[se]:{$merge:q}}});v({type:"UPDATE",index:s,data:ee})},[e,N,k,v,s]),D=h.useCallback(F=>{const se=e();if(!se)return;const oe={x:(F.x-window.scrollX-se.e)/se.a-$,y:(F.y-window.scrollY-se.f)/se.d-$};T.current=k.points.map(U=>{const q=oe.x-U.x,ee=oe.y-U.y;return{offsetX:q,offsetY:ee}})},[$,k.points,e]),H=h.useCallback(F=>{const se=e();if(!se)return;const{points:oe}=k,U={x:(F.x-window.scrollX-se.e)/se.a-$,y:(F.y-window.scrollY-se.f)/se.d-$},q=oe.map((ee,ne)=>{const{offsetX:ae=0,offsetY:O=0}=T.current[ne]||{};return N({x:Math.round(U.x-ae),y:Math.round(U.y-O)})});v({type:"UPDATE",index:s,data:{...k,points:[...q]}})},[e,k,$,v,s,N]),j=(F,se,oe,U)=>Math.atan2(U-se,oe-F)*180/Math.PI+90,A=h.useCallback(F=>{const{points:se}=F,oe=[];F.points.forEach((U,q)=>{const ee=q+2>se.length?0:q+1,ne=se[ee],ae=j(U.x,U.y,ne.x,ne.y);oe.push(ae)}),E(oe)},[]);h.useEffect(()=>{L&&A(k)},[k,A,L]);const P=(k?.showPointHandle===void 0||k?.showPointHandle)&&k.points.map(({x:F,y:se},oe)=>c.jsx(tA,{lineSetId:s,rotate:k.rotate,Icon:k.icon,index:oe,unit:a,size:o,useAngles:L,angle:S[oe],x:F,y:se,moveEndCB:f,moveCallback:z,options:u,styling:k.styling,readOnlyHandle:k.readOnly},oe+s)),X=u.showPoint&&k.points.map(({x:F,y:se},oe)=>c.jsx(cA,{styling:k.styling||"primary",r:a,cx:F,cy:se},oe)),B=k.points.map(({x:F,y:se},oe)=>{const{points:U,name:q,styling:ee="primary"}=k,ne=oe+1>=U.length?0:oe+1;if(oe===1&&ne===0)return null;const{x:ae,y:O}=U[ne];return c.jsx(lA,{moveEndCB:f,lineSetId:s,options:u,x1:F,y1:se,x2:ae,y2:O,unit:a,label:q,styling:ee,lineClickCallback:p,lineMoveCallback:H,lineMoveStartCallback:D,showSmallDirectionMark:k.showSmallDirectionMark,overrideShowMoveHandle:k.showMoveHandle,lineClickSensingBorder:m,hasClickSensingBorder:x},oe)}),V=k.points.map(F=>`${F.x},${F.y}`).join(" ");return c.jsxs("g",{children:[c.jsx(sA,{points:V,color:k.areaFillColor?k.areaFillColor:"transparent",opacity:k.areaTransparencyLevel?k.areaTransparencyLevel/100:0}),B,P,X,c.jsx(dA,{lineSetData:k,unit:a,showAreaLabelShadow:C})]})},fA=b.div`
  position: relative;
  line-height: 0;
  user-select: none;
  touch-action: none;
...
`,pA=b.img`
  ...
  width:  100%;
  height: 100%;
`,mA=({src:e,onSizeChange:r=()=>{},onLineMoveEnd:a=()=>{},onLineClick:o=()=>{},lineClickSensingBorder:s="65",hasClickSensingBorder:u=!0,options:{showHandleFinder:f,showSetIndex:p,showPointLabel:m=!1,showLabelShadow:x=!1,showPointHandle:y,showMoveHandle:v,showGrabHandle:k,setIndexOffset:C=0,pointIndexOffset:S=0,showPoint:E=!1,fixedImgDimensions:T,boundaryOffset:$=0,showDirectionMark:L=!1}={}})=>{const[N,z]=h.useState({x:{min:0,max:0},y:{min:0,max:0}}),{state:D}=h.useContext(ro),[H,j]=h.useState(!1),[A,P]=h.useState(!1),[X,B]=h.useState({h:1,w:1}),[V,F]=h.useState(1),se=h.useRef(null),oe=h.useRef(null),U=h.useCallback(()=>{if(!se.current)return;const{naturalHeight:O,naturalWidth:Z,clientHeight:re}=se.current,ue=T&&T.y||O,fe=T&&T.x||Z;(ue!==X.h||fe!==X.w)&&(B({h:ue,w:fe}),r({h:ue,w:fe}),console.debug("image size:",{naturalHeight:O,naturalWidth:Z,clientHeight:re,unit:O/re})),ue/re!==V&&F(ue/re),P(!0)},[T,X.h,X.w,r,V]),q=h.useCallback(()=>{if(!oe.current)return null;const O=oe.current.getScreenCTM();return console.debug("calculateCTM",O),O},[]),ee=O=>{O.target===oe.current&&j(!!H&&!0)},ne=()=>{j(f||!1)};h.useEffect(()=>{if(!oe.current)return;const{viewBox:O}=oe.current,Z={x:{min:O.baseVal.x+$,max:O.baseVal.x+O.baseVal.width-$},y:{min:O.baseVal.y+$,max:O.baseVal.y+O.baseVal.height-$}};console.debug("setBoundaries",Z),z(Z)},[X,$]),h.useEffect(()=>(window.addEventListener("resize",U),()=>{window.removeEventListener("resize",U)}),[U]);const ae={handleFinderActive:H,revealSetIndex:p!==!1&&(p||D.length>1),showPointLabel:m,showLabelShadow:x,showPointHandle:y||y!==!1&&k!==!1,showMoveHandle:v||v!==!1&&k!==!1,setIndexOffset:C,pointIndexOffset:S,showPoint:E,showDirectionMark:L};return c.jsxs(fA,{children:[c.jsx(pA,{ref:se,onLoad:U,src:e,alt:""}),A&&N?c.jsx(gA,{ref:oe,viewBox:`0 0 ${X.w} ${X.h} `,version:"1.1",xmlns:"http://www.w3.org/2000/svg",onPointerDown:ee,onPointerUp:ne,onPointerLeave:ne,transculent:H,children:D.map((O,Z)=>c.jsx(ip,{hasClickSensingBorder:u,lineClickSensingBorder:s,onLineMoveEnd:a,onLineClick:o,lineSetId:Z,lineData:O,getCTM:q,boundaries:N,unit:V,size:30,options:ae},Z))}):c.jsx(hA,{children:c.jsx(mr,{size:"large",styling:"primary"})})]})},vA=b.div`
  position: relative;
  line-height: 0;
  user-select: none;
  touch-action: none;
...
`,wA=({src:e,onSizeChange:r=()=>{},onLineMoveEnd:a=()=>{},onLineClick:o=()=>{},onLoaded:s=()=>{},lineClickSensingBorder:u="65",hasClickSensingBorder:f=!0,videoOptions:{loop:p=!1,autoPlay:m=!1,controls:x=!1,muted:y=!0,...v},options:{showHandleFinder:k,showSetIndex:C,showPointLabel:S=!1,showPointHandle:E,showLabelShadow:T,showMoveHandle:$,showGrabHandle:L,setIndexOffset:N=0,pointIndexOffset:z=0,showPoint:D=!1,boundaryOffset:H=0,showDirectionMark:j=!1}={}})=>{const A=h.useRef(null),P=h.useRef(null),[X,B]=h.useState({x:{min:0,max:0},y:{min:0,max:0}}),{state:V}=h.useContext(ro),[F,se]=h.useState(!1),[oe,U]=h.useState({h:768,w:1024}),[q,ee]=h.useState(1),[ne,ae]=h.useState(!1),O=h.useCallback(()=>{if(!P.current)return;const{videoHeight:he,videoWidth:xe,clientHeight:pe}=P.current;(he!==oe.h||xe!==oe.w)&&(U({h:he,w:xe}),r({h:he,w:xe})),he/pe!==q&&ee(he/pe)},[oe.h,oe.w,q,r]),Z=he=>{he.target===A.current&&se(!!F&&!0)},re=()=>{se(k||!1)},ue=h.useCallback(()=>A.current?A.current.getScreenCTM():null,[]);h.useEffect(()=>{if(!A.current||!ne)return;const{viewBox:he}=A.current,xe={x:{min:he.baseVal.x+H,max:he.baseVal.x+he.baseVal.width-H},y:{min:he.baseVal.y+H,max:he.baseVal.y+he.baseVal.height-H}};B(xe)},[oe,ne,H]);const fe=h.useCallback(({target:he})=>{if(he){ae(!0),O();const{videoHeight:xe=1,videoWidth:pe=1}=he;s({height:xe,width:pe})}},[O,s]);h.useEffect(()=>(window.addEventListener("resize",O),()=>{window.removeEventListener("resize",O)}),[O]);const me={handleFinderActive:F,revealSetIndex:C!==!1&&(C||V.length>1),showPointLabel:S,showLabelShadow:T,showPointHandle:E||E!==!1&&L!==!1,showMoveHandle:$||$!==!1&&L!==!1,setIndexOffset:N,pointIndexOffset:z,showPoint:D,showDirectionMark:j};return c.jsxs(vA,{children:[c.jsx(xA,{ref:P,controls:x,muted:y,autoPlay:m,loop:p,...v,onLoadedMetadata:fe,src:e,id:"1",children:" "}),!ne&&c.jsx(yA,{children:c.jsx(mr,{size:"large",styling:"primary"})}),ne&&c.jsx(bA,{ref:A,viewBox:`0 0 ${oe.w} ${oe.h} `,version:"1.1",xmlns:"http://www.w3.org/2000/svg",onPointerDown:Z,onPointerUp:re,onPointerLeave:re,transcalent:F,children:V.map((he,xe)=>c.jsx(ip,{hasClickSensingBorder:f,lineClickSensingBorder:u,onLineMoveEnd:a,onLineClick:o,lineSetId:xe,lineData:he,getCTM:ue,boundaries:X,unit:q,size:30,options:me},xe))})]})},SA=b.video`
  /* width: 800px; */
`,CA=({id:e="1",enabled:r,peerAddress:a,maxConnectionAttempts:o=30,rtcConfiguration:s={},setStatus:u=()=>{},setError:f=()=>{},autoPlay:p=!0,muted:m=!0,children:x,...y})=>{const[v,k]=h.useState(0),C=h.useRef(null),S=h.useRef(null),E=h.useRef(null);function T(B){f(B),P()}const $=async B=>{if(!E.current||!S.current)return;try{B.type==="offer"&&E.current.signalingState!=="stable"?await Promise.all([E.current.setLocalDescription({type:"rollback"}),E.current.setRemoteDescription(B)]):(B.sdp&&(B.sdp=B.sdp.replace(/profile-level-id=(640028|64001f|64002a);/,"")),await E.current.setRemoteDescription(new RTCSessionDescription(B)),u("Remote Description set"))}catch(F){console.error("Error:",F),f("Error Setting remote description");return}if(B.type!=="offer")return;u("Creating Answer");try{const F=await E.current.createAnswer();console.debug("Got local description: "+JSON.stringify(F)),await E.current.setLocalDescription(F)}catch(F){console.error(F),F instanceof Error&&f(F.message);return}const V={sdp:E.current.localDescription};u("Sending Local Description");try{await S.current.send(JSON.stringify(V)),u("Connected")}catch(F){console.error(F),F instanceof Error&&f(F.message)}};function L(B){if(!E.current){console.error("peerConnection.current not found onIncomingICE ");return}const V=new RTCIceCandidate(B);E.current.addIceCandidate(V).catch(f)}const N=({data:B=""})=>{if(B==="HELLO")console.debug("Received HELLO"),u("Registered with server, waiting for offer.");else if(B.startsWith("ERROR"))console.error("Received "+B),T(B);else{let V;try{V=JSON.parse(B)}catch(F){F instanceof SyntaxError?T("Error parsing incoming JSON: "+B):T("Unknown error parsing response: "+B);return}E.current||A(V),V.sdp!=null?(console.debug("Received Remote SDP:"+JSON.stringify(V.sdp)),$(V.sdp)):V.ice!=null?(console.debug("Received Remote ICE:"+JSON.stringify(V.ice)),L(V.ice)):T("Unknown incoming JSON: "+V)}};function z(B){console.debug("serverClose"),S.current&&(u("Disconnected from server"),X(),B!==null&&B.code!==1e3&&r&&window.setTimeout(H,3e3))}function D(B){console.debug(B),f("Unable to connect to server"),P()}function H(){if(console.debug("connectToPeer",v),v>=o){f("Too many connection attempts, aborting. Refresh page to try again");return}f(null);const B=kA(e);u("Connecting to server "+a);const V=new WebSocket(a);S.current=V,V.addEventListener("open",()=>{const F=setInterval(()=>{try{V.send("HELLO "+B),clearInterval(F),u("Registering with server (sent HELLO) for peer id: "+B)}catch(se){console.debug(se)}},3e3)}),V.addEventListener("error",D),V.addEventListener("message",N),V.addEventListener("close",z),k(v+1)}function j(B){C.current&&C.current.srcObject!==B.streams[0]&&(console.debug("Incoming stream"),C.current.srcObject=B.streams[0],u("Adding Track"))}function A(B){if(k(0),console.debug("Creating RTCPeerConnection"),!B.sdp){console.debug("WARNING: First message wasn't an SDP message!?");return}const V=new RTCPeerConnection(s);E.current=V,V.addEventListener("track",j),V.addEventListener("icecandidate",({candidate:F=null})=>{if(!F){console.debug("All local ICE Candidates sent.");return}S.current?S.current.send(JSON.stringify({ice:F})):console.debug("no WS found on peer connection 'icecandidate' event... how?")}),u("RTCPeerConnection created, waiting for SDP")}const P=async()=>{console.debug("closeWebSocket"),await X(),S.current&&(await S.current.close(),S.current=null)},X=async()=>{console.debug("closePeerConnection"),E.current&&(await E.current.close(),E.current=null)};return h.useEffect(()=>(r===!0?H():S.current&&S.current.close(1e3,"WebRTC Disabled"),()=>{console.debug("cleanup"),P()}),[r]),c.jsx(SA,{...y,autoPlay:p,muted:m,ref:C,children:c.jsx(c.Fragment,{children:x})})};function kA(e){return"WRP_"+e+"_"+Math.floor(Math.random()*8990+10).toString()}const EA=b.div`
  position: relative;
  line-height: 0;
  user-select: none;
  touch-action: none;
...
`,$A=({ws:e,onSizeChange:r=()=>{},onLineMoveEnd:a=()=>{},onLineClick:o=()=>{},onLoaded:s=()=>{},lineClickSensingBorder:u="65",hasClickSensingBorder:f=!0,videoOptions:p,options:{showHandleFinder:m,showSetIndex:x,showPointLabel:y=!1,showLabelShadow:v=!1,showPointHandle:k,showMoveHandle:C,showGrabHandle:S,setIndexOffset:E=0,pointIndexOffset:T=0,showPoint:$=!1,boundaryOffset:L=0,showDirectionMark:N=!1}={}})=>{const z=h.useRef(null),D=h.useRef(null),[H,j]=h.useState({x:{min:0,max:0},y:{min:0,max:0}}),{state:A}=h.useContext(ro),[P,X]=h.useState(!1),[B,V]=h.useState({h:768,w:1024}),[F,se]=h.useState(1),[oe,U]=h.useState(!1),q=h.useCallback(()=>{if(!D.current)return;const{videoHeight:re,videoWidth:ue,clientHeight:fe}=D.current;(re!==B.h||ue!==B.w)&&(V({h:re,w:ue}),r({h:re,w:ue})),re/fe!==F&&se(re/fe)},[B.h,B.w,F,r]),ee=re=>{re.target===z.current&&X(!!P&&!0)},ne=()=>{X(m||!1)},ae=h.useCallback(()=>z.current?z.current.getScreenCTM():null,[]);h.useEffect(()=>{if(!z.current||!oe)return;const{viewBox:re}=z.current,ue={x:{min:re.baseVal.x+L,max:re.baseVal.x+re.baseVal.width-L},y:{min:re.baseVal.y+L,max:re.baseVal.y+re.baseVal.height-L}};j(ue)},[B,oe,L]);const O=h.useCallback(({target:re})=>{if(re){U(!0);const ue=re;D.current=ue,q();const{videoHeight:fe=1,videoWidth:me=1}=ue;s({height:fe,width:me})}},[q,s]);h.useEffect(()=>(window.addEventListener("resize",q),()=>{window.removeEventListener("resize",q)}),[q]);const Z={handleFinderActive:P,revealSetIndex:x!==!1&&(x||A.length>1),showPointLabel:y,showLabelShadow:v,showPointHandle:k||k!==!1&&S!==!1,showMoveHandle:C||C!==!1&&S!==!1,setIndexOffset:E,pointIndexOffset:T,showPoint:$,showDirectionMark:N};return c.jsxs(EA,{children:[c.jsx(jA,{onLoadedMetadata:O,peerAddress:e,id:"1",...p,enabled:!0,children:" "}),!oe&&c.jsx(TA,{children:c.jsx(mr,{size:"large",styling:"primary"})}),oe&&c.jsx(MA,{ref:z,viewBox:`0 0 ${B.w} ${B.h} `,version:"1.1",xmlns:"http://www.w3.org/2000/svg",onPointerDown:ee,onPointerUp:ne,onPointerLeave:ne,transcalent:P,children:A.map((re,ue)=>c.jsx(ip,{hasClickSensingBorder:f,lineClickSensingBorder:u,onLineMoveEnd:a,onLineClick:o,lineSetId:ue,lineData:re,getCTM:ae,boundaries:H,unit:F,size:30,options:Z},ue))})]})},AA=(e,r)=>({x:e.x+(r.x-e.x)*.5,y:e.y+(r.y-e.y)*.5}),op=(e,r)=>{switch(r.type){case"UPDATE_SET_POINTS":case"UPDATE":{const a=r.data.points.map(o=>({...o}));return la(e,{[r.index]:{points:{$set:a}}})}case"RENAME_SET":{const a={...e[r.index],name:r.data.name};return la(e,{[r.index]:{$set:a}})}case"UPDATE_SET_OPTIONS":{const a={...e[r.index],...r.data};return la(e,{[r.index]:{$set:a}})}case"ADD_SET":return[...e,r.data];case"REMOVE_SET":return la(e,{$splice:[[r.index,1]]});case"ADD_POINT":{const a=AA(e[r.index].points[0],e[r.index].points[1]);return la(e,{[r.index]:{points:{$splice:[[1,0,a]]}}})}case"REMOVE_POINT":return e[r.index].points.length<=2?e:la(e,{[r.index]:{points:{$splice:[[e[r.index].points.length-1,1]]}}});case"LOAD":return r.state.map(({name:o,points:s,...u})=>({name:o,points:s.map(({x:f,y:p})=>({x:f,y:p})),...u}));case"UPDATE_FILL_COLOR":{const a={...e[r.index],areaFillColor:r.data.areaFillColor};return la(e,{[r.index]:{$set:a}})}case"UPDATE_TRANSPARENCY_LEVEL":{const a={...e[r.index],areaTransparencyLevel:r.data.areaTransparencyLevel};return la(e,{[r.index]:{$set:a}})}default:return console.error(`Action ${r.type} not registered.`),e}},h5=24,g5=20,LA=-g5-h5,OA=b.div`
  position: relative;
  display: flex;
  flex-direction: column;
  gap: 8px;
...
`,BA=({title:e,icon:r,areaTitle:a,areaHref:o,updateDocTitle:s=!0,hideAreaInDocTitle:u=!1,areaTitleBottom:f=!1,iconColor:p="dimmed",onAreaClick:m})=>(DT(e,u?void 0:a||"",void 0,s),c.jsxs(OA,{children:[r?c.jsx(_A,{children:c.jsx(Se,{size:h5,color:p,icon:r})}):null,c.jsxs(zA,{areaTitleBottom:f,children:[a&&m?c.jsx(HA,{onClick:m,type:"button",children:a}):a&&o?c.jsx(NA,{to:o,children:a}):a?c.jsx(RA,{children:a}):null,c.jsx(DA,{children:e})]})]})),IA=b.p`
  font-family: var(--font-ui);
  color: var(--grey-11);
  font-size: 14px;
  font-style: normal;
...
`,p5=b.div`
  ...
  `};
`,WA=({icon:e="",size:r=12,weight:a="regular",label:o="",linkTo:s,noBorder:u=!1,tagSize:f,onTagClick:p,...m})=>{const x=h.useMemo(()=>f==="compact"?8:10,[f]),y=h.useMemo(()=>f==="compact"?12:14,[f]),v=()=>c.jsxs(p5,{hoverColor:"primary",enableHover:!!(p||s),size:f?y:r,tagSize:f,noBorder:u,children:[e&&c.jsx(Se,{icon:e,size:f?x:r,weight:a,...m}),c.jsx(GA,{children:o})]});return p?c.jsx(qA,{onClick:p,type:"button",children:v()}):s?c.jsx(PA,{to:s,children:v()}):v()},FA=b.div`
  display: flex;
  justify-content: space-between;
  gap: 32px;
`,YA=b.div`
...
`,aL=({status:e="neutral"})=>c.jsx(rL,{status:e}),m5=b.button`
...
`,wy=b.div`
  ...
  ${({isLastOfGroup:e})=>e&&R`
    margin-right: 15px;
  `};
`,mL=(e,r)=>{if(r<0)return null;let a=!0;return r<e.length-1&&(a=e[r].groupTitle!==e[r+1].groupTitle),e[r].groupTitle?r!==0&&e[r-1].groupTitle===e[r].groupTitle?c.jsxs(h.Fragment,{children:[c.jsx(by,{}),c.jsx(wy,{isLastOfGroup:a})]}):c.jsxs(h.Fragment,{children:[c.jsx(pL,{children:e[r].groupTitle}),c.jsx(wy,{isLastOfGroup:a})]}):c.jsx(by,{})},vL=({selectable:e,hasStatus:r,hasThumbnail:a,hasTypeIcon:o,allChecked:s,disableAllChecked:u,hasHeaderGroups:f,columnConfig:p,defaultAscending:m,toggleAllCallback:x=()=>{},sortCallback:y=()=>{}})=>{const[v,k]=h.useState(p),[C,S]=h.useState(m),E=h.useCallback($=>{x($)},[x]),T=h.useCallback(($,L)=>{if(v[$]===void 0||!v[$].sortable)return;const N=[...v];let z=null;N.forEach((j,A)=>{j.sortActive&&(z=A),A===$?j.sortActive=!0:j.sortActive=!1});const D=z===$?!C:C,H=L===void 0?`column_${$}`:L;y(D,H),k(N),S(D)},[C,y,v]);return c.jsxs(fL,{children:[e?c.jsx(ys,{headerStyle:"header",fixedWidth:30,children:c.jsx(Kg,{checked:s,disabled:u,onChangeCallback:E})}):null,r?c.jsx(ys,{headerStyle:"header",fixedWidth:10}):null,a?c.jsx(ys,{headerStyle:"header",fixedWidth:70}):null,o?c.jsx(ys,{headerStyle:"header",fixedWidth:35}):null,p.map(($,L,N)=>{const{header:z,alignment:D,hasCopyButton:H,sortActive:j,columnId:A,sortable:P,minWidth:X}=$;return c.jsx(ys,{alignment:D,hasCopyButton:H,minWidth:X,headerStyle:f?"subHeader":"header",isSortActive:j,children:c.jsxs(hL,{alignment:D,children:[f&&c.jsx(gL,{children:f&&mL(N,L)}),c.jsx(dL,{header:z,sortable:P,indexKey:L,columnId:A,isSortActive:j,ascending:C,toggleSort:T})]})},L)})]})},xL=b.div``,yL=b.div`
  display: table;
  width: 100%;
  position: relative;
`,v5=b.div`
...
`,wL=b.div`
  ...
  color: var(--grey-10);
`,SL=({_checked:e=!1})=>e===!0,CL=({checkboxDisabled:e=!1})=>e===!0,kL=({columnConfig:e,selectable:r,rows:a=[],closeText:o,hasStatus:s=!1,hasThumbnail:u=!1,hasTypeIcon:f=!1,defaultAscending:p=!1,isLoading:m=!1,loadingText:x="Loading Data...",emptyTableTitle:y="",emptyTableText:v="",hasHeaderGroups:k=!1,sortCallback:C=()=>{},selectCallback:S=()=>{},toggleAllCallback:E=()=>{}})=>{const[T,$]=h.useState(!1),[L,N]=h.useState(!1),z=a.length===1&&a[0].columns.length===0&&!m;return h.useEffect(()=>{let D=!1,H=!1;a.every(SL)&&a.length>0&&!z&&(D=!0),(a.some(CL)||z||m)&&(H=!0),$(D),N(H)},[z,m,a]),c.jsx(xL,{children:c.jsxs(yL,{children:[c.jsx(vL,{selectable:r,hasStatus:s,hasThumbnail:u,hasTypeIcon:f,defaultAscending:p,allChecked:T,disableAllChecked:L,hasHeaderGroups:k,columnConfig:e,toggleAllCallback:E,sortCallback:C}),m?c.jsxs(bL,{children:[c.jsx(mr,{size:"large",styling:"primary"}),c.jsx(v5,{children:x})]}):null,z?c.jsxs(wL,{children:[c.jsx("h3",{children:y}),c.jsx("p",{children:v})]}):null,a.map((D,H)=>{const j=a.length-1===H;return c.jsx(cL,{rowData:D,isLastRow:j,selectable:r,selectCallback:S,columnConfig:e,hasStatus:s,hasThumbnail:u,hasTypeIcon:f,closeText:o},H)})]})})};b.div`
  position: relative;
  ${({theme:e})=>R`
    font-family: ${e.fontFamily.ui};
  `}
...
`,uO=b.button`
  ...
  `}
`,dO=({show:e=!0,link:r,label:a="Back",$showDivider:o,$iconInGutter:s,onClick:u})=>{const f=h.useMemo(()=>c.jsxs(qe.Fragment,{children:[c.jsx(cg,{children:c.jsx(Se,{icon:"Back",size:16,color:"grey-10"})}),a]}),[a]);return e?c.jsx(qe.Fragment,{children:u?c.jsx(uO,{$showDivider:o,$iconInGutter:s,onClick:u,children:f}):r&&c.jsx(cO,{to:r,$showDivider:o,$iconInGutter:s,children:f})}):null},fO=b.div`
...
`,bO=({showBreadcrumbs:e=!0,breadcrumbs:r=[],showHomeIcon:a=!0,back:o,share:s,$iconInGutter:u})=>{const{isLarge:f}=rp(),p=u!==void 0?u:f,m=e&&r.length>0;return c.jsxs(fO,{children:[c.jsxs(hO,{children:[o&&c.jsx(dO,{$showDivider:m,$iconInGutter:p,...o}),m?c.jsx(gO,{children:r.map((x,y)=>{const{text:v,href:k,onClick:C}=x,S=y===0,E=y===r.length-1,T=c.jsxs(qe.Fragment,{children:[S&&a?c.jsx(w5,{children:c.jsx(Se,{icon:"Home",size:11,color:"grey-10"})}):null,v]});return c.jsx(qe.Fragment,{children:c.jsxs(pO,{children:[C?c.jsx(vO,{onClick:C,type:"button",children:T}):k?c.jsx(mO,{to:k,children:T}):c.jsx(xO,{children:T}),E?null:c.jsx(b5,{children:c.jsx(Se,{icon:"Right",size:6,color:"grey-8"})})]})},y)})}):null]}),c.jsx(yO,{children:c.jsx(sO,{...s})})]})},Dr=qe.createContext({selected:"",setSelected:()=>{}}),sp=({children:e})=>{const[r,a]=h.useState("");return c.jsx(Dr.Provider,{value:{selected:r,setSelected:a},children:e})},wO=b.div`
  display: flex;
  align-items: center;
  flex-direction: column;
  position: relative;
...
`,DO=b.section`
  ...
  ${({$reverse:e})=>e==="true"?R`
    ...
    ${fg}{ order: 1; }
  `:null}
`,RO=h.forwardRef(({mainArea:e,sideArea:r,layout:a="horizontal",reverse:o,dividerSize:s=16,persist:u=!1,persistenceKey:f="resizable_ui",showDebug:p},m)=>{const y="resizable_layout_"+f,v=1,k=50,C=r.defaultSize||350,S=r.minSize||0,E=r.maxSize,T=e.minSize,[$,L]=h.useState(!1),[N,z]=h.useState(),[D,H]=h.useState(),[j,A]=h.useState(),[P,X]=h.useState(r.defaultCollapsed?"collapsed":"open"),[B,V]=h.useState(C),[F,se]=h.useState(C),[oe,U]=h.useState(C),q=h.useRef(null),ee=h.useRef(null),[ne,ae]=C0(`${y}_size`,null),[O,Z]=C0(`${y}_state`,null),[re,ue]=C0(`${y}_quick_open_size`,null);h.useEffect(()=>{$||(u&&(ne&&V(ne),O&&X(O),re&&U(re)),L(!0))},[$,u,O,ne,re]),h.useEffect(()=>{!$||!r.onSideAreaStateChange||r.onSideAreaStateChange(P)},[$,r,P]),h.useImperativeHandle(m,()=>({open:()=>{he()},close:()=>{me()},reset:()=>{fe()}}));const fe=h.useCallback(()=>{V(C),X("open"),ae(null),Z(null)},[V,C,X,ae,Z]),me=h.useCallback(()=>{X("collapsed"),V(v),se(v),u&&(ae(v),Z("collapsed"),ue(F))},[V,X,Z,ae,ue,F,u]),he=h.useCallback(()=>{X("open");let en;B>v&&ee.current?en=a==="horizontal"?ee.current.clientWidth:ee.current.clientHeight:en=oe,se(en),V(en),u&&(ae(Math.round(B)),Z("open"))},[u,Z,ae,oe,B,a]),xe=h.useCallback(()=>{P==="collapsing"&&B<S-k?me():(se(Math.round(B)),U(Math.round(B)),he()),A(!1)},[me,he,S,B,P]),pe=h.useCallback(en=>{en.preventDefault();const{clientX:Rr,clientY:vr}=en;se(P==="collapsed"?B:bs(B,S,E)),z({x:Rr,y:vr}),H({x:0,y:0}),A(!0)},[B,E,S,P]),Te=()=>{j&&xe()},pt=h.useCallback(en=>{const{clientX:Rr,clientY:vr}=en;let Dn,Rn=P;if(j&&N&&F){if(H({x:N.x-Rr,y:N.y-vr}),a==="horizontal"){const Wt=(q.current?.clientWidth??0)-s-(T||0);o?Dn=bs(F-(N.x-Rr),null,Wt):Dn=bs(F+(N.x-Rr),null,Wt)}else{const Wt=(q.current?.clientHeight??0)-s-(T||0);o?Dn=bs(F-(N.y-vr),null,Wt):Dn=bs(F+(N.y-vr),null,Wt)}if(r.collapsable){const Wt=Dn<S-k;P==="open"&&Wt||P==="opening"&&Wt?Rn="collapsing":P==="collapsing"&&!Wt?Rn="open":P==="collapsed"?Rn="peeking":P==="peeking"&&!Wt&&(Rn="opening")}V(Dn),X(Rn)}},[V,H,j,N,F,P,a,s,T,S,o,r.collapsable]),ut=h.useCallback(()=>{j&&xe()},[j,xe]);h.useEffect(()=>(document.addEventListener("mouseleave",ut),()=>{document.removeEventListener("mouseleave",ut)}),[ut]);const mt=()=>P==="collapsed"||P==="peeking"?a==="horizontal"?o?"right":"left":o?"down":"up":a==="horizontal"?o?"left":"right":o?"up":"down",_n=()=>P==="collapsed"||P==="peeking"||P==="collapsing"?"arrow":"default",si=c.jsxs(zO,{children:[c.jsxs("div",{children:[c.jsx("span",{children:"State:"})," ",P]}),c.jsxs("div",{children:[c.jsx("span",{children:"Position:"})," ",N?.x,", ",N?.y]}),c.jsxs("div",{children:[c.jsx("span",{children:"Difference:"})," ",D?.x,", ",D?.y]}),c.jsxs("div",{children:[c.jsx("span",{children:"sideAreaStartBasis:"})," ",F]}),c.jsxs("div",{children:[c.jsx("span",{children:"sideAreaBasis:"})," ",B]}),c.jsxs("div",{children:[c.jsx("span",{children:"lastOpenSize:"})," ",oe]})]});return c.jsxs(DO,{ref:q,onPointerMove:pt,onPointerUp:Te,$initialised:$?"true":"false",$layout:a,$reverse:o?"true":"false",children:[c.jsx(dg,{$layout:a,$minDimension:T,children:c.jsx(c.Fragment,{children:e.content})}),c.jsx(fg,{onPointerDown:pe,onDoubleClick:fe,$size:s,$fauxHover:j?"true":"false",children:c.jsx(OO,{state:_n(),layout:a,arrowDirection:mt()})}),c.jsx(_O,{ref:ee,style:{flexBasis:`${B}px`},$defaultSize:C,$minDimension:S,$maxDimension:E,$layout:a,$collapseState:P,children:c.jsx(Ii,{children:c.jsx(c.Fragment,{children:r.content})})}),p?si:null]})}),bs=(e,r,a)=>{let o=e;return o=a&&o>a?a:o,o=r&&o<r?r:o,o},E5=50,j5=68,oc=b.div`
  display: flex;
`,NO=b.div``,lc=b.div`
  padding: 0;
  flex: 1;
...
`,KO=b.div`
  ...
  `};
`,A5=({item:e,menuOpen:r,submenuOpen:a,contextKey:o,topLevelPath:s,mobileMenu:u=!1,onClickCallback:f})=>{const{icon:p,title:m,href:x,submenu:y,isExternalLink:v}=e,k=s===x,C=h.useRef(null),S=JO(y,f)||[],E=S.length>0;return c.jsxs(KO,{open:a,mobileMenu:u,children:[c.jsx(xd,{title:m,href:x,isActive:k,icon:p,hasSubmenu:E,isExternalLink:v,submenuOpen:a,menuOpen:r,onClickCallback:f,contextKey:o}),E?c.jsx(hg,{ref:C,children:c.jsx(ZO,{children:S})}):null]})},JO=(e,r)=>{if(!e)return;const a=[],o=[];return a.push([]),e.forEach((s,u)=>{const{title:f,href:p,isExternalLink:m}=s;p?m?a[a.length-1].push(c.jsx(Ey,{isActive:!1,children:c.jsxs($5,{href:p,target:"_blank",children:[f,c.jsx(QO,{children:c.jsx(Se,{icon:"ExternalLink",color:"dimmed",size:10})})]})},u)):a[a.length-1].push(c.jsx(Ey,{isActive:!1,children:c.jsx(M5,{to:p,onClick:()=>r&&r(-1),children:f})},u)):(a[a.length-1].length>1&&a.push([]),a[a.length-1].push(c.jsx(VO,{children:c.jsx(XO,{children:f})},u)))}),a.forEach((s,u)=>{o.push(c.jsx(YO,{children:s},u))}),o},ez=b(Ge)`
  height: 50px;
...
`,Oz=b.div`
  ...
  color: var(--grey-11);
  opacity: 0.5;
`,zz=e=>{if(e)return document.documentElement.setAttribute("lang",e),e;const r=navigator.language.split("-")[0],a=document.documentElement.lang;return a||(document.documentElement.setAttribute("lang",r),r)},z5=({hasLanguage:e=!1,selectedLanguageText:r="",languageOptionsText:a="LANGUAGE / 言語",selectedLangAttribute:o,hasLogout:s=!0,logoutLink:u="/logout",logoutText:f="Logout",hasCurrentUser:p=!0,currentUserText:m="Current User",accountOptionText:x="Account Options",userSubmenu:y=[],userDrawerBespoke:v,loggedInUser:k,hasSwitchTheme:C=!1,isLightMode:S=!0,switchThemeText:E="SWITCH THEME",selectedThemeText:T="",onLogout:$=()=>{},onLanguageToggle:L=()=>{},closeOnClick:N,onThemeToggle:z=()=>{},userDrawerFooter:D={icon:"",title:""},copySuccessMessage:H,includeCopyTitle:j,onUserDrawerMetaClick:A=()=>{},userDrawerMeta:P,hasUserDrawerMeta:X,hasUserDrawerFooter:B})=>{const{icon:V,title:F}=D,se=h.useCallback(async U=>{U.preventDefault(),await $(),window.location.assign(u),N&&N()},[N,u,$]),oe=h.useCallback(()=>{N&&N()},[N]);return h.useEffect(()=>{zz(o)},[o]),c.jsxs(h.Fragment,{children:[c.jsx(kz,{children:c.jsxs(c.Fragment,{children:[p?c.jsxs(jz,{children:[c.jsx(My,{children:m}),k]}):null,X?c.jsx(Lz,{children:P?.map((U,q)=>c.jsx(yz,{onUserDrawerMetaClick:A,item:U,includeCopyTitle:j,copySuccessMessage:H},q))}):null,y.length>0?c.jsxs(Tz,{children:[c.jsx(My,{children:x}),c.jsx($y,{children:y.map(({text:U,href:q},ee)=>c.jsx(Ay,{children:c.jsx(Ly,{to:q,onClick:oe,children:U})},ee))})]}):null,v||null,s?c.jsx(Mz,{children:c.jsx($y,{children:c.jsx(Ay,{children:c.jsx(Ly,{onClick:se,to:u,children:f})})})}):null]})}),c.jsxs(Ez,{children:[C&&c.jsx(Ty,{icon:S?"LightMode":"DarkMode",title:E,subTitle:T,onClickCallback:z}),e&&c.jsx(Ty,{icon:"Language",title:a,subTitle:r,onClickCallback:L}),B?c.jsxs(Az,{title:F,icon:V,children:[V?c.jsx($z,{children:c.jsx(Se,{icon:V,size:14,color:"dimmed"})}):null,c.jsx(Oz,{icon:V,children:F})]}):null]})]})},_z=b.div`
  display: flex;
  flex-direction: row;
  align-items: center;
...
`,Uz=b.div`
  ...
  color: var(--grey-12);
  margin-top: 15px;
`,Gz=({imgUrl:e,title:r,message:a,time:o})=>c.jsxs(_z,{children:[c.jsx(Dz,{children:e?c.jsx(Nz,{image:e}):c.jsx(Rz,{})}),c.jsxs(Hz,{children:[c.jsx(Bz,{children:r}),c.jsx(Iz,{children:a}),c.jsx(Uz,{children:o})]})]}),Oy=b.div`
  display: flex;
  flex-direction: column;
`,k0=b.h2`
    text-transform: uppercase;
...
`,Pz=b.div`
  border-bottom: var(--dividing-line) 1px solid;
`,zy=(e,r)=>e.map((a,o)=>c.jsx(Pz,{children:c.jsx(Gz,{...a})},`alert-${r}-${o}`)),_5=({read:e,unread:r,noNotificationsText:a="No new notifications",readNotificationsText:o="New",unreadNotificationsText:s="Read"})=>e.length===0&&r.length===0?c.jsx(Oy,{children:c.jsx(k0,{children:a})}):c.jsxs(Oy,{children:[r&&c.jsxs(h.Fragment,{children:[c.jsx(k0,{children:o}),zy(r,"unread")]}),e&&c.jsxs(h.Fragment,{children:[c.jsx(k0,{children:s}),zy(e,"read")]})]}),D5=R`
  display: flex;
  height: 32px;
  padding: 8px;
  align-items: center;
...
`,Fz=b.div`
  ...
  `};
`,Yz=({text:e,color:r,linkHref:a,linkTo:o,linkText:s,onClick:u})=>{const f=h.useRef(null),p=h.useRef(null),[m,x]=h.useState(!1),[y,v]=h.useState(!1),[k,C]=h.useState(0);h.useEffect(()=>{x(!1);const L=setTimeout(()=>{const N=f.current?.getBoundingClientRect().width??0,z=p.current?.getBoundingClientRect().width??0,D=N>=z?N:z;C(Math.ceil(D)),x(!0)},100);return()=>clearTimeout(L)},[e,s]);const S=h.useMemo(()=>c.jsx(R5,{ref:f,children:e}),[e]),E=h.useMemo(()=>u||o||a?c.jsx(N5,{ref:p,children:s||e}):null,[u,o,a,s,e]),T=h.useMemo(()=>m?c.jsx(h.Fragment,{children:y?E:S}):c.jsxs(h.Fragment,{children:[S,E]}),[m,y,S,E]),$=h.useMemo(()=>u?c.jsx(Wz,{themeColor:r,children:c.jsx("button",{onClick:u,type:"button",children:T})}):o?c.jsx(_y,{themeColor:r,children:c.jsx(Ge,{to:o,children:T})}):a?c.jsx(_y,{themeColor:r,children:c.jsx("a",{href:a,children:T})}):c.jsx(qz,{themeColor:r,children:S}),[u,o,a,r,T,S]);return c.jsx(Fz,{ready:m,minWidth:k,onPointerEnter:()=>m&&v(!0),onPointerLeave:()=>m&&v(!1),children:$})},Vz=b.div`
  z-index: 9;
  position: sticky;
  top: 0;
  height: 56px;
...
`,E0=b.button.attrs({type:"button"})`
  ...
  ${({$isActive:e})=>e&&R`
    &, &:hover {
      ...
      svg {
        transform: scale(1);
        animation: ${e_} 0.35s cubic-bezier(0.7, 0, 0.84, 0);
      }
...
`,n_=b.div`
    overflow-y: scroll;
    margin-right: -17px;
`,B5=({hasNotifications:e=!1,hasLanguage:r=!1,selectedLanguageText:a="",languageOptionsText:o,selectedLangAttribute:s,hasLogout:u=!0,logoutLink:f="/logout",logoutText:p="Logout",hasSearch:m=!1,hasCurrentUser:x=!0,currentUserText:y="Current User",accountOptionText:v="Account Options",searchPlaceholder:k="Search for devices, analysis tasks, etc.",userSubmenu:C=[],userDrawerBespoke:S,loggedInUser:E,notificationsHistory:T,customDrawer:$,hasSwitchTheme:L=!1,isLightMode:N=!0,switchThemeText:z="SWITCH THEME",selectedThemeText:D="",onLogout:H=()=>{},onLanguageToggle:j=()=>{},onThemeToggle:A=()=>{},userDrawerFooter:P,userDrawerMeta:X,onUserDrawerMetaClick:B=()=>{},hasUserDrawerMeta:V,copySuccessMessage:F,includeCopyTitle:se,hasUserDrawerFooter:oe,badge:U})=>{const[q,ee]=h.useState(null),ne=ae=>{ee(O=>O===ae?null:ae)};return c.jsx(Vz,{children:c.jsxs(c.Fragment,{children:[m?c.jsxs(Xz,{children:[c.jsx(Qz,{children:c.jsx(Se,{icon:"Search",size:16,color:"grey-6"})}),c.jsx(Kz,{placeholder:k})]}):c.jsx("div",{}),c.jsxs(Zz,{children:[U&&c.jsx(Yz,{...U}),c.jsxs(Jz,{children:[$&&c.jsx(E0,{$isActive:q==="custom",onClick:()=>ne("custom"),children:c.jsx(f5,{...$})}),e&&c.jsx(E0,{$isActive:q==="notifications",onClick:()=>ne("notifications"),children:c.jsx(Se,{icon:"Notifications",size:20,color:"dimmed"})}),c.jsx(E0,{$isActive:q==="user",onClick:()=>ne("user"),children:c.jsx(Se,{icon:"UserProfile",size:20,color:"dimmed"})})]})]}),Ks.createPortal(c.jsxs(t_,{children:[c.jsx(j0,{isOpen:q==="user",children:c.jsx(z5,{hasLanguage:r,hasLogout:u,logoutLink:f,logoutText:p,hasCurrentUser:x,currentUserText:y,accountOptionText:v,userSubmenu:C,userDrawerBespoke:S,loggedInUser:E,onLogout:H,onLanguageToggle:j,selectedLanguageText:a,languageOptionsText:o,selectedLangAttribute:s,hasSwitchTheme:L,isLightMode:N,switchThemeText:z,selectedThemeText:D,onThemeToggle:A,onUserDrawerMetaClick:B,userDrawerFooter:P,userDrawerMeta:X,hasUserDrawerMeta:V,copySuccessMessage:F,includeCopyTitle:se,hasUserDrawerFooter:oe})}),e?c.jsx(j0,{isOpen:q==="notifications",baseWidth:"300px",children:c.jsx(n_,{children:T?c.jsx(_5,{...T}):null})}):null,$&&c.jsx(j0,{isOpen:q==="custom",baseWidth:$.width?$.width:"200px",children:c.jsx(c.Fragment,{children:$.customComponent})})]}),document.body)]})})},I5=b.div`
  display: flex;
  flex-direction: row;
`,up=({children:e,defaultTabId:r})=>{const{setSelected:a}=h.useContext(Dr);return h.useEffect(()=>{a(r)},[r,a]),c.jsx(I5,{children:c.jsx(c.Fragment,{children:e})})},r_=b.div`
  margin-right: 39px;
  display: flex;
  align-items: center;
  line-height: 20px;
`,a_=b.label`
  ...
  flex-shrink: 0;
  user-select: none;
`,Hs=({children:e,tabFor:r,onClick:a,...o})=>{const{selected:s,setSelected:u}=h.useContext(Dr),f=h.useCallback(p=>{a&&a(p),u(r)},[a,u,r]);return c.jsx(r_,{...o,onClick:f,children:c.jsx(a_,{active:s===r,children:c.jsx(c.Fragment,{children:e})})})},i_=b.div`
`,ga=({children:e,tabId:r,...a})=>{const{selected:o}=h.useContext(Dr);return o===r?c.jsx(i_,{...a,children:c.jsx(c.Fragment,{children:e})}):null},o_=b.button`
  ${st}
  flex-basis: auto;
  flex-grow: 1;
`,l_=b.div`
  ...
  `}
`,Nu=({tabFor:e,icon:r,closeId:a,counter:o,status:s,...u})=>{const{selected:f,setSelected:p}=h.useContext(Dr),m=h.useCallback(x=>{p(f===x?a:x)},[a,f,p]);return c.jsx(o_,{...u,onClick:()=>m(e),children:c.jsx(l_,{isActive:f===e,children:c.jsx(f5,{icon:r,status:s,counter:o})})})};b.div`
  display: flex;
  align-items: center;
  margin-right: 22px;
  padding-bottom: 7px;
...
`,u_=b.div`
  text-transform: uppercase;
`,d_=({closeId:e,closeText:r="CLOSE MENU",children:a,formAction:o,...s})=>{const{setSelected:u}=h.useContext(Dr);return c.jsxs(s_,{onClick:()=>u(e),...s,children:[c.jsx(c_,{children:c.jsx(Se,{icon:"CloseCompact",color:"dimmed",size:16})}),c.jsx(u_,{children:r})]})},f_=b.div`
  position: relative;
  min-height: calc(100vh - ${j5+E5}px);
  width: 100%;
  overflow-y: scroll;
`,h_=b.div`
  position: absolute;
  ...
  height: 100%;
  width: 100%;
`,g_=({closeId:e,children:r})=>{const{selected:a}=h.useContext(Dr);return a===e?null:c.jsx(f_,{children:c.jsx(h_,{children:c.jsx(c.Fragment,{children:r})})})},p_=b.div``,Dy=b.div`
  padding: 14px 0;
  border-bottom: 1px solid var(--dividing-line);
`,m_=({content:e,supportUrl:r,supportText:a="Help & Support",closeId:o})=>{const[s,u]=h.useState(0),f=zr(),{setSelected:p}=h.useContext(Dr),m=h.useCallback(y=>{(y===-1||!e.items[y].submenu)&&p(o),y!==-1&&u(s!==y?y:-1)},[o,e.items,s,p]),x=h.useCallback(()=>{p(o)},[o,p]);return c.jsxs(p_,{children:[e.items.map((y,v)=>c.jsx(Dy,{"data-key":v,children:c.jsx(A5,{mobileMenu:!0,topLevelPath:Fb(f.pathname),contextKey:v,menuOpen:!0,submenuOpen:v===s,onClickCallback:m,item:y,focusedContext:s})},v)),r&&c.jsx(Dy,{children:c.jsx(xd,{compact:!0,isActive:!1,icon:"Question",title:a,href:r,menuOpen:!0,onClickCallback:x})})]})},v_=b(Ge)`
  ${st};
  display: flex;
  flex-basis: 0;
  flex-grow: 1;
...
`,x_=b.div`
  margin-right: 15px;
`,y_=b.object``,b_=({home:e="/",logoMark:r,closeId:a})=>{const{setSelected:o}=h.useContext(Dr);return c.jsx(v_,{to:e,onClick:()=>o(a),children:c.jsx(x_,{children:r?c.jsx(y_,{type:"image/svg+xml",data:r}):c.jsx(qb,{})})})},w_=b.div`
  background: var(--global-element-background);

  z-index: 100;
  display: flex;
  flex-direction: column;
`,S_=({closeId:e,hasLanguage:r,hasLogout:a,logoutLink:o,hasCurrentUser:s,userSubmenu:u,userDrawerBespoke:f,loggedInUser:p,onLogout:m,onLanguageToggle:x,...y})=>{const{setSelected:v}=h.useContext(Dr),k=h.useCallback(()=>{v(e)},[e,v]);return c.jsx(w_,{children:c.jsx(z5,{hasLanguage:r,hasLogout:a,logoutLink:o,hasCurrentUser:s,userSubmenu:u,userDrawerBespoke:f,loggedInUser:p,onLogout:m,onLanguageToggle:x,...y,closeOnClick:k})})},Tr="closeMenu",Ry="notifications",Ny="user",Hy="menu",By="custom",C_=b.nav`
  background-color: var(--global-element-background);
  position: sticky;
  top: 0;
  left: 0;
...
`,E_=({content:e,home:r,logoMark:a,supportUrl:o,defaultMenuOpen:s=!0,closeText:u,hasLanguage:f,hasLogout:p,logoutLink:m,hasCurrentUser:x,hasNotifications:y,userSubmenu:v,userDrawerBespoke:k,loggedInUser:C,notificationsHistory:S,customDrawer:E,supportText:T,onLogout:$,onLanguageToggle:L,...N})=>c.jsx(C_,{children:c.jsxs(sp,{children:[c.jsxs(k_,{children:[c.jsx(b_,{home:r,logoMark:a,closeId:Tr}),c.jsxs(up,{defaultTabId:Tr,children:[E&&c.jsx(Nu,{...E,tabFor:By,closeId:Tr}),y?c.jsx(Nu,{tabFor:Ry,icon:"Notifications",closeId:Tr}):null,c.jsx(Nu,{tabFor:Ny,icon:"UserProfile",closeId:Tr}),c.jsx(Nu,{tabFor:Hy,icon:"Menu",closeId:Tr})]})]}),c.jsxs(g_,{closeId:Tr,children:[c.jsx(ga,{tabId:By,children:E&&E.customComponent}),c.jsx(ga,{tabId:Ry,children:S&&y?c.jsx(_5,{...S}):null}),c.jsx(ga,{tabId:Ny,children:c.jsx(S_,{hasLanguage:f,hasLogout:p,logoutLink:m,hasCurrentUser:x,userSubmenu:v,userDrawerBespoke:k,loggedInUser:C,onLogout:$,onLanguageToggle:L,...N,closeId:Tr})}),c.jsx(ga,{tabId:Hy,children:c.jsx(m_,{content:e,supportUrl:o,supportText:T,defaultMenuOpen:s,closeId:Tr})}),c.jsx(d_,{closeText:u,closeId:Tr})]})]})}),dp=({content:e,home:r,openWidth:a,logoMark:o,logoText:s,supportUrl:u,defaultMenuOpen:f,canAlwaysPin:p,paddingOverride:m,maxWidth:x,legacyLayout:y,children:v,keepOpenText:k,autoHideText:C,supportText:S,onMenuToggle:E,...T})=>{const{isLarge:$}=rp();return $?c.jsxs(oc,{children:[c.jsx(cz,{content:e,home:r,openWidth:a,logoMark:o,logoText:s,supportUrl:u,defaultMenuOpen:f,canAlwaysPin:p,onMenuToggle:E,keepOpenText:k,autoHideText:C,supportText:S}),c.jsxs(HO,{children:[c.jsx(B5,{...T}),c.jsx(ky,{maxWidth:x,paddingOverride:m,legacyLayout:y,children:c.jsx(c.Fragment,{children:v})})]})]}):c.jsxs(NO,{children:[c.jsx(E_,{content:e,home:r,logoMark:o,supportUrl:u,defaultMenuOpen:f,supportText:S,...T}),c.jsx(ky,{children:c.jsx(c.Fragment,{children:v})})]})},j_=b.div`
  width: 286px;
...
`;b(Ge)`
  ...
  text-decoration: none;
  padding: 7px 20px;
`;const Id=({logoTextTop:e,logoTextBottom:r})=>c.jsxs(T_,{children:[c.jsx(M_,{children:e}),c.jsxs($_,{children:["•",r,"•"]})]}),Ud=({children:e,...r})=>c.jsx(j_,{...r,children:c.jsx(c.Fragment,{children:e})}),Jt=we.div`
  display: inline-block;
  padding: 0 4px;
  margin-top: 12px;
  border-radius: 3px;
...
`,zn=({children:e})=>c.jsxs(O_,{children:[c.jsx(z_,{children:c.jsx(Ge,{to:"/",children:c.jsx(Se,{size:12,icon:"Home"})})}),c.jsx(Jt,{children:e})]}),__=we.div`
    margin: 100px 200px;
`,D_=()=>c.jsxs(__,{children:[c.jsx(zn,{children:"FormPage.tsx"}),c.jsx(ma,{title:"Input State Examples",areaTitle:"Forms",areaHref:"/"}),c.jsxs(ep,{children:[c.jsx(Dt,{name:"my_field",label:"Basic",placeholder:"Placeholder...",fieldState:"default",showFeedback:!0}),c.jsx(Dt,{name:"my_field",label:"Required",placeholder:"",fieldState:"required",showFeedback:!0}),c.jsx(Dt,{name:"my_field",label:"Loading",placeholder:"",fieldState:"processing",showFeedback:!0}),c.jsx(Dt,{name:"my_field",label:"Valid",placeholder:"",fieldState:"valid",showFeedback:!0}),c.jsx(Dt,{name:"my_field",label:"Error",placeholder:"",fieldState:"invalid",showFeedback:!0}),c.jsx(Dt,{name:"my_field",label:"Error",placeholder:"",fieldState:"invalid",showFeedback:!0,feedbackMessage:"Error: Oh noes!!!"}),c.jsx(Jg,{name:"my_field",label:"My Field",placeholder:"",fieldState:"default",showFeedback:!0})]})]}),R_=()=>{const[e,r]=h.useReducer(op,[]),[a]=h.useState(""),[o,s]=h.useState({showSetIndex:!0,pointIndexOffset:1,showPointHandle:!0,showPointLabel:!0,showLabelShadow:!0,setIndexOffset:1,showMoveHandle:!0,fixedImgDimensions:{x:2310,y:1535},boundaryOffset:0,showDirectionMark:!0,areaFillColor:"",areaTransparencyLevel:0}),u=h.useCallback(async()=>{r({type:"LOAD",state:[{name:"Line 1",points:[{x:600,y:200},{x:1100,y:450}],readOnly:!1,styling:"primary"}]})},[]),f=h.useCallback(async()=>{r({type:"LOAD",state:[{name:"UP",points:[{x:1048,y:456},{x:1613,y:584},{x:1322,y:985},{x:922,y:785}],showPointHandle:!0,showSmallDirectionMark:!0,readOnly:!1,styling:"primary",areaFillColor:"#0B0B0B",areaTransparencyLevel:40},{name:"DOWN",points:[{x:841,y:700},{x:256,y:576}],showPointHandle:!1,showMoveHandle:!1,readOnly:!1,styling:"primary"}]})},[]),p=h.useCallback(({target:{value:E}})=>{r({type:"RENAME_SET",index:0,data:{name:E}})},[]),m=h.useCallback((E,{target:{value:T}})=>{r({type:"RENAME_SET",index:E,data:{name:T}})},[]),x=h.useCallback((E,{target:{value:T}})=>{r({type:"UPDATE_FILL_COLOR",index:E,data:{areaFillColor:T}})},[]),y=h.useCallback((E,{target:{value:T}})=>{r({type:"UPDATE_TRANSPARENCY_LEVEL",index:E,data:{areaTransparencyLevel:parseInt(T)}})},[]),v=h.useCallback((E=0)=>()=>{r({type:"UPDATE_SET_OPTIONS",index:E,data:{readOnly:!e[0]?.readOnly}})},[e]),k=h.useCallback(E=>{const T=e.findIndex($=>$.showPointHandle);r({type:"UPDATE_SET_OPTIONS",index:T,data:{showPointHandle:!1,showMoveHandle:!1}}),r({type:"UPDATE_SET_OPTIONS",index:E,data:{showPointHandle:!0,showMoveHandle:!0}})},[e]),C=h.useCallback(E=>()=>{s({...o,[E]:!o[E]})},[o]);h.useEffect(()=>{o.showDirectionMark?f():u()},[u,f,o]);const S=h.useCallback(({target:{value:E}})=>{s({...o,boundaryOffset:parseInt(E)})},[o]);return c.jsxs(oc,{children:[c.jsx(zn,{children:"LinePage.tsx"}),c.jsxs(Ud,{children:[c.jsx(Id,{logoTextTop:"SCORER",logoTextBottom:"UI Kit"}),c.jsx(pa,{style:{flex:"1"},children:c.jsx("pre",{children:JSON.stringify(e,null,2)})}),c.jsxs(pa,{children:[c.jsx(Pt,{labelText:"Show Point Handle",htmlFor:"showPointHandle",children:c.jsx("input",{id:"showPointHandle",type:"checkbox",name:"showPointHandle",checked:o.showPointHandle,onChange:C("showPointHandle")})}),c.jsx(Pt,{labelText:"Show Move Handle",htmlFor:"showMoveHandle",children:c.jsx("input",{id:"showMoveHandle",type:"checkbox",name:"showMoveHandle",checked:o.showMoveHandle,onChange:C("showMoveHandle")})}),c.jsx(Pt,{labelText:"Show Point",htmlFor:"showPoint",children:c.jsx("input",{id:"showPoint",type:"checkbox",name:"showPoint",checked:o.showPoint,onChange:C("showPoint")})}),c.jsx(Pt,{labelText:"Show Direction Mark",htmlFor:"showDirectionMark",children:c.jsx("input",{id:"showDirectionMark",type:"checkbox",name:"showDirectionMark",checked:o.showDirectionMark,onChange:C("showDirectionMark")})}),c.jsx(Pt,{labelText:"Show Label Shadow",htmlFor:"showLabelShadow",children:c.jsx("input",{id:"showLabelShadow",type:"checkbox",name:"showLabelShadow",checked:o.showLabelShadow,onChange:C("showLabelShadow")})})]}),c.jsxs(pa,{children:[o.showDirectionMark?c.jsxs(c.Fragment,{children:[c.jsx(Dt,{id:"renameLine1",label:"Rename UP Line",fieldState:"default",name:"renameLine1",value:e[0]?.name||"",onChange:E=>m(0,E)}),c.jsx(Dt,{id:"renameLine2",label:"Rename DOWN Line",fieldState:"default",name:"renameLine2",value:e[1]?.name||"",onChange:E=>m(1,E)})]}):c.jsx(Dt,{id:"rename",label:"Rename Line",fieldState:"default",name:"rename",value:e[0]?.name||"",onChange:p}),c.jsx(Pt,{labelText:"Boundary Offset",htmlFor:"boundaryOffset",children:c.jsx(Qg,{id:"boundaryOffset",type:"number",name:"boundaryOffset",min:0,value:o.boundaryOffset,onChange:S})}),c.jsx(Dt,{id:"fillColor",label:"Area Fill Color",fieldState:"default",name:"fillColor",value:e[0]?.areaFillColor||"",onChange:E=>x(0,E)}),c.jsx(Dt,{id:"transparencyLevel",label:"Area Tranparency Level",fieldState:"default",name:"transparencyLevel",value:e[0]?.areaTransparencyLevel||"",onChange:E=>y(0,E)})]}),c.jsx(pa,{children:c.jsx(gt,{design:"secondary",onClick:v(),children:"Toggle Read Only"})})]}),c.jsxs(lc,{padBottom:!1,children:[a&&c.jsx("div",{children:a}),c.jsx(ro.Provider,{value:{state:e,dispatch:r},children:c.jsx(mA,{options:o,onLineClick:k,src:"/scorer-ui-kit/images/line-ui-railyard.jpg"})})]})]})},Iy=we.div`
  margin-bottom: 15px;
`,N_=we.div`
  display: flex;
  margin: 20px 0;
  justify-content: flex-end;
`,H_=()=>{const[e,r]=h.useReducer(op,[]),[a]=h.useState(""),[o,s]=h.useState("localhost/wsapp"),[u,f]=h.useState(""),[p,m]=h.useState(!1),[x,y]=h.useState(!1),{createMediaModal:v}=ap(),[k,C]=h.useState({loop:!0,autoPlay:!0}),S={showSetIndex:!0,showLabelShadow:!0,setIndexOffset:1,showDirectionMark:p},E=h.useCallback(async()=>{r({type:"LOAD",state:[{name:"Line 1",points:[{x:1407,y:869},{x:2293,y:531}],showPointHandle:!0,showMoveHandle:!0,readOnly:!1,styling:"primary"},{name:"Line 2",points:[{x:1426,y:254},{x:2260,y:283}],showPointHandle:!1,showMoveHandle:!1,readOnly:!1,styling:"secondary"},{name:"Yikes!",points:[{x:500,y:500},{x:1e3,y:1e3}],showPointHandle:!1,showMoveHandle:!1,readOnly:!1,styling:"danger"},{name:"Shape 1",areaName:"Traffic Area",points:[{x:502,y:453},{x:1067,y:581},{x:776,y:982},{x:376,y:782}],readOnly:!1,styling:"secondary",areaFillColor:"#0B0B0B",areaTransparencyLevel:40}]})},[]),T=h.useCallback(async()=>{},[]);h.useEffect(()=>{E()},[E]);const $=h.useCallback(()=>{o&&f(o)},[o]),L=h.useCallback(j=>{m(j)},[]),N=h.useCallback(j=>{y(j)},[]),z=h.useCallback(()=>{C({loop:!0,autoPlay:!0})},[]),D=h.useCallback(()=>{C({loop:!1,autoPlay:!1,muted:!0}),v({mediaType:"video",src:`ws://${u}/`,dismissCallback:z})},[v,z,u]),H=h.useCallback(j=>{const A=e.findIndex(P=>P.showPointHandle);r({type:"UPDATE_SET_OPTIONS",index:A,data:{showPointHandle:!1,showMoveHandle:!1}}),r({type:"UPDATE_SET_OPTIONS",index:j,data:{showPointHandle:!0,showMoveHandle:!0}})},[e]);return c.jsxs(oc,{children:[c.jsx(zn,{children:"LineRTCPage.tsx"}),c.jsxs(Ud,{children:[c.jsx(Id,{logoTextTop:"SCORER",logoTextBottom:"UI Kit"}),c.jsx(pa,{style:{flex:"1"},children:c.jsx("pre",{children:JSON.stringify(e,null,2)})}),c.jsxs(pa,{children:[c.jsx(Iy,{children:c.jsx(fl,{checked:p,labelText:"Show Direction Mark",leftTheme:"off",onChangeCallback:L,rightTheme:"on",state:"default"})}),c.jsx(Iy,{children:c.jsx(fl,{checked:x,labelText:"Show Label Shadow",leftTheme:"off",onChangeCallback:N,rightTheme:"on",state:"default"})}),c.jsx(gt,{design:"secondary",onClick:E,children:"Cancel"}),c.jsx(gt,{style:{marginLeft:"10px"},onClick:T,children:"Save"})]})]}),c.jsxs(lc,{children:[a&&c.jsx(fa,{message:a,type:"error"}),c.jsx(Dt,{label:"Host",name:"host",fieldState:"default",value:o,onChange:({target:{value:j}})=>s(j)}),c.jsx(gt,{onClick:$,children:"Connect"}),u&&c.jsxs(c.Fragment,{children:[c.jsx(ro.Provider,{value:{state:e,dispatch:r},children:c.jsx($A,{ws:`ws://${u}/`,videoOptions:k,options:S,onLineClick:H})}),c.jsx(N_,{children:c.jsx(gt,{onClick:D,children:"Open Video Modal"})})]})]})]})},Hu=we(Zg)`
  width: 100%;
  margin-bottom: 15px;
`,B_=we.div`
  display: flex;
...
`,J_=we(ep)`
    ...
    animation: ${X_} 0.35s cubic-bezier(0.7, 0, 0.84, 0);
...
`,sD=we.img`
  height: 1080px;
  background-image: ${({design:e})=>Z_[e]};
  position: absolute;
  bottom: -360px;
  left: -600px;
  min-width: ${Zs}px;
...
`,dD=({onLogin:e,design:r="primary"})=>{const[a,o]=h.useState(!1),[s,u]=h.useState(null),[f,p]=h.useState({username:"",password:""}),m=h.useCallback(y=>({target:{value:v}})=>{p({...f,[y]:v})},[f]),x=h.useCallback(async y=>{y.preventDefault(),o(!0),u(null);try{const v=await e(f);console.log(v,"login")}catch(v){v instanceof Error?u({message:v.message,type:"error"}):console.warn(v)}o(!1)},[f,e]);return c.jsxs(Q_,{children:[c.jsx(zn,{children:"Login.tsx"}),c.jsxs(oD,{children:[c.jsxs(uD,{children:[c.jsxs(cD,{children:[c.jsx(lD,{}),c.jsx(sD,{src:Y_,design:r})]}),c.jsxs(J_,{onSubmit:x,spacing:"25px",children:[c.jsx(eD,{children:"Sign In To Your Account"}),c.jsx(tD,{children:"This service requires an account to login. If you do not have one, please make one first."}),c.jsx(Dt,{fieldState:"default",required:!0,label:"Username",onChange:m("username"),value:f.username,name:"username",id:"username"}),c.jsx(Jg,{fieldState:"default",required:!0,label:"Password",onChange:m("password"),value:f.password,name:"password",id:"password"}),s&&c.jsx(fa,{type:s.type,message:s.message}),c.jsx(K_,{flex:"1",children:c.jsx(Xg,{loading:a,type:"submit",onClick:x,children:"Login"})}),c.jsx(rD,{children:c.jsx(nD,{to:"#",children:"Forgotten Password"})})]})]}),c.jsxs(gg,{children:[c.jsxs(aD,{children:["Copyright ",new Date().getFullYear()," - Future Standard Co. Ltd. All Rights Reserved. "]}),c.jsx(Uy,{to:"#",children:"Terms"}),c.jsx(iD,{children:"·"}),c.jsx(Uy,{to:"#",children:"Privacy"})]})]})]})},fD=we.div`
  display: flex;
  align-items: center;
  justify-content: space-around;
  gap: 4px;
`,hD=we.div`
  ...
  background-color: ${({type:e})=>`var(--${e}, var(--primary-9))`};
    ...
    `}
`,ws=({statusList:e})=>{const r=h.useRef([]);return r.current=e.map(()=>qe.createRef()),c.jsx(fD,{children:e.map(({type:a,tooltipMessage:o,tooltipIcon:s,tooltipType:u,tooltipPosition:f},p)=>c.jsxs(h.Fragment,{children:[c.jsx(hD,{ref:r.current[p],type:a,tooltipMessage:o}),o&&c.jsx(zj,{tooltipFor:r.current[p],message:o,icon:s,type:u,tooltipPosition:f})]},p))})},gD=we.div`
  margin: 100px 200px;
`,pD=we.pre`
  color: var(--grey-11);
  margin-top: 75px;
...
`,yR=we.div`
  margin-top: 20px;
`,bR=()=>c.jsxs(mR,{children:[c.jsx(zn,{children:"TabsPage.tsx"}),c.jsxs(lc,{children:[c.jsx(ma,{title:"Tabs Example",areaTitle:"Examples",areaHref:"/"}),c.jsxs(sp,{children:[c.jsxs(up,{defaultTabId:"tab1",children:[c.jsx(Hs,{tabFor:"tab1",children:"Tab 1"}),c.jsx(Hs,{tabFor:"tab2",children:"Tab 2"})]}),c.jsx(vR,{}),c.jsx(ga,{tabId:"tab1",children:c.jsxs(xR,{children:[c.jsx(Pt,{htmlFor:"fullname",labelText:"Content of tab 1"}),c.jsx(Dt,{fieldState:"default",required:!0,label:"Full Name",name:"fullname",id:"fullname"}),c.jsx(Dt,{fieldState:"default",required:!0,label:"Department",name:"department",id:"department"}),c.jsx(gt,{design:"primary",size:"small",children:" Save "})]})}),c.jsx(ga,{tabId:"tab2",children:c.jsxs(yR,{children:[c.jsx(Pt,{htmlFor:"content2",labelText:"Content of tab 2"}),c.jsx(Pt,{htmlFor:"lorem",labelText:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sit amet erat et sapien pulvinar efficitur. Quisque tristique massa at auctor rhoncus. Ut venenatis sem id gravida volutpat. Phasellus faucibus accumsan sapien, id pellentesque dolor consectetur quis. Duis non rhoncus nunc. Suspendisse et rhoncus tortor."}),c.jsx(gt,{design:"primary",size:"small",children:" OK "})]})})]})]})]}),Cs=we.div`
  h2 {
    font-family: var(--font-ui);
    font-weight: 500;
    color: var(--grey-11);

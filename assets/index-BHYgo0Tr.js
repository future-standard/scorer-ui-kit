...
`,ok=y.div`
  ...
  `};
`,I0=({design:e="primary",size:a="normal",loading:i=!1,shadow:o=!1,onClick:c,disabled:u,position:h,icon:p,weight:m="regular",children:x,...b})=>s.jsx(ak,{children:s.jsx(nt,{noPadding:!0,disabled:u||i,design:e,size:a,shadow:o,onClick:c,loading:i,...b,children:s.jsxs(ok,{$disabled:u,children:[s.jsx(rk,{$size:a,$position:h,$weight:m,children:s.jsx(s.Fragment,{children:x})}),s.jsxs(ik,{$loading:i,$position:h,children:[s.jsx($i,{children:s.jsx(we,{icon:p,weight:m})}),s.jsx(e0,{children:s.jsx(ia,{size:a==="xsmall"||a==="small"?"xsmall":"small",styling:e})})]})]})})}),lk=y.div`
  display: inline;
`,sk=y.div`
  height: inherit;
  flex: 1;
...
`,P0=({indeterminate:e=!1,disabled:a,checked:i=!1,onChangeCallback:o})=>{const[c,u]=f.useState(i),[h,p]=f.useState(i?"on":"off"),m=b=>{const v=b.target.checked;u(v),o&&o(v)};f.useEffect(()=>{p(i?"on":"off")},[i,c,p]),f.useEffect(()=>{u(i)},[i,u]);const x=Wu.icons.weights.regular;return s.jsxs($k,{onChange:m,$disabled:a,$visualState:h,children:[s.jsx(ta,{children:s.jsx(Lk,{children:h==="on"?s.jsx(r0,{$color:"input-toggle-icon-color",children:s.jsx(r2,{color:"input-toggle-icon-color",stroke:"inverse",size:12,weight:x})}):null})}),s.jsx(Mk,{type:"checkbox",checked:c,readOnly:!0,disabled:a})," "]})},ru=y.div`
  width: 10px;
  height: 10px;
  border-radius: 50%;
  user-select: none;
...
`,wE=(e,a)=>{if(a)return a;if(e)return`${e-mE}px`},Wl=({mainButtonId:e,buttonList:a,design:i="primary",size:o,textMaxWidth:c,disabled:u=!1,...h})=>{const[p,m]=f.useState(!1),x=f.useRef(null),b=f.useRef(null),v=f.useCallback(()=>{m(C=>!C)},[]),k=f.useCallback(()=>{m(!1)},[]);return Y0(b,k),s.jsx(vE,{children:s.jsxs(xE,{ref:b,className:`split-button-${i} split-button-size-${o}`,$isOpen:p,...h,children:[s.jsxs(yE,{ref:x,children:[a.filter(C=>C.id===e).map(({id:C,text:S,icon:E,disabled:T,...M})=>s.jsx(qv,{noBorderTop:!0,disabled:u||T,closeCallback:k,icon:E||"NoIcon",text:S,design:i,...M},C)),s.jsx(bE,{onClick:v,disabled:u,children:s.jsx(we,{icon:p?"Close":"Down",size:8})})]}),p&&!u?s.jsx(f.Fragment,{children:a.filter(C=>C.id!==e).map(({id:C,text:S,icon:E,disabled:T,...M})=>s.jsx(qv,{icon:E||"NoIcon",text:S,design:i,disabled:T,textMaxWidth:wE(x.current?.clientWidth,c),...M,closeCallback:k},C))}):null]})})},SE=y.div`
  display: flex;
  flex-direction: column;
  gap: 8px;
  button {
...
`,Lj=y.div`
  ...
  transform: translateX(-50%);
  pointer-events: none;
`,$j=(e,a)=>{let i=!1;return Array.isArray(a)?a.forEach(o=>{o.value===e.value&&(i=!0)}):ys(a)&&(i=e.value===a.value),i},Oj=(e,a,i)=>{let o=!1;if(i==="checkbox"){const c=Array.isArray(a)?a:ys(a)?[a]:[],u=[];return c.forEach(h=>{e.value===h.value?o=!0:u.push(h)}),o||u.push(e),u.length===0?null:u}return e},Yl=(e,a)=>{if(e.length<=1)return e;const i=[...e],o=document.documentElement.lang||"en";return i.sort((c,u)=>{const h=c.text.localeCompare(u.text,o);return a?h:-h}),i},Qa=(e,a,i,o)=>{if(e.length<=a||i===null)return Yl(e,o);if(ys(i)){const c=e.findIndex(p=>p.value===i.value);if(c===-1||c<a)return Yl(e,o);const u=e.filter(p=>p.value!==i.value),h=Yl(u,o);return h.unshift(e[c]),h}if(Array.isArray(i)){const c=new Set(i.map(x=>x.value)),u=[],h=[];for(const x of e)c.has(x.value)?u.push(x):h.push(x);const p=Yl(u,o),m=Yl(h,o);return[...p,...m]}return e},zj=(e,a)=>e.filter(i=>i.text.toLowerCase().includes(a.toLowerCase())),Aj=(e,a,i)=>e.replace("[TOTAL]",`${i}`).replace("[VISIBLE]",`${a}`),Rj=(e,a)=>e===null&&a===null?!0:e===null||a===null?!1:Array.isArray(e)&&Array.isArray(a)?e.length!==a.length?!1:e.every(i=>a.some(o=>o.value===i.value)):Array.isArray(e)||Array.isArray(a)?!1:e.value===a.value,Dj=({buttonIcon:e,buttonText:a,list:i,selected:o=null,disabled:c=!1,isLoading:u=!1,loadingText:h,optionType:p="text",hasOptionsFilter:m,searchPlaceholder:x,maxDisplayedItems:b=5,searchResultText:v="Showing [VISIBLE] of [TOTAL]",emptyResultText:k,design:C="default",resetText:S,cancelText:E,closeText:T,applyText:M,hasReset:z,hasApply:_,descendingText:B="Descending",ascendingText:N="Ascending",isListAscending:U=!0,onSelect:L=()=>{},onResetCallback:R=()=>{},onCancelCallback:F=()=>{},...J})=>{const[q,ee]=f.useState(U),[re,Q]=f.useState(Qa(i,b,o,q)),[ne,D]=f.useState(""),[G,ae]=f.useState(o),oe=f.useRef(null),de=f.useCallback(()=>{Q(Qa(i,b,G,q))},[q,i,b,G]),$=f.useCallback(()=>{D(""),ae(o),ee(U),Q(Qa(i,b,o,U))},[U,i,b,o]),W=f.useCallback(ve=>{const _e=Oj(ve,G,p);_||L(_e),ae(_e),Q(Qa(i,b,_e,q)),D("")},[G,p,_,i,b,q,L]),Y=f.useCallback(ve=>{const _e=ve.target.value.replace(/<[^>]*>/g,"").trim();if(D(_e),_e===""){Q(Qa(i,b,G,q));return}const $t=zj(i,_e);Q(Qa($t,b,null,q))},[q,i,b,G]),se=f.useCallback(()=>{ae(o),F(),oe.current?.imperativeClose()},[F,o]),he=f.useCallback(()=>{L(G),oe.current?.imperativeClose()},[L,G]),me=f.useCallback(()=>{_||L(null),D(""),Q(Qa(i,b,null,U)),ae(null),ee(U),R()},[_,i,b,U,R,L]),fe=f.useCallback(()=>{ee(ve=>(Q(Qa(i,b,G,!ve)),!ve))},[i,b,G]);f.useEffect(()=>{let ve=!0;return ve&&(D(""),Q(Qa(i,b,G,q))),()=>{ve=!1}},[q,i,b,G]),f.useEffect(()=>{ae(o)},[o]);const ye=f.useMemo(()=>Rj(G,o),[o,G]);return s.jsx(wj,{...J,children:s.jsx(S2,{ref:oe,buttonIcon:e,buttonText:a,disabled:c,design:C,onCloseCallback:de,onToggleOpenCallback:$,noCloseOnClickOutside:_,children:s.jsxs(x2,{children:[m&&s.jsx(Tj,{children:s.jsx(cj,{type:"text",hasBorder:!1,placeholder:x,color:"dimmed",iconSize:12,value:ne,onChange:Y,noBackground:!0})}),u||!i?s.jsx(mj,{loadingText:h}):s.jsxs(Cj,{children:[m&&s.jsxs(Ej,{children:[s.jsx(jj,{children:Aj(v,re.length,i.length)}),s.jsx(kj,{children:s.jsx(I0,{design:"text-only",position:"left",size:"xsmall",weight:"light",onClick:fe,icon:q?"FilterAscending":"FilterDescending",children:q?N:B})})]}),s.jsx(Sj,{$moreItem:i.length>5,children:re.length>0?re.map((ve,_e)=>{const $t=ve.value,jt=ve.text;return s.jsx(C2,{title:jt,onClick:()=>W(ve),selected:$j(ve,G),optionType:p,value:$t},_e)}):s.jsx(Mj,{children:k})}),i.length>5&&s.jsx(Lj,{})]}),(_||z)&&s.jsx(bj,{hasApply:_,hasReset:z,resetText:S,cancelText:E,closeText:T,applyText:M,onCancel:se,onApply:he,disableApply:ye,onReset:me,disableReset:G===null&&q===U&&ne===""})]})})})};y.div`
  display: inline-block;
  position: relative;
`;const _j=y(b2)`
  letter-spacing: 0.2px;
...
`,xT=e=>{const{index:a,useAngles:i,angle:o,unit:c,size:u,lineSetId:h,x:p,y:m,moveCallback:x,moveEndCB:b=()=>{},Icon:v,rotate:k=0,options:C,readOnlyHandle:S=!1,styling:E="primary"}=e,T=f.useRef(null),[M,z]=f.useState(!1),[_,B]=f.useState(!1),[N,U]=f.useState(null),L=f.useCallback($=>{if($.preventDefault(),!S)for(let W=0;W<$.touches.length;W++){const Y=$.touches[W];(Y.target.parentNode.parentElement===T.current||Y.target.parentNode.parentElement.parentElement)&&(z(!0),U(W))}},[S]),R=f.useCallback(()=>{S||(z(!1),U(null),b())},[b,S]),F=f.useCallback($=>{if(!S)for(let W=0;W<$.touches.length;W++)W===N&&x({x:$.touches[W].pageX,y:$.touches[W].pageY},a)},[a,x,S,N]),J=f.useRef(null),q=f.useRef(null),ee=f.useCallback(()=>{J.current&&(window.removeEventListener("mousemove",J.current),J.current=null),q.current&&(window.removeEventListener("mouseup",q.current),q.current=null)},[]),re=f.useCallback($=>{$.preventDefault(),!S&&x({x:$.pageX,y:$.pageY},a)},[a,x,S]),Q=f.useCallback($=>{$.preventDefault(),!S&&(B(!1),ee(),x({x:$.pageX,y:$.pageY},a),setTimeout(b))},[ee,a,x,b,S]),ne=f.useCallback($=>{$.preventDefault(),!S&&(ee(),B(!0),J.current=re,q.current=Q,window.addEventListener("mousemove",re),window.addEventListener("mouseup",Q))},[ee,re,Q,S]);f.useEffect(()=>ee,[ee]);const D=i?"mask-"+h+"-"+a:"",G="shadowGradient-"+h+"-"+a,{showPointHandle:ae=!0,showPointLabel:oe=!1,pointIndexOffset:de}=C;return s.jsxs(oT,{ref:T,$styling:E,x:p,y:m,$mouseDragging:_,onTouchStart:L,onTouchEnd:R,onTouchMove:F,onMouseDown:ne,children:[s.jsxs("defs",{children:[s.jsxs("mask",{id:D,children:[s.jsx("rect",{width:"100%",height:"100%",x:"-50%",y:"-50%",fill:"white"}),s.jsx("rect",{width:u/3,height:u/.9,x:-(u/3/2),y:-(u/.9+5),fill:"black",transform:`rotate(${o||0} 0 0)`})]}),s.jsxs("radialGradient",{id:G,children:[s.jsx(gT,{$styling:E,offset:"0%"}),s.jsx(pT,{$styling:E,offset:"80%"})]})]}),v?s.jsx(vT,{transform:`scale(${c*1.5}) translate(-21 -21) rotate(${k}, 21, 21 )`,children:s.jsx(v,{height:"42",width:"42"})}):ae&&s.jsxs("g",{transform:`scale(${c})`,children:[s.jsx(fT,{r:u*1,$fillID:G}),s.jsx(dT,{$styling:E,r:u/2.4,strokeWidth:u/3}),s.jsxs(sT,{$touchDragging:M,$mouseDragging:_,children:[s.jsx(cT,{$styling:E,r:u/1.8}),s.jsx(uT,{$styling:E,r:u/2.25,strokeWidth:u/3})]}),s.jsx(lT,{$styling:E,r:u/2,strokeWidth:u/6,$maskID:D}),oe&&s.jsx(hT,{$showIndex:!0,children:s.jsx(mT,{$styling:E,transform:"translate(-5,6)",fontSize:"20px",$showIndex:!0,children:a+de})})]})]})},yT=y.line`
...
`,zT=y.img`
  ...
  width:  100%;
  height: 100%;
`,AT=({src:e,onSizeChange:a=()=>{},onLineMoveEnd:i=()=>{},onLineClick:o=()=>{},lineClickSensingBorder:c="65",hasClickSensingBorder:u=!0,options:{showHandleFinder:h,showSetIndex:p,showPointLabel:m=!1,showLabelShadow:x=!1,showPointHandle:b,showMoveHandle:v,showGrabHandle:k,setIndexOffset:C=0,pointIndexOffset:S=0,showPoint:E=!1,fixedImgDimensions:T,boundaryOffset:M=0,showDirectionMark:z=!1}={}})=>{const[_,B]=f.useState({x:{min:0,max:0},y:{min:0,max:0}}),{state:N}=f.useContext(Ni),[U,L]=f.useState(!1),[R,F]=f.useState(!1),[J,q]=f.useState({h:1,w:1}),[ee,re]=f.useState(1),Q=f.useRef(null),ne=f.useRef(null),D=f.useCallback(()=>{if(!Q.current)return;const{naturalHeight:$,naturalWidth:W,clientHeight:Y}=Q.current,se=T&&T.y||$,he=T&&T.x||W;(se!==J.h||he!==J.w)&&(q({h:se,w:he}),a({h:se,w:he}),console.debug("image size:",{naturalHeight:$,naturalWidth:W,clientHeight:Y,unit:$/Y})),se/Y!==ee&&re(se/Y),F(!0)},[T,J.h,J.w,a,ee]),G=f.useCallback(()=>{if(!ne.current)return null;const $=ne.current.getScreenCTM();return console.debug("calculateCTM",$),$},[]),ae=$=>{$.target===ne.current&&L(!!U&&!0)},oe=()=>{L(h||!1)};f.useEffect(()=>{if(!ne.current)return;const{viewBox:$}=ne.current,W={x:{min:$.baseVal.x+M,max:$.baseVal.x+$.baseVal.width-M},y:{min:$.baseVal.y+M,max:$.baseVal.y+$.baseVal.height-M}};console.debug("setBoundaries",W),B(W)},[J,M]),f.useEffect(()=>(window.addEventListener("resize",D),()=>{window.removeEventListener("resize",D)}),[D]);const de={handleFinderActive:U,revealSetIndex:p!==!1&&(p||N.length>1),showPointLabel:m,showLabelShadow:x,showPointHandle:b||b!==!1&&k!==!1,showMoveHandle:v||v!==!1&&k!==!1,setIndexOffset:C,pointIndexOffset:S,showPoint:E,showDirectionMark:z};return s.jsxs(LT,{children:[s.jsx(zT,{ref:Q,onLoad:D,src:e,alt:""}),R&&_?s.jsx(OT,{ref:ne,viewBox:`0 0 ${J.w} ${J.h} `,version:"1.1",xmlns:"http://www.w3.org/2000/svg",onPointerDown:ae,onPointerUp:oe,onPointerLeave:oe,$transculent:U,children:N.map(($,W)=>s.jsx(Q0,{hasClickSensingBorder:u,lineClickSensingBorder:c,onLineMoveEnd:i,onLineClick:o,lineSetId:W,lineData:$,getCTM:G,boundaries:_,unit:ee,size:30,options:de},W))}):s.jsx($T,{children:s.jsx(ia,{size:"large",styling:"primary"})})]})},RT=y.div`
  position: relative;
  line-height: 0;
  user-select: none;
  touch-action: none;
...
`,bM=({status:e="neutral"})=>s.jsx(yM,{$status:e}),$2=y.button`
...
`,_L=({showBreadcrumbs:e=!0,breadcrumbs:a=[],showHomeIcon:i=!0,back:o,share:c,$iconInGutter:u})=>{const{isLarge:h}=Z0(),p=u!==void 0?u:h,m=e&&a.length>0;return s.jsxs(ML,{children:[s.jsxs(LL,{children:[o&&s.jsx(TL,{$showDivider:m,$iconInGutter:p,...o}),m?s.jsx($L,{children:a.map((x,b)=>{const{text:v,href:k,onClick:C}=x,S=b===0,E=b===a.length-1,T=s.jsxs(st.Fragment,{children:[S&&i?s.jsx(D2,{children:s.jsx(we,{icon:"Home",size:11,color:"grey-10"})}):null,v]});return s.jsx(st.Fragment,{children:s.jsxs(OL,{children:[C?s.jsx(AL,{onClick:C,type:"button",children:T}):k?s.jsx(zL,{to:k,children:T}):s.jsx(RL,{children:T}),E?null:s.jsx(R2,{children:s.jsx(we,{icon:"Right",size:6,color:"grey-8"})})]})},b)})}):null]}),s.jsx(DL,{children:s.jsx(kL,{...c})})]})},ja=st.createContext({selected:"",setSelected:()=>{}}),eg=({children:e})=>{const[a,i]=f.useState("");return s.jsx(ja.Provider,{value:{selected:a,setSelected:i},children:e})},NL=y.div`
  display: flex;
  align-items: center;
  flex-direction: column;
  position: relative;
...
`,VL=y.div`
  ...
  `}
`,YL=({state:e="default",layout:a="horizontal",arrowDirection:i})=>s.jsx(VL,{$layout:a,children:s.jsxs(d0,{children:[s.jsx(Ou,{}),s.jsx(PL,{children:e==="default"?s.jsxs(FL,{$layout:a,width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[s.jsx("path",{d:"M13 14.875V5.125",strokeLinecap:"round",strokeLinejoin:"round"}),s.jsx("path",{d:"M10 14.875V5.125",strokeLinecap:"round",strokeLinejoin:"round"}),s.jsx("path",{d:"M7 14.875L7 5.125",strokeLinecap:"round",strokeLinejoin:"round"})]}):s.jsx(WL,{$direction:i,width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:s.jsx("path",{d:"M7.25 4.375L12.61 9.735C12.6803 9.80525 12.7199 9.90058 12.7199 10C12.7199 10.0994 12.6803 10.1948 12.61 10.265L7.25 15.625",stroke:"#9BA1A6",strokeLinecap:"round",strokeLinejoin:"round"})})}),s.jsx(Ou,{})]})}),ZL=y.div`
  position: absolute;
  z-index: 10;
  bottom: 20px;
  left: 20px;
...
`,QL=y.section`
  ...
  ${({$reverse:e})=>e==="true"?A`
    ...
    ${h0}{ order: 1; }
  `:null}
`,KL=f.forwardRef(({mainArea:e,sideArea:a,layout:i="horizontal",reverse:o,dividerSize:c=16,persist:u=!1,persistenceKey:h="resizable_ui",showDebug:p},m)=>{const b="resizable_layout_"+h,v=1,k=50,C=a.defaultSize||350,S=a.minSize||0,E=a.maxSize,T=e.minSize,[M,z]=f.useState(!1),[_,B]=f.useState(),[N,U]=f.useState(),[L,R]=f.useState(),[F,J]=f.useState(a.defaultCollapsed?"collapsed":"open"),[q,ee]=f.useState(C),[re,Q]=f.useState(C),[ne,D]=f.useState(C),G=f.useRef(null),ae=f.useRef(null),[oe,de]=Mh(`${b}_size`,null),[$,W]=Mh(`${b}_state`,null),[Y,se]=Mh(`${b}_quick_open_size`,null);f.useEffect(()=>{M||(u&&(oe&&ee(oe),$&&J($),Y&&D(Y)),z(!0))},[M,u,$,oe,Y]),f.useEffect(()=>{!M||!a.onSideAreaStateChange||a.onSideAreaStateChange(F)},[M,a,F]),f.useImperativeHandle(m,()=>({open:()=>{fe()},close:()=>{me()},reset:()=>{he()}}));const he=f.useCallback(()=>{ee(C),J("open"),de(null),W(null)},[ee,C,J,de,W]),me=f.useCallback(()=>{J("collapsed"),ee(v),Q(v),u&&(de(v),W("collapsed"),se(re))},[ee,J,W,de,se,re,u]),fe=f.useCallback(()=>{J("open");let Kt;q>v&&ae.current?Kt=i==="horizontal"?ae.current.clientWidth:ae.current.clientHeight:Kt=ne,Q(Kt),ee(Kt),u&&(de(Math.round(q)),W("open"))},[u,W,de,ne,q,i]),ye=f.useCallback(()=>{F==="collapsing"&&q<S-k?me():(Q(Math.round(q)),D(Math.round(q)),fe()),R(!1)},[me,fe,S,q,F]),ve=f.useCallback(Kt=>{Kt.preventDefault();const{clientX:Ta,clientY:oa}=Kt;Q(F==="collapsed"?q:Ql(q,S,E)),B({x:Ta,y:oa}),U({x:0,y:0}),R(!0)},[q,E,S,F]),_e=()=>{L&&ye()},$t=f.useCallback(Kt=>{const{clientX:Ta,clientY:oa}=Kt;let Ln,$n=F;if(L&&_&&re){if(U({x:_.x-Ta,y:_.y-oa}),i==="horizontal"){const Gt=(G.current?.clientWidth??0)-c-(T||0);o?Ln=Ql(re-(_.x-Ta),null,Gt):Ln=Ql(re+(_.x-Ta),null,Gt)}else{const Gt=(G.current?.clientHeight??0)-c-(T||0);o?Ln=Ql(re-(_.y-oa),null,Gt):Ln=Ql(re+(_.y-oa),null,Gt)}if(a.collapsable){const Gt=Ln<S-k;F==="open"&&Gt||F==="opening"&&Gt?$n="collapsing":F==="collapsing"&&!Gt?$n="open":F==="collapsed"?$n="peeking":F==="peeking"&&!Gt&&($n="opening")}ee(Ln),J($n)}},[ee,U,L,_,re,F,i,c,T,S,o,a.collapsable]),jt=f.useCallback(()=>{L&&ye()},[L,ye]);f.useEffect(()=>(document.addEventListener("mouseleave",jt),()=>{document.removeEventListener("mouseleave",jt)}),[jt]);const It=()=>F==="collapsed"||F==="peeking"?i==="horizontal"?o?"right":"left":o?"down":"up":i==="horizontal"?o?"left":"right":o?"up":"down",Mn=()=>F==="collapsed"||F==="peeking"||F==="collapsing"?"arrow":"default",Wr=s.jsxs(ZL,{children:[s.jsxs("div",{children:[s.jsx("span",{children:"State:"})," ",F]}),s.jsxs("div",{children:[s.jsx("span",{children:"Position:"})," ",_?.x,", ",_?.y]}),s.jsxs("div",{children:[s.jsx("span",{children:"Difference:"})," ",N?.x,", ",N?.y]}),s.jsxs("div",{children:[s.jsx("span",{children:"sideAreaStartBasis:"})," ",re]}),s.jsxs("div",{children:[s.jsx("span",{children:"sideAreaBasis:"})," ",q]}),s.jsxs("div",{children:[s.jsx("span",{children:"lastOpenSize:"})," ",ne]})]});return s.jsxs(QL,{ref:G,onPointerMove:$t,onPointerUp:_e,$initialised:M?"true":"false",$layout:i,$reverse:o?"true":"false",children:[s.jsx(f0,{$layout:i,$minDimension:T,children:s.jsx(s.Fragment,{children:e.content})}),s.jsx(h0,{onPointerDown:ve,onDoubleClick:he,$size:c,$fauxHover:L?"true":"false",children:s.jsx(YL,{state:Mn(),layout:i,arrowDirection:It()})}),s.jsx(XL,{ref:ae,style:{flexBasis:`${q}px`},$defaultSize:C,$minDimension:S,$maxDimension:E,$layout:i,$collapseState:F,children:s.jsx(ki,{children:s.jsx(s.Fragment,{children:a.content})})}),p?Wr:null]})}),Ql=(e,a,i)=>{let o=e;return o=i&&o>i?i:o,o=a&&o<a?a:o,o},B2=50,U2=68,$s=y.div`
  display: flex;
`,JL=y.div``,Os=y.div`
  padding: 0;
  flex: 1;
...
`,i$=y.button`
  ...
  `}
`,zu=({hasSubmenu:e=!1,contextKey:a=-1,submenuOpen:i,menuOpen:o,title:c,href:u,icon:h,compact:p,isActive:m,isExternalLink:x,onClickCallback:b})=>{const v=s.jsxs(st.Fragment,{children:[s.jsx(qr,{$compact:p,children:s.jsx(we,{icon:h,color:m?"inverse":"dimmed",size:20})}),s.jsx(Zu,{$compact:p,children:c}),e?s.jsx(I2,{children:s.jsx(we,{icon:i?"Up":"Down",color:"dimmed"})}):null]});return e?s.jsx(i$,{$menuOpen:o,$isActive:m,onClick:()=>b&&b(a),children:v}):x?s.jsx(t$,{href:u,target:"_blank",children:s.jsxs(a$,{$menuOpen:o,children:[v,s.jsx(n$,{children:s.jsx(we,{icon:"ExternalLink",color:"dimmed",size:12})})]})}):s.jsx(r$,{$menuOpen:o,to:u||"#",$isActive:m,onClick:()=>b&&b(a),children:v})},o$=(e,a)=>{switch(a.type){case"SET_MENU":{const i=localStorage.getItem(window.location.hostname+"_isMenuOpen");let o=i==="true"||i===null&&!!a.data.defaultMenuOpen,c=i==="true"&&!!a.data.canAlwaysPin;const u=a.data.desktopSize==="xlarge"||!!a.data.canAlwaysPin;return a.data.desktopSize==="xxlarge"&&a.data.canAlwaysPin===!1&&(o=!0,c=!0),{...e,desktopSize:a.data.desktopSize,isMenuOpen:o,isMenuPinned:c,canPin:u}}case"SET_OPEN":return e.isMenuOpen===!0||e.desktopSize==="xxlarge"&&!e.canPin?e:{...e,isMenuOpen:!0};case"SET_CLOSE":return e.isMenuOpen===!1||e.desktopSize==="xxlarge"&&!e.canPin||e.isMenuPinned===!0?e:{...e,isMenuOpen:!1};case"TOGGLE_PIN":{if(!e.canPin)return e;let i=!0;return e.isMenuPinned?(localStorage.setItem(window.location.hostname+"_isMenuOpen","false"),i=!1):localStorage.setItem(window.location.hostname+"_isMenuOpen","true"),{...e,isMenuOpen:i,isMenuPinned:!e.isMenuPinned}}default:return console.error(`Action ${a.type} not registered.`),e}},l$={desktopSize:"large",isMenuPinned:!1,isMenuOpen:!1,canPin:!1},s$=(e,a)=>{const{activeScreen:i}=Z0(),[o,c]=f.useReducer(o$,l$),u=f.useCallback((x,b,v)=>{c({type:"SET_MENU",data:{defaultMenuOpen:x,desktopSize:v,canAlwaysPin:b}})},[]),h=f.useCallback(()=>{c({type:"SET_OPEN"})},[]),p=f.useCallback(()=>{c({type:"SET_CLOSE"})},[]),m=f.useCallback(()=>{c({type:"TOGGLE_PIN"})},[]);return f.useLayoutEffect(()=>{u(e,a,i)},[i,e,a,u]),{menuState:o,setMenuOpen:h,setMenuClose:p,togglePinned:m}},c$=y.ul`
  display: block;
  position: relative;
  margin-left: 40px;
  padding: 0;
...
`,g$=y.div`
  ...
  `};
`,P2=({item:e,menuOpen:a,submenuOpen:i,contextKey:o,topLevelPath:c,mobileMenu:u=!1,onClickCallback:h})=>{const{icon:p,title:m,href:x,submenu:b,isExternalLink:v}=e,k=c===x,C=f.useRef(null),S=p$(b,h)||[],E=S.length>0;return s.jsxs(g$,{$open:i,$mobileMenu:u,children:[s.jsx(zu,{title:m,href:x,isActive:k,icon:p,hasSubmenu:E,isExternalLink:v,submenuOpen:i,menuOpen:a,onClickCallback:h,contextKey:o}),E?s.jsx(g0,{ref:C,children:s.jsx(d$,{children:S})}):null]})},p$=(e,a)=>{if(!e)return;const i=[],o=[];return i.push([]),e.forEach((c,u)=>{const{title:h,href:p,isExternalLink:m}=c;p?m?i[i.length-1].push(s.jsx(rx,{$isActive:!1,children:s.jsxs(q2,{href:p,target:"_blank",children:[h,s.jsx(h$,{children:s.jsx(we,{icon:"ExternalLink",color:"dimmed",size:10})})]})},u)):i[i.length-1].push(s.jsx(rx,{$isActive:!1,children:s.jsx(G2,{to:p,onClick:()=>a&&a(-1),children:h})},u)):(i[i.length-1].length>1&&i.push([]),i[i.length-1].push(s.jsx(u$,{children:s.jsx(f$,{children:h})},u)))}),i.forEach((c,u)=>{o.push(s.jsx(c$,{children:c},u))}),o},m$=y(He)`
  height: 50px;
...
`,k$=y.div`
  ...
  flex-direction: column;
  height: 100%;
`,E$=({content:e,home:a="/",logoMark:i,logoText:o,keepOpenText:c="Keep Open",autoHideText:u="Auto-Hide",supportUrl:h,supportText:p="Help & Support",defaultMenuOpen:m=!0,canAlwaysPin:x=!1,onMenuToggle:b=()=>{}})=>{const{menuState:v,setMenuOpen:k,setMenuClose:C,togglePinned:S}=s$(m,x),[E,T]=f.useState(0),M=ka(),z=f.useCallback(U=>{U.pointerType!=="touch"&&k()},[k]),_=f.useCallback(()=>{C()},[C]),B=f.useCallback(U=>{U.pointerType!=="touch"&&S()},[S]);f.useEffect(()=>{b(v.isMenuOpen)},[v.isMenuOpen,b]);const N=f.useCallback(U=>{U!==-1&&T(E!==U?U:-1)},[T,E]);return s.jsx(S$,{$isPinned:v.isMenuPinned,children:s.jsx(s.Fragment,{children:Ss.createPortal(s.jsx(C$,{$open:v.isMenuOpen,$desktopSize:v.desktopSize,onPointerEnter:v.isMenuPinned?()=>{}:z,onTouchStart:()=>console.debug("touch"),onMouseLeave:v.isMenuPinned?()=>{}:_,children:s.jsxs(k$,{children:[s.jsxs(m$,{to:a,children:[s.jsx(v$,{children:i?s.jsx(x$,{type:"image/svg+xml",data:i}):s.jsx(a2,{})}),s.jsx(F2,{children:o?s.jsx(y$,{type:"image/svg+xml",data:o}):s.jsx(jk,{})})]}),s.jsx(b$,{children:e.items.map((U,L)=>s.jsx(P2,{topLevelPath:i2(M.pathname),contextKey:L,menuOpen:v.isMenuOpen,submenuOpen:L===E&&v.isMenuOpen,onClickCallback:N,item:U,focusedContext:E},L))}),s.jsxs(w$,{children:[h&&s.jsx(ix,{children:s.jsx(zu,{compact:!0,isActive:!1,icon:"Question",title:p,href:h,menuOpen:v.isMenuOpen})}),v.canPin?s.jsx(ix,{children:s.jsx(zu,{compact:!0,isActive:!1,icon:v.isMenuOpen&&v.isMenuPinned?"Left":"Menu",title:v.isMenuPinned?c:u,onClickCallback:B,menuOpen:v.isMenuOpen})}):null]})]})}),document.body)})})},j$=y.div`
  margin: 10px 10px;
...
`,A$=y.pre`
  ...
  margin-top: -23px;
`,R$=y.div`
`,D$=({item:e,onUserDrawerMetaClick:a,copySuccessMessage:i,includeCopyTitle:o})=>{const{icon:c,title:u,subTitle:h,notes:p,hasCopyIcon:m}=e,{copyToClipboard:x}=V0(),[b,v]=f.useState(!1),[k,C]=f.useState("dimmed"),S=f.useCallback((M,z,_)=>{let B;o?B=(M||"")+`
`+(z||"")+`
`+(_||""):B=(z||"")+`
`+(_||""),x(B),v(!0),setTimeout(()=>{v(!1)},1500)},[o,x]),E=f.useCallback(()=>{C("mono")},[]),T=f.useCallback(()=>{C("dimmed")},[]);return s.jsx(f.Fragment,{children:u!==""&&s.jsx(W2,{onClick:a,children:s.jsxs(j$,{children:[s.jsxs(O$,{children:[s.jsxs($$,{children:[s.jsx(we,{icon:c,size:10,color:"dimmed"}),s.jsx(T$,{title:u,children:u})]}),s.jsxs(R$,{children:[b&&s.jsx(A$,{children:i!==""?i:"Copied!"}),m?s.jsx(z$,{onClick:()=>S(u,h,p),onMouseEnter:E,onMouseLeave:T,children:s.jsx(we,{icon:"Copy",size:12,color:k})}):null]})]}),h!==""?s.jsx(M$,{title:h,children:h}):null,p!==""?s.jsx(L$,{title:p,children:p}):null]})})})},_$=y.div`
...
`,B$=y.div`
  ...
  padding-top: 2px;
  opacity: 0.5;
`,ox=({icon:e="Settings",title:a,subTitle:i,onClickCallback:o=()=>{}})=>s.jsxs(_$,{onClick:o,children:[s.jsx(we,{icon:e,size:18,color:"dimmed"}),s.jsxs(N$,{children:[s.jsx(H$,{children:a}),s.jsx(B$,{children:i})]})]}),U$=y.div``,I$=y.div`
  width: 100%;
  position: fixed;
  bottom: 50px;
  @media ${fn.medium} {
...
`,Y$=y.div`
  ...
  color: var(--grey-11);
  opacity: 0.5;
`,Z$=e=>{if(e)return document.documentElement.setAttribute("lang",e),e;const a=navigator.language.split("-")[0],i=document.documentElement.lang;return i||(document.documentElement.setAttribute("lang",a),a)},V2=({hasLanguage:e=!1,selectedLanguageText:a="",languageOptionsText:i="LANGUAGE / 言語",selectedLangAttribute:o,hasLogout:c=!0,logoutLink:u="/logout",logoutText:h="Logout",hasCurrentUser:p=!0,currentUserText:m="Current User",accountOptionText:x="Account Options",userSubmenu:b=[],userDrawerBespoke:v,loggedInUser:k,hasSwitchTheme:C=!1,isLightMode:S=!0,switchThemeText:E="SWITCH THEME",selectedThemeText:T="",onLogout:M=()=>{},onLanguageToggle:z=()=>{},closeOnClick:_,onThemeToggle:B=()=>{},userDrawerFooter:N={icon:"",title:""},copySuccessMessage:U,includeCopyTitle:L,onUserDrawerMetaClick:R=()=>{},userDrawerMeta:F,hasUserDrawerMeta:J,hasUserDrawerFooter:q})=>{const{icon:ee,title:re}=N,Q=f.useCallback(async D=>{D.preventDefault(),await M(),window.location.assign(u),_&&_()},[_,u,M]),ne=f.useCallback(()=>{_&&_()},[_]);return f.useEffect(()=>{Z$(o)},[o]),s.jsxs(f.Fragment,{children:[s.jsx(U$,{children:s.jsxs(s.Fragment,{children:[p?s.jsxs(G$,{children:[s.jsx(lx,{children:m}),k]}):null,J?s.jsx(V$,{children:F?.map((D,G)=>s.jsx(D$,{onUserDrawerMetaClick:R,item:D,includeCopyTitle:L,copySuccessMessage:U},G))}):null,b.length>0?s.jsxs(q$,{children:[s.jsx(lx,{children:x}),s.jsx(sx,{children:b.map(({text:D,href:G},ae)=>s.jsx(cx,{children:s.jsx(ux,{to:G,onClick:ne,children:D})},ae))})]}):null,v||null,c?s.jsx(P$,{children:s.jsx(sx,{children:s.jsx(cx,{children:s.jsx(ux,{onClick:Q,to:u,children:h})})})}):null]})}),s.jsxs(I$,{children:[C&&s.jsx(ox,{icon:S?"LightMode":"DarkMode",title:E,subTitle:T,onClickCallback:B}),e&&s.jsx(ox,{icon:"Language",title:i,subTitle:a,onClickCallback:z}),q?s.jsxs(W$,{title:re,$icon:ee,children:[ee?s.jsx(F$,{children:s.jsx(we,{icon:ee,size:14,color:"dimmed"})}):null,s.jsx(Y$,{$icon:ee,children:re})]}):null]})]})},X$=y.div`
  display: flex;
  flex-direction: row;
  align-items: center;
...
`,aO=y.div`
  ...
  color: var(--grey-12);
  margin-top: 15px;
`,rO=({imgUrl:e,title:a,message:i,time:o})=>s.jsxs(X$,{children:[s.jsx(Q$,{children:e?s.jsx(J$,{$image:e}):s.jsx(K$,{})}),s.jsxs(eO,{children:[s.jsx(tO,{children:a}),s.jsx(nO,{children:i}),s.jsx(aO,{children:o})]})]}),dx=y.div`
  display: flex;
  flex-direction: column;
`,Lh=y.h2`
    text-transform: uppercase;
...
`,sO=y.div`
  ...
  `};
`,cO=({text:e,color:a,linkHref:i,linkTo:o,linkText:c,onClick:u})=>{const h=f.useRef(null),p=f.useRef(null),[m,x]=f.useState(!1),[b,v]=f.useState(!1),[k,C]=f.useState(0);f.useEffect(()=>{x(!1);const z=setTimeout(()=>{const _=h.current?.getBoundingClientRect().width??0,B=p.current?.getBoundingClientRect().width??0,N=_>=B?_:B;C(Math.ceil(N)),x(!0)},100);return()=>clearTimeout(z)},[e,c]);const S=f.useMemo(()=>s.jsx(X2,{ref:h,children:e}),[e]),E=f.useMemo(()=>u||o||i?s.jsx(Q2,{ref:p,children:c||e}):null,[u,o,i,c,e]),T=f.useMemo(()=>m?s.jsx(f.Fragment,{children:b?E:S}):s.jsxs(f.Fragment,{children:[S,E]}),[m,b,S,E]),M=f.useMemo(()=>u?s.jsx(lO,{$themeColor:a,children:s.jsx("button",{onClick:u,type:"button",children:T})}):o?s.jsx(hx,{$themeColor:a,children:s.jsx(He,{to:o,children:T})}):i?s.jsx(hx,{$themeColor:a,children:s.jsx("a",{href:i,children:T})}):s.jsx(oO,{$themeColor:a,children:S}),[u,o,i,a,T,S]);return s.jsx(sO,{$ready:m,$minWidth:k,onPointerEnter:()=>m&&v(!0),onPointerLeave:()=>m&&v(!1),children:M})},uO=y.div`
  z-index: 9;
  position: sticky;
  top: 0;
  height: 56px;
...
`,$h=y.button.attrs({type:"button"})`
  ...
  ${({$isActive:e})=>e&&A`
    &, &:hover {
      ...
      svg {
        transform: scale(1);
        animation: ${mO} 0.35s cubic-bezier(0.7, 0, 0.84, 0);
      }
...
`,xO=y.div`
    overflow-y: scroll;
    margin-right: -17px;
`,J2=({hasNotifications:e=!1,hasLanguage:a=!1,selectedLanguageText:i="",languageOptionsText:o,selectedLangAttribute:c,hasLogout:u=!0,logoutLink:h="/logout",logoutText:p="Logout",hasSearch:m=!1,hasCurrentUser:x=!0,currentUserText:b="Current User",accountOptionText:v="Account Options",searchPlaceholder:k="Search for devices, analysis tasks, etc.",userSubmenu:C=[],userDrawerBespoke:S,loggedInUser:E,notificationsHistory:T,customDrawer:M,hasSwitchTheme:z=!1,isLightMode:_=!0,switchThemeText:B="SWITCH THEME",selectedThemeText:N="",onLogout:U=()=>{},onLanguageToggle:L=()=>{},onThemeToggle:R=()=>{},userDrawerFooter:F,userDrawerMeta:J,onUserDrawerMetaClick:q=()=>{},hasUserDrawerMeta:ee,copySuccessMessage:re,includeCopyTitle:Q,hasUserDrawerFooter:ne,badge:D})=>{const[G,ae]=f.useState(null),oe=de=>{ae($=>$===de?null:de)};return s.jsx(uO,{children:s.jsxs(s.Fragment,{children:[m?s.jsxs(fO,{children:[s.jsx(hO,{children:s.jsx(we,{icon:"Search",size:16,color:"grey-6"})}),s.jsx(gO,{placeholder:k})]}):s.jsx("div",{}),s.jsxs(dO,{children:[D&&s.jsx(cO,{...D}),s.jsxs(pO,{children:[M&&s.jsx($h,{$isActive:G==="custom",onClick:()=>oe("custom"),children:s.jsx(E2,{...M})}),e&&s.jsx($h,{$isActive:G==="notifications",onClick:()=>oe("notifications"),children:s.jsx(we,{icon:"Notifications",size:20,color:"dimmed"})}),s.jsx($h,{$isActive:G==="user",onClick:()=>oe("user"),children:s.jsx(we,{icon:"UserProfile",size:20,color:"dimmed"})})]})]}),Ss.createPortal(s.jsxs(vO,{children:[s.jsx(Oh,{$isOpen:G==="user",children:s.jsx(V2,{hasLanguage:a,hasLogout:u,logoutLink:h,logoutText:p,hasCurrentUser:x,currentUserText:b,accountOptionText:v,userSubmenu:C,userDrawerBespoke:S,loggedInUser:E,onLogout:U,onLanguageToggle:L,selectedLanguageText:i,languageOptionsText:o,selectedLangAttribute:c,hasSwitchTheme:z,isLightMode:_,switchThemeText:B,selectedThemeText:N,onThemeToggle:R,onUserDrawerMetaClick:q,userDrawerFooter:F,userDrawerMeta:J,hasUserDrawerMeta:ee,copySuccessMessage:re,includeCopyTitle:Q,hasUserDrawerFooter:ne})}),e?s.jsx(Oh,{$isOpen:G==="notifications",$baseWidth:"300px",children:s.jsx(xO,{children:T?s.jsx(Y2,{...T}):null})}):null,M&&s.jsx(Oh,{$isOpen:G==="custom",$baseWidth:M.width?M.width:"200px",children:s.jsx(s.Fragment,{children:M.customComponent})})]}),document.body)]})})},e5=y.div`
  display: flex;
  flex-direction: row;
`,ng=({children:e,defaultTabId:a})=>{const{setSelected:i}=f.useContext(ja);return f.useEffect(()=>{i(a)},[a,i]),s.jsx(e5,{children:s.jsx(s.Fragment,{children:e})})},yO=y.div`
  margin-right: 39px;
  display: flex;
  align-items: center;
  line-height: 20px;
`,bO=y.label`
  ...
  flex-shrink: 0;
  user-select: none;
`,ds=({children:e,tabFor:a,onClick:i,...o})=>{const{selected:c,setSelected:u}=f.useContext(ja),h=f.useCallback(p=>{i&&i(p),u(a)},[i,u,a]);return s.jsx(yO,{...o,onClick:h,children:s.jsx(bO,{$active:c===a,children:s.jsx(s.Fragment,{children:e})})})},wO=y.div`
`,ar=({children:e,tabId:a,...i})=>{const{selected:o}=f.useContext(ja);return o===a?s.jsx(wO,{...i,children:s.jsx(s.Fragment,{children:e})}):null},SO=y.button`
  ${at}
  flex-basis: auto;
  flex-grow: 1;
`,CO=y.div`
  ...
  `}
`,ou=({tabFor:e,icon:a,closeId:i,counter:o,status:c,customComponent:u,...h})=>{const{selected:p,setSelected:m}=f.useContext(ja),x=f.useCallback(b=>{m(p===b?i:b)},[i,p,m]);return s.jsx(SO,{...h,onClick:()=>x(e),children:s.jsx(CO,{$isActive:p===e,children:s.jsx(E2,{icon:a,status:c,counter:o})})})};y.div`
  display: flex;
  align-items: center;
  margin-right: 22px;
  padding-bottom: 7px;
...
`,jO=y.div`
  text-transform: uppercase;
`,TO=({closeId:e,closeText:a="CLOSE MENU",children:i,formAction:o,...c})=>{const{setSelected:u}=f.useContext(ja);return s.jsxs(kO,{onClick:()=>u(e),...c,children:[s.jsx(EO,{children:s.jsx(we,{icon:"CloseCompact",color:"dimmed",size:16})}),s.jsx(jO,{children:a})]})},MO=y.div`
  position: relative;
...
`,LO=y.div`
  ...
  height: 100%;
  width: 100%;
`,$O=({closeId:e,children:a})=>{const{selected:i}=f.useContext(ja);return i===e?null:s.jsx(MO,{children:s.jsx(LO,{children:s.jsx(s.Fragment,{children:a})})})},OO=y.div``,gx=y.div`
  padding: 14px 0;
  border-bottom: 1px solid var(--dividing-line);
`,zO=({content:e,supportUrl:a,supportText:i="Help & Support",closeId:o})=>{const[c,u]=f.useState(0),h=ka(),{setSelected:p}=f.useContext(ja),m=f.useCallback(b=>{(b===-1||!e.items[b].submenu)&&p(o),b!==-1&&u(c!==b?b:-1)},[o,e.items,c,p]),x=f.useCallback(()=>{p(o)},[o,p]);return s.jsxs(OO,{children:[e.items.map((b,v)=>s.jsx(gx,{"data-key":v,children:s.jsx(P2,{mobileMenu:!0,topLevelPath:i2(h.pathname),contextKey:v,menuOpen:!0,submenuOpen:v===c,onClickCallback:m,item:b,focusedContext:c})},v)),a&&s.jsx(gx,{children:s.jsx(zu,{compact:!0,isActive:!1,icon:"Question",title:i,href:a,menuOpen:!0,onClickCallback:x})})]})},AO=y(He)`
  ${at};
  display: flex;
  flex-basis: 0;
  flex-grow: 1;
...
`,RO=y.div`
  margin-right: 15px;
`,DO=y.object``,_O=({home:e="/",logoMark:a,closeId:i})=>{const{setSelected:o}=f.useContext(ja);return s.jsx(AO,{to:e,onClick:()=>o(i),children:s.jsx(RO,{children:a?s.jsx(DO,{type:"image/svg+xml",data:a}):s.jsx(a2,{})})})},NO=y.div`
  background: var(--global-element-background);

  z-index: 100;
  display: flex;
  flex-direction: column;
`,HO=({closeId:e,hasLanguage:a,hasLogout:i,logoutLink:o,hasCurrentUser:c,userSubmenu:u,userDrawerBespoke:h,loggedInUser:p,onLogout:m,onLanguageToggle:x,...b})=>{const{setSelected:v}=f.useContext(ja),k=f.useCallback(()=>{v(e)},[e,v]);return s.jsx(NO,{children:s.jsx(V2,{hasLanguage:a,hasLogout:i,logoutLink:o,hasCurrentUser:c,userSubmenu:u,userDrawerBespoke:h,loggedInUser:p,onLogout:m,onLanguageToggle:x,...b,closeOnClick:k})})},ma="closeMenu",px="notifications",mx="user",vx="menu",xx="custom",BO=y.nav`
  background-color: var(--global-element-background);
  position: sticky;
  top: 0;
  left: 0;
...
`,IO=({content:e,home:a,logoMark:i,supportUrl:o,defaultMenuOpen:c=!0,closeText:u,hasLanguage:h,hasLogout:p,logoutLink:m,hasCurrentUser:x,hasNotifications:b,userSubmenu:v,userDrawerBespoke:k,loggedInUser:C,notificationsHistory:S,customDrawer:E,supportText:T,onLogout:M,onLanguageToggle:z,..._})=>s.jsx(BO,{children:s.jsxs(eg,{children:[s.jsxs(UO,{children:[s.jsx(_O,{home:a,logoMark:i,closeId:ma}),s.jsxs(ng,{defaultTabId:ma,children:[E&&s.jsx(ou,{...E,tabFor:xx,closeId:ma}),b?s.jsx(ou,{tabFor:px,icon:"Notifications",closeId:ma}):null,s.jsx(ou,{tabFor:mx,icon:"UserProfile",closeId:ma}),s.jsx(ou,{tabFor:vx,icon:"Menu",closeId:ma})]})]}),s.jsxs($O,{closeId:ma,children:[s.jsx(ar,{tabId:xx,children:E&&E.customComponent}),s.jsx(ar,{tabId:px,children:S&&b?s.jsx(Y2,{...S}):null}),s.jsx(ar,{tabId:mx,children:s.jsx(HO,{hasLanguage:h,hasLogout:p,logoutLink:m,hasCurrentUser:x,userSubmenu:v,userDrawerBespoke:k,loggedInUser:C,onLogout:M,onLanguageToggle:z,..._,closeId:ma})}),s.jsx(ar,{tabId:vx,children:s.jsx(zO,{content:e,supportUrl:o,supportText:T,defaultMenuOpen:c,closeId:ma})}),s.jsx(TO,{closeText:u,closeId:ma})]})]})}),ag=({content:e,home:a,openWidth:i,logoMark:o,logoText:c,supportUrl:u,defaultMenuOpen:h,canAlwaysPin:p,paddingOverride:m,maxWidth:x,legacyLayout:b,children:v,keepOpenText:k,autoHideText:C,supportText:S,onMenuToggle:E,...T})=>{const{isLarge:M}=Z0();return M?s.jsxs($s,{children:[s.jsx(E$,{content:e,home:a,openWidth:i,logoMark:o,logoText:c,supportUrl:u,defaultMenuOpen:h,canAlwaysPin:p,onMenuToggle:E,keepOpenText:k,autoHideText:C,supportText:S}),s.jsxs(e$,{children:[s.jsx(J2,{...T}),s.jsx(ax,{$maxWidth:x,$paddingOverride:m,$legacyLayout:b,children:s.jsx(s.Fragment,{children:v})})]})]}):s.jsxs(JL,{children:[s.jsx(IO,{content:e,home:a,logoMark:o,supportUrl:u,defaultMenuOpen:h,supportText:S,...T}),s.jsx(ax,{children:s.jsx(s.Fragment,{children:v})})]})},GO=y.div`
  width: 286px;
...
`;y(He)`
  ...
  text-decoration: none;
  padding: 7px 20px;
`;const Xu=({logoTextTop:e,logoTextBottom:a})=>s.jsxs(qO,{children:[s.jsx(PO,{children:e}),s.jsxs(FO,{children:["•",a,"•"]})]}),Qu=({children:e,...a})=>s.jsx(GO,{...a,children:s.jsx(s.Fragment,{children:e})}),Nt=y.div`
  display: inline-block;
  padding: 0 4px;
  margin-top: 12px;
  border-radius: 3px;
...
`,MA=y.div`
  ...
  line-height: 20px;
  color: var(--grey-9);
`,LA="full.name@example.com",$A=!0,OA=!0,zA=!0,AA="#",RA=()=>{const{onThemeToggle:e,isLightMode:a}=Ls(),{t:i}=ig(["GlobalUI","Common"]),o=f.useCallback(()=>{const u=Ke.language==="ja"?"en":"ja";Ke.changeLanguage(u),localStorage.setItem("language",u)},[]),c=s.jsx(TA,{children:s.jsxs(MA,{children:[s.jsx("p",{children:i("Common:userDrawerTextP1")}),s.jsx("p",{children:i("Common:userDrawerTextP2")})]})});return s.jsxs(jA,{children:[s.jsx(hn,{children:"CustomUserDrawerPage.tsx"}),s.jsx(J2,{userDrawerBespoke:c,loggedInUser:LA,hasSearch:$A,useNotifications:OA,logoutLink:AA,searchPlaceholder:i("Common:searchPlaceholder"),isLightMode:a,switchThemeText:i("GlobalUI:theme.switchTheme"),selectedThemeText:i(a?"GlobalUI:theme.lightMode":"GlobalUI:theme.darkMode"),onThemeToggle:e,hasLanguage:zA,onLanguageToggle:o,selectedLangAttribute:Ke.language,selectedLanguageText:i(`GlobalUI:theme.${Ke.language}`),accountOptionText:i("Common:accountOptions"),currentUserText:i("GlobalUI:currentUser"),userSubmenu:[{href:"/user/accounts",text:i("Common:accounts")},{href:"/user/billing",text:i("Common:billing")},{href:"/user/payments",text:i("Common:payments")}]})]})},DA=y.div`
  margin: 100px 200px;
`,_A=y.div`
  height: 1px;
  border-radius: 3px;
...
//# sourceMappingURL=index-BHYgo0Tr.js.map

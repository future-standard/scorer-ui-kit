...
`)),InputActionButton=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button.attrs({type:"button"})(_t2$8||(_t2$8=_$a`
  ...
  cursor: pointer;
  outline: none;
`)),FeedbackContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$6||(_t3$6=_$a`
  flex-shrink: 0;
...
`),({theme:theme,fieldState:fieldState})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$a||(_t2$a=_$c`
    min-height: 30px;
    font-family: ${0};
    border: 1px solid ${0};
  `),theme.fontFamily.data,theme.styles.form.input[fieldState].normal.borderColor),({theme:{typography:typography}})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$7||(_t3$7=_$c`
    ${0};
    &::placeholder {
      ${0};
    }
...
`)),CheckboxOuter=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$c||(_t2$c=_$e`
  ...
  border-width: 2px;
  border-style: solid;
`)),CheckboxInner=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$9||(_t3$9=_$e`
  position: absolute;
  top: 0;
  bottom: 0;
  right: 0;
...
`),({visualState:visualState,disabled:disabled,parentHover:parentHover,theme:{styles:styles}})=>visualState===CheckboxState.Off&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$6||(_t6$6=_$e`
    ${0}{
      ${0};
    }
  ...
  `),CheckboxOuter,styles.form.checkbox.unchecked.default,!disabled&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t7$6||(_t7$6=_$e`
      &:hover ${0} {
        ${0};
      }`),CheckboxOuter,styles.form.checkbox.unchecked.hover),!disabled&&void 0!==parentHover&&parentHover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$5||(_t8$5=_$e`
      ${0}{
        ${0};
      }
    `),CheckboxOuter,styles.form.checkbox.unchecked.hover),disabled&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t9$5||(_t9$5=_$e`
      ${0}{
        ${0};
        cursor: not-allowed;
      }
    `),CheckboxOuter,styles.form.checkbox.unchecked.disabled)),({visualState:visualState,disabled:disabled,parentHover:parentHover,theme:{styles:styles}})=>visualState===CheckboxState.On&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t10$4||(_t10$4=_$e`
    ${0}{
      ${0};
      border: none;
    }
...
`)),OuterRadio=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.label(_t2$d||(_t2$d=_$f`
  ...
  ${0};
`),({theme:theme,isChecked:isChecked,disabled:disabled,parentHover:parentHover})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$a||(_t3$a=_$f`
    border-color: ${0};
    ...
    ${0}
  `),theme.styles.form.checkbox.unchecked.default.borderColor,!disabled&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$9||(_t4$9=_$f`
      &:hover {
        cursor: pointer;
        border-color: ${0};
      }
    `),theme.styles.form.checkbox.unchecked.hover.borderColor),!disabled&&void 0!==parentHover&&parentHover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$7||(_t5$7=_$f`
      cursor: pointer;
      border-color: ${0};
    `),theme.styles.form.checkbox.unchecked.hover.borderColor),isChecked&&!disabled&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$7||(_t6$7=_$f`
      border-color: ${0};
      ${0} {
        background-color: ${0};
      }
    `),theme.styles.form.checkbox.checked.default.backgroundColor,InnerRadio,theme.styles.form.checkbox.checked.default.backgroundColor),isChecked&&!disabled&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t7$7||(_t7$7=_$f`
      &:hover {
        border-color: ${0};
        ${0} {
          background-color: ${0};
    ...
    `),theme.styles.form.checkbox.checked.hover.backgroundColor,InnerRadio,theme.styles.form.checkbox.checked.hover.backgroundColor),isChecked&&!disabled&&void 0!==parentHover&&parentHover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$6||(_t8$6=_$f`
      border-color: ${0};
      ${0} {
        background-color: ${0};
      }

    `),theme.styles.form.checkbox.checked.hover.backgroundColor,InnerRadio,theme.styles.form.checkbox.checked.hover.backgroundColor),isChecked&&disabled&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t9$6||(_t9$6=_$f`
      cursor: not-allowed;
      border-color: ${0};
      ${0} {
        background-color: ${0};
      }
    `),theme.styles.form.checkbox.checked.disabled.backgroundColor,InnerRadio,theme.styles.form.checkbox.checked.disabled.backgroundColor),!isChecked&&disabled&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t10$5||(_t10$5=_$f`
      cursor: not-allowed;
      border-color: ${0};
      ${0} {
        background-color: ${0};
      }
    `),theme.styles.form.checkbox.unchecked.disabled.borderColor,InnerRadio,theme.styles.form.checkbox.unchecked.disabled.backgroundColor))),HiddenInput=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.input(_t11$4||(_t11$4=_$f`
  position: absolute;
  height: 100%;
  width: 100%;
  margin: 0;
  padding:0;
  opacity: 0;
`)),Container$6=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t12$2||(_t12$2=_$f`
  position: relative;
  display: inline-block;
  width: 18px;
  height: 18px;
...
`)),RadioButton=({id:id,value:value,name:name,currentChecked:currentChecked,disabled:_disabled=!1,required:required,parentHover:parentHover,onChangeCallback:_onChangeCallback=(()=>{})})=>{const handleChange=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(e=>{const checkedValue=e.target.value;_onChangeCallback(checkedValue)},[]),isChecked=void 0!==currentChecked&&currentChecked==value;return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$6,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(HiddenInput,Object.assign({type:"radio"},{id:id,name:name,disabled:_disabled,required:required,value:value},{checked:isChecked,onChange:handleChange})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(OuterRadio,Object.assign({},{isChecked:isChecked,disabled:_disabled,parentHover:parentHover},{htmlFor:id}),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(InnerRadio,null)))};let _t$g,_t2$e,_t3$b,_t4$a,_t5$8,_t6$8,_t7$8,_t8$7,_t9$7,_t10$6,_$g=t=>t;const FeedbackIcon$1=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$g||(_t$g=_$g`
  ...
  align-items:center;
  padding-top: 2px;
`)),StyledTextArea=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.textarea(_t2$e||(_t2$e=_$g`
...
${0};
  ...
  ${0};
`),({theme:theme,fieldState:fieldState})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$b||(_t3$b=_$g`
  font-family: ${0};
  border: 1px solid ${0};
...
`),IconWrapper),StyledSelect=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.select(_t2$f||(_t2$f=_$h`
  box-sizing: border-box;
  outline: none;
  border-radius: 3px;
  height: 40px;
...
`)),Container$8=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$c||(_t3$c=_$h`
...
`),({leftValue:leftValue})=>`calc(${leftValue}% + 7px)`,({alignment:alignment})=>"center"===alignment&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t7$a||(_t7$a=_$i`transform: translateX(-50%);;`)),({alignment:alignment})=>"right"===alignment&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$9||(_t8$9=_$i`transform: translateX(5%);`)),({alignment:alignment})=>"left"===alignment&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t9$9||(_t9$9=_$i`transform: translateX(-95%);`))),ThumbWrapper=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t10$8||(_t10$8=_$i`
  ...
  width: calc(100% - ${0}px);
  height: 2px;
`),16),Thumb=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.span(_t11$6||(_t11$6=_$i`
  width: ${0}px;
  height: ${0}px;
  border-radius: 8px;
  background-color: ${0};
...
`)),InputFileButton=({text:text,buttonDesign:buttonDesign,buttonSize:buttonSize,inputCallback:inputCallback,...props})=>{let fileInputRef=Object(react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);const handleFile=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(async e=>{if(!(e.target.files&&e.target.files.length>0))return;const newFiles=e.target.files;inputCallback&&inputCallback(newFiles),e.target.value=""},[inputCallback]),forwardClick=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(()=>{fileInputRef.current&&fileInputRef.current.click()},[]);return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$9,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(HiddenInput$2,Object.assign({},props,{ref:fileInputRef,type:"file",onChange:handleFile})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledButton$2,{onClick:forwardClick,design:buttonDesign,size:buttonSize},text))};let _t$k,_t2$i,_t3$f,_t4$d,_t5$b,_$k=t=>t;const Container$a=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$k||(_t$k=_$k``)),Headers=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$i||(_t2$i=_$k`
  ...
  margin-bottom: 30px;
  padding: 0 6px;
`)),ValueLabel=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(Label)(_t3$f||(_t3$f=_$k`
  font-family: ${0};
  margin-bottom: 0;
...
`)),TopLine=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$l||(_t2$l=_$n`
  ...
  left: 0;
  top: -3px;
`),CropLineStyle),RightLine=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$h||(_t3$h=_$n`
  ${0};
  cursor: e-resize;
  right: -3px;
  top: 0;
...
`),resizeSquaresCss,({isResizable:isResizable})=>isResizable&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t10$9||(_t10$9=_$n`
    cursor: nw-resize;
  `))),PointNE=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t11$7||(_t11$7=_$n`
  ${0};
  top: -5px;
  right: -5px;
  ${0};
`),resizeSquaresCss,({isResizable:isResizable})=>isResizable&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t12$4||(_t12$4=_$n`
  ...
  ${0};
    ...
    right: -5px;
  ${0};
`),resizeSquaresCss,({isResizable:isResizable})=>isResizable&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t14$2||(_t14$2=_$n`
    cursor: e-resize;
  `))),PointSE=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t15$1||(_t15$1=_$n`
  ${0};
  bottom: -5px;
  right: -5px;
  ${0};
...
`),resizeSquaresCss,({isResizable:isResizable})=>isResizable&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t22||(_t22=_$n`
  ...
  font-family: ${0};
  z-index: 999;
`),({theme:theme})=>theme.fontFamily.ui),InnerContainer$2=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$m||(_t2$m=_$o`
    position: relative;
  z-index: 99;
`)),ToolHeader=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$i||(_t3$i=_$o`
  display: flex;
  align-items: center;
  justify-content: space-between;
  margin-bottom: 17px;
...
`),"142px",({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$n||(_t2$n=_$p`
    font-family: ${0};
  `),theme.fontFamily.ui)),PreviewImageGroup=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$j||(_t3$j=_$p`
  position: relative;
  margin-bottom: 17px;
  height: ${0};
  width: ${0};
...
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$h||(_t4$h=_$r`
    font-family: ${0};
    ${0};
  `),theme.fontFamily.ui,({theme:theme})=>theme.typography.filters.datepicker.metaHeader.default),({theme:theme})=>theme.colors.divider,({theme:theme})=>theme.typography.filters.datepicker.metaHeader.active),Item=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$f||(_t5$f=_$r`
  padding: 12px;
  display: flex;
  justify-content: left;
`)),IconWrap=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$e||(_t6$e=_$r`
  flex: 0 0 40px;
  padding-top: 2px;
`)),Input$1=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.input(_t7$e||(_t7$e=_$r`
  ${0}
  ...
  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$d||(_t8$d=_$r`
    font-family: ${0};
  `),theme.fontFamily.data),({theme:theme})=>theme.typography.filters.value,({readOnly:readOnly})=>readOnly&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t9$d||(_t9$d=_$r`
    border-color: transparent;
  `))),TimeColon=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t10$a||(_t10$a=_$r`
  flex: 0 0 20px;
`)),InputWrap=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t11$8||(_t11$8=_$r`
  display: flex;
  flex: 1;
  box-sizing: border-box;
  border-radius: 3px;
...
`),({theme:theme})=>theme.colors.divider),TimeZoneOption=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$l||(_t3$l=_$s`
  ...
  padding: 10px;
  box-sizing: border-box;
`),({theme:theme})=>theme.colors.divider),TimeZoneLabel=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$i||(_t4$i=_$s`
  ${0}

`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$g||(_t5$g=_$s`
    font-family: ${0};
    ${0};
  `),theme.fontFamily.ui,theme.typography.filters.subOption.label)),TimeZoneValue=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$f||(_t6$f=_$s`
  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t7$f||(_t7$f=_$s`
    font-family: ${0};
    ${0};
  `),theme.fontFamily.data,theme.typography.filters.subOption.value)),CalendarArea=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t8$e||(_t8$e=_$s`
  user-select: none;
`)),CalendarHeader=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t9$e||(_t9$e=_$s`
  display: flex;
  height: 70px;
  border-bottom: ${0} 1px solid;
  text-align: center;
`),({theme:theme})=>theme.colors.divider),CurrentMonth=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t10$b||(_t10$b=_$s`
  flex: 1;
  flex-direction: column;
  display: flex;
  align-items: center;
...
`),({theme:theme})=>theme.typography.filters.datepicker.focusedMonth,({theme:theme})=>theme.typography.filters.datepicker.focusedYear),IconWrap$1=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t11$9||(_t11$9=_$s``)),PaginateMonth=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t12$5||(_t12$5=_$s`
  cursor: pointer;
  flex: 0 0 90px;
...
`),({theme:theme})=>theme.typography.filters.datepicker.monthLink.default,({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t13$3||(_t13$3=_$s`
      background: ${0};
      ${0}
    `),theme.colors.menu.active,theme.typography.filters.datepicker.monthLink.hover),IconWrap$1,({theme:theme})=>theme.colors.pureBase),CalBody=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t14$3||(_t14$3=_$s`
  padding: 5px 0;
`)),CalRow=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t15$2||(_t15$2=_$s`
  display: grid;
  ...
  padding: 0 10px;
`)),CalHRow=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(CalRow)(_t16$1||(_t16$1=_$s`
  border-bottom: ${0} 1px solid;
`),({theme:theme})=>theme.colors.divider),CalCell=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t17$1||(_t17$1=_$s`
...
`),({theme:theme})=>theme.typography.filters.datepicker.calendar.default,({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t18$1||(_t18$1=_$s`
    font-family: ${0};
  `),theme.fontFamily.data)),CalHCell=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(CalCell)(_t19$1||(_t19$1=_$s`
  ${0};
`),({theme:theme})=>theme.typography.filters.datepicker.calendar.header),CalCellB=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(CalCell)(_t20$1||(_t20$1=_$s`
  cursor: pointer;
  position: relative;
...
`),({thisMonth:thisMonth})=>!thisMonth&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t21$1||(_t21$1=_$s`
    ${0};
  `),({theme:theme})=>theme.typography.filters.datepicker.calendar.otherMonth),({isToday:isToday})=>isToday&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t22$1||(_t22$1=_$s`
    border: 2px solid ${0};
  `),({theme:theme})=>theme.colors.menu.passive),({state:state,theme:theme})=>("single"===state||"start"===state||"end"===state)&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t23||(_t23=_$s`
    background: ${0};
    ${0};
  `),theme.colors.menu.active,theme.typography.filters.datepicker.calendar.active),({state:state})=>"start"===state&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t24||(_t24=_$s`
    border-top-right-radius: 0;
    border-bottom-right-radius: 0;
  `)),({state:state})=>"end"===state&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t25||(_t25=_$s`
    border-top-left-radius: 0;
    border-bottom-left-radius: 0;
  `)),({state:state})=>"insideHover"===state&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t26||(_t26=_$s`
    background: ${0} !important;
  `),({theme:theme})=>theme.colors.divider),({state:state})=>"inside"===state&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t27||(_t27=_$s`
    background: ${0};
    border-radius: 0;
    opacity: 1;
...
`),({theme:theme})=>theme.styles.filters.dropdownContainer.background,({theme:theme})=>theme.styles.filters.dropdownContainer.topBorder),Inner=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$r||(_t2$r=_$t`
  display: inline-flex;
  flex-direction: row;
`)),FilterDropdownContainer=({children:children,...props})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$h,Object.assign({},props),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Inner,null,children));let _t$u,_t2$s,_t3$m,_t4$j,_t5$h,_t6$g,_$u=t=>t;const StyledButton$3=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t$u||(_t$u=_$u`
  ${0};
  ...
  ${0};
`),resetButtonStyles,({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$s||(_t2$s=_$u`
    font-family: ${0};
    transition: opacity ${0} ${0};
...
`),theme.fontFamily.ui,theme.animation.speed.normal,theme.animation.easing.primary.easeOut,IconWrapper,theme.colors.icons.dimmed,theme.colors.icons.inverse,IconWrapper,theme.colors.icons.inverse),({theme:theme,isOpen:isOpen,hasFlipArrow:hasFlipArrow})=>isOpen&&hasFlipArrow&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$m||(_t3$m=_$u`
  ...
  `),theme.colors.icons.inverse,IconWrapper,theme.colors.icons.inverse)),InnerContainer$3=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$j||(_t4$j=_$u`
    display: flex;
    align-items: center;
`)),ArrowIcon=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(Icon)(_t5$h||(_t5$h=_$u``)),ButtonText=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$g||(_t6$g=_$u`
  padding-right: ${0};
`),({hasFlipArrow:hasFlipArrow})=>hasFlipArrow?"3px":"20px"),FilterButton=({icon:icon,hasFlipArrow:_hasFlipArrow=!1,isOpen:isOpen,children:children,...props})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledButton$3,Object.assign({type:"button"},props,{isOpen:isOpen,hasFlipArrow:_hasFlipArrow}),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(InnerContainer$3,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Icon,{icon:icon,size:12}),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ButtonText,Object.assign({},{hasFlipArrow:_hasFlipArrow}),children),_hasFlipArrow&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ArrowIcon,{icon:isOpen?"Up":"Down",size:8})));function useClickOutside(elRef,elCallback){const callbackRef=Object(react__WEBPACK_IMPORTED_MODULE_1__.useRef)(elCallback);callbackRef.current=elCallback,Object(react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{const handleClickOutside=eve=>{var _elRef$current;null!=elRef&&null!==(_elRef$current=elRef.current)&&void 0!==_elRef$current&&_elRef$current.contains(eve.target)||callbackRef.current(eve)};return document.addEventListener("click",handleClickOutside,!0),()=>{document.removeEventListener("click",handleClickOutside,!0)}},[elCallback,elRef])}let _t$v,_t2$t,_t3$n,_t4$k,_t5$i,_t6$h,_t7$g,_t8$f,_t9$f,_$v=t=>t;const StyledCheckbox=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(Checkbox)(_t$v||(_t$v=_$v``)),StyledLabel$1=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.label(_t2$t||(_t2$t=_$v`
  font-family: ${0};
  display: block;
  color: hsl(0, 0%, 56%);
  font-size: 14px;
  ...
  ${0};
`),({theme:theme})=>theme.fontFamily.data,({buttonSize:buttonSize})=>buttonSize&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$n||(_t3$n=_$v`
    ${0};

    ${0};

    ${0};
  `),"xsmall"===buttonSize&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$k||(_t4$k=_$v`
      font-size: 12px;
      margin-left: 10px;
    `)),"normal"===buttonSize&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$i||(_t5$i=_$v`
      font-size: 16px;
      margin-left: 17px;
    `)),"large"===buttonSize&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$h||(_t6$h=_$v`
      font-size: 18px;
      margin-left: 20px;
    `)))),Container$i=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$g||(_t7$g=_$v`
  display: flex;
  align-items: center;
  height: 100%;
  width: 100%;
  ${0};
`),({theme:theme,selected:selected})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$f||(_t8$f=_$v`
  ...
  `),StyledLabel$1,theme.styles.form.checkbox.checked.hover.backgroundColor,selected&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t9$f||(_t9$f=_$v`
      ${0} {
        color: ${0};
      }
    `),StyledLabel$1,theme.styles.form.checkbox.checked.default.backgroundColor)));let _t$w,_t2$u,_t3$o,_t4$l,_t5$j,_$w=t=>t;const Container$j=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$w||(_t$w=_$w`
  ${0};
  ...
  display: flex;
  border-radius: 3px;
`),({theme:theme,hasBorder:hasBorder})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$u||(_t2$u=_$w`
    ${0};
  `),hasBorder&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$o||(_t3$o=_$w`
      border: 1px solid ${0}
    `),theme.styles.form.input.default.normal.borderColor)),IconWrapper),StyledInput$2=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.input(_t4$l||(_t4$l=_$w`
  ${0};
...
`),({theme:theme,color:color})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$j||(_t5$j=_$w`
    font-family: ${0};
    ${0};
    &::placeholder {
      ${0};
  ...
  `),theme.fontFamily.ui,theme.typography.form.input.value.compact,theme.typography.form.input.placeholder.compact,theme.colors.icons[color])),BasicSearchInput=({color:_color="subtle",hasBorder:_hasBorder=!0,iconSize:_iconSize=11,...props})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$j,Object.assign({},{hasBorder:_hasBorder}),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Icon,Object.assign({},{color:_color},{icon:"Search",weight:"heavy",size:_iconSize})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledInput$2,Object.assign({},{color:_color},props))),isFilterItem=item=>null!==item&&(("number"==typeof item.value||"string"==typeof item.value)&&"string"==typeof item.text);let _t$x,_t2$v,_t3$p,_t4$m,_t5$k,_t6$i,_t7$h,_t8$g,_t9$g,_t10$c,_t11$a,_t12$6,_t13$4,_t14$4,_$x=t=>t;const Container$k=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$x||(_t$x=_$x`
  display: inline-block;
  position: relative;
`)),ButtonWrapper=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$v||(_t2$v=_$x`
  display: inline-block;
`)),ContentBox=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$p||(_t3$p=_$x`
  z-index: 100;
  min-width: ${0}px;
  position: absolute;

  ${0};
`),270,({openState:openState,disabled:disabled})=>openState&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$m||(_t4$m=_$x`
    display: ${0};
    display: ${0};
...
`)),InnerBox=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$i||(_t6$i=_$x`
  ...
  background-color: hsl(200, 23%, 97%);
`)),LoadingBox=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$h||(_t7$h=_$x`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`),({theme:theme})=>theme.fontFamily.data),SearchWrapper=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t14$4||(_t14$4=_$x`
  height: 41px;
  display: flex;
  align-items: center;
`)),isValueSelected=(item,selected)=>{let isItemSelected=!1;return Array.isArray(selected)?selected.forEach(element=>{element.value===item.value&&(isItemSelected=!0)}):isFilterItem(selected)&&(isItemSelected=item.value===selected.value),isItemSelected},getVisibleList=(list,maxItems,selected)=>{if(list.length<=maxItems)return list;if(null===selected)return list.slice(0,maxItems);if(isFilterItem(selected)){const index=list.findIndex(item=>item.value===selected.value);if(-1!==index)return list.slice(0,maxItems);if(-1!==index&&index<maxItems)return list.slice(0,maxItems);const newList=list.slice(0,maxItems-1);return newList.push(selected),newList}if(Array.isArray(selected)){if(selected.length>maxItems)return selected.slice(0,maxItems);if(selected.length===maxItems)return selected;const selectedIndexList=[];selected.forEach(element=>{const index=list.findIndex(item=>item.value===element.value);-1!==index&&selectedIndexList.push(index)}),selectedIndexList.sort((function(a,b){return a-b}));let selectedIndex=0,visibleListAvailability=maxItems-selected.length;const newList=[];for(let listIndex=0;listIndex<list.length&&(selectedIndex<selectedIndexList.length&&listIndex===selectedIndexList[selectedIndex]?selectedIndex++:visibleListAvailability--,newList.push(list[listIndex]),0!==visibleListAvailability);listIndex++);if(newList.length<maxItems&&selectedIndex<selectedIndexList.length)for(;selectedIndex<selectedIndexList.length;selectedIndex++)newList.push(list[selectedIndexList[selectedIndex]]);return newList}return list.slice(0,maxItems-1)},FilterDropdown=({buttonIcon:buttonIcon,buttonText:buttonText,list:list,selected:_selected=null,disabled:_disabled=!1,isLoading:_isLoading=!1,loadingText:loadingText,optionType:_optionType="text",searchPlaceholder:searchPlaceholder,maxDisplayedItems:_maxDisplayedItems=5,searchResultText:_searchResultText="Showing [VISIBLE] of [TOTAL]",onSelect:_onSelect=(()=>{}),...props})=>{const[visibleList,setVisibleList]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)(getVisibleList(list,_maxDisplayedItems,_selected)),[searchText,setSearchText]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)(""),[openState,setOpenState]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)({isOpen:!1,position:"bottom-right"}),buttonWrapperRef=Object(react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null),mainRef=Object(react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);useClickOutside(mainRef,Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(()=>{setOpenState(prev=>({...prev,isOpen:!1})),setSearchText(""),setVisibleList(getVisibleList(list,_maxDisplayedItems,_selected))},[list,_maxDisplayedItems,_selected]));const handleToggleOpen=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(()=>{var _buttonWrapperRef$cur;if(!buttonWrapperRef.current)return;const buttonRect=null===(_buttonWrapperRef$cur=buttonWrapperRef.current)||void 0===_buttonWrapperRef$cur?void 0:_buttonWrapperRef$cur.getBoundingClientRect();if(!buttonRect)return;const position=(buttonRect=>{let position="bottom-right";const openLeft=buttonRect.left+270>window.innerWidth,openTop=buttonRect.bottom+190>window.innerHeight,spaceTop=buttonRect.bottom>190;return openLeft&&openTop&&spaceTop&&(position="top-left"),openTop&&!openLeft&&spaceTop&&(position="top-right"),!openTop&&openLeft&&(position="bottom-left"),position})(buttonRect);setSearchText(""),setVisibleList(getVisibleList(list,_maxDisplayedItems,_selected)),setOpenState(prev=>{const isOpen=!prev.isOpen;return{...prev,isOpen:isOpen,position:position}})},[list,_maxDisplayedItems,_selected]),handleSelection=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(item=>{const newSelected=((item,selected,optionType)=>{let isItemSelected=!1;if("checkbox"===optionType){const validSelected=Array.isArray(selected)?selected:isFilterItem(selected)?[selected]:[],newSelected=[];return validSelected.forEach(element=>{item.value===element.value?isItemSelected=!0:newSelected.push(element)}),isItemSelected||newSelected.push(item),0===newSelected.length?null:newSelected}return item})(item,_selected,_optionType);_onSelect(newSelected)},[_selected,_optionType,_onSelect]),handleInputFilter=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(e=>{const{value:value}=e.target;if(setSearchText(value),""===value)return void setVisibleList(getVisibleList(list,_maxDisplayedItems,_selected));const newValue="number"==typeof value?value.toString(10):value,newList=((list,newValue)=>list.filter(element=>element.text.toLowerCase().includes(newValue.toLowerCase())))(list,newValue);setVisibleList(getVisibleList(newList,_maxDisplayedItems,null))},[list,_maxDisplayedItems,_selected]);return Object(react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{let isActive=!0;return isActive&&(setSearchText(""),setVisibleList(getVisibleList(list,_maxDisplayedItems,_selected))),()=>{isActive=!1}},[list,_maxDisplayedItems,_selected]),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$k,Object.assign({ref:mainRef},props),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ButtonWrapper,{ref:buttonWrapperRef},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(FilterButton,Object.assign({icon:buttonIcon,isOpen:openState.isOpen,hasFlipArrow:!0,onClick:handleToggleOpen},{disabled:_disabled}),buttonText)),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ContentBox,Object.assign({},{openState:openState,disabled:_disabled}),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TopLine$1,null),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(InnerBox,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(SearchWrapper,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(BasicSearchInput,{type:"text",hasBorder:!1,placeholder:searchPlaceholder,color:"dimmed",iconSize:12,value:searchText,onChange:handleInputFilter})),_isLoading||!list?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(LoadingBox,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Spinner,{size:"large",styling:"primary"}),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(LoadingText,null,loadingText)):react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ResultsContainer,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ResultCounter,null,(template=_searchResultText,visible=visibleList.length,total=list.length,template.replace("[TOTAL]",""+total).replace("[VISIBLE]",""+visible))),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(OptionList,null,visibleList.length>0&&visibleList.map(item=>{const value=item.value,text=item.text;return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledFilterOption,Object.assign({key:"select-"+text,id:"select-"+text,label:text.toString(),onClick:()=>handleSelection(item),selected:isValueSelected(item,_selected)},{optionType:_optionType,value:value}))}))))));var template,visible,total};let _t$y,_t2$w,_t3$q,_t4$n,_$y=t=>t;const SearchInputWrapper=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$y||(_t$y=_$y`
  width: 214px;
  background-color: hsl(0, 0%, 100%);
  border-radius: 3px;
`)),StyledFilterButton=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(FilterButton)(_t2$w||(_t2$w=_$y``)),StyledDropdown=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(FilterDropdown)(_t3$q||(_t3$q=_$y``)),Container$l=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$n||(_t4$n=_$y`
  display: flex;
  flex-wrap: wrap;
  ${0}, ${0}, ${0} {
    margin: 0 5px 10px 0;
  }
`),SearchInputWrapper,StyledDropdown,StyledFilterButton),FilterInputs=({hasShowMore:_hasShowMore=!1,searchFilters:searchFilters,dropdownFilters:dropdownFilters,showMoreText:_showMoreText="Show More",showLessText:_showLessText="Show Less",...props})=>{const[visibleSearchInputs,setVisibleSearchInputs]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)((searchFilters=>{const currentVisible=[];return searchFilters.forEach(element=>{element.canHide||currentVisible.push(element.id)}),currentVisible})(searchFilters)),[showMoreDropdowns,setShowMoreDropdowns]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)(!!_hasShowMore),toggleShowMore=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(()=>{setShowMoreDropdowns(prev=>!prev)},[]),handleVisibleSearch=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(searchId=>{const newVisible=[...visibleSearchInputs,searchId];setVisibleSearchInputs(newVisible)},[visibleSearchInputs]);return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$l,Object.assign({},{props:props}),((searchFilters,visibleSearchInputs)=>searchFilters.map(searchInput=>visibleSearchInputs.includes(searchInput.id)?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(SearchInputWrapper,{key:"searchFilter-id-"+searchInput.id},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(BasicSearchInput,Object.assign({},searchInput))):null))(searchFilters,visibleSearchInputs),((dropdownFilters,showMoreDropdowns)=>dropdownFilters.map(dropdown=>dropdown.canHide&&showMoreDropdowns?null:react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledDropdown,Object.assign({key:"dropdownFilter-id-"+dropdown.id},dropdown))))(dropdownFilters,showMoreDropdowns),(!_hasShowMore||!showMoreDropdowns)&&((searchFilters,visibleSearchInputs,handleVisibleSearch)=>searchFilters.map(element=>{if(element.canHide&&!visibleSearchInputs.includes(element.id)){const searchId=element.id;return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledFilterButton,{key:"search-button-id-"+element.id,icon:"Add",onClick:()=>handleVisibleSearch(searchId)},element.showFieldText)}return null}))(searchFilters,visibleSearchInputs,handleVisibleSearch),_hasShowMore&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(FilterButton,{icon:"SwitchAccount",onClick:toggleShowMore},showMoreDropdowns?_showMoreText:_showLessText))};let _t$z,_t2$x,_t3$r,_t4$o,_t5$l,_t6$j,_t7$i,_t8$h,_$z=t=>t;const Container$m=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$z||(_t$z=_$z`
  display: flex;
  align-items: center;
  font-size: 12px;
`)),ResultsTextWrapper=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$x||(_t2$x=_$z`
  font-family: ${0};
  color: hsl(207, 5%, 57%);
`),({theme:theme})=>theme.fontFamily.ui),FilterLabel=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$r||(_t3$r=_$z`
  height: 18px;
  flex-shrink: 0;
  display: flex;
  align-items: center;
...
`),({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$o||(_t4$o=_$z`
    font-family: ${0};
  `),theme.fontFamily.data),IconWrapper),FilterLabelText=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$l||(_t5$l=_$z`
  padding: ${0};
`),({hasIcon:hasIcon})=>hasIcon?"0 15px 0 9px":"0 15px 0 0"),ClearTextButton=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t6$j||(_t6$j=_$z`
  ${0};
  font-family: ${0};
  color: hsl(216, 4%, 77%);
  margin-left: 11px;
  font-size: 12px;
`),resetButtonStyles,({theme:theme})=>theme.fontFamily.data),RemoveButton=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t7$i||(_t7$i=_$z`
  ${0};
`),resetButtonStyles),FilterLabelsGroup=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t8$h||(_t8$h=_$z`
  display: flex;
  flex-wrap: wrap;
  align-items: center;
  margin-left: 10px;
`)),FiltersResults=({labelLists:labelLists,totalResults:totalResults,resultTextTemplate:_resultTextTemplate="Showing Results ([TOTAL_RESULTS]):",clearText:_clearText="CLEAR ALL",onRemoveFilter:_onRemoveFilter=(()=>{}),onClearAll:_onClearAll=(()=>{}),...props})=>{return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$m,Object.assign({},props),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ResultsTextWrapper,null,(total=totalResults,_resultTextTemplate.replace("[TOTAL_RESULTS]",""+total))),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(FilterLabelsGroup,null,labelLists.map(({icon:icon,item:item,filterName:filterName,filterId:filterId,type:type},index)=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(FilterLabel,{key:"Filter-Label-id-"+index},icon&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Icon,{icon:icon,color:"dimmed",size:10,weight:"heavy"}),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(FilterLabelText,{hasIcon:!!icon},filterName?`${filterName}: ${item.text}`:item.text),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(RemoveButton,{onClick:()=>_onRemoveFilter(filterId,type,item)},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Icon,{icon:"CloseCompact",color:"dimmed",size:10,weight:"heavy"})))),labelLists.length>0&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ClearTextButton,{onClick:_onClearAll},_clearText)));var total};let _t$A,_t2$y,_t3$s,_$A=t=>t;const Title=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$A||(_t$A=_$A`
  font-family: ${0};
  color: hsl(207, 5%, 57%);
  font-size: 12px;
  font-weight: 700;
  margin-bottom: 17px;
`),({theme:theme})=>theme.fontFamily.ui),StyledFilterResults=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(FiltersResults)(_t2$y||(_t2$y=_$A``)),Container$n=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$s||(_t3$s=_$A`
  ${0} {
    margin-top: 29px;
  }
`),StyledFilterResults),createDropdownFilters=(dropdownsConfig,filtersValues,handleSelected)=>{const dropdownFilters=[];return dropdownsConfig.forEach(dropdown=>{const filter=filtersValues.find(filter=>filter.id===dropdown.id);if(filter){const selected=filter.selected,onSelect=newSelection=>{handleSelected(newSelection,filter.id)},newDropdown={...dropdown,selected:selected,onSelect:onSelect};dropdownFilters.push(newDropdown)}}),dropdownFilters},createSearchers=(searchersConfig,filtersValues,handleSearchers)=>{const searchersFilters=[];return searchersConfig.forEach(searcher=>{const filter=filtersValues.find(filter=>filter.id===searcher.id);if(filter&&!Array.isArray(filter.selected)){const value=null===filter.selected?"":filter.selected.text,onChange=e=>{const newValue=e.currentTarget.value;handleSearchers(newValue,filter.id)},newSearcher={...searcher,value:value,onChange:onChange};searchersFilters.push(newSearcher)}}),searchersFilters},createLabelResults=(searchersConfig,dropdownsConfig,filtersValues)=>{const labelLists=[];return searchersConfig.forEach(searcher=>{const foundSearcher=filtersValues.find(element=>element.id===searcher.id);if(foundSearcher&&isFilterItem(foundSearcher.selected)){const newLabel={filterId:foundSearcher.id,item:foundSearcher.selected,filterName:searcher.name,type:"search"};labelLists.push(newLabel)}}),dropdownsConfig.forEach(dropdown=>{const foundDropdown=filtersValues.find(element=>element.id===dropdown.id);if(foundDropdown&&null!==foundDropdown.selected)if(Array.isArray(foundDropdown.selected))foundDropdown.selected.forEach(dropdownLabelVal=>{const newLabel={filterId:foundDropdown.id,item:dropdownLabelVal,icon:dropdown.buttonIcon,type:"dropdown"};labelLists.push(newLabel)});else if(isFilterItem(foundDropdown.selected)){const newLabel={filterId:foundDropdown.id,item:foundDropdown.selected,icon:dropdown.buttonIcon,type:"dropdown"};labelLists.push(newLabel)}}),labelLists},FilterBar=({filtersTitle:_filtersTitle="Filters:",hasShowMore:hasShowMore,searchersConfig:searchersConfig,dropdownsConfig:dropdownsConfig,showMoreText:showMoreText,showLessText:showLessText,resultTextTemplate:resultTextTemplate,clearText:clearText,totalResults:totalResults,onChangeCallback:_onChangeCallback=(()=>{}),...props})=>{const[filtersValues,setFilterValues]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)(((searchersConfig,dropdownsConfig)=>{const newFilters=[];return searchersConfig.forEach(({id:id})=>{newFilters.push({id:id,selected:null})}),dropdownsConfig.forEach(({id:id})=>{newFilters.push({id:id,selected:null})}),newFilters})(searchersConfig,dropdownsConfig)),handleChange=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(newValues=>{const notNullValues=newValues.filter(filter=>null!==filter.selected);_onChangeCallback(notNullValues)},[_onChangeCallback]),handleSelected=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)((newValue,filterId)=>{setFilterValues(prev=>{const updatedFilters=[...prev],foundFilter=updatedFilters.find(filter=>filter.id===filterId);return foundFilter?(foundFilter.selected=newValue,handleChange(updatedFilters),updatedFilters):prev})},[handleChange]),handleSearchers=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)((newValue,filterId)=>{setFilterValues(prev=>{const updatedFilters=[...prev],foundFilter=updatedFilters.find(filter=>filter.id===filterId);return foundFilter?(foundFilter.selected=""===newValue?null:{text:newValue,value:newValue},handleChange(updatedFilters),updatedFilters):prev})},[handleChange]),handleOnClear=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(()=>{setFilterValues(prev=>{const updatedFilters=[...prev];return updatedFilters.forEach(filterElement=>{null!==filterElement.selected&&(filterElement.selected=null)}),handleChange(updatedFilters),updatedFilters})},[handleChange]),handleOnRemoveFilter=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)((filterId,type,item)=>{setFilterValues(prev=>{const updatedFilters=[...prev],foundFilter=updatedFilters.find(filterElement=>filterElement.id===filterId);if(!foundFilter)return prev;if(Array.isArray(foundFilter.selected)){const selectedFiltered=foundFilter.selected.filter(oldItem=>oldItem.value!==item.value);foundFilter.selected=0===selectedFiltered.length?null:selectedFiltered}else isFilterItem(foundFilter.selected)&&(foundFilter.selected=null);return handleChange(updatedFilters),updatedFilters})},[handleChange]);return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$n,Object.assign({},props),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Title,null,_filtersTitle),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(FilterInputs,Object.assign({},{hasShowMore:hasShowMore,showMoreText:showMoreText,showLessText:showLessText},{searchFilters:createSearchers(searchersConfig,filtersValues,handleSearchers),dropdownFilters:createDropdownFilters(dropdownsConfig,filtersValues,handleSelected)})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledFilterResults,Object.assign({},{resultTextTemplate:resultTextTemplate,clearText:clearText,totalResults:totalResults},{labelLists:createLabelResults(searchersConfig,dropdownsConfig,filtersValues),onClearAll:handleOnClear,onRemoveFilter:handleOnRemoveFilter})))};let _t$B,_t2$z,_t3$t,_t4$p,_t5$m,_$B=t=>t;const Container$o=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$B||(_t$B=_$B`
  position: relative;
  display: inline-block;
`)),StatusCounter=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$z||(_t2$z=_$B`
  position: absolute;
  left: 14px;;
  top: -12px;
  border-radius: 50%;
  ...
  ${0}
  background-color: ${0};
`),({theme:{animation:animation}})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$t||(_t3$t=_$B`
    transition: background-color ${0} ${0};
  `),animation.speed.slow,animation.easing.primary.easeInOut),({theme:theme,color:color})=>color?theme.colors.status[color]:"hsla(0, 0%, 91.8%, 0)"),StatusDot=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$p||(_t4$p=_$B`
  width: 10px;
  height: 10px;
  ...
  ${0}
  background-color: ${0};
`),({theme:{animation:animation}})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$m||(_t5$m=_$B`
    transition: background-color ${0} ${0};
  `),animation.speed.slow,animation.easing.primary.easeInOut),({theme:theme,color:color})=>color?theme.colors.status[color]:"hsla(0, 0%, 91.8%, 0)"),StatusIcon=({icon:icon,status:status,counter:counter})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$o,null,status&&void 0===counter?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StatusDot,{color:status}):void 0===counter?null:react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StatusCounter,{color:status},counter),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Icon,{icon:icon,size:status&&void 0===counter?14:18,color:"dimmed"}));let _t$C,_t2$A,_t3$u,_t4$q,_t5$n,_t6$k,_t7$j,_t8$i,_t9$h,_t10$d,_t11$b,_t12$7,_t13$5,_t14$5,_t15$3,_t16$2,_t17$2,_$C=t=>t;const HandleTouchReactionKeyframes=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.e)(_t$C||(_t$C=_$C`
 0% {
    transform: scale(1);
 }
...
`)),HandleMouseReactionKeyframes=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.e)(_t2$A||(_t2$A=_$C`
 0% {
    transform: scale(1);
 }
...
`));styled_components__WEBPACK_IMPORTED_MODULE_2__.d.svg(_t3$u||(_t3$u=_$C`
  touch-action: none;
  user-select: none;
  overflow: visible;
  cursor: pointer;
  fill: ${0};
  appearance: none;
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].handleBase.fill),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.circle(_t4$q||(_t4$q=_$C`
  fill: none;
  stroke: ${0};
  mask: url(#${0});
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].handleRingLayer.stroke,props=>props.maskID),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t5$n||(_t5$n=_$C`
  opacity: 0.65;
  cursor: pointer;
  transform: scale(1);
...
`),props=>props.touchDragging&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$k||(_t6$k=_$C`
    animation: ${0} 0.5s forwards cubic-bezier(0.175, 0.885, 0.32, 1.275) 1;
  `),HandleTouchReactionKeyframes),props=>props.mouseDragging&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t7$j||(_t7$j=_$C`
    animation: ${0} 0.25s forwards cubic-bezier(0.175, 0.885, 0.32, 1.275) 1;
  `),HandleMouseReactionKeyframes)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.circle(_t8$i||(_t8$i=_$C`
  mix-blend-mode: multiply;
  fill: ${0};
  stroke: none;
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].handleReactiveFill.fill),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.circle(_t9$h||(_t9$h=_$C`
  fill: none;
  stroke: ${0};
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].handleReactiveRing.stroke),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.circle(_t10$d||(_t10$d=_$C`
  overflow: visible;
  mix-blend-mode: multiply;
  fill: none;
  stroke: ${0};
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].handleContrastLayer.stroke),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.circle(_t11$b||(_t11$b=_$C`
    mix-blend-mode: multiply;
    fill: url(#${0});
`),props=>props.fillID),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t12$7||(_t12$7=_$C`
  opacity: 0;
  pointer-events: none;
  ${0};

`),props=>props.showIndex&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t13$5||(_t13$5=_$C`
    opacity: 1;
  `))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.stop(_t14$5||(_t14$5=_$C`
  stop-color: ${0};
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].stopStart.stopColor),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.stop(_t15$3||(_t15$3=_$C`
  stop-color: ${0};
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].stopEnd.stopColor),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.text(_t16$2||(_t16$2=_$C`
...
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].grabHandleText.stroke),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t17$2||(_t17$2=_$C`

`));let _t$D,_t2$B,_t3$v,_t4$r,_t5$o,_t6$l,_t7$k,_t8$j,_t9$i,_t10$e,_t11$c,_$D=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.line(_t$D||(_t$D=_$D`
  pointer-events: none;
  stroke: ${0};
  mix-blend-mode: multiply;
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].contrastLine.stroke),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.line(_t2$B||(_t2$B=_$D`
  pointer-events: none;
  stroke: ${0};
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].highlightLine.stroke);const GrabHandle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.circle(_t3$v||(_t3$v=_$D`
  fill: ${0};
  stroke: ${0};
  opacity: 1;
  transition: opacity 250ms ease;
  ...
  ${0};
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].grabHandle.fill,({theme:theme,styling:styling})=>theme.custom.lines[styling].grabHandle.stroke,props=>props.hide&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$r||(_t4$r=_$D`
    pointer-events: none;
    opacity: 0;
  `))),GrabHandleContrast=(styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t5$o||(_t5$o=_$D`
  opacity: 0;
  pointer-events: none;
  ${0};

`),props=>props.showIndex&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$l||(_t6$l=_$D`
    opacity: 1;
  `))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.text(_t7$k||(_t7$k=_$D`
  font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
  text-align: center;
  fill: ${0};
  font-weight: bold;
  transition: opacity 250ms ease;
  pointer-events: none;
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].grabHandleText.stroke),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.text(_t8$j||(_t8$j=_$D`
  text-align: center;
  fill: ${0};
  font-weight: bold;
  transition: opacity 250ms ease;
  pointer-events: none;
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].label.fill),Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(GrabHandle)(_t9$i||(_t9$i=_$D`
  fill: none;
  stroke: ${0};
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].grabHandleContrast.stroke));styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t10$e||(_t10$e=_$D`
  ...
  ${0};
`),GrabHandle,GrabHandleContrast,props=>props.showIndex&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t11$c||(_t11$c=_$D`
    ${0}, ${0} {
      pointer-events: none;
      r: ${0};
    }
  `),GrabHandle,GrabHandleContrast,1.75*props.originalRadius)),Object(react__WEBPACK_IMPORTED_MODULE_1__.createContext)({});let _t$E,_t2$C,_$E=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.circle(_t$E||(_t$E=_$E`
  fill: ${0};
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].point.fill),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.text(_t2$C||(_t2$C=_$E`
  text-align: center;
  fill: ${0};
  font-weight: bold;
  transition: opacity 250ms ease;
  pointer-events: none;
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].label.fill);let _t$F,_t2$D,_t3$w,_t4$s,_t5$p,_$F=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$F||(_t$F=_$F`
  position: relative;
  line-height: 0;
  user-select: none;
  touch-action: none;
...
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$D||(_t2$D=_$F`
  position: absolute;
  top:0;
  bottom: 0;
  left: 0;
  ...
  align-items: center;
  justify-content: center;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.svg(_t3$w||(_t3$w=_$F`
  touch-action: none;
  user-select: none;
  margin: 0;
...
`),props=>props.transculent&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$s||(_t4$s=_$F`
    background: hsla(0deg, 0%, 0%, 35%);
  `))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.img(_t5$p||(_t5$p=_$F`
  object-fit: contain;
  width:  100%;
  height: 100%;
`));let _t$G,_t2$E,_t3$x,_t4$t,_t5$q,_$G=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$G||(_t$G=_$G`
  position: relative;
  line-height: 0;
  user-select: none;
  touch-action: none;
  ...
  width: auto;
  /* transform: translateY(-70%); */
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.video(_t2$E||(_t2$E=_$G`
  width:  100%;
  height: 100%;
  border-radius: 3px;
  background-color: hsla(0deg, 0%, 0%, 35%);
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$x||(_t3$x=_$G`
  position: absolute;
  top:0;
  bottom: 0;
  left: 0;
  ...
  align-items: center;
  justify-content: center;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.svg(_t4$t||(_t4$t=_$G`
  touch-action: none;
  user-select: none;
  margin: 0;
...
`),props=>props.transcalent&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$q||(_t5$q=_$G`
    background: hsla(0deg, 0%, 0%, 35%);
  `)));let _t$H;const Video$1=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.video(_t$H||(_t$H=(t=>t)`
  /* width: 800px; */
`));let _t$I,_t2$F,_t3$y,_t4$u,_t5$r,_$I=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$I||(_t$I=_$I`
  position: relative;
  line-height: 0;
  user-select: none;
  touch-action: none;
...
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$y||(_t3$y=_$I`
  ...
  align-items: center;
  justify-content: center;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.svg(_t4$u||(_t4$u=_$I`
  touch-action: none;
  user-select: none;
  margin: 0;
...
`),props=>props.transcalent&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$r||(_t5$r=_$I`
    background: hsla(0deg, 0%, 0%, 35%);
  `)));const makeTitle=(parts,delimiter="|")=>{let title="";return delimiter=" "+delimiter+" ",parts.forEach((part,key)=>{title+=part,parts.length-1!==key&&(title+=delimiter)}),title};let _t$J,_t2$G,_t3$z,_t4$v,_t5$s,_t6$m,_t7$l,_t8$k,_$J=t=>t;const Container$s=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$J||(_t$J=_$J`
  position: relative;
`)),IconContainer$1=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$G||(_t2$G=_$J`
  position: absolute;
  left: -45px;
  bottom: 0;
  height: 30px;
...
`)),Title$1=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.h1(_t3$z||(_t3$z=_$J`
  ${0}
  margin: 0 0 20px;
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$v||(_t4$v=_$J`
    font-family: ${0};
    ${0};
  `),theme.fontFamily.ui,theme.typography.pageHeader.mainTitle)),AreaTitleCss=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$s||(_t5$s=_$J`
  ${0}
  margin: 0;
  position: absolute;
  top: -18px;
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$m||(_t6$m=_$J`
  font-family: ${0};
  ${0};
  `),theme.fontFamily.ui,theme.typography.pageHeader.areaTitle)),AreaTitle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$l||(_t7$l=_$J`
  ${0}
`),AreaTitleCss),AreaLinkTitle=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_27__.a)(_t8$k||(_t8$k=_$J`
  ${0}
  &:hover {
    text-decoration: underline;
  }
`),AreaTitleCss),PageTitle=({title:title,icon:icon,areaTitle:areaTitle,areaHref:areaHref,updateDocTitle:_updateDocTitle=!0})=>(_updateDocTitle&&((title,area,delimiter)=>{const[baseTitle]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)(document.title);Object(react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{document.title=makeTitle([...title?[title]:[],...area?[area]:[],baseTitle],delimiter)},[title,area])})(title,areaTitle||""),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$s,null,areaTitle&&areaHref?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(AreaLinkTitle,{to:areaHref},areaTitle):areaTitle&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(AreaTitle,null,areaTitle),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Title$1,null,title),icon?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(IconContainer$1,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Icon,Object.assign({size:24,color:"dimmed"},{icon:icon}))):null));let _t$K,_t2$H,_$K=t=>t;const Container$t=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.p(_t$K||(_t$K=_$K`
  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$H||(_t2$H=_$K`
    font-family: ${0};
    ${0};
  `),theme.fontFamily.ui,theme.typography.pageHeader.introduction)),IntroductionText=({children:children})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$t,null,children);let _t$L;const Container$u=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$L||(_t$L=(t=>t)``)),PageHeader=({title:title,icon:icon,introductionText:introductionText,areaHref:areaHref,areaTitle:areaTitle,updateDocTitle:_updateDocTitle=!0})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$u,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(PageTitle,Object.assign({},{title:title,icon:icon,areaHref:areaHref,areaTitle:areaTitle,updateDocTitle:_updateDocTitle})),introductionText?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(IntroductionText,null,introductionText):null);let _t$M;const Container$v=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$M||(_t$M=(t=>t)`
  display: flex;
  flex-direction: column;
`)),MultilineContent=({contentArray:contentArray})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$v,null,contentArray.map((element,index)=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div",{key:"element-"+index},element)));let _t$N,_t2$I,_t3$A,_t4$w,_t5$t,_t6$n,_t7$m,_t8$l,_$N=t=>t;const Container$w=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$N||(_t$N=_$N`
  position: relative;
  line-height: 0;
`)),mediaStyle="\n  max-width:  100%;\n  max-height: 100%;\n  border-radius: 3px;\n  background-color: hsla(0deg, 0%, 0%, 35%);\n",LoadingOverlay$3=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$I||(_t2$I=_$N`
  position: absolute;
  top:0;
  bottom: 0;
  left: 0;
...
`),mediaStyle,({theme:theme,isLoaded:isLoaded,hasModalLimits:hasModalLimits})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t7$m||(_t7$m=_$N`
  ...
  font-family: ${0};
  z-index: 999;
`),({theme:theme})=>theme.fontFamily.ui),CloseIcon=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(Icon)(_t2$J||(_t2$J=_$O``)),CloseButton=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t3$B||(_t3$B=_$O`
  ${0};
  display: flex;
  align-items: center;
  justify-content: center;
...
`),resetButtonStyles,({theme:theme})=>theme.colors.icons.dimmed,IconWrapper,({selected:_selected=!1})=>_selected&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$x||(_t4$x=_$O`
    border-bottom: 5px solid hsl(207, 80%, 64%);
  `)),({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$u||(_t5$u=_$O`
      opacity: .8;
      transition: transform ${0} ${0};
    `),theme.animation.speed.normal,theme.animation.easing.primary.inOut)),LightBox=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$o||(_t6$o=_$O`
  position: relative;
  margin: 27px 0 0;
...
`),({aspect:aspect})=>"16:9"===aspect&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$K||(_t2$K=_$P`
      padding-left: 56.25%;
    `)),({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$C||(_t3$C=_$P`
    transition:
      opacity ${0} ${0},
      transform ${0} ${0};
  `),theme.animation.speed.normal,theme.animation.easing.primary.easeOut,theme.animation.speed.fast,theme.animation.easing.primary.easeOut),({mediaUrl:mediaUrl,hasPreview:hasPreview})=>mediaUrl&&hasPreview&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$y||(_t4$y=_$P`
      cursor: pointer;
    `)),({theme:theme,hoverZoom:hoverZoom,isImageValid:isImageValid})=>theme&&hoverZoom&&isImageValid&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$v||(_t5$v=_$P`
      transform: scale(1.5);
      opacity: 1;
      transition: transform ${0} ${0};
    `),theme.animation.speed.normal,theme.animation.easing.primary.easeOut)),Image$2=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$p||(_t6$p=_$P`
  position: absolute;
  left: 0;
  top: 0;
  right: 0;
  ...
  display: ${0};
`),p=>p.image,p=>p.image?"block":"none"),PlayableDrop=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$n||(_t7$n=_$P`
  position: absolute;
  left: 50%;
  top: 50%;
...
`),({status:status,theme:{colors:colors}})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$L||(_t2$L=_$Q`
    background: ${0};
    content:'${0}';
  `),colors.status[status],status)),TypeTableDeviceStatus=({status:_status="neutral"})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$z,{status:_status});let _t$R,_t2$M,_t3$D,_t4$z,_t5$w,_t6$q,_t7$o,_t8$m,_t9$j,_t10$f,_t11$d,_$R=t=>t;const CopyToClipboard=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t$R||(_t$R=_$R`
...
`),({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$M||(_t2$M=_$R`
    transition: ${0} ${0};
  `),theme.animation.speed.normal,theme.animation.easing.easeOut)),CellContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$D||(_t3$D=_$R`
  display: table-cell;
  height: 50px;
  vertical-align: middle;
  position: relative;
  ...
  ${0}
`),p=>p.theme.fontFamily.data,CopyToClipboard,({theme:theme,cellStyle:cellStyle,alignment:alignment})=>"firstColumn"===cellStyle?Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$z||(_t4$z=_$R`
      ${0};
    `),theme.typography.table.columnData[cellStyle]):Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$w||(_t5$w=_$R`
      ${0};
    `),theme.typography.table.columnData[cellStyle][alignment]),({hasCopyButton:hasCopyButton})=>hasCopyButton&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$q||(_t6$q=_$R`
    padding-right: 20px;
  `)),({hideDivider:hideDivider})=>!hideDivider&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t7$o||(_t7$o=_$R`
    &::after {
      content: '';
      display: block;
      height: 1px;
  ...
  `))),UnitText=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.span(_t8$m||(_t8$m=_$R`
  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t9$j||(_t9$j=_$R`
    ${0};
  `),theme.typography.table.columnData.unit)),StatusBlip=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t10$f||(_t10$f=_$R`
  display: inline-block;
  width: 10px;
  height: 10px;
  border-radius: 50%;
...
`),({isEmpty:isEmpty})=>isEmpty&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$N||(_t2$N=_$S`
  ...
  ${0}
`),IconWrapper,({ascending:ascending})=>ascending&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$O||(_t2$O=_$T`
      ...
      border-top-left-radius: 0;
      top: 0;
    `)),({isSortActive:isSortActive})=>isSortActive&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$E||(_t3$E=_$T`
    &:not(hover) {
      ${0} {
        display: inline-flex;
      }
    }
  `),IconWrapper),({sortable:sortable})=>sortable&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$A||(_t4$A=_$T`
    &:hover {
...
`)),HeaderItem=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$P||(_t2$P=_$U`
  ...
  ${0};
`),p=>p.theme.fontFamily.ui,({hasCopyButton:hasCopyButton})=>hasCopyButton&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$F||(_t3$F=_$U`
    padding-right: 20px;
  `)),({theme:theme,alignment:alignment,headerStyle:headerStyle})=>alignment?Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$B||(_t4$B=_$U`
    ${0};
  `),theme.typography.table[headerStyle][alignment]):Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$x||(_t5$x=_$U`
    ${0};
  `),theme.typography.table[headerStyle].left),p=>p.fixedWidth&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$r||(_t6$r=_$U`
    width: ${0}px;
  `),p.fixedWidth),({minWidth:minWidth})=>minWidth&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t7$p||(_t7$p=_$U`
    min-width:${0}px;
  `),minWidth),({headerStyle:headerStyle,isSortActive:isSortActive})=>"subHeader"===headerStyle&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$n||(_t8$n=_$U`
  padding-bottom: 15px;
...
`),isSortActive?"-15px":"0",isSortActive?"calc(100% + 15px)":"100%")),TitleItems=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t9$k||(_t9$k=_$U`
  display: flex;
  flex-direction: column;
  align-items: flex-start;
  ${0};
`),({alignment:alignment})=>alignment&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t10$g||(_t10$g=_$U`
      ${0};
      ${0};
  `),"right"===alignment?"align-items: flex-end":null,"center"===alignment?"align-items: center":null)),GroupTitle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t11$e||(_t11$e=_$U`
  display: flex;
  flex-direction: row;
  align-items: center;
  align-self: stretch;
  margin-bottom: 4px;
`)),Title$2=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t12$8||(_t12$8=_$U`
  padding-left: 2px;
  padding-right: 8px;
...
`),({theme:theme})=>theme.colors.pureBase,LoadingText$1),EmptyTableBox=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$y||(_t5$y=_$V`
  position: absolute;
  left: 0;
  z-index: 99;
  padding: 20px;
...
`)),EditContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$s||(_t6$s=_$W`
  min-width: 320px;
  background-color: hsl(0, 0%, 100%);
  z-index: 99;
  position: absolute;
...
`),StyledLabel,StyledButton$4,StyledLoadingButton),StyledIconButton$1=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(IconButton$2)(_t7$q||(_t7$q=_$W``)),TextContainer$2=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t8$o||(_t8$o=_$W`
  display: flex;
  justify-content: space-between;
  align-items: center;
  padding-right: 18px;
...
`),({active:active})=>active&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$S||(_t2$S=_$X`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t3$I||(_t3$I=_$X`
  opacity: 0;
  ${0}
`),({hover:hover})=>hover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$E||(_t4$E=_$X`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t5$A||(_t5$A=_$X`
`));let _t$Y,_t2$T,_t3$J,_t4$F,_t5$B,_t6$t,_$Y=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t$Y||(_t$Y=_$Y`
  opacity: 0;
  ${0}
...
`),({active:active})=>active&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$T||(_t2$T=_$Y`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t3$J||(_t3$J=_$Y`
  opacity: 0;
  ${0}
`),({hover:hover})=>hover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$F||(_t4$F=_$Y`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t5$B||(_t5$B=_$Y`
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t6$t||(_t6$t=_$Y`

`));let _t$Z,_t2$U,_t3$K,_t4$G,_t5$C,_$Z=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t$Z||(_t$Z=_$Z`
  opacity: 0;
  ${0}
...
`),({active:active})=>active&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$U||(_t2$U=_$Z`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t3$K||(_t3$K=_$Z`
  opacity: 0;
  ${0}
`),({hover:hover})=>hover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$G||(_t4$G=_$Z`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t5$C||(_t5$C=_$Z`
`));let _t$_,_t2$V,_t3$L,_t4$H,_t5$D,_$_=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t$_||(_t$_=_$_`
  opacity: 0;
  ${0}

`),({active:active})=>active&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$V||(_t2$V=_$_`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t3$L||(_t3$L=_$_`
  opacity: 0;
  ${0}
`),({hover:hover})=>hover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$H||(_t4$H=_$_`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t5$D||(_t5$D=_$_`
`));let _t$$,_t2$W,_t3$M,_t4$I,_t5$E,_$$=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t$$||(_t$$=_$$`
  opacity: 0;
  ${0}

`),({active:active})=>active&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$W||(_t2$W=_$$`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t3$M||(_t3$M=_$$`
  opacity: 0;
  ${0}
`),({hover:hover})=>hover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$I||(_t4$I=_$$`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t5$E||(_t5$E=_$$`
`));let _t$10,_t2$X,_t3$N,_t4$J,_t5$F,_$10=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t$10||(_t$10=_$10`
  opacity: 0;
  ${0}

`),({active:active})=>active&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$X||(_t2$X=_$10`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t3$N||(_t3$N=_$10`
  opacity: 0;
  ${0}
`),({hover:hover})=>hover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$J||(_t4$J=_$10`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t5$F||(_t5$F=_$10`
`));let _t$11;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$11||(_t$11=(t=>t)`
  user-select: none;
  display: flex;
  flex-direction: column;
`));let _t$12,_t2$Y,_t3$O,_t4$K,_$12=t=>t;const TextContainer$3=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$12||(_t$12=_$12`
  user-select: none;
`)),StyledLink$1=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_27__.a)(_t2$Y||(_t2$Y=_$12`
  text-decoration: none;
`)),TagWrapper=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$O||(_t3$O=_$12`
  font-family: ${0};
  font-size: ${0}px;
  font-weight: 500;
  color: hsl(200, 3%, 39%);
  ...
  ${0};
`),({theme:theme})=>theme.fontFamily.ui,({size:size})=>size,IconWrapper,({theme:theme})=>theme.colors.icons.dimmed,({theme:theme,hoverColor:hoverColor,enableHover:enableHover})=>enableHover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$K||(_t4$K=_$12`
    &:hover {
      cursor: pointer;
      border-color: ${0};
      color: ${0};
...
`),TagWrapper),TagList=({tagsConfig:tagsConfig})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TagListWrapper,null,tagsConfig.map((tagProps,index)=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Tag,Object.assign({key:"tag-"+index},tagProps))));const defaultContext$1={sendNotification:()=>console.log("This is the context initialization should not appear")},NotificationContext=react__WEBPACK_IMPORTED_MODULE_1___default.a.createContext(defaultContext$1),notificationList=[],NotificationProvider=({children:children})=>{const[activeNotification,setActiveNotification]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)(null),showNotification=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(()=>{const nextNotification=notificationList.shift();if(!nextNotification)return;const displayedNotification={...nextNotification,closeCallback:()=>{nextNotification.closeCallback&&nextNotification.closeCallback(),setActiveNotification(null),showNotification()}};setActiveNotification(displayedNotification)},[]);return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NotificationContext.Provider,{value:{sendNotification:async newNotification=>{const validNotification={message:newNotification.message,type:newNotification.type};newNotification.actionTextButton&&(validNotification.actionTextButton=newNotification.actionTextButton),newNotification.onTextButtonClick&&(validNotification.onTextButtonClick=newNotification.onTextButtonClick),newNotification.closeCallback&&(validNotification.closeCallback=newNotification.closeCallback),newNotification.isPinned&&(validNotification.isPinned=newNotification.isPinned),notificationList.push(validNotification),1===notificationList.length&&null===activeNotification&&showNotification()}}},activeNotification?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Notification,Object.assign({},activeNotification)):null,children)},useNotification=()=>react__WEBPACK_IMPORTED_MODULE_1___default.a.useContext(NotificationContext);function useMediaQuery(query){const[matches,setMatches]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)(!1);return Object(react__WEBPACK_IMPORTED_MODULE_1__.useLayoutEffect)(()=>{const mediaQuery=window.matchMedia(query);setMatches(mediaQuery.matches);const handler=event=>setMatches(event.matches);return mediaQuery.addEventListener("change",handler),()=>mediaQuery.removeEventListener("change",handler)},[]),matches}function useBreakpoints(){const breakpoints={isSmall:useMediaQuery(deviceMediaQuery.small),isMedium:useMediaQuery(deviceMediaQuery.medium),isLarge:useMediaQuery(deviceMediaQuery.large),isXLarge:useMediaQuery(deviceMediaQuery.xlarge),isXXLarge:useMediaQuery(deviceMediaQuery.xxlarge),activeScreen:"small"};return breakpoints.isSmall&&(breakpoints.activeScreen="small"),breakpoints.isMedium&&(breakpoints.activeScreen="medium"),breakpoints.isLarge&&(breakpoints.activeScreen="large"),breakpoints.isXLarge&&(breakpoints.activeScreen="xlarge"),breakpoints.isXXLarge&&(breakpoints.activeScreen="xxlarge"),breakpoints}let _t$14,_t2$Z,_t3$P,_t4$L,_t5$G,_$14=t=>t;const Container$J=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$14||(_t$14=_$14``)),Title$3=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$Z||(_t2$Z=_$14`
  ...
  letter-spacing: normal;
  color: hsl(210, 6%, 47%);
`)),MessageBox$1=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$P||(_t3$P=_$14`
  font-size: 14px;
  font-weight: 500;
  font-stretch: normal;
  font-style: normal;
...
`)),MobileLayout=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$_||(_t2$_=_$15``)),MainContainer=(styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$Q||(_t3$Q=_$15`
  ...
  ${0}
`),({padBottom:_padBottom=!0})=>_padBottom?"70px 90px":"70px 90px 0",({maxWidth:maxWidth})=>maxWidth&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$M||(_t4$M=_$15`
      & > div {
        max-width: ${0};
      }
    `),maxWidth)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$H||(_t5$H=_$15`
  flex: 1;
  display: flex;
  flex-direction: column;
`))),ContentArea=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$u||(_t6$u=_$15`
  flex: 1;
  width: 100%;
  padding: ${0};
  margin-left: auto;
...
`),({paddingOverride:paddingOverride})=>paddingOverride||"40px 20px",deviceMediaQuery.medium,({paddingOverride:paddingOverride})=>paddingOverride||"40px",deviceMediaQuery.large,({maxWidth:maxWidth})=>maxWidth||"1200px",({paddingOverride:paddingOverride})=>paddingOverride||"70px 90px");let _t$16,_t2$$,_t3$R,_t4$N,_t5$I,_t6$v,_t7$r,_t8$p,_t9$m,_t10$i,_t11$f,_t12$9,_t13$7,_t14$7,_t15$5,_t16$3,_t17$3,_$16=t=>t;const ContextTitle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$16||(_t$16=_$16`
  opacity: 0;

  ${0}

  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$$||(_t2$$=_$16`
    transition: opacity ${0} ${0};
  `),theme.animation.speed.fast,theme.animation.easing.primary.easeInOut),({compact:compact})=>compact&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$R||(_t3$R=_$16`
    font-size:14px;
  `))),ContextIcon=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$N||(_t4$N=_$16`
  ${0};
  ...
  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$I||(_t5$I=_$16`
    ${0};
    transition: background ${0} ${0};
  `),theme.styles.global.mainMenu.iconBackground.default,theme.animation.speed.fast,theme.animation.easing.primary.easeInOut),({compact:compact})=>compact&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$v||(_t6$v=_$16`
    // width: 24px;
    // height: 24px;
    // flex: 0 0 24px;
    // margin: 0 28px 0 28px;
  `))),ContextIndicator=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$r||(_t7$r=_$16`
  width: 12px;
  height: 12px;
  flex: 0 0 14px;
...
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$p||(_t8$p=_$16`
    transition: opacity 0 ${0};
  `),theme.animation.easing.primary.easeInOut)),ContextActionBaseCSS=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t9$m||(_t9$m=_$16`
  -webkit-tap-highlight-color: transparent;
  border: none;
  background: none;
  display: flex;
  ...
  padding: 0;
  text-decoration: none;
`)),ContextActionA=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_27__.a)(_t10$i||(_t10$i=_$16`
  ${0}
  ${0}
  ...
  ${0}
`),ContextActionBaseCSS,({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t11$f||(_t11$f=_$16`
    font-family: ${0};
    ${0};
  `),theme.fontFamily.ui,theme.typography.global.mainMenu.menuItem.default),({$menuOpen:$menuOpen})=>$menuOpen&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t12$9||(_t12$9=_$16`
    ${0}{
      opacity: 1;
    }
  `),ContextTitle),ContextIcon,({theme:theme})=>theme.styles.global.mainMenu.iconBackground.hover,IconWrapper,({theme:theme})=>theme.colors.icons.inverse,({$isActive:$isActive})=>$isActive&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t13$7||(_t13$7=_$16`
    ${0},
    &:hover ${0}{
      ${0};
    }
  `),ContextIcon,ContextIcon,({theme:theme})=>theme.styles.global.mainMenu.iconBackground.active)),ContextActionButton=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t14$7||(_t14$7=_$16`
  ${0}
...
`),ContextActionBaseCSS,({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t15$5||(_t15$5=_$16`
    font-family: ${0};
    ${0};
  `),theme.fontFamily.ui,theme.typography.global.mainMenu.menuItem.default),({menuOpen:menuOpen,theme:theme})=>menuOpen&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t16$3||(_t16$3=_$16`
    ${0}{
      opacity: 1;
    }
...
`),({theme:{colors:colors}})=>colors.divider,SubmenuItemLink,({theme:theme,isActive:isActive})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t7$s||(_t7$s=_$17`
      font-family: ${0};
      ${0};
    ...
    `),theme.fontFamily.ui,theme.typography.global.mainMenu.subItem.default,theme.typography.global.mainMenu.subItem.hover,isActive&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$q||(_t8$q=_$17`
        &, &:hover {
          ${0};
        }
      `),theme.typography.global.mainMenu.subItem.active))),SubmenuContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t9$n||(_t9$n=_$17`
  ${0};
...
`),({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t10$j||(_t10$j=_$17`
    transition:
      max-height ${0} ${0},
      opacity ${0} ${0};
  `),theme.animation.speed.normal,theme.animation.easing.primary.easeOut,theme.animation.speed.fast,theme.animation.easing.primary.easeOut),({theme:{colors:colors}})=>colors.divider),ContextContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t11$g||(_t11$g=_$17`
  min-height: ${0};
  width: inherit;
...
`),({minHeight:minHeight})=>minHeight?minHeight+"px":"70px",SubmenuContainer,({open:open,maxHeight:maxHeight,theme:theme})=>open&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t12$a||(_t12$a=_$17`
    ${0}{
      transition:
        max-height ${0} ${0},
        opacity ${0} ${0};
...
`)),LogoMark=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$11||(_t2$11=_$18`
  height: 50px;
  flex: 0 0 50px;
  margin-right: 15px;
  display: flex;
...
`)),LogoType=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$T||(_t3$T=_$18`
  opacity: 0;
  flex: 1;
  height: 50px;
  display: flex;
  justify-content: left;
  align-items: center;
`)),SVGObject=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.object(_t4$P||(_t4$P=_$18``)),SVGObjectText=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.object(_t5$K||(_t5$K=_$18`
  max-width: 180px;
`)),NavigationContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$x||(_t6$x=_$18``)),MenuFooter=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$t||(_t7$t=_$18`
  ${0};
  display: flex;
  flex-direction: column;
  flex: 1;
  justify-content: flex-end;
`),({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$r||(_t8$r=_$18`
    ${0}
  `),theme.styles.global.mainMenu.footerBackground)),FooterItemContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t9$o||(_t9$o=_$18`
  min-height: 70px;
`)),PushContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t10$k||(_t10$k=_$18`
  position: relative;
  height: 100%;
  ${0};
`),({theme:theme,isPinned:isPinned})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t11$h||(_t11$h=_$18`
    width: ${0};
  `),isPinned?theme.dimensions.global.mainMenu.width.open:theme.dimensions.global.mainMenu.width.closed)),Container$K=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t12$b||(_t12$b=_$18`
  z-index: 99;
  position: fixed;
  top: 0;
  left: 0;
  ...
  padding: 20px 0 0 0;
  overflow: hidden;
`),({theme:theme,open:open,desktopSize:desktopSize})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t13$9||(_t13$9=_$18`
    ${0}
    ${0};
    width: ${0};
...
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$U||(_t3$U=_$19`
  ...
  `),theme.deviceMediaQuery.large)),DrawerHeader=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.h2(_t4$Q||(_t4$Q=_$19`
  ${0};
  padding: 0;
  margin: 0 0 5px;
`),({theme:theme})=>theme.typography.global.mainMenu.subheader),CurrentUser=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$L||(_t5$L=_$19`
  padding: 20px 20px 15px;

  ${0};
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$y||(_t6$y=_$19`
    border-bottom: ${0} 1px solid;
    ${0};
  `),theme.colors.divider,theme.typography.global.mainMenu.identity)),UserOptions=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$u||(_t7$u=_$19`
  padding: 20px 20px 10px 20px;
  border-bottom: ${0} 1px solid;
`),({theme:{colors:colors}})=>colors.divider),Logout=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t8$s||(_t8$s=_$19`
    padding: 0 20px;
`)),LinkMenu=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.ul(_t9$p||(_t9$p=_$19`
  padding: 0;
  margin: 12px 0 0 0;
  list-style: none;
`)),LinkMenuItem=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.li(_t10$l||(_t10$l=_$19`
  padding: 10px 0;
`)),IconWrapper$3=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t11$i||(_t11$i=_$19`
  flex: 0 40px;
  width: 5px;
  display: flex;
  justify-content: center;
...
`)),LinkMenuItemA=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_27__.a)(_t12$c||(_t12$c=_$19`
  ${0};
  display: block;
  width: 100%;
  ...
  ${0};
`),resetButtonStyles,({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t13$a||(_t13$a=_$19`
    ${0};

    &:hover {
      ${0};
    }
  `),theme.typography.global.mainMenu.subItem.default,theme.typography.global.mainMenu.subItem.hover),({theme:theme,isActive:isActive})=>isActive&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t14$9||(_t14$9=_$19`
    &, &:hover {
      ${0};
    }
  `),theme.typography.global.mainMenu.subItem.active)),LanguageMenu=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t15$7||(_t15$7=_$19`
  ${0};
...
`)),Image$3=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$R||(_t4$R=_$1a`
  ...
  background-repeat: no-repeat; 
  display: ${0};
`),p=>p.image,p=>p.image?"block":"none"),InfoContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$M||(_t5$M=_$1a`
  margin-left: 20px;
`)),Title$4=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$z||(_t6$z=_$1a`
  font-size: 16px;
  font-weight: 500;
  color: hsl(0, 0%, 34%);
`)),Message=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$v||(_t7$v=_$1a`
  font-size: 13px;
  font-weight: 500;
  overflow: hidden;
  color: hsl(0, 0%, 34%);
...
`),({theme:{colors:colors}})=>colors.divider),renderNotifications=(items,type)=>items.map((item,index)=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NotificationWrapper,{key:`alert-${type}-${index}`},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NotificationItem,Object.assign({},item)))),NotificationsHistory=({read:read,unread:unread,noNotificationsText:_noNotificationsText="No new notifications",readNotificationsText:_readNotificationsText="New",unreadNotificationsText:_unreadNotificationsText="Read"})=>0===read.length&&0===unread.length?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$M,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StatusContainer,null,_noNotificationsText)):react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$M,null,unread&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StatusContainer,null,_readNotificationsText),renderNotifications(unread,"unread")),read&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StatusContainer,null,_unreadNotificationsText),renderNotifications(read,"read")));let _t$1c,_t2$15,_t3$X,_t4$S,_t5$N,_t6$A,_t7$w,_t8$u,_t9$q,_t10$m,_t11$j,_t12$d,_t13$b,_t14$a,_$1c=t=>t;const Container$N=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$1c||(_t$1c=_$1c`
  ...
  ${0}
`),({theme:theme,theme:{colors:colors}})=>colors&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$15||(_t2$15=_$1c`
    border-bottom: ${0} 1px solid;
    box-shadow: 5px 7px 10px 0 hsla(205, 16%, 77%, 0.1);
    background-color:${0};
  `),colors.divider,theme.styles.global.mainMenu.background.backgroundColor)),SearchBar=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$X||(_t3$X=_$1c`
  margin-left: 25px;
  flex: 0 1 500px;
  display: flex;
  justify-content: center;
  align-items: center;
`)),IconWrapper$4=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$S||(_t4$S=_$1c`
  flex: 0 40px;
  width: 5px;
  display: flex;
  justify-content: center;
...
`)),SearchInput=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.input(_t5$N||(_t5$N=_$1c`
  font-family: ${0};
  flex: 1;
  height: 35px;
  line-height: 35px;
...
`),({theme:theme})=>theme.fontFamily.data,({theme:{typography:typography}})=>typography.global.topBar.search.value,({theme:{typography:typography}})=>typography.global.topBar.search.placeholder),ButtonArea=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$A||(_t6$A=_$1c`
  height: inherit;
  padding-right: 10px;
  display: flex;
`)),DrawerToggle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button.attrs({type:"button"})(_t7$w||(_t7$w=_$1c`
  width: 60px;
  margin: 0 5px;
  height: inherit;
  background: none;
  ...
  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$u||(_t8$u=_$1c`
  ...
  `),theme.colors.menu.indicator,theme.colors.menu.hover,theme.animation.speed.normal,theme.animation.easing.primary.easeInOut),({isActive:isActive,theme:theme})=>isActive&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t9$q||(_t9$q=_$1c`
    &, &:hover {
      border-bottom-color: ${0};
    }
  `),theme.colors.menu.active)),DrawerPortalWrapper=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t10$m||(_t10$m=_$1c``)),Drawer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t11$j||(_t11$j=_$1c`
  font-family: ${0};
...
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.label(_t2$16||(_t2$16=_$1e`
  ...
  padding-bottom: 14px;
  flex-shrink: 0;
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$Y||(_t3$Y=_$1e`
    font-family: ${0};
  `),theme.fontFamily.ui),({active:active})=>active?"600":"500",({active:active})=>active?"#0097ce":"#787878",({active:active})=>active?"2px solid #0097ce":"2px solid transparent");let _t$1f;const Container$O=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$1f||(_t$1f=(t=>t)`
`)),TabContent=({children:children,tabId:tabId,...props})=>{const{selected:selected}=Object(react__WEBPACK_IMPORTED_MODULE_1__.useContext)(TabContext);return selected===tabId?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$O,Object.assign({},props),children):null};let _t$1g,_t2$17,_t3$Z,_t4$T,_$1g=t=>t;const Container$P=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t$1g||(_t$1g=_$1g`
  ${0}
  flex-basis: auto;
  flex-grow: 1;
`),resetButtonStyles),LinkTab=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$17||(_t2$17=_$1g`
    display: flex;
    justify-content: center;
    align-items: center;
    height: 100%;
  ...
  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$Z||(_t3$Z=_$1g`
    transition: border ${0} ${0};
    border-bottom: 5px solid ${0};
...
`),({active:active})=>active?Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$18||(_t2$18=_$1h`
    border-bottom: 3px solid hsl(196, 100%, 40%);
    `)):Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$_||(_t3$_=_$1h`
    border-bottom: 3px solid transparent;
  `)),IconWrapper),Title$5=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$U||(_t4$U=_$1h`
  font-size: 14px;
  font-family: ${0};
  letter-spacing: 0.09px;
  font-weight: 500;
  ...
  white-space: nowrap;
  text-overflow: ellipsis;
`),({theme:theme})=>theme.fontFamily.ui,({active:active})=>active?"hsl(196, 100%, 40%)":"hsl(0, 0%, 46%)"),SubTitle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$O||(_t5$O=_$1h`
  font-size: 12px;
  font-family: ${0};
  font-style: italic;
  color: hsla(195, 10%, 52%, 0.72);
...
`),resetButtonStyles,({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$1a||(_t2$1a=_$1j`
    font-family: ${0};
    ${0};
    ${0};
    border-top: 1px solid ${0};
  `),theme.fontFamily.ui,theme.typography.global.mainMenu.menuItem.default,theme.styles.global.mainMenu.background,theme.colors.divider),50),IconContainer$2=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$$||(_t3$$=_$1j`
  height: inherit;
  position: absolute;
  top: 0;
  left: 0;
...
`),({theme:theme})=>theme.styles.global.mainMenu.background),MobileUserMenu=({closeId:closeId,hasLanguage:hasLanguage,hasLogout:hasLogout,logoutLink:logoutLink,hasCurrentUser:hasCurrentUser,userSubmenu:userSubmenu,userDrawerBespoke:userDrawerBespoke,loggedInUser:loggedInUser,onLogout:onLogout,onLanguageToggle:onLanguageToggle})=>{const{setSelected:setSelected}=Object(react__WEBPACK_IMPORTED_MODULE_1__.useContext)(TabContext),handleCloseMenu=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(()=>{setSelected(closeId)},[closeId,setSelected]);return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$U,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(UserMenu,Object.assign({},{hasLanguage:hasLanguage,hasLogout:hasLogout,logoutLink:logoutLink,hasCurrentUser:hasCurrentUser,userSubmenu:userSubmenu,userDrawerBespoke:userDrawerBespoke,loggedInUser:loggedInUser,onLogout:onLogout,onLanguageToggle:onLanguageToggle},{closeOnClick:handleCloseMenu})))};let _t$1o,_t2$1e,_$1o=t=>t;const CLOSE_ID="closeMenu",Container$V=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.nav(_t$1o||(_t$1o=_$1o`
  ...
  width: 100%;
  z-index: 99;
`),({theme:theme})=>theme.styles.global.mainMenu.background.backgroundColor),HeaderContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$1e||(_t2$1e=_$1o`
  display: flex;
  flex-direction: row;
  height: ${0}px;
  border-bottom: ${0} 1px solid;
...
`),68,({theme:theme})=>theme.colors.divider,TabListWrapper),MobileNavbar=({content:content,home:home,logoMark:logoMark,supportUrl:supportUrl,defaultMenuOpen:_defaultMenuOpen=!0,closeText:closeText,hasLanguage:hasLanguage,hasLogout:hasLogout,logoutLink:logoutLink,hasCurrentUser:hasCurrentUser,hasNotifications:hasNotifications,userSubmenu:userSubmenu,userDrawerBespoke:userDrawerBespoke,loggedInUser:loggedInUser,notificationsHistory:notificationsHistory,customDrawer:customDrawer,onLogout:onLogout,onLanguageToggle:onLanguageToggle})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$V,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Tabs,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(HeaderContainer,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileLogoLink,Object.assign({},{home:home,logoMark:logoMark},{closeId:CLOSE_ID})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TabList,{defaultTabId:CLOSE_ID},customDrawer&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileTab,Object.assign({},customDrawer,{tabFor:"custom",closeId:CLOSE_ID})),hasNotifications?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileTab,{tabFor:"notifications",icon:"Notifications",closeId:CLOSE_ID}):null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileTab,{tabFor:"user",icon:"UserProfile",closeId:CLOSE_ID}),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileTab,{tabFor:"menu",icon:"Menu",closeId:CLOSE_ID}))),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileNavbarContent,{closeId:CLOSE_ID},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TabContent,{tabId:"custom"},customDrawer&&customDrawer.customComponent),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TabContent,{tabId:"notifications"},notificationsHistory&&hasNotifications?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NotificationsHistory,Object.assign({},notificationsHistory)):null),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TabContent,{tabId:"user"},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileUserMenu,Object.assign({},{hasLanguage:hasLanguage,hasLogout:hasLogout,logoutLink:logoutLink,hasCurrentUser:hasCurrentUser,userSubmenu:userSubmenu,userDrawerBespoke:userDrawerBespoke,loggedInUser:loggedInUser,onLogout:onLogout,onLanguageToggle:onLanguageToggle},{closeId:CLOSE_ID}))),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TabContent,{tabId:"menu"},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileMenu,Object.assign({},{content:content,supportUrl:supportUrl,defaultMenuOpen:_defaultMenuOpen},{closeId:CLOSE_ID}))),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(CloseButton$1,Object.assign({},{closeText:closeText},{closeId:CLOSE_ID}))))),GlobalUI=({content:content,home:home,openWidth:openWidth,logoMark:logoMark,logoText:logoText,supportUrl:supportUrl,defaultMenuOpen:defaultMenuOpen,paddingOverride:paddingOverride,maxWidth:maxWidth,children:children,...props})=>{const{isLarge:isLarge}=useBreakpoints();return isLarge?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Layout,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MainMenu,Object.assign({},{content:content,home:home,openWidth:openWidth,logoMark:logoMark,logoText:logoText,supportUrl:supportUrl,defaultMenuOpen:defaultMenuOpen})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MainContainer,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TopBar,Object.assign({},{...props})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ContentArea,Object.assign({},{maxWidth:maxWidth,paddingOverride:paddingOverride}),children))):react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileLayout,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileNavbar,Object.assign({},{content:content,home:home,logoMark:logoMark,supportUrl:supportUrl,defaultMenuOpen:defaultMenuOpen,...props})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ContentArea,null,children))};let _t$1p,_t2$1f,_t3$12,_t4$W,_t5$P,_t6$C,_t7$x,_t8$v,_t9$r,_$1p=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$1p||(_t$1p=_$1p`
  ...
  display: flex;
  flex-direction: column;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$1f||(_t2$1f=_$1p`
  height: 84px;
  color: hsl(205, 7%, 35%);
  ...
  padding-top: 18px;
  padding-bottom: 15px;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$12||(_t3$12=_$1p`
  height: 31px;
  font-family: Monorale;
  font-size: 18px;
  font-weight: 500;
  ...
  text-align: center;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$W||(_t4$W=_$1p`
  height: 19px;
  font-family: Monorale;
  font-size: 16px;
  font-weight: 300;
  ...
  text-align: center;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$P||(_t5$P=_$1p`
  position: relative;
  border-bottom: 1px solid hsla(0, 0%, 84%, 50%);
  padding: 22px 20px 21px 20px;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$C||(_t6$C=_$1p`
  font-size: 14px;
  font-weight: 500;
  letter-spacing: 0.35px;
  color: hsl(0, 0%, 50%);
  margin-bottom: 18px;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$x||(_t7$x=_$1p`
  font-size: 14px;
  font-weight: 500;
  letter-spacing: 0.35px;
  color: hsl(0, 0%, 50%);
`)),Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_27__.a)(_t8$v||(_t8$v=_$1p`
  font-size: 14px;
  font-weight: 500;
  letter-spacing: 0.35px;
  color: hsl(0, 0%, 50%);
`)),Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_27__.a)(_t9$r||(_t9$r=_$1p`
  position: absolute;
  right: 30px;
  top: 15px;
  /* width: 80px; */

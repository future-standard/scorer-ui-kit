import{i as e}from"./preload-helper-xPQekRTU.js";import{Ct as t,Pt as n,Wt as r,h as i}from"./iframe-a2YLqPZY.js";import{n as a,t as o}from"./helpers-LtX1v9x3.js";var s,c,l,u,d,f;e((()=>{s=r(),t(),a(),c=n(),{action:l}=__STORYBOOK_MODULE_ACTIONS__,u={title:`Chips/atoms`,component:i,decorators:[]},d=()=>{let e=o(),t=(0,s.select)(`Variant`,{Icon:`icon`,Text:`text`,"Icon + text":`icon-text`},`text`),n=(0,s.select)(`Icon`,e,`LayoutGrid`),r=(0,s.text)(`Label`,`1`);return(0,c.jsx)(i,{variant:t,icon:n,label:r,isCompact:(0,s.boolean)(`Compact`,!1),selected:(0,s.boolean)(`Selected`,!1),barOnly:(0,s.boolean)(`Bar only (no wash, needs Selected)`,!1),noDivider:(0,s.boolean)(`No divider`,!1),onClick:l(`chip-click`),"aria-label":t===`icon`?`Workspace`:t===`text`?`Space ${r}`:void 0})},d.__docgenInfo={description:``,methods:[],displayName:`_ChipButton`},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`() => {

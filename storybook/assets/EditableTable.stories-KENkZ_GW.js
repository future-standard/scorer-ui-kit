import{a as e,n as t}from"./chunk-BneVvdWh.js";import{Lt as n,Ot as r,R as i,Rt as a,gt as o,jt as s,kt as c,vt as l,x as u}from"./iframe-YIV3yJSz.js";import{n as d,t as f}from"./placeholder-DnTErttm.js";import{n as p,r as m}from"./helpers-BvtElLFs.js";var h,g,_,v,y,b,x,S,C;t((()=>{h=n(),g=e(a()),l(),c(),f(),p(),_=r(),v={title:`Tables/molecules`,component:o,decorators:[]},y=s.div`
  padding: 100px;
`,b=[{header:`Job Number`,sortable:!1,cellStyle:`firstColumn`},{header:`Camera Name`,sortable:!1,cellStyle:`normalImportance`,alignment:`left`},{header:`When`,sortable:!1,cellStyle:`normalImportance`,alignment:`center`},{header:`Status`,sortable:!1,cellStyle:`normalImportance`,showStatus:!0},{header:`Temperature`,sortable:!1,cellStyle:`normalImportance`,showStatus:!0}],x=[{id:`device-1`,jobName:`capture123`,cameraName:`Camera1`,jobTime:`Just Now`,status:`good`,statusText:`OK`,temperature:`38.2ºC`},{id:`device-2`,jobName:`capture234`,cameraName:`Camera2`,jobTime:`Just Now`,status:`good`,statusText:`OK`,temperature:`38.2ºC`},{id:`device-3`,jobName:`capture345`,cameraName:`Camera3`,jobTime:`3 mins ago`,status:`danger`,statusText:`Warning`,temperature:`38.2ºC`},{id:`device-4`,jobName:`capture456`,cameraName:`Camera4`,jobTime:`12 mins ago`,status:`danger`,statusText:`Warning`,temperature:`38.2ºC`}],S=()=>{let[e,t]=(0,g.useState)(x),[n,r]=(0,g.useState)([]),a=(0,h.object)(`ColumConfig`,b),s=(0,g.useCallback)(async(n,r)=>{let i=[...e],a=i.find(({id:e})=>e===r);a&&n.length>0&&(a.cameraName=n,await m(3e3),t(i))},[e]),c=(0,g.useCallback)(e=>e.map(({id:e,jobName:t,cameraName:n,jobTime:r,status:i,statusText:a,temperature:o})=>({id:e,header:{image:d,mediaUrl:d,mediaType:`img`},columns:[{text:t},{customComponent:(0,_.jsx)(u,{alignment:`left`,defaultValue:n,rowKey:e,saveCallback:s,toLink:`/`})},{text:r},{text:a,status:i},{text:o}]})),[s]);return(0,g.useEffect)(()=>(r(c(e)),()=>{r([])}),[e,c]),(0,_.jsx)(y,{children:(0,_.jsx)(i,{children:(0,_.jsx)(o,{columnConfig:a,rows:n,hasThumbnail:!0})})})},S.__docgenInfo={description:``,methods:[],displayName:`_EditableTable`},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`() => {

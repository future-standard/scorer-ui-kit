import{a as e,n as t}from"./chunk-BneVvdWh.js";import{Et as n,Ft as r,Lt as i,Pt as a,Rt as o,V as s,vt as c,w as l}from"./iframe-BHdSP_o9.js";import{n as u,r as d}from"./helpers-DamNdi88.js";import{S as f,f as p,h as m,p as h,x as g}from"./data_samples-BPpc5FO9.js";var _,v,y,b,x,S,C,w,T,E,D;t((()=>{_=e(o()),r(),v=a(),c(),d(),m(),y=n(),{action:b}=__STORYBOOK_MODULE_ACTIONS__,x={title:`Filters/molecules/FilterDropdown`,component:l,parameters:{componentSubtitle:`FilterDropdown component with footer controls`}},S=i.div`
  margin: 100px;
...
`,C=i.div`
  ...
  gap: 20px;
`,w=[{text:`Ramen`,value:0},{text:`Takoyaki`,value:1},{text:`Gyoza`,value:2},{text:`Tempura`,value:3},{text:`Sushi`,value:4},{text:`Natto`,value:5},{text:`Sashimi`,value:6}],T=[{text:`ラーメン`,value:0},{text:`蛸焼き`,value:1},{text:`餃子`,value:2},{text:`天婦羅`,value:3},{text:`すし`,value:4},{text:`納豆`,value:5},{text:`お造り`,value:6}],E=()=>{let e=(0,v.select)(`Language`,{English:`english`,Japanese:`japanese`},`japanese`),t=u(),n=(0,v.select)(`Icon`,t,Object.keys(t)[0]),r=(0,v.boolean)(`Disabled`,!1),i=(0,v.boolean)(`Has Options Filter`,!0),[a,o]=(0,_.useState)(null),c=b(`Reset clicked`),d=b(`Cancel/Close clicked`),m=b(`Item selected`),x=(0,v.boolean)(`Has Apply`,!0),E=(0,v.boolean)(`Has Reset`,!0),D=(0,_.useCallback)(e=>{m(e),o(e)},[m]),O=(0,_.useCallback)(()=>{c()},[c]),k=(0,_.useCallback)(()=>{d()},[d]);return(0,y.jsx)(C,{children:(0,y.jsxs)(S,{children:[(0,y.jsx)(s,{title:`FilterDropdown with Footer Controls`,introductionText:`This example demonstrates the FilterDropdown component with both Reset and Apply buttons.`}),(0,y.jsx)(l,{buttonIcon:n,buttonText:e===`japanese`?`メニュー`:`Menu`,list:e===`japanese`?T:w,selected:a,disabled:r,hasOptionsFilter:i,searchPlaceholder:e===`japanese`?`メニュー...`:`Menu options...`,searchResultText:e===`japanese`?f:g,optionType:`checkbox`,onSelect:D,onResetCallback:O,onCancelCallback:k,hasReset:E,hasApply:x,resetText:e===`japanese`?`リセット`:`Reset`,cancelText:e===`japanese`?`キャンセル`:`Cancel`,closeText:e===`japanese`?`閉じる`:`Close`,applyText:e===`japanese`?`適用`:`Apply`,descendingText:e===`japanese`?`降順`:`Descending`,ascendingText:e===`japanese`?`昇順`:`Ascending`,emptyResultText:e===`english`?p:h,isListAscending:!0})]})})},E.__docgenInfo={description:``,methods:[],displayName:`DropdownWithApplyAndReset`},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`() => {

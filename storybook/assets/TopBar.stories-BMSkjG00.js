import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{Bt as n,Ct as r,Mt as i,Q as a,ht as o,jt as s,kt as c,s as l,vt as u,zt as d}from"./iframe-DzbtGLxg.js";import{n as f,t as p}from"./placeholder-Bsx_gz26.js";var m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M;e((()=>{m=d(),h=t(n()),u(),i(),p(),g=c(),{action:_}=__STORYBOOK_MODULE_ACTIONS__,v=s.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,D=s.h3`
  ...
  color: var(--grey-9);
  margin: 8px 0 0;
`,O={en:{brand:`Smart Cafeteria`,newOrder:`New Order`,printReceipt:`Print Receipt`,clearOrders:`Clear Orders`,ordersTitle:`Orders`,inTheMaking:`In the making`,readyForPickup:`Ready for pick up`,ready:`Ready`,coffee:`Coffee`,cake:`Cake`,tea:`Tea`,todaysMenu:`Today's Menu`,aboutTitle:`About the Cafeteria`,aboutImageAlt:`Cafeteria photo`,currentUser:`Current User`,logout:`Logout`,accountOptions:`Account Options`,accounts:`Accounts`,billing:`Billing`,payments:`Payments`,switchTheme:`SWITCH THEME`,themeMode:`Light/Dark Mode`,copied:`Copied`,searchPlaceholder:`Search area names, etc.`,badgeText:`Guest`,badgeLinkText:`Login`,minutes:e=>`${e} min`,yen:e=>`${e} yen`},ja:{brand:`スマートカフェテリア`,newOrder:`新規注文`,printReceipt:`レシートを印刷`,clearOrders:`注文をクリア`,ordersTitle:`注文`,inTheMaking:`準備中`,readyForPickup:`受け取り可能`,ready:`準備完了`,coffee:`コーヒー`,cake:`ケーキ`,tea:`紅茶`,todaysMenu:`本日のメニュー`,aboutTitle:`カフェテリアについて`,aboutImageAlt:`カフェテリアの写真`,currentUser:`現在のユーザー`,logout:`ログアウト`,accountOptions:`アカウント設定`,accounts:`アカウント`,billing:`請求`,payments:`支払い`,switchTheme:`テーマ切り替え`,themeMode:`ライト/ダークモード`,copied:`コピーしました`,searchPlaceholder:`エリア名などを検索`,badgeText:`ゲスト`,badgeLinkText:`ログイン`,minutes:e=>`${e}分`,yen:e=>`${e}円`}},k={title:`Global`,component:o,decorators:[]},A={unread:[{imgUrl:``,title:`Event Type`,message:`A short message limited to two lines. Extra text will just truncat...`,time:`Just Now`},{imgUrl:``,title:`Device is off`,message:`The device has correctly turn off`,time:`1 min ago`},{imgUrl:``,title:`Device is on`,message:`The device has correctly turn on`,time:`6 mins ago`},{imgUrl:``,title:`Connection was interrupted`,message:`The connections is not working properly. Please verify your connection or contact your personal support.`,time:`1 hour ago`},{imgUrl:``,title:`Device is off`,message:`The device has correctly turn off`,time:`3 hour ago`}],read:[{imgUrl:``,title:`Device is off`,message:`The device has correctly turn off`,time:`3 days ago`},{imgUrl:``,title:`Device is on`,message:`The device has correctly turn on`,time:`3 days ago`},{imgUrl:``,title:`A new device was added`,message:`The device has bean correctly added`,time:`3 days ago`}],noNotificationsText:`NO NEW NOTIFICATIONS`,readNotificationsText:`NEW`,unreadNotificationsText:`READ`},j=()=>{let{onThemeToggle:e,isLightMode:t}=r(),[n,i]=(0,h.useState)(`en`),[s,c]=(0,h.useState)(null),u=n===`ja`?O.ja:O.en,d=(0,m.text)(`Logged In User`,`full.name@example.com`),p=(0,m.boolean)(`Has Search`,!1),k=(0,m.boolean)(`Has Logout`,!0),j=(0,m.boolean)(`Has Notifications`,!0),M=(0,m.boolean)(`Has Current User`,!0),N=(0,m.text)(`Logout Url`,`#`),P=(0,m.boolean)(`Has Language`,!0),F=(0,m.boolean)(`Has Switch Theme`,!0),I=_(`onLanguageToggle`),L=(0,m.boolean)(`Has User Drawer Meta`,!0),R=(0,m.boolean)(`Include Title Copy`,!0),z=(0,m.boolean)(`Has User Drawer Footer`,!1),B=(0,m.object)(`User Drawer Footer`,{icon:`Information`,title:`V12.3.4`}),V=(0,m.object)(`Notifications History`,A),H=(0,m.object)(`User Drawer Meta`,[{icon:``,title:`Device ID:`,subTitle:`DEB-NUC8i7BE-G6BE935008VH`,notes:``,hasCopyIcon:!0},{icon:`Information`,title:`GPU machine with 4 GPU`,subTitle:`Building B`,notes:`This is a GPU machine having 30 camera support`,hasCopyIcon:!0},{icon:`Success`,title:`Device is Live`,subTitle:`Building C`,notes:`This is a GPU machine having 30 camera support`}]),U=(0,m.select)(`Badge Color`,[`primary`,`grey`,`info`,`success`,`caution`,`warning`],`info`),W=(0,m.text)(`Badge To`,`/login`),G=(0,m.boolean)(`Use Badge onClick`,!1),K=_(`Badge onClick was triggered`),q=[{text:u.accounts,href:`#`},{text:u.billing,href:`#`},{text:u.payments,href:`#`}],J=(0,h.useCallback)(()=>{i(e=>{let t=e===`en`?`ja`:`en`;return I(t),t})},[I]),Y=_(`New Order pressed`),X=_(`Print Receipt pressed`),Z=_(`Clear Orders pressed`),Q=[{id:`new-order`,text:u.newOrder,icon:`Add`,hasOnSelectLoading:!0,onClickCallback:Y},{id:`print-receipt`,text:u.printReceipt,icon:`Download`,onClickCallback:X},{id:`clear-orders`,text:u.clearOrders,icon:`RetryJob`,onClickCallback:Z}],$=(0,g.jsxs)(y,{children:[(0,g.jsx)(b,{children:u.brand}),(0,g.jsx)(a,{mainButtonId:`new-order`,buttonList:Q})]}),ee={customComponent:(0,g.jsxs)(S,{children:[(0,g.jsx)(w,{children:u.ordersTitle}),(0,g.jsx)(D,{children:u.inTheMaking}),(0,g.jsxs)(T,{children:[(0,g.jsxs)(E,{children:[(0,g.jsxs)(`span`,{children:[`#014 · `,u.coffee]}),(0,g.jsx)(`span`,{children:u.minutes(2)})]}),(0,g.jsxs)(E,{children:[(0,g.jsxs)(`span`,{children:[`#015 · `,u.cake]}),(0,g.jsx)(`span`,{children:u.minutes(5)})]})]}),(0,g.jsx)(D,{children:u.readyForPickup}),(0,g.jsxs)(T,{children:[(0,g.jsxs)(E,{children:[(0,g.jsxs)(`span`,{children:[`#012 · `,u.tea]}),(0,g.jsx)(`span`,{children:u.ready})]}),(0,g.jsxs)(E,{children:[(0,g.jsxs)(`span`,{children:[`#013 · `,u.coffee]}),(0,g.jsx)(`span`,{children:u.ready})]})]})]}),icon:`Time`,status:`caution`,counter:2,width:`300px`},te=[{id:`menu`,width:`260px`,content:(0,g.jsxs)(S,{children:[(0,g.jsx)(w,{children:u.todaysMenu}),(0,g.jsxs)(T,{children:[(0,g.jsxs)(E,{children:[(0,g.jsx)(`span`,{children:u.tea}),(0,g.jsx)(`span`,{children:u.yen(130)})]}),(0,g.jsxs)(E,{children:[(0,g.jsx)(`span`,{children:u.coffee}),(0,g.jsx)(`span`,{children:u.yen(300)})]}),(0,g.jsxs)(E,{children:[(0,g.jsx)(`span`,{children:u.cake}),(0,g.jsx)(`span`,{children:u.yen(350)})]})]})]})},{id:`about`,width:`320px`,content:(0,g.jsxs)(S,{children:[(0,g.jsx)(C,{src:f,alt:u.aboutImageAlt}),(0,g.jsx)(w,{children:u.aboutTitle})]})}];return(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(v,{children:(0,g.jsx)(o,{badge:{text:u.badgeText,color:U,linkTo:W,linkText:u.badgeLinkText,onClick:G?K:void 0},loggedInUser:d,userSubmenu:q,hasSearch:p,hasLogout:k,hasNotifications:j,logoutLink:N,hasLanguage:P,hasUserDrawerMeta:L,hasUserDrawerFooter:z,hasCurrentUser:M,notificationsHistory:V,hasSwitchTheme:F,isLightMode:t,onThemeToggle:e,onLanguageToggle:J,userDrawerFooter:B,includeCopyTitle:R,leftAreaElement:$,searchPlaceholder:u.searchPlaceholder,switchThemeText:u.switchTheme,selectedThemeText:u.themeMode,currentUserText:u.currentUser,logoutText:u.logout,accountOptionText:u.accountOptions,copySuccessMessage:u.copied,userDrawerMeta:H,customDrawer:ee,sideDrawers:te,activeDrawer:s,onActiveDrawerChange:c,selectedLangAttribute:n,selectedLanguageText:n===`ja`?`日本語`:`ENGLISH`})}),(0,g.jsxs)(x,{children:[(0,g.jsx)(l,{design:`secondary`,onClick:()=>c(`menu`),children:u.todaysMenu}),(0,g.jsx)(l,{design:`secondary`,onClick:()=>c(`about`),children:u.aboutTitle})]})]})},j.__docgenInfo={description:``,methods:[],displayName:`_TopBar`},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`() => {
  const {
    onThemeToggle,
    isLightMode
  } = useThemeToggle();

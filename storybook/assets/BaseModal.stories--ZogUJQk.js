import{a as e,n as t}from"./chunk-BneVvdWh.js";import{Et as n,Ft as r,Lt as i,Pt as a,R as o,Rt as s,s as c,vt as l,xt as u}from"./iframe-BHdSP_o9.js";var d,f,p,m,h,g,_,v,y,b;t((()=>{d=e(s()),r(),f=a(),l(),p=n(),{action:m}=__STORYBOOK_MODULE_ACTIONS__,h={title:`Alerts/Modals`,components:o,decorator:[]},g=i.div``,_=e=>{let[t,n]=(0,d.useState)(e),{createModal:r}=u();return(0,d.useEffect)(()=>{n(e)},[e]),(0,p.jsx)(c,{design:`secondary`,onClick:()=>{r({...t})},children:`Base Modal`})},v=(0,p.jsx)(`h1`,{children:`Hello!`}),y=()=>(0,p.jsx)(g,{children:(0,p.jsx)(o,{children:(0,p.jsx)(_,{closeText:(0,f.text)(`Close text`,`Close`),isCloseEnable:(0,f.boolean)(`Is Close Enabled`,!0),padding:(0,f.boolean)(`Padding`,!0),dismissCallback:m(`Modal dismissed`),customComponent:(0,f.boolean)(`Show Custom Component`,!1)?v:void 0})})}),y.__docgenInfo={description:``,methods:[],displayName:`_BaseModal`},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`() => {

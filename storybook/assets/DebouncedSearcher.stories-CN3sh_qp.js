import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{Ft as n,It as r,Nt as i,S as a,St as o,Ut as s,Wt as c}from"./iframe-CW3QRQX7.js";var l,u,d,f,p,m,h,g;e((()=>{l=s(),u=t(c()),o(),r(),d=i(),{action:f}=__STORYBOOK_MODULE_ACTIONS__,p={title:`Misc/molecules`,component:a,decorators:[],parameters:{jsx:{skip:1}}},m=n.div`
  margin: 20px;
`,h=()=>{let e=(0,l.text)(`Placeholder`,`Search by name...`),t=f(`Search value`),n=(0,l.boolean)(`Has border`,!0),r=(0,l.select)(`Color`,{Mono:`mono`,Dimmed:`dimmed`,Subtle:`subtle`},`subtle`),i=(0,l.number)(`Icon size`,12),o=(0,l.boolean)(`Disabled`,!1),s=(0,l.text)(`Default Value`,``);return(0,d.jsx)(m,{children:(0,d.jsx)(a,{placeholder:e,onDebouncedChange:(0,u.useCallback)(e=>{t(e)},[t]),hasBorder:n,color:r,iconSize:i,disabled:o,defaultValue:s})})},h.__docgenInfo={description:``,methods:[],displayName:`_DebouncedSearcher`},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`() => {

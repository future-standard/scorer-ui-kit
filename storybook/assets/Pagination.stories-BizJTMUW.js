import{ao as g,d as e,r as o,j as v}from"./iframe-BQPDKgpJ.js";import"./preload-helper-C1FmrZbK.js";import"@storybook/preview-api";const{action:c}=__STORYBOOK_MODULE_ACTIONS__,A={title:"Misc/Molecules",component:g,decorators:[]},_=[{value:5,textValue:"5"},{value:10,textValue:"10"},{value:20,textValue:"20"},{value:30,textValue:"30"},{value:100,textValue:"100"}],t=()=>{const s=e.number("Active Page",1),[u,a]=o.useState(s),m=c("Page changed"),P=c("Items Per Page"),x=e.text("Page Text","Page:"),d=e.text("Button Text","GO"),p=e.text("Items Per Page","Items Per Page:"),b=e.number("Items Default Value",10),I=e.text("Select Width","70px"),O=e.text("SelectId","UniqID23"),h=e.number("Total Pages",20),T=e.boolean("Select Disabled",!1),C=e.object("Items Options",_),f=n=>{m(n),a(n)},D=n=>{P(n)};return o.useEffect(()=>{a(s)},[s]),v.jsx(g,{selectId:O,pageText:x,totalPages:h,activePage:u,buttonText:d,itemsText:p,selectWidth:I,selectDisabled:T,itemsDefaultValue:b,itemsOptions:C,onPageChange:f,onItemsChange:D})};t.__docgenInfo={description:"",methods:[],displayName:"_Pagination"};var i,l,r;t.parameters={...t.parameters,docs:{...(i=t.parameters)==null?void 0:i.docs,source:{originalSource:`() => {
...
}`,...(r=(l=t.parameters)==null?void 0:l.docs)==null?void 0:r.source}}};const E=["_Pagination"];export{t as _Pagination,E as __namedExportsOrder,A as default};

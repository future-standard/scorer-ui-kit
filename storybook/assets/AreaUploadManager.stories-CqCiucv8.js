import{n as e}from"./chunk-BneVvdWh.js";import{Et as t,Ft as n,H as r,Lt as i,Pt as a,Rt as o,bt as s,i as c}from"./iframe-C0e3YAX7.js";var l,u,d,f,p,m,h,g,_;e((()=>{o(),n(),s(),l=a(),u=t(),{action:d}=__STORYBOOK_MODULE_ACTIONS__,f={title:`Form/File Management`,component:c,decorators:[]},p=i.div`
  margin: 20px
`,m=[`MonitoringProfile`,`RetryJob`],h=[`image/jpeg`,`image/png`,`text/csv`],g=()=>{let e=(0,l.boolean)(`Show Custom Component`,!1),t=(0,l.text)(`Title`,`Select Files`),n=(0,l.text)(`Select Files Text`,`Select Files`),i=(0,l.text)(`Description`,`To begin, drop your CSV and Images files here to continue or click Select Files below.`),a=(0,l.text)(`Add More Files Text`,`Add More files`),o=(0,l.object)(`File Icons`,m),s=d(`Input Callback`),f=(0,l.text)(`Message`,`Cleared all selected files`),g=d(`Action was clicked`),_=(0,l.object)(`Allowed File Types`,h),v=d(`Begin Upload Button Click`);return(0,u.jsx)(p,{children:(0,u.jsx)(c,{selectFilesText:n,title:t,fileIcons:o,description:i,allowedFileTypes:_,addMoreFilesText:a,onChangeCallback:(e,t)=>{console.log(`good Files`,e),console.log(`rejected`,t),s({goodFiles:e,rejectedFiles:t})},clearFilesCallback:()=>{g(f)},beginUploadCallback:v,customComponent:e?(0,u.jsx)(r,{title:`CustomComponent Example`,introductionText:`This is a page header component that was sent as an example of a custom component. Select multiple files`}):void 0})})},g.__docgenInfo={description:``,methods:[],displayName:`_AreaUploadManager`},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`() => {

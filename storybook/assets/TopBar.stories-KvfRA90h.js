import{j as o}from"./emotion-unitless.esm-y1ruXoeO.js";import{r}from"./index-Dh2lLoQQ.js";import{c as R}from"./styled-components.browser.esm-D8a0uvnT.js";import{d as e}from"./index-BtgrC99a.js";import{ab as u,a1 as J}from"./index.modern-BCxVMgPd.js";import{a as i}from"./chunk-D5ZWXAHU-Dm3eDOzv.js";import"./iframe-CQb0CZlC.js";import"./index-Dz_aA26r.js";import"./v4-CtRu48qb.js";const q=R.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
`,ie={title:"Global",component:u,decorators:[]},z=o.jsx("h1",{children:"Hello Drawer"}),K={customComponent:z,icon:"Add",status:"danger",width:"300px;"},Q=[{imgUrl:"",title:"Event Type",message:"A short message limited to two lines. Extra text will just truncat...",time:"Just Now"},{imgUrl:"",title:"Device is off",message:"The device has correctly turn off",time:"1 min ago"},{imgUrl:"",title:"Device is on",message:"The device has correctly turn on",time:"6 mins ago"},{imgUrl:"",title:"Connection was interrupted",message:"The connections is not working properly. Please verify your connection or contact your personal support.",time:"1 hour ago"},{imgUrl:"",title:"Device is off",message:"The device has correctly turn off",time:"3 hour ago"}],X=[{imgUrl:"",title:"Device is off",message:"The device has correctly turn off",time:"3 days ago"},{imgUrl:"",title:"Device is on",message:"The device has correctly turn on",time:"3 days ago"},{imgUrl:"",title:"A new device was added",message:"The device has bean correctly added",time:"3 days ago"}],Y={unread:Q,read:X,noNotificationsText:"NO NEW NOTIFICATIONS",readNotificationsText:"NEW",unreadNotificationsText:"READ"},t=()=>{const{onThemeToggle:h,isLightMode:d}=J(),[a,T]=r.useState("ja"),m=e.text("Logged In User","full.name@example.com"),x=e.boolean("Has Search",!0),p=e.boolean("Has Logout",!0),b=e.boolean("Has Notifications",!0),f=e.boolean("Has Current User",!0),L=e.text("Logout Url","#"),w=e.text("Search Placeholder","Search area names, etc."),C=e.boolean("Has Language",!0),U=e.boolean("Has Switch Theme",!0),D=e.text("Switch Theme Text","SWITCH THEME"),y=e.text("Selected Theme Text","Light/Dark Mode"),s=i("onLanguageToggle"),S=e.text("Current User Text","Current User"),B=e.text("Logout Text","Logout"),k=e.boolean("Has User Drawer Meta",!0),H=e.text("Tooltip Text","Copied"),v=e.boolean("Include Title Copy",!0),I=e.boolean("Has User Drawer Footer",!1),N=e.object("User Drawer Footer",{icon:"Information",title:"V12.3.4"}),M=e.object("Submenu",[{text:"Accounts",href:"#"},{text:"Billing",href:"#"},{text:"Payments",href:"#"}]),E=e.object("Notifications History",Y),j=e.object("User Drawer Meta",[{icon:"",title:"Device ID:",subTitle:"DEB-NUC8i7BE-G6BE935008VH",notes:"",hasCopyIcon:!0},{icon:"Information",title:"GPU machine with 4 GPU",subTitle:"Building B",notes:"This is a GPU machine having 30 camera support",hasCopyIcon:!0},{icon:"Success",title:"Device is Live",subTitle:"Building C",notes:"This is a GPU machine having 30 camera support"}]),P=e.text("Badge Text","Guest"),A=e.select("Badge Color",["primary","grey","info","success","caution","warning"],"info"),G=e.text("Badge To","/login"),F=e.text("Badge Link Text","Login"),O=e.boolean("Use Badge onClick",!1),_=i("Badge onClick was triggered"),V=r.useCallback(()=>{T(W=>{const n=W==="en"?"ja":"en";return s(n),n})},[s]);return o.jsx(q,{children:o.jsx(u,{badge:{text:P,color:A,linkTo:G,linkText:F,onClick:O?_:void 0},loggedInUser:m,userSubmenu:M,hasSearch:x,hasLogout:p,hasNotifications:b,logoutLink:L,searchPlaceholder:w,hasLanguage:C,hasUserDrawerMeta:k,hasUserDrawerFooter:I,hasCurrentUser:f,notificationsHistory:E,hasSwitchTheme:U,isLightMode:d,switchThemeText:D,selectedThemeText:y,onThemeToggle:h,onLanguageToggle:V,currentUserText:S,logoutText:B,userDrawerFooter:N,copySuccessMessage:H,includeCopyTitle:v,userDrawerMeta:j,customDrawer:K,selectedLangAttribute:a,selectedLanguageText:a==="ja"?"日本語":"ENGLISH"})})};t.__docgenInfo={description:"",methods:[],displayName:"_TopBar"};var c,g,l;t.parameters={...t.parameters,docs:{...(c=t.parameters)==null?void 0:c.docs,source:{originalSource:`() => {
  const {
    onThemeToggle,
    isLightMode
  } = useThemeToggle();
...
}`,...(l=(g=t.parameters)==null?void 0:g.docs)==null?void 0:l.source}}};const ce=["_TopBar"];export{t as _TopBar,ce as __namedExportsOrder,ie as default};

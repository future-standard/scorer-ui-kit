...
`,dm=d.g`
  ${Ll};
`,B=({icon:e,size:t=24,weight:r="regular",color:n="grey-12",forSvgUsage:o=!1})=>{const a=go.icons.weights[r],l=Zs[e];return l!=null?o?i.jsx(dm,{children:l({size:t,weight:a,color:`var(--${n}, var(--grey-12))`})}):i.jsx(U,{children:l({size:t,weight:a,color:`var(--${n}, var(--grey-12))`})}):null},vn=d.div`
  position: absolute;
  width: 10px;
  height: 10px;
...
`,km=d.div`
  ...
  text-align: left;
  flex-grow: 2;
`,$m=({id:e,type:t="info",message:r,icon:n="",isPinned:o=!1,actionTextButton:a,closeNow:l=!1,closeCallback:c,onTextButtonClick:u})=>{const[h,f]=s.useState(!1),[g,b]=s.useState(!1),[p,v]=s.useState(!1);s.useEffect(()=>{f(!1),b(!1),v(!1)},[e]);const y=s.useCallback(()=>{b(!0)},[]),C=s.useCallback(async()=>{v(!0),y()},[y]),k=s.useCallback(()=>{g&&(f(!0),u&&p&&u(),c&&c())},[g,c,u,p]);return s.useEffect(()=>{let S=!0;return o||setTimeout(()=>{S&&y()},7e3),()=>{S=!1}},[o,r,y,e]),s.useEffect(()=>{l&&y()},[l,y]),r&&!h?gr.createPortal(i.jsxs(mm,{$type:t,$isClosing:g,onAnimationEnd:k,children:[i.jsx(B,{icon:n||bm[t],color:"inverse"}),i.jsx(km,{children:r}),a?i.jsxs(wm,{onClick:()=>C(),children:[a," "]}):i.jsx(ym,{onClick:()=>y(),children:i.jsx(B,{icon:"CloseCompact",color:"inverse"})})]}),document.body):null},me=8,ke=16,Fe=d.div`
  content:'';
  display:block;
  width:0;
  height:0;
...
`,Em=(e,t)=>{const{left:r,top:n,width:o,height:a}=t,l=n+window.scrollY,c=r+window.scrollX;switch(e){case"bottom-right":return`
            ...
            transform: translateX(-50%);
            align-items: center;
          `}},jm=(e,t,r)=>{const n=e.left+(t||0)+30>window.innerWidth,o=e.bottom+(r||0)>window.innerHeight,a=e.left-(t||0)<0,l=e.top-(r||0)<0;return l&&n&&o?"left":l&&a&&o?"right":l&&a?"bottom-right":l&&n?"bottom-left":o&&a?"top-right":o&&n?"top-left":a?"right":n?"left":o?"top":"bottom"},Z7=({icon:e,message:t,type:r,tooltipFor:n,tooltipPosition:o,maxWidth:a})=>{const[l,c]=s.useState(null),[u,h]=s.useState(!1),[f,g]=s.useState("top"),b=s.useRef(null),p=s.useCallback(()=>{if(n&&n.current){const C=n.current.getBoundingClientRect();c(C),h(!0),g(jm(C,n.current.offsetWidth,n.current.offsetHeight))}},[n]),v=s.useCallback(()=>{h(!1)},[]),y=s.useCallback(()=>{if(n&&n.current){const C=n.current.getBoundingClientRect();c(C)}},[n]);return s.useEffect(()=>{let C=null;return n&&n.current&&(C=n.current,n.current.addEventListener("mouseover",p),n.current.addEventListener("mouseout",v),y()),()=>{C&&(C.removeEventListener("mouseover",p),C.removeEventListener("mouseout",v))}},[v,p,n,y]),!u||!l?null:gr.createPortal(i.jsxs(Sm,{ref:b,$maxWidth:a,$directionStyle:Em(o||f,l),children:[i.jsx(Fe,{$type:r||"neutral"}),i.jsxs(Cm,{$type:r||"neutral",children:[e&&i.jsx(B,{icon:e,size:16,color:"white-a12"}),t]})]}),document.body)},Mm=e=>Xe`
    0% {
      box-shadow:
...
`,Vi=e=>e==="primary"||e==="secondary"||e==="warning"?e:e==="danger"?(console.warn("Button.tsx - Warning, the design prop value `danger` is being deprecated. Use `warning` instead."),"danger"):"simple",Im={xsmall:12,small:16,medium:24,large:36,xlarge:48},bt=({size:e="medium",styling:t="primary",custom:r={}})=>{const{baseColor:n,topColor:o}=r,a=r!=null&&r.size?r.size:Im[e],l=a/5.333,c=a/2-l/2;return i.jsxs("svg",{viewBox:`-${a/2} -${a/2} ${a} ${a}`,width:a,height:a,xmlns:"http://www.w3.org/2000/svg",children:[i.jsx(_m,{cx:"0",cy:"0",r:c,strokeWidth:l,$styling:Vi(t),$customColor:n}),i.jsx(Rm,{cx:"0",cy:"0",r:c,strokeWidth:l,$styling:Vi(t),$customColor:o})]})},Am=d.div`
  display: inline;
`,Pm=d.div`
  height: inherit;
  flex: 1;
...
`,Dm=d.div`
  ...
  `};
`,Yr=({design:e="primary",size:t="normal",loading:r=!1,shadow:n=!1,onClick:o,disabled:a,position:l,icon:c,weight:u="regular",children:h,...f})=>i.jsx(Am,{children:i.jsx(Se,{noPadding:!0,disabled:a||r,design:e,size:t,shadow:n,onClick:o,loading:r,...f,children:i.jsxs(Dm,{$disabled:a,children:[i.jsx(Pm,{$size:t,$position:l,$weight:u,children:i.jsx(i.Fragment,{children:h})}),i.jsxs(Om,{$loading:r,$position:l,children:[i.jsx(Xt,{children:i.jsx(B,{icon:c,weight:u})}),i.jsx(na,{children:i.jsx(bt,{size:t==="xsmall"||t==="small"?"xsmall":"small",styling:e})})]})]})})}),Wm=d.div`
  display: inline;
`,Fm=d.div`
  height: inherit;
  flex: 1;
...
`,Bm=d.div`
  ...
  `}
`,Tl=({design:e="primary",size:t="normal",shadow:r=!1,onClick:n,disabled:o,position:a,loading:l=!1,children:c,...u})=>i.jsx(Wm,{children:i.jsx(Se,{noPadding:!0,disabled:o||l,design:e,size:t,shadow:r,onClick:n,loading:l,...u,children:i.jsxs(Bm,{$loading:l,$design:e,$size:t,children:[i.jsx(Fm,{children:i.jsx(i.Fragment,{children:c})}),i.jsx(oa,{$design:e,$position:a,children:i.jsx(bt,{size:t==="xsmall"||t==="small"?"xsmall":"small",styling:e})})]})})}),Hm=d.button`
  ${oe};
  [stroke]{
    stroke: ${({$color:e})=>e};
  }
...
`,_l=({icon:e,size:t=20,weight:r="regular",color:n="dimmed",hoverColor:o="mono",children:a,formAction:l,...c})=>i.jsx(Hm,{type:"button",$color:n,$hoverColor:o,...c,children:i.jsx(B,{icon:e,size:t,weight:r})}),aa=d(_l)``,Nm=d.div`
  ...
  `};
`,K7=({buttonsConfig:e,alignment:t="right"})=>i.jsx(Nm,{$alignment:t,children:e.map(r=>{const{icon:n,size:o,weight:a,color:l,hoverColor:c,onClick:u}=r;return i.jsx(aa,{icon:n,size:o,weight:a,color:l,hoverColor:c,onClick:u},`${n}-${o}`)})}),Vm=d.div`
  position: absolute;
  right: 0;
  top: 0;
...
`,Il=({type:e="text",placeholder:t="",defaultValue:r,fieldState:n="default",showFeedback:o=!1,feedbackMessage:a,actionCallback:l,actionIcon:c,postfix:u,children:h,formAction:f,...g})=>{const b=l!==void 0,p=v=>{switch(v){case"default":break;case"disabled":break;case"required":return i.jsx(B,{icon:"Required",size:16});case"valid":return i.jsx(B,{icon:"Success",size:16});case"invalid":return i.jsx(B,{icon:"Invalid",size:16});case"processing":return i.jsx(bt,{size:"medium",styling:"primary"})}};return i.jsxs(Jm,{$fieldState:n||"default",$showFeedback:o,children:[i.jsxs(qm,{$hasAction:b,children:[i.jsx(Vn,{$fieldState:n||"default",disabled:n==="disabled"||n==="processing",type:e,placeholder:t,defaultValue:r,...g}),b?i.jsx(Vm,{children:i.jsx(Um,{onClick:l,children:i.jsx(B,{icon:c||"NoIcon",color:"primary"})})}):null]}),n&&o?i.jsxs(Rl,{children:[i.jsx(Ym,{children:p(n)}),a?i.jsx(Gm,{children:a}):null]}):null]})},Al=d.span`
  display: flex;
  flex: 1;
  align-items: center;
  gap: 8px;
...
`,Qm=d.div`
  ...
  `};
`,Zm=({unit:e,label:t,name:r,type:n="text",placeholder:o="",defaultValue:a,fieldState:l="default",required:c=!1,className:u,children:h,formAction:f,...g})=>i.jsx(Qm,{className:u,$fieldState:l||"default",children:i.jsx(Ze,{labelText:t,htmlFor:r||"",required:c,children:i.jsxs(Ol,{$fieldState:l||"default",children:[i.jsx(Pl,{$fieldState:l||"default",type:n,placeholder:o,defaultValue:a,...g}),e?i.jsx(Xm,{children:e}):null]})})}),Km=e=>{switch(e){case 0:return"off";case 1:return"on";case 2:return"neutral";case 3:return"locked";default:return"off"}},eb=d.input`
  display: none;
`,Dl=d.div`
...
`,Bl=({indeterminate:e=!1,disabled:t,checked:r=!1,onChangeCallback:n})=>{const[o,a]=s.useState(r),[l,c]=s.useState(r?"on":"off"),u=f=>{const g=f.target.checked;a(g),n&&n(g)};s.useEffect(()=>{c(r?"on":"off")},[r,o,c]),s.useEffect(()=>{a(r)},[r,a]);const h=go.icons.weights.regular;return i.jsxs(ub,{onChange:u,$disabled:t,$visualState:l,children:[i.jsx(Ge,{children:i.jsx(db,{children:l==="on"?i.jsx(la,{$color:"input-toggle-icon-color",children:i.jsx(Fl,{color:"input-toggle-icon-color",stroke:"inverse",size:12,weight:h})}):null})}),i.jsx(cb,{type:"checkbox",checked:o,readOnly:!0,disabled:t})," "]})},Pr=d.div`
  width: 10px;
  height: 10px;
  border-radius: 50%;
  user-select: none;
...
`,Gl=({fieldState:e="default",placeholder:t,label:r,icon:n,isCompact:o,defaultValue:a,changeCallback:l=()=>{},children:c,...u})=>{r!=null&&r.isSameRow&&console.warn("Deprecation warning: `SelectField` is deprecating `label.isSameRow`, please update this to use `label.direction` set to `row`.");const[h,f]=s.useState(!a),g=s.useCallback(v=>{const{value:y}=v.target;f(C=>C&&!1),l(y)},[l]),b=s.useCallback(()=>u.disabled||e==="disabled"?"input-disabled-lead-icon":"input-lead-icon",[e,u.disabled]),p=s.useCallback(v=>i.jsxs(Nl,{children:[n&&i.jsx(bb,{$isCompact:o,children:i.jsx(B,{icon:n,color:b(),size:12,weight:"regular"})}),i.jsx(Ul,{$withIcon:!!n,id:v,$fieldState:e,$isCompact:o,...u,defaultValue:a||"",onChange:g,children:i.jsxs(i.Fragment,{children:[!a&&i.jsx("option",{value:"",disabled:!0,hidden:!0,children:t}),c]})}),i.jsx(Vl,{$isCompact:o,children:i.jsx(B,{icon:"Down",color:b(),weight:"regular",size:o?8:10})})]}),[c,a,g,t,u,e,n,b,o]);return i.jsx(yb,{$isCompact:o,$activePlaceholder:h,children:r?i.jsx(Ze,{htmlFor:r.htmlFor,labelText:r.text,direction:r.isSameRow?"row":r.direction,children:p(r.htmlFor)}):p()})},Ui=(e,t,r)=>!(e<t||e>r),zt=(e,t,r)=>Math.min(Math.max(e,t),r),wb=(e,t)=>{switch(t){case"seconds":return e<2?"sec":"secs";case"minutes":return e<2?"min":"mins";default:return e<2?"hr":"hrs"}},Gi=e=>{switch(e){case"seconds":case"minutes":case"hours":return!0;default:return!1}},Yl=e=>{const t=e.split("/").filter(String);return t.length>0?"/"+t[0]:"/"},kb=e=>{const t=e.src.substr(0,20);return t.includes("data")?t.split("/")[1].split(";")[0]:"image/jpeg"},$b=e=>e&&["image/jpeg","image/png"].includes(e.type),Sb=()=>String(Date.now().toString(32)+Math.random().toString(16)).replace(/\./g,""),Un=e=>{const t=Number(e);return t!==t},Cb=(e,t)=>e===null&&t===null||e===void 0&&t===null?!0:qr(e)&&qr(t)?Nr(e==null?void 0:e.start,t==null?void 0:t.start)&&Nr(e==null?void 0:e.end,t==null?void 0:t.end):e instanceof Date&&t instanceof Date?Nr(e,t):!1,qr=e=>e==null||e.start===null||e.start===void 0||e.end===null||e.end===void 0?!1:e.start instanceof Date&&e.end instanceof Date,Jr=16,Eb=d.div`
...
`,_b=d(ql)`
  opacity: .5;
`,xn=(e,t,r)=>Jl(e,t,r),Bo=(e,t)=>t.reduce((n,o)=>Math.abs(o.value-e)<Math.abs(n.value-e)?o:n).value,Rb=(e,t)=>!e&&!t?0:t||(e>0?0:e-1),Ib=(e,t)=>e===null&&!t?100:t&&t>e?t+1:e,Jl=(e,t,r)=>Math.round((e-t)*100/(r-t)),Ab=(e,t,r)=>e===t?"right":e===r?"left":"center",Pb=(e,t,r,n,o)=>{const a=[],l=e.map(({value:c,label:u},h)=>{const f=h===e.length-1?100:Jl(c,t,r);return a.push(i.jsx("option",{children:c},`option-${c}`)),i.jsxs(s.Fragment,{children:[i.jsx(Lb,{"data-leftvalue":`${f}%`,$leftValue:f}),i.jsx(zb,{$leftValue:f,$alignment:o?"center":Ab(c,t,r),children:u})]},`mark-${h}`)});return i.jsxs(s.Fragment,{children:[l,i.jsx("datalist",{id:n,children:a})]})};let Cr=0;const Xl=({min:e,max:t,marks:r,defaultValue:n,thumbColor:o="info",disabled:a=!1,onlyMarkSelect:l=!1,inputCallback:c=()=>{},onChangeCallback:u=()=>{},allMarkCentered:h=!1,showValue:f,children:g,formAction:b,...p})=>{const v=Ib(t,e),y=Rb(t,e),C=n&&Ui(n,y,v)?n:y,[k,S]=s.useState(C),[E,L]=s.useState(!1),_=s.useRef(xn(k,y,v));if(r&&l){const z=Bo(k,r);Cr=xn(z,y,v)}const T=s.useCallback((z,R)=>{const j=z.target.value;if(j===null)return;const I=parseInt(j,10);_.current=xn(I,y,v);const P=r?Bo(I,r):I,A=r?Bo(R,r):I;l&&A!==P&&u(P),l||u(I),S(D=>I===D?D:I)},[r,v,y,u,l]),x=s.useCallback(()=>{L(!0)},[]),$=s.useCallback(z=>{c(l?Cr:z),l&&(_.current=Cr),L(!1)},[c,l]);return s.useEffect(()=>{const z=n&&Ui(n,y,v)?n:y;_.current=xn(z,y,v),S(z)},[n,v,y]),i.jsxs(Eb,{$disabled:a,children:[i.jsx(Mb,{}),i.jsxs(Tb,{children:[r&&Pb(r,y,v,`sliderList-${y}-${v}`,h),E&&l?i.jsx(_b,{"data-value":k,$leftValue:Cr,"data-percentage":Cr,$bgColor:o}):null,i.jsx(ql,{"data-value":k,$leftValue:_.current,"data-percentage":_.current,$bgColor:o})]}),i.jsx(jb,{...p,type:"range",disabled:a,list:`sliderList-${y}-${v}`,min:y,max:v,value:k,onMouseUp:()=>$(k),onMouseDown:x,onTouchStart:()=>$(k),onTouchEnd:x,onChange:z=>T(z,k)})]})},Ob=d.div``,Db=d.input`
  display: none;
`,Ql=({text:e,buttonDesign:t,buttonSize:r,inputCallback:n,children:o,formAction:a,...l})=>{const c=s.useRef(null),u=s.useCallback(async f=>{if(!(f.target.files&&f.target.files.length>0))return;const g=f.target.files;n&&n(g),f.target.value=""},[n]),h=s.useCallback(()=>{c.current&&c.current.click()},[]);return i.jsxs(Ob,{children:[i.jsx(Db,{...l,ref:c,type:"file",onChange:u}),i.jsx(Se,{style:{textAlign:"center"},onClick:h,design:t,size:r,children:e})]})},Wb=d.div``,Fb=d.div`
  font-size: 14px;
  color: var(--grey-10);
  display: flex;
  justify-content: space-between;
...
`,qb=d(Ze)`
  font-family: ${({theme:e})=>e.fontFamily.data};
`,Jb=e=>e<=10?"error":e>10&&e<=30?"warning":"success",Xb=e=>e<=10?"Critical Level":e>10&&e<=30?"Warning Level":"Safe Level",n6=({defaultValue:e=0,inputCallback:t,updateThumbColor:r,updateTitle:n,showValue:o,allMarkCentered:a,...l})=>{const[c,u]=s.useState(e),h=s.useCallback(f=>{t&&t(f),u(f)},[t]);return i.jsxs(Gb,{children:[i.jsxs(Yb,{$allMarkCentered:a,children:[i.jsx(Ze,{htmlFor:"percentage-slider",labelText:n?n(c):Xb(c)}),o&&i.jsx(qb,{htmlFor:"percentage-slider",labelText:`${c}%`})]}),i.jsx(Xl,{...l,id:"percentage-slider",max:100,min:0,defaultValue:e,showValue:o,onChangeCallback:h,thumbColor:r?r(c):Jb(c),allMarkCentered:a})]})},o6=({name:e,label:t,fieldState:r,feedbackMessage:n,required:o,children:a,formAction:l,...c})=>{const[u,h]=s.useState(!1),[f,g]=s.useState("PasswordHide"),b=()=>{const p=!u;h(p),g(p?"PasswordShow":"PasswordHide")};return i.jsx(Ze,{htmlFor:e,labelText:t,required:o,children:i.jsx(Il,{type:u?"text":"password",actionCallback:b,actionIcon:f,name:e,fieldState:r,feedbackMessage:n,required:o,...c})})},a6=({name:e,label:t,fieldState:r="default",feedbackMessage:n,required:o,type:a,...l})=>i.jsx(Ze,{htmlFor:e,labelText:t,required:o,children:i.jsx(Il,{type:"text",fieldState:r,feedbackMessage:n,required:o,name:e,...l})}),i6=({name:e,label:t,fieldState:r="default",feedbackMessage:n,required:o=!1,children:a,...l})=>i.jsx(Ze,{htmlFor:e,labelText:t,required:o,children:i.jsx(mb,{fieldState:r,feedbackMessage:n,name:e,required:o,...l})}),Qb=d.div`
...
`,Kl=({height:e,text:t,dropCallback:r,...n})=>{const[o,a]=s.useState(!1),l=s.useCallback(g=>{g.preventDefault(),g.stopPropagation(),a(!0)},[]),c=s.useCallback(g=>{g.preventDefault(),g.stopPropagation(),a(!1)},[]),u=s.useCallback(g=>{g.preventDefault(),g.stopPropagation()},[]),h=s.useCallback(g=>{var b;g.preventDefault(),g.stopPropagation(),(b=g.dataTransfer)!=null&&b.files&&r&&r(g.dataTransfer.files),a(!1)},[r]),f=s.useCallback(g=>{g.preventDefault()},[]);return s.useEffect(()=>(window.addEventListener("dragover",f),window.addEventListener("drop",f),()=>{window.removeEventListener("dragover",f),window.removeEventListener("drop",f)}),[f]),i.jsx(Qb,{$height:e,...n,children:i.jsx(Zb,{$inDropZone:o,onDragEnter:l,onDragLeave:c,onDrop:h,onDragOver:u,children:t})})},Kb=(e,t,r,n,o,a)=>{let l="default";return a-t<5?r-(o-e)<5?l="ne-resize":o-e<5?l="nw-resize":l="n-resize":n-(a-t)<5?r-(o-e)<5?l="se-resize":o-e<5?l="sw-resize":l="s-resize":r-(o-e)<5?l="e-resize":o-e<5?l="w-resize":l="move",l},e5=(e,t,r)=>{const n=Math.min(r/e.naturalWidth,t/e.naturalHeight),o=Math.floor(e.naturalWidth*n),a=Math.floor(e.naturalHeight*n),l=0+Math.floor((t-a)/2);return{left:0+Math.floor((r-o)/2),top:l,width:o,height:a}},t5=(e,t,r,n,o,a,l)=>{let c,u;const h=l||1,f=Math.min(e,r,o),g=Math.min(t,n,a);f>g*h?(u=Math.floor(g*h),c=g):(u=f,c=Math.floor(f/h));const b=0+Math.floor(n/2-c/2);return{left:0+Math.floor(r/2-u/2),top:b,width:u,height:c}},r5=e=>{let t;return typeof e.buttons<"u"?t=e.buttons:typeof e.button<"u"?t=e.button:t=e.which,t===1},n5=(e,t,r)=>{let[n,o,a,l]=[e.cropLeft,e.cropTop,e.cropWidth,e.cropHeight];const c=t-e.mouseStartX,u=r-e.mouseStartY;switch(e.cursorStart){case"ne-resize":o=e.cropTop+u,l=e.cropHeight-u,a=e.cropWidth+c;break;case"nw-resize":o=e.cropTop+u,n=e.cropLeft+c,l=e.cropHeight-u,a=e.cropWidth-c;break;case"n-resize":o=e.cropTop+u,l=e.cropHeight-u;break;case"se-resize":l=e.cropHeight+u,a=e.cropWidth+c;break;case"sw-resize":n=e.cropLeft+c,l=e.cropHeight+u,a=e.cropWidth-c;break;case"s-resize":l=e.cropHeight+u;break;case"e-resize":a=e.cropWidth+c;break;case"w-resize":n=e.cropLeft+c,a=e.cropWidth-c;break;case"move":o=e.cropTop+u,n=e.cropLeft+c;break}const h=zt(a,0,e.imgWidth),f=zt(l,0,e.imgHeight),g=zt(n,e.imgLeft,e.imgWidth-e.cropWidth+e.imgLeft),b=zt(o,e.imgTop,e.imgHeight-e.cropHeight+e.imgTop),p=ec(e,{left:g,top:b,height:f,width:h});return{left:g,top:b,width:h,height:f,isUpdateRequired:p}},o5=(e,t,r,n)=>{const o=n||1;let[a,l,c,u]=[e.cropLeft,e.cropTop,e.cropWidth,e.cropHeight];const h=t-e.mouseStartX,f=r-e.mouseStartY;switch(e.cursorStart){case"ne-resize":l=e.cropTop+f,u=e.cropHeight-f,c=Math.floor(u*o);break;case"nw-resize":l=e.cropTop+f,a=e.cropLeft+f*o,u=e.cropHeight-f,c=Math.floor(u*o);break;case"se-resize":u=e.cropHeight+f,c=Math.floor(u*o);break;case"sw-resize":a=e.cropLeft+h,c=e.cropWidth-h,u=Math.floor(c/o);break;case"move":l=e.cropTop+f,a=e.cropLeft+h;break}const g=zt(a,e.imgLeft,e.imgWidth-e.cropWidth+e.imgLeft),b=zt(l,e.imgTop,e.imgHeight-e.cropHeight+e.imgTop),p=zt(c,0,e.imgWidth),v=zt(u,0,e.imgHeight);let y=g,C=b,k=p,S=v;e.cursorStart!=="move"&&p===e.imgWidth&&(S=e.cropHeight,C=e.cropTop),e.cursorStart!=="move"&&v===e.imgHeight&&(k=e.cropWidth,y=e.cropLeft);const E=ec(e,{left:y,top:C,height:S,width:k});return{left:y,top:C,width:k,height:S,isUpdateRequired:E}},ec=(e,t)=>{let r=!1;return e.cropLeft!==t.left&&(r=!0),e.cropTop!==t.top&&(r=!0),e.cropHeight!==t.height&&(r=!0),e.cropWidth!==t.width&&(r=!0),r},vo=w`
  position: absolute;
  display: block;
  opacity: 0.1;
`,a5=d.div`
...
`,C5=d.div`
  ...
  `};
  cursor: move;
`,Y={cropLeft:0,cropTop:0,cropWidth:350,cropHeight:300,mouseStartX:0,mouseStartY:0,imgLeft:0,imgTop:0,imgWidth:400,imgHeight:400,cursorStart:"default",isResizing:!1},E5=({title:e="Crop Image",cancelBtnTxt:t="Cancel",cropBtnTxt:r="Crop & Save",isResizable:n=!0,cropHeight:o=300,cropWidth:a=350,canvasHeight:l=400,canvasWidth:c=450,aspectRatio:u,imgUrl:h,onCrop:f,onClose:g=()=>{},onError:b=()=>{}})=>{const[p,v]=s.useState(!1),[y,C]=s.useState(Y),k=s.useRef(null),S=s.useRef(null),E=s.useRef(null),L=s.useCallback(()=>{if(!k||!S)return;const j=S.current;if(!j){b("error loading image");return}const I=k.current;if(!I){b("error loading canvas");return}const P=I.getContext("2d");if(!P){b("error drawing image");return}const A=e5(j,l,c);P==null||P.drawImage(j,A.left,A.top,A.width,A.height);const D=t5(a,o,c,l,A.width,A.height,u);C(W=>({...W,cropLeft:D.left,cropTop:D.top,cropWidth:D.width,cropHeight:D.height,imgLeft:A.left,imgTop:A.top,imgWidth:A.width,imgHeight:A.height})),Y.cropLeft=D.left,Y.cropTop=D.top,Y.cropWidth=D.width,Y.cropHeight=D.height,Y.imgLeft=A.left,Y.imgTop=A.top,Y.imgWidth=A.width,Y.imgHeight=A.height,Y.cursorStart="default",Y.isResizing=!1,v(!1)},[u,l,c,o,a,b]),_=s.useCallback(async j=>{if(v(!0),!k||!k.current||!S)return;const I=S.current;if(!I)return;const P=k.current;if(!P)return;const A=P.getContext("2d"),D=A==null?void 0:A.getImageData(j.left,j.top,j.width,j.height);if(!D)return;const W=document.createElement("canvas"),F=W.getContext("2d");W.width=j.width,W.height=j.height,F==null||F.putImageData(D,0,0);const V=kb(I),N=W.toDataURL(V);f&&f(N,V)},[f]),T=s.useCallback(j=>{var J;if(j.preventDefault(),j.stopPropagation(),!E||!r5(j.nativeEvent))return;const I=(J=E.current)==null?void 0:J.getBoundingClientRect();if(!I)return;const{left:P,top:A,width:D,height:W}=I,[F,V]=[j.clientX,j.clientY];let N;n?N=Kb(P,A,D,W,F,V):N="move",Y.mouseStartX=F,Y.mouseStartY=V,Y.cursorStart=N,Y.isResizing=!0},[n]),x=s.useCallback(j=>{j.preventDefault(),j.stopPropagation(),Y.isResizing&&(Y.isResizing=!1)},[]),$=s.useCallback((j,I,P,A)=>{E.current&&(E.current.style.left=`${j}px`,E.current.style.top=`${I}px`,E.current.style.width=`${P}px`,E.current.style.height=`${A}px`)},[]),z=s.useCallback(j=>{var W;if(j.preventDefault(),j.stopPropagation(),!E||!Y.isResizing||!((W=E.current)==null?void 0:W.getBoundingClientRect()))return;const[P,A]=[j.clientX,j.clientY],D=u?o5(Y,P,A,u):n5(Y,P,A);D.isUpdateRequired&&(Y.cropTop=D.top,Y.cropLeft=D.left,Y.cropWidth=D.width,Y.cropHeight=D.height,Y.mouseStartX=P,Y.mouseStartY=A,$(Y.cropLeft,Y.cropTop,Y.cropWidth,Y.cropHeight))},[u,$]),R=s.useCallback(j=>{j.preventDefault(),j.stopPropagation(),Y.isResizing&&(Y.isResizing=!1)},[]);return gr.createPortal(i.jsx(m5,{children:i.jsxs(b5,{children:[i.jsxs(y5,{children:[i.jsxs(w5,{children:[i.jsx(B,{icon:"Crop",size:20,color:"mono"}),e]}),i.jsxs(k5,{children:[i.jsx(Se,{design:"secondary",size:"small",onClick:g,children:t}),i.jsxs(Tl,{loading:p,size:"small",onClick:()=>_({left:Y.cropLeft,top:Y.cropTop,width:Y.cropWidth,height:Y.cropHeight}),children:[" ",r]})]})]}),i.jsxs($5,{$canvasHeight:l,$canvasWidth:c,onMouseUp:x,onMouseMove:z,onMouseLeave:R,children:[i.jsx(S5,{ref:S,src:h,onLoad:L,crossOrigin:"anonymous"}),i.jsx("canvas",{ref:k,width:`${c}px`,height:`${l}px`}),i.jsx(C5,{ref:E,onMouseDown:T,$cropLeft:Y.cropLeft,$cropTop:Y.cropTop,$cropWidth:Y.cropWidth,$cropHeight:Y.cropHeight,children:i.jsx(x5,{isResizable:n,hasAspectRatio:!!u})})]})]})}),document.body)},tc=500,rc=475,j5=490,M5=460,L5=Math.round(rc/tc*100)/100,nc="150px",oc="142px",z5=d.div`
  position: relative;
  width: ${oc};
  ${({theme:e})=>w`
...
`,s6=({title:e="Photograph",photoText:t="Drop Photo",buttonText:r="Select File",buttonTextReplace:n="Replace Photo",uploaderCropText:o="Crop Image",deletePhotoText:a="Remove",cropToolTitle:l,cropToolCancelTxt:c,cropToolConfirmTxt:u,currentImg:h,hasCrop:f=!0,onAvatarUpdate:g=()=>{},onError:b=()=>{},onRemove:p=()=>{}})=>{const[v,y]=s.useState(h),[C,k]=s.useState(""),[S,E]=s.useState(!1),L=s.useCallback(async(z,R)=>{y(z);const j=await fetch(z).then(I=>I.blob()).then(I=>new File([I],"newAvatar",{type:R}));g(j),E(!1)},[g]),_=s.useCallback(()=>{E(!1),k(""),URL.revokeObjectURL(C)},[C]),T=s.useCallback(z=>{if(z.length===1){if(!$b(z[0])){b("Please upload only jpeg and png file");return}const R=URL.createObjectURL(z[0]);f?(k(R),E(!0)):(g(z[0]),y(R))}else b("Drop only one file")},[f,b,g]),x=s.useCallback(z=>{k(z),E(!0)},[]);s.useEffect(()=>(y(h),()=>{y("")}),[h]);const $=s.useCallback(()=>{y(""),p()},[p]);return i.jsxs(z5,{children:[i.jsx(Ze,{labelText:e,htmlFor:"avatar-upload"}),i.jsxs(T5,{children:[v?i.jsx(_5,{src:v,alt:"avatar image",crossOrigin:"anonymous"}):i.jsxs(R5,{children:[i.jsx(sb,{}),i.jsx(ic,{children:t})]}),(h&&!f||!h)&&i.jsx(Kl,{height:nc,dropCallback:T})]}),v?i.jsxs(I5,{children:[f?i.jsx(Yr,{icon:"Crop",design:"secondary",position:"left",size:"small",onClick:()=>x(v),children:o}):i.jsx(qi,{id:"avatar-upload",text:n,buttonSize:"small",buttonDesign:"secondary",accept:"image/*",inputCallback:T}),i.jsx(Yr,{icon:"Delete",design:"secondary",position:"left",size:"small",onClick:$,children:a})]}):i.jsx(qi,{id:"avatar-upload",text:r,buttonSize:"small",accept:"image/*",inputCallback:T}),S&&f?i.jsx(E5,{imgUrl:C,onCrop:L,onClose:_,onError:b,canvasHeight:j5,canvasWidth:M5,cropHeight:rc,cropWidth:tc,aspectRatio:L5,title:l,cancelBtnTxt:c,cropBtnTxt:u,isResizable:!0}):null]})},A5=d.div`
  display: flex;
  align-items: center;
  margin-bottom: 27px;
  ${U} {
...
`,D5=({icons:e,color:t="dimmed",size:r=72,weight:n="light",...o})=>i.jsx(A5,{...o,children:e.map((a,l)=>i.jsxs(s.Fragment,{children:[l!==0&&i.jsx(O5,{children:i.jsx(P5,{icon:"CloseCompact",size:22})}),i.jsx(B,{icon:a,color:t,size:r,weight:n})]},`type-upload-${a}}`))}),W5=d.div`
  font-family: ${({theme:e})=>e.fontFamily.ui};
`,F5=d(Kl)`
  position: absolute;
  top: 0;
...
`,V5=d.div`
  ...
  margin-top: 10px;
  max-width: 386px;
`,U5=(e,t,r)=>{const n=new DataTransfer,o=new DataTransfer;for(let u=0;u<e.length;u++)(r===void 0||r.length===0?!0:r.includes(e[u].type))?n.items.add(e[u]):o.items.add(e[u]);if(t===null)return{goodFiles:n.files,rejectedFiles:o.files};const a=new DataTransfer,l=new Set;for(let u=0;u<t.length;u++){a.items.add(t[u]);const h=t[u].name;l.add(h)}for(let u=0;u<n.files.length;u++){const h=l.has(n.files[u].name),f=r===void 0||r.length===0?!0:r.includes(e[u].type);h||!f?o.items.add(e[u]):a.items.add(n.files[u])}return{goodFiles:a.files,rejectedFiles:o.files}},l6=({title:e="Select Files",description:t,fileIcons:r,selectFilesText:n="Select Files",addMoreFilesText:o="Add More Files",clearFilesText:a="Clear Files",beginUploadText:l="Begin Upload",allowedFileTypes:c,customComponent:u,onChangeCallback:h=()=>{},clearFilesCallback:f=()=>{},beginUploadCallback:g=()=>{}})=>{const[b,p]=s.useState(null),v=s.useCallback(C=>{if(C===null)return;const{goodFiles:k,rejectedFiles:S}=U5(C,b,c);p(k),h(k,S)},[b,c,h]),y=s.useCallback(()=>{p(null),f()},[f]);return i.jsx(W5,{children:i.jsxs(H5,{$hasFiles:b!==null,children:[i.jsx(F5,{dropCallback:v}),u||i.jsxs(s.Fragment,{children:[r&&i.jsx(D5,{icons:r}),i.jsx(N5,{children:e}),b===null&&i.jsx(V5,{children:t})]}),i.jsxs(B5,{children:[i.jsx(Ql,{buttonSize:"small",text:b!==null?o:n,inputCallback:v,multiple:!0,buttonDesign:b!==null?"secondary":"primary",accept:c==null?void 0:c.join(", ")}),b!==null&&i.jsxs(s.Fragment,{children:[i.jsx(Se,{size:"small",onClick:g,design:"primary",children:l}),i.jsx(Se,{size:"small",onClick:y,design:"secondary",children:a})]})]})]})})},G5=d.form`
  ${({$spacing:e})=>e&&w`
      & >  ${po} {
        margin-bottom: ${e};
      }
...
`,Ji=({text:e,icon:t="",design:r="primary",noBorderTop:n=!1,textMaxWidth:o="",size:a="normal",onClickCallback:l,closeCallback:c,hasOnSelectLoading:u,children:h,formAction:f,...g})=>{const b=s.useRef(null),[p,v]=s.useState(!1),[y,C]=s.useState(0),k=s.useCallback(()=>{l&&l(),u?(v(!0),setTimeout(()=>{v(!1),c()},2e3)):setTimeout(()=>{c()},200)},[c,u,l]);return s.useEffect(()=>{b.current&&C(parseInt(getComputedStyle(b.current).getPropertyValue("--button-icon-size")))},[b]),i.jsxs(Y5,{ref:b,$noBorderTop:n,size:a,onClick:k,...g,children:[i.jsx(X5,{$isAscendingIcon:t==="FilterAscending",children:p?i.jsx(bt,{custom:{size:y},styling:r}):i.jsx(B,{icon:t})}),i.jsx(J5,{$textMaxWidth:o,children:i.jsx(q5,{children:e})})]})},Q5=(e,t,r,n=!0)=>{const o=document.title.split("|").slice(-1)[0].trim();s.useLayoutEffect(()=>()=>{document.title=o},[o]),s.useEffect(()=>{n&&(document.title=Z5([...e?[e]:[],...t?[t]:[],...o?[o]:[]],r))},[e,t,r,n,o])},Z5=(e,t="|")=>{let r="";return t=" "+t+" ",e.forEach((n,o)=>{r+=n,e.length-1!==o&&(r+=t)}),r},Da=()=>({copyToClipboard:s.useCallback(t=>{const r=document.createElement("textarea");r.value=t,r.setAttribute("readonly",""),r.style.position="absolute",r.style.left="-9999px",document.body.appendChild(r);const n=document.getSelection();if(n){const o=n.rangeCount>0?n.getRangeAt(0):!1;r.select();const a=document.execCommand("copy");return document.body.removeChild(r),o&&(n.removeAllRanges(),n.addRange(o)),a}return!1},[])});function Ho(e,t){const[r,n]=s.useState(()=>{if(typeof window>"u")return t;try{const a=window.localStorage.getItem(e);return a?JSON.parse(a):t}catch(a){return console.warn(`[useLocalStorage] Failed to parse key "${e}" from localStorage, using initial value:`,a),t}}),o=s.useCallback(a=>{try{n(l=>{const c=a instanceof Function?a(l):a;return typeof window<"u"&&window.localStorage.setItem(e,JSON.stringify(c)),c})}catch(l){console.error(`[useLocalStorage] Failed to write key "${e}" to localStorage:`,l)}},[e]);return[r,o]}function rn(e,t){const r=s.useRef(t);r.current=t,s.useEffect(()=>{const n=o=>{var a;(a=e==null?void 0:e.current)!=null&&a.contains(o.target)||r.current(o)};return document.addEventListener("click",n,!0),()=>{document.removeEventListener("click",n,!0)}},[t,e])}const K5=d.div`
  position: fixed;
  top: 0;
  left: 0;
  height: 100%;
...
`,ly=d.img`
  ...
  ${({$isLoaded:e,$hasModalLimits:t})=>w`
    ...
    `};
  `};
`,hc=({src:e,alt:t,videoOptions:r={},mediaType:n,hasModalLimits:o,retryLoading:a=!1,retryLimit:l=5,minWidth:c,minHeight:u,onError:h=()=>{},onMediaLoad:f=()=>{}})=>{const[g,b]=s.useState(0),[p,v]=s.useState(e),[y,C]=s.useState(!1),[k,S]=s.useState(!1),{loop:E=!1,autoPlay:L=!0,controls:_=!1,muted:T=!0,children:x,...$}=r,z=s.useCallback(j=>{if(!a||g>=l)h(j.nativeEvent),S(!0),C(!0);else{const I=1e3*(g**2+Math.random());b(P=>P+1),setTimeout(()=>{v(`${e}?v=${Date.now()}`)},I)}},[e,h,g,a,l]),R=s.useCallback(()=>{f(),S(!0)},[f,S]);return i.jsxs(uc,{$minWidth:c,$minHeight:u,children:[n==="video"?i.jsx(sy,{loop:E,autoPlay:L,controls:_,muted:T,onError:z,...$,$hasModalLimits:o,src:y?"":p,$isLoaded:k&&!y,preload:"metadata",onCanPlayThrough:R,children:i.jsx(i.Fragment,{children:x})}):i.jsx(ly,{alt:t,onError:z,$hasModalLimits:o,src:y?"":p,onLoad:R,$isLoaded:k&&!y}),!k&&i.jsx(iy,{children:i.jsx(bt,{size:"large",styling:"primary"})}),y&&i.jsx(ay,{})]})},cy={controls:!0},dy=()=>{const{createModal:e,isModalOpen:t,setModalOpen:r}=cc();async function n(a,l){let c=!1;if(l==="img"){const u=new Image;u.src=a;try{await new Promise((h,f)=>{u.onload=()=>h(c=!0),u.onerror=f})}catch{c=!1}}if(l==="video"){const u=document.createElement("video");u.src=a;try{await new Promise((h,f)=>{u.oncanplaythrough=()=>h(c=!0),u.onerror=f})}catch{c=!1}}return c}return{createMediaModal:s.useCallback(async a=>{const{src:l,mediaType:c,alt:u,videoOptions:h=cy,onError:f,onMediaLoad:g,closeText:b,dismissCallback:p,retryLoading:v=!1,retryLimit:y=5,minHeight:C="300px",minWidth:k="300px"}=a;e({padding:!1,width:"auto",closeText:b,dismissCallback:p,customComponent:i.jsx(hc,{src:l,mediaType:c,alt:u,videoOptions:h,onError:f,onMediaLoad:g,retryLoading:v,retryLimit:y,minHeight:C,minWidth:k,hasModalLimits:!0})})},[e]),isMediaUrlValid:n,isMediaModalOpen:t,setMediaModalOpen:r}},da="(prefers-color-scheme: dark)",ua=e=>{e?(document.body.classList.add("light-theme"),document.body.classList.remove("dark-theme")):(document.body.classList.add("dark-theme"),document.body.classList.remove("light-theme"))},uy=()=>{const e=localStorage.getItem("isDarkThemeEnabled");let t=!0;return e===null?t=window.matchMedia(da)&&window.matchMedia(da).matches:t=e!=="false",ua(!t),t},h6=()=>{const[e,t]=s.useState(uy),r=s.useCallback(()=>{t(o=>(localStorage.isDarkThemeEnabled=!o,ua(o),!o))},[]),n=s.useCallback(o=>{if(localStorage.getItem("isDarkThemeEnabled")!==null)return;const l=o.matches;t(()=>(ua(!l),l))},[]);return s.useEffect(()=>{const o=window.matchMedia(da);return o.addEventListener("change",n),()=>{o.removeEventListener("change",n)}},[r,n]),{isDarkThemeEnabled:e,setIsDarkThemeEnabled:t,onThemeToggle:r,isLightMode:!e}},fy=30,hy=d.div`
  height: var(--button-height);
  overflow: visible;
`,gy=d.div`
...
`,xy=(e,t)=>{if(t)return t;if(e)return`${e-fy}px`},g6=({mainButtonId:e,buttonList:t,design:r="primary",size:n,textMaxWidth:o,disabled:a=!1,...l})=>{const[c,u]=s.useState(!1),h=s.useRef(null),f=s.useRef(null),g=s.useCallback(()=>{u(p=>!p)},[]),b=s.useCallback(()=>{u(!1)},[]);return rn(f,b),i.jsx(hy,{children:i.jsxs(gy,{ref:f,className:`split-button-${r} split-button-size-${n}`,$isOpen:c,...l,children:[i.jsxs(py,{ref:h,children:[t.filter(p=>p.id===e).map(({id:p,text:v,icon:y,disabled:C,...k})=>i.jsx(Ji,{noBorderTop:!0,disabled:a||C,closeCallback:b,icon:y||"NoIcon",text:v,design:r,size:n,...k},p)),i.jsx(vy,{onClick:g,disabled:a,children:i.jsx(B,{icon:c?"Close":"Down",size:8})})]}),c&&!a?i.jsx(s.Fragment,{children:t.filter(p=>p.id!==e).map(({id:p,text:v,icon:y,disabled:C,...k})=>{var S;return i.jsx(Ji,{icon:y||"NoIcon",text:v,design:r,size:n,disabled:C,textMaxWidth:xy((S=h.current)==null?void 0:S.clientWidth,o),...k,closeCallback:b},p)})}):null]})})},my=d.div`
  display: flex;
  flex-direction: column;
  gap: 8px;
  button {
...
`,p6=({buttons:e})=>i.jsx(my,{children:e.map(({id:t,buttonType:r,icon:n,text:o,iconPosition:a,size:l,...c})=>r==="icon-button"?i.jsx(Yr,{size:l||"small",icon:n||"",position:a,...c,children:o},t||`button-stack-${t}`):i.jsx(Se,{size:l||"small",...c,children:o},t||`button-stack-${t}`))}),by=d.div`
  display: flex;
  flex-direction: column;
...
`,Ki=({allowAfterMidnight:e=!1,title:t,hasDate:r,hasTime:n,isTimeRangeValid:o=!0,date:a=new Date,setDateCallback:l=()=>{}})=>{const c=(v,y,C,k)=>{const S=Number(v.slice(-2)),E=Number(y.slice(-2)),L=S>24?Number(v.slice(-1)):S,_=E>60?Number(y.slice(-1)):E;return L>=24&&_!==-1&&k?{newHour:24,newMin:0}:L===0&&_===0&&k&&!C?{newHour:0,newMin:1}:L===23&&_===60&&!k?{newHour:23,newMin:59}:L>=24&&!k?{newHour:23,newMin:_}:_===60?{newHour:L+1,newMin:0}:L>0&&_===-1?{newHour:L-1,newMin:59}:L===0&&_===-1?{newHour:L,newMin:0}:L===-1?{newHour:0,newMin:_}:{newHour:L,newMin:_}},[u,h]=s.useState(be(a,"mm")),[f,g]=s.useState(be(a,"HH")),b=s.useCallback(({target:{value:v}})=>{if(Un(v))return;const{newHour:y,newMin:C}=c(v,f,r,e);l(Ci([sr(a),An(a,{hours:y,minutes:C,seconds:0,milliseconds:0})]))},[e,a,f,r,l]),p=s.useCallback(({target:{value:v}})=>{if(Un(v))return;const{newHour:y,newMin:C}=c(u,v,r,e);l(Ci([sr(a),An(a,{hours:y,minutes:C,seconds:0,milliseconds:0})]))},[e,a,u,r,l]);return s.useEffect(()=>{e&&Nr(a,sr(a))?(h("24"),g("00")):(g(be(a,"mm")),h(be(a,"HH")))},[a,e]),i.jsxs(by,{$hide:!r&&!n,children:[i.jsx(yy,{children:t}),r&&i.jsxs(Xi,{children:[i.jsx(Qi,{children:i.jsx(B,{icon:"Date",color:"dimmed",size:14,weight:"light"})}),i.jsx(Zi,{children:i.jsx(Mn,{type:"text",readOnly:!0,value:be(a,"yyyy/MM/dd"),$isTimeRangeValid:o})})]}),n&&i.jsxs(Xi,{children:[i.jsx(Qi,{children:i.jsx(B,{icon:"Time",color:"dimmed",size:14,weight:"light"})}),i.jsxs(Zi,{children:[i.jsx(Mn,{name:"hours",type:"number",min:"-1",max:e?24:23,value:u,onChange:b,$isTimeRangeValid:o,autoComplete:"off",$isTimeInput:!0}),i.jsx(gc,{children:":"}),i.jsx(Mn,{name:"minutes",type:"number",min:"-1",max:"60",value:f,onChange:p,$isTimeRangeValid:o,autoComplete:"off",$isTimeInput:!0})]})]})]})},Gn=e=>({start:An(e,{seconds:0,milliseconds:0}),end:sr(e)}),wy=new Date,rr=Gn(Rt(new Date)),ky=d.div`
  display: flex;
`,$y=d.div`
...
`,Dy=["S","M","T","W","T","F","S"],Wy=["日","月","火","水","木","金","土"],Fy=({dateMode:e="interval",timeMode:t="interval",dateTimeTextUpper:r="From",dateTimeTextLower:n="To",timeZoneTitle:o="Timezone",timeZoneValueTitle:a="JST",hasEmptyValue:l=!1,updateCallback:c=()=>{},initialValue:u,availableRange:h,contentDays:f,lang:g="en",cancelText:b="Cancel",applyText:p="Apply",hasApply:v=!1,disableApply:y=!1,applyCallback:C=()=>{},cancelCallback:k=()=>{}})=>{const[S,E]=s.useState(Hy(l,u)),[L,_]=s.useState(S===null?wy:S.start),[T,x]=s.useState("start"),[$,z]=s.useState([]),R=s.useRef(!0),[j,I]=s.useState(!0),P=g==="ja"?Wy:Dy;s.useEffect(()=>{if(R.current)R.current=!1;else{const F=new Date;E(Gn(Rt(F))),_(F)}},[e,t]),s.useEffect(()=>{z(O0({start:D0(L),end:ol(L)}))},[L]),s.useEffect(()=>{S!==null&&c(e==="interval"||t==="interval"?S:S.start)},[e,S,t,c]);const A=s.useCallback(F=>{const V=S||rr;if(e==="single"){const N=jr(V.start,F),J=jr(V.end,F);E({start:N,end:J})}else if(T==="end"&&Ti(F,V.start)){const N=jr(V.end,F);E({...V,end:N}),x("done")}else if(T==="start"||T==="end"||T==="done"){const N=jr(V.start,F),J=jr(V.end,F);E({start:N,end:J}),x("end")}},[e,S,T]);s.useEffect(()=>{const{start:F,end:V}=S||rr;t==="interval"&&Ti(Gt(F,{minutes:1}),V)?Nr(V,sr(F))&&V.getSeconds()>0?I(!0):I(!1):I(!0)},[S,t]);const D=s.useCallback(F=>{const{end:V}=S||rr;E({start:F,end:V})},[S]),W=s.useCallback(F=>{const{start:V}=S||rr;E({start:V,end:F})},[S]);return i.jsxs(ky,{children:[i.jsxs($y,{children:[i.jsx(Ki,{isTimeRangeValid:j,title:r,hasDate:!0,hasTime:t!=="off",date:S?S.start:rr.start,setDateCallback:D}),i.jsx(Ki,{isTimeRangeValid:j,title:n,hasDate:e==="interval",hasTime:t==="interval",date:S?S.end:rr.end,allowAfterMidnight:!0,setDateCallback:W}),i.jsxs(Sy,{children:[i.jsx(Cy,{children:o}),i.jsx(Ey,{children:a})]})]}),i.jsxs(jy,{children:[i.jsxs(My,{children:[i.jsxs(es,{type:"button",disabled:Ny(L,h),onClick:()=>_(Ir(L,-1)),children:[i.jsx(Yn,{children:i.jsx(B,{icon:"Left",color:"dimmed",size:10})}),be(Ir(L,-1),"MMM",{locale:g==="ja"?Ro:Cn})]}),i.jsxs(Ly,{children:[i.jsx("span",{children:be(L,"yyyy")}),be(L,"MMMM",{locale:g==="ja"?Ro:Cn})]}),i.jsxs(es,{type:"button",disabled:Vy(L,h),onClick:()=>_(Ir(L,1)),children:[be(Ir(L,1),"MMM",{locale:g==="ja"?Ro:Cn}),i.jsx(Yn,{children:i.jsx(B,{icon:"Right",color:"dimmed",size:10})})]})]}),i.jsx(Ry,{children:P.map((F,V)=>i.jsx(Iy,{children:F},V))}),i.jsx(zy,{children:$.map((F,V)=>{const N=P0({start:F,end:F0(F)});return i.jsx(pc,{children:N.map((J,ve)=>{const se=By(J,S),Ie=Fp(J);return i.jsxs(Oy,{disabled:Uy(J,h),onClick:()=>A(J),$state:se,$thisMonth:Wp(J,L),$isToday:Ie,children:[i.jsx(Py,{children:be(J,"d")}),i.jsx(Ay,{$hasContent:Gy(J,f),$state:se,$isToday:Ie})]},ve)})},V)})}),v&&i.jsx(Ty,{children:v&&i.jsxs(_y,{children:[i.jsx(Se,{design:"secondary",onClick:k,children:b}),i.jsx(Se,{onClick:C,disabled:!j||S===null||y,children:p})]})})]})]})},By=(e,t,r)=>{let n="off",o=!1;if(t===null)return n;const a=Dp(t).days===0;try{o=Bp(e,t)}catch{o=!1}return(o||qt(t.start,e))&&(a?n="single":qt(t.start,e)?n="start":qt(t.end,e)?n="end":n="inside"),n},jr=(e,t)=>An(t,{hours:e.getHours(),minutes:e.getMinutes(),seconds:e.getSeconds(),milliseconds:e.getMilliseconds()}),Hy=(e,t)=>{if(e&&t===void 0)return null;const r=t||Gn(Rt(new Date));return r instanceof Date?Gn(r):r},Ny=(e,t)=>{if(!(t!=null&&t.start))return!1;try{const r=t.start.getFullYear(),n=t.start.getMonth();if(e.getFullYear()<r||e.getFullYear()===r&&e.getMonth()<=n)return!0}catch(r){console.warn("Invalid available range:",t,r)}return!1},Vy=(e,t)=>{if(!(t!=null&&t.end))return!1;try{const r=t.end.getFullYear(),n=t.end.getMonth();if(e.getFullYear()>r||e.getFullYear()===r&&e.getMonth()>=n)return!0}catch(r){console.warn("Invalid available range:",t,r)}return!1},Uy=(e,t)=>{if(!t)return!1;const{start:r,end:n}=t;try{if(r&&e<r&&!qt(e,r)||n&&e>n&&!qt(e,n))return!0}catch(o){console.warn("Invalid available range:",t,o)}return!1},Gy=(e,t)=>t?t.some(r=>qt(e,r)):!1,Yy=d.div`
...
`,Zy=d.div`
  ...
  align-items: center;
  gap: 4px;
`,Ky=d.div``,mo=({icon:e,hasFlipArrow:t=!1,isSortAscending:r=!1,isOpen:n,design:o="default",children:a,formAction:l,...c})=>i.jsx(Qy,{type:"button",...c,$isOpen:n,$hasFlipArrow:t,$design:o,children:i.jsxs(Zy,{children:[i.jsx(Jy,{$isSortAscending:r,children:i.jsx(B,{icon:e,size:12,weight:"light",color:"filter-button-icon-color"})}),i.jsx(Ky,{$hasFlipArrow:t,children:i.jsx(i.Fragment,{children:a})}),t&&i.jsx(fa,{$design:o,children:i.jsx(B,{icon:n?"Up":"Down",size:6,color:"grey-11"})})]})}),Or=d.div`
  font-family: var(--font-ui);
  display: block;
  color: var(--grey-12);
  font-size: 14px;
...
`,s2=d.div`
  ...
  `};
`,l2=(e,t,r)=>{let n="bottom-right";const o=e.left+t>window.innerWidth,a=e.bottom+r>window.innerHeight,l=e.bottom>r;return o&&a&&l&&(n="top-left"),a&&!o&&l&&(n="top-right"),!a&&o&&(n="bottom-left"),n},Fa=s.forwardRef(({buttonIcon:e,buttonText:t,disabled:r=!1,minWidth:n=270,minHeight:o=190,isSortAscending:a,design:l="default",noCloseOnClickOutside:c,children:u,onToggleOpenCallback:h=()=>{},onCloseCallback:f=()=>{},...g},b)=>{const[p,v]=s.useState({isOpen:!1,position:"bottom-right"}),y=s.useRef(null),C=s.useRef(null),k=s.useCallback(()=>{c||(p.isOpen&&f(),v(L=>({...L,isOpen:!1})))},[c,f,p.isOpen]);rn(C,k);const S=s.useCallback((L,_)=>{if(!y.current)return;const T=y.current.getBoundingClientRect();if(!T)return;const x=l2(T,L,_);h(!p.isOpen),v($=>{const z=!$.isOpen;return{...$,isOpen:z,position:x}})},[h,p.isOpen]),E=s.useCallback(()=>{v(L=>({...L,isOpen:!1}))},[]);return s.useImperativeHandle(b,()=>({imperativeClose:E})),i.jsxs(a2,{ref:C,...g,children:[i.jsx(i2,{ref:y,children:i.jsx(mo,{icon:e,isOpen:p.isOpen,onClick:()=>S(n,o),disabled:r,isSortAscending:a,design:l,hasFlipArrow:!0,children:t})}),i.jsx(s2,{$openState:p,$disabled:r,$minWidth:n,children:i.jsx(i.Fragment,{children:u})})]})}),c2=d.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,h2=d.div`
  ...
  align-items: center;
  gap: 8px;
`,g2=({resetText:e="Reset",cancelText:t="Cancel",closeText:r="Close",applyText:n="Apply",hasReset:o=!1,hasApply:a=!1,disableApply:l=!1,disableReset:c=!0,onReset:u=()=>{},onCancel:h=()=>{},onApply:f=()=>{}})=>i.jsxs(u2,{children:[i.jsx(f2,{children:o&&i.jsx(Se,{size:"small",design:"text-only",disabled:c,onClick:u,children:e})}),a&&i.jsxs(h2,{children:[i.jsx(Se,{size:"small",design:"secondary",onClick:h,children:l?r:t}),i.jsx(Se,{size:"small",onClick:f,disabled:l,children:n})]})]}),p2=d.div`
  display: inline-block;
  position: relative;
`,bc=d(qn)`
  letter-spacing: 0.2px;
...
`,$2=d.div`
  ...
  transform: translateX(-50%);
  pointer-events: none;
`,S2=(e,t)=>{let r=!1;return Array.isArray(t)?t.forEach(n=>{n.value===e.value&&(r=!0)}):$e(t)&&(r=e.value===t.value),r},C2=(e,t,r)=>{let n=!1;if(r==="checkbox"){const o=Array.isArray(t)?t:$e(t)?[t]:[],a=[];return o.forEach(l=>{e.value===l.value?n=!0:a.push(l)}),n||a.push(e),a.length===0?null:a}return e},Mr=(e,t)=>{if(e.length<=1)return e;const r=[...e],n=document.documentElement.lang||"en";return r.sort((o,a)=>{const l=o.text.localeCompare(a.text,n);return t?l:-l}),r},gt=(e,t,r,n)=>{if(e.length<=t||r===null)return Mr(e,n);if($e(r)){const o=e.findIndex(c=>c.value===r.value);if(o===-1||o<t)return Mr(e,n);const a=e.filter(c=>c.value!==r.value),l=Mr(a,n);return l.unshift(e[o]),l}if(Array.isArray(r)){const o=new Set(r.map(h=>h.value)),a=[],l=[];for(const h of e)o.has(h.value)?a.push(h):l.push(h);const c=Mr(a,n),u=Mr(l,n);return[...c,...u]}return e},E2=(e,t)=>e.filter(r=>r.text.toLowerCase().includes(t.toLowerCase())),j2=(e,t,r)=>e.replace("[TOTAL]",`${r}`).replace("[VISIBLE]",`${t}`),M2=(e,t)=>e===null&&t===null?!0:e===null||t===null?!1:Array.isArray(e)&&Array.isArray(t)?e.length!==t.length?!1:e.every(r=>t.some(n=>n.value===r.value)):Array.isArray(e)||Array.isArray(t)?!1:e.value===t.value,L2=({buttonIcon:e,buttonText:t,list:r,selected:n=null,disabled:o=!1,isLoading:a=!1,loadingText:l,optionType:c="text",hasOptionsFilter:u,searchPlaceholder:h,maxDisplayedItems:f=5,searchResultText:g="Showing [VISIBLE] of [TOTAL]",emptyResultText:b,design:p="default",resetText:v,cancelText:y,closeText:C,applyText:k,hasReset:S,hasApply:E,descendingText:L="Descending",ascendingText:_="Ascending",isListAscending:T=!0,onSelect:x=()=>{},onResetCallback:$=()=>{},onCancelCallback:z=()=>{},...R})=>{const[j,I]=s.useState(T),[P,A]=s.useState(gt(r,f,n,j)),[D,W]=s.useState(""),[F,V]=s.useState(n),N=s.useRef(null),J=s.useCallback(()=>{A(gt(r,f,F,j))},[j,r,f,F]),ve=s.useCallback(()=>{W(""),V(n),I(T),A(gt(r,f,n,T))},[T,r,f,n]),se=s.useCallback(K=>{const ae=C2(K,F,c);E||x(ae),V(ae),A(gt(r,f,ae,j)),W("")},[F,c,E,r,f,j,x]),Ie=s.useCallback(K=>{const ae=K.target.value.replace(/<[^>]*>/g,"").trim();if(W(ae),ae===""){A(gt(r,f,F,j));return}const Ae=E2(r,ae);A(gt(Ae,f,null,j))},[j,r,f,F]),ut=s.useCallback(()=>{var K;V(n),z(),(K=N.current)==null||K.imperativeClose()},[z,n]),X=s.useCallback(()=>{var K;x(F),(K=N.current)==null||K.imperativeClose()},[x,F]),Te=s.useCallback(()=>{E||x(null),W(""),A(gt(r,f,null,T)),V(null),I(T),$()},[E,r,f,T,$,x]),je=s.useCallback(()=>{I(K=>(A(gt(r,f,F,!K)),!K))},[r,f,F]);s.useEffect(()=>{let K=!0;return K&&(W(""),A(gt(r,f,F,j))),()=>{K=!1}},[j,r,f,F]),s.useEffect(()=>{V(n)},[n]);const ue=s.useMemo(()=>M2(F,n),[n,F]);return i.jsx(p2,{...R,children:i.jsx(Fa,{ref:N,buttonIcon:e,buttonText:t,disabled:o,design:p,onCloseCallback:J,onToggleOpenCallback:ve,noCloseOnClickOutside:E,children:i.jsxs(xo,{children:[u&&i.jsx(w2,{children:i.jsx(Jn,{type:"text",hasBorder:!1,placeholder:h,color:"dimmed",iconSize:12,value:D,onChange:Ie,noBackground:!0})}),a||!r?i.jsx(mc,{loadingText:l}):i.jsxs(x2,{children:[u&&i.jsxs(b2,{children:[i.jsx(y2,{children:j2(g,P.length,r.length)}),i.jsx(m2,{children:i.jsx(Yr,{design:"text-only",position:"left",size:"xsmall",weight:"light",onClick:je,icon:j?"FilterAscending":"FilterDescending",children:j?_:L})})]}),i.jsx(v2,{$moreItem:r.length>5,children:P.length>0?P.map((K,ae)=>{const Ae=K.value,Me=K.text;return i.jsx(bc,{title:Me,onClick:()=>se(K),selected:S2(K,F),optionType:c,value:Ae},ae)}):i.jsx(k2,{children:b})}),r.length>5&&i.jsx($2,{})]}),(E||S)&&i.jsx(g2,{hasApply:E,hasReset:S,resetText:v,cancelText:y,closeText:C,applyText:k,onCancel:ut,onApply:X,disableApply:ue,onReset:Te,disableReset:F===null&&j===T&&D===""})]})})})},z2=d.div`
  display: inline-block;
  position: relative;
`,yc=d(qn)`
  letter-spacing: 0.2px;
...
`,ts=d.button`
  ...
  `}
`,v6=({buttonText:e,disabled:t,list:r,isLoading:n,loadingText:o,isSortAscending:a=!0,selected:l,descendingText:c="Descending",ascendingText:u="Ascending",design:h="basic",onSelect:f,...g})=>{const b=s.useCallback(v=>{v.value!==l.value&&f(v,a)},[a,f,l.value]),p=s.useCallback(v=>{a!==v&&f(l,v)},[a,f,l]);return i.jsx(z2,{...g,children:i.jsx(Fa,{buttonText:e,disabled:t,isSortAscending:a,design:h,buttonIcon:"FilterSorting",children:i.jsxs(xo,{children:[n||r.length===0?i.jsx(mc,{loadingText:o}):i.jsx(T2,{children:r.map((v,y)=>i.jsx(yc,{title:v.text,optionType:"radio",selected:l.value===v.value,onClick:()=>b(v)},y))}),i.jsxs(_2,{children:[i.jsxs(ts,{$isSelected:a,onClick:()=>p(!0),children:[i.jsx(B,{icon:"FilterAscending",size:16,weight:"light"}),i.jsx(qn,{selected:a,title:u})]}),i.jsxs(ts,{$isSelected:!a,onClick:()=>p(!1),children:[i.jsx(B,{icon:"FilterDescending",size:16,weight:"light"}),i.jsx(qn,{selected:!a,title:c})]})]})]})})})},R2=d.div`
  display: inline-block;
  position: relative;
`,I2=w`
  -webkit-tap-highlight-color: transparent;
...
`,H2=(e,t,r)=>{let n="bottom-right";const o=e.left+t>window.innerWidth,a=e.bottom+r>window.innerHeight,l=e.bottom>r;return o&&a&&l?n="top-left":a&&!o&&l?n="top-right":!a&&o&&(n="bottom-left"),n},x6=({disabled:e=!1,onToggleOpenCallback:t=()=>{},onCloseCallback:r=()=>{},pageSizeOptions:n=[10,20,30,50,100],onPageSizeChange:o=()=>{},defaultPageSize:a=10,getLayout:l=()=>{},layoutText:c="Layout",pageSizeText:u="Items Per Page",contentArray:h,minWidth:f=250,minHeight:g=90,hasPageSettings:b=!0})=>{const[p,v]=s.useState({isOpen:!1,position:"bottom-right"}),y=s.useRef(null),C=s.useRef(null),[k,S]=s.useState("grid"),[E,L]=s.useState(a),_=s.useCallback(()=>{p.isOpen&&r(),v(R=>({...R,isOpen:!1}))},[r,p.isOpen]);rn(C,_);const T=s.useCallback((R,j)=>{if(!y.current)return;const I=y.current.getBoundingClientRect();if(!I)return;const P=H2(I,R,j);t(p.isOpen),v(A=>{const D=!A.isOpen;return{...A,isOpen:D,position:P}})},[t,p.isOpen]),x=s.useCallback(R=>{S(R),l(R)},[l]),$=s.useCallback(R=>{o(Number(R))},[o]);s.useEffect(()=>{L(a)},[a]);const z=i.jsx(ge.Fragment,{children:i.jsx(ir,{children:i.jsx(B,{icon:"ViewSettings",color:p.isOpen?"inverse":"dimmed",size:16})})});return i.jsxs(R2,{ref:C,children:[i.jsx(P2,{ref:y,children:i.jsx(rs,{$isActive:p.isOpen,$isInnerContextButton:!1,onClick:()=>T(f,g),children:z})}),i.jsx(A2,{$openState:p,$disabled:e,$minWidth:f,children:i.jsxs(xo,{children:[i.jsxs(O2,{children:[i.jsx(ns,{children:c}),i.jsx(W2,{children:h.map((R,j)=>i.jsx(rs,{$isInnerContextButton:j!==h.length-1,$isActive:k===R.id,onClick:()=>x(R.id),children:i.jsx(ir,{title:R.tooltipText,children:i.jsx(B,{icon:R.icon,color:k===R.id?"inverse":"dimmed",size:16})})},j))})]}),b&&i.jsxs(D2,{children:[i.jsx(ns,{children:u}),n&&i.jsx(F2,{children:i.jsx(B2,{children:i.jsx(Gl,{changeCallback:$,defaultValue:E,isCompact:!0,value:E,children:n.map((R,j)=>i.jsx("option",{value:R,children:R},j))})})})]})]})})]})},N2=470,V2=360,U2=d.div``,G2=({buttonIcon:e,buttonText:t,disabled:r,initialValue:n,dateMode:o,timeMode:a,selected:l,dateTimeTextUpper:c,dateTimeTextLower:u,timeZoneTitle:h,timeZoneValueTitle:f,lang:g,hasEmptyValue:b,availableRange:p,contentDays:v,cancelText:y="Cancel",applyText:C="Apply",hasApply:k=!0,onCloseCallback:S=()=>{},onUpdateCallback:E=()=>{},onToggleCallback:L=()=>{},onCancelCallback:_=()=>{},onApplyCallback:T=()=>{},...x})=>{const $=s.useRef(null),[z,R]=s.useState({initialValue:n,isMount:!0}),[j,I]=s.useState(!1),P=s.useRef(null),A=s.useCallback(N=>{$.current=N,E(N),I(Cb(l,N))},[E,l]),D=s.useCallback(()=>{$.current&&$.current!==l&&S($.current)},[S,l]),W=s.useCallback(N=>{!k&&$.current&&$.current!==l&&L($.current,N),N&&!z.isMount&&R(J=>({...J,isMount:!0}))},[k,z.isMount,L,l]),F=s.useCallback(()=>{var N;$.current&&$.current!==l&&($.current=l===void 0?null:l,R({initialValue:l===null?void 0:l,isMount:!1})),_(),(N=P.current)==null||N.imperativeClose()},[_,l]),V=s.useCallback(()=>{var N;$.current&&$.current!==l&&T($.current),(N=P.current)==null||N.imperativeClose()},[T,l]);return s.useEffect(()=>{let N=!0;return N&&l===null&&$.current!==null&&($.current=l,R({initialValue:void 0,isMount:!1})),()=>{N=!1}},[l]),i.jsx(U2,{...x,children:i.jsx(Fa,{ref:P,minWidth:N2,minHeight:V2,onCloseCallback:D,onToggleOpenCallback:W,noCloseOnClickOutside:k,buttonIcon:e,buttonText:t,disabled:r,children:i.jsx(xo,{children:z.isMount&&i.jsx(Fy,{dateMode:o,timeMode:a,dateTimeTextUpper:c,dateTimeTextLower:u,timeZoneTitle:h,timeZoneValueTitle:f,lang:g,availableRange:p,contentDays:v,cancelText:y,applyText:C,hasApply:k,updateCallback:A,cancelCallback:F,applyCallback:V,hasEmptyValue:!0,initialValue:z.initialValue,disableApply:j})})})})},Y2=Xe`
  0% {
    width: 50%;
    opacity: .5;
  }
...
`,J2=d.div`
  ...
  `};
`,X2=d(mo)``,Q2=d(L2)``,Z2=d(G2)``,K2=d.div`
  display: flex;
  flex-wrap: wrap;
  gap: 8px 6px;
`,ew=(e,t,r)=>e.map(({id:n,canHide:o,...a})=>!o||!t||o&&!r?i.jsx(Q2,{...a},`dropdownFilter-id-${n}`):null),tw=(e,t,r)=>e.map(({id:n,canHide:o,showFieldText:a,selected:l,...c})=>t.includes(n)?i.jsx(q2,{children:o?i.jsx(J2,{children:i.jsx(Jn,{...c,hasCrossButton:!0,onCrossClick:()=>r(n)})}):i.jsx(Jn,{...c})},`searchFilter-id-${n}`):null),rw=e=>e.map(({id:t,canHide:r,...n})=>i.jsx(Z2,{...n},`datePicker-filter-${t}`)),nw=(e,t,r)=>e.map(n=>{if(n.canHide&&!t.includes(n.id)){const o=n.id;return i.jsx(X2,{icon:"Add",onClick:()=>r(o),children:n.showFieldText},`search-button-id-${n.id}`)}return null}),ow=e=>{const t=[];return e.forEach(r=>{r.canHide||t.push(r.id)}),t},aw=({hasShowMore:e=!1,searchFilters:t=[],datePickerFilters:r=[],dropdownFilters:n=[],showMoreText:o="Show More",showLessText:a="Show Less",...l})=>{const[c,u]=s.useState(ow(t)),[h,f]=s.useState(!!e),g=s.useCallback(()=>{f(p=>!p)},[]),b=s.useCallback(p=>{if(c.includes(p)){const v=c.filter(y=>p!==y);u(v)}else{const v=[...c,p];u(v)}},[c]);return i.jsxs(K2,{...l,children:[tw(t,c,b),rw(r),ew(n,h,e),(!e||!h)&&nw(t,c,b),e&&i.jsx(mo,{icon:"FilterEllipsis",onClick:g,children:h?o:a})]})},iw=d.div`
  display: flex;
  align-items: center;
  font-size: 12px;
  min-height: 22px;
...
`,fw=d.div`
  ...
  align-items: center;
  margin-left: 10px;
`,os=(e,t)=>e.getHours()===23&&e.getSeconds()>0?be(Gt(Rt(e),{days:1}),t):be(e,t),hw=e=>{let t=!1;if(e!=="")try{be(new Date,e),t=!0}catch{t=!1}return t},gw=(e,t)=>e.replace("[TOTAL_RESULTS]",`${t}`),pw=(e,t,r,n)=>{let o="";const a=hw(t);return n&&$e(e)?o=`${n}: ${e.text}`:n&&e instanceof Date?o=a?`${n}: ${be(e,t)}`:`${n}: ${e.toDateString()}`:n&&qr(e)?o=a?`${n}: ${be(e.start,t)} - ${os(e.end,t)}`:`${n}: ${e.start.toDateString()} - ${e.end.toDateString()}`:!n&&$e(e)?o=e.text:!n&&e instanceof Date?o=a?be(e,t):e.toDateString():!n&&qr(e)&&(o=a?`${be(e.start,t)} - ${os(e.end,t)}`:`${e.start.toDateString()} - ${e.end.toDateString()}`),i.jsx(cw,{$hasIcon:!!r,children:o})},vw=({labelLists:e,totalResults:t,resultTextTemplate:r="Showing Results ([TOTAL_RESULTS]):",clearText:n="CLEAR ALL",resultsDateFormat:o="",onRemoveFilter:a=()=>{},onClearAll:l=()=>{},...c})=>i.jsxs(iw,{...c,children:[i.jsx(sw,{children:gw(r,t)}),i.jsxs(fw,{children:[e.map(({icon:u,item:h,filterName:f,filterId:g,type:b},p)=>i.jsxs(lw,{children:[u&&i.jsx(B,{icon:u,color:"dimmed",size:10,weight:"light"}),pw(h,o,u,f),i.jsx(uw,{onClick:()=>a(g,b,h),children:i.jsx(B,{icon:"CloseCompact",color:"dimmed",size:10,weight:"light"})})]},`Filter-Label-id-${p}`)),e.length>0&&i.jsx(dw,{onClick:l,children:n})]})]}),xw=d.div`
  font-family: var(--font-ui);
  color: var(--grey-10);
  font-size: 12px;
  font-weight: 700;
...
`,Ba=(e,t,r)=>{let n=!1;if(r.disabled)n=r.disabled;else if(t){const o=e.filter(a=>a.selected!==null);o&&(n=o.length>1||o[0]&&o[0].id!==r.id)}return n},bw=(e,t,r,n)=>{const o=[];return e.forEach(a=>{const l=t.find(c=>c.id===a.id);if(l){const c=Array.isArray(l.selected)||$e(l.selected)?l.selected:null,u=g=>{n(g,l.id)},h=Ba(t,r,a),f={...a,selected:c,disabled:h,onSelect:u};o.push(f)}}),o},yw=(e,t,r,n)=>{const o=[];return e.forEach(a=>{const l=t.find(c=>c.id===a.id);if(l&&!Array.isArray(l.selected)){const c=l.selected===null||!$e(l.selected)?"":l.selected.text,u=g=>{const b=g.currentTarget.value;n(b,l.id)},h=Ba(t,r,a),f={...a,value:c,disabled:h,onChange:u};o.push(f)}}),o},ww=(e,t,r,n)=>{const o=[];return e.forEach(a=>{const l=p=>{n(p,a.id)},c=(p,v)=>{v||n(p,a.id)},u=p=>{n(p,a.id)},h=Ba(t,r,a),f=t.find(p=>p.id===a.id);let g;a.selected?g=a.selected:a.initialValue&&(g=a.initialValue);const b={...a,onCloseCallback:l,onToggleCallback:c,onApplyCallback:u,disabled:h,selected:f&&(f.selected instanceof Date||qr(f.selected))?f.selected:null,initialValue:g};o.push(b)}),o},kw=(e,t,r,n)=>{const o=[];return e.forEach(a=>{const l=n.find(c=>c.id===a.id);if(l){if($e(l.selected)){const c={filterId:l.id,item:l.selected,filterName:a.name,type:l.type};o.push(c)}}else return}),t.forEach(a=>{const l=n.find(c=>c.id===a.id);if(!(!l||l.selected===null)){if(Array.isArray(l.selected))l.selected.forEach(c=>{const u={filterId:l.id,item:c,icon:a.buttonIcon,filterName:a.name,type:l.type};o.push(u)});else if($e(l.selected)){const c={filterId:l.id,item:l.selected,icon:a.buttonIcon,filterName:a.name,type:l.type};o.push(c)}}}),r.forEach(a=>{const l=n.find(c=>c.id===a.id);if(!(!l||l.selected===null||Array.isArray(l.selected)||$e(l.selected))){const c={filterId:l.id,item:l.selected,icon:a.buttonIcon,filterName:a.name,type:l.type};o.push(c)}}),o},$w=(e,t,r)=>{const n=[];return e.forEach(({id:o,value:a,selected:l})=>{let c=null;typeof a=="number"?c={text:a.toString(),value:a}:a==="string"?c={text:a,value:a}:$e(l)&&(c=l);const u={id:o,type:"search",selected:c};n.push(u)}),t.forEach(({id:o,selected:a})=>{const l={id:o,type:"dropdown",selected:$e(a)||Array.isArray(a)?a:null};n.push(l)}),r.forEach(({id:o,initialValue:a,selected:l})=>{let c=null;a?c=a:l&&(c=l),n.push({id:o,type:"datepicker",selected:c})}),n},m6=({filtersTitle:e="Filters:",hasShowMore:t,searchersConfig:r=[],dropdownsConfig:n=[],datePickersConfig:o=[],showMoreText:a,showLessText:l,resultTextTemplate:c,clearText:u,totalResults:h,singleFilter:f=!1,resultsDateFormat:g,onChangeCallback:b=()=>{},...p})=>{const[v,y]=s.useState($w(r,n,o)),C=s.useRef(n);C.current&&!b1(C.current,n)&&(C.current=n);const k=s.useRef(ll($=>S($),600)).current,S=s.useCallback($=>{const z=$.filter(R=>R.selected!==null);b(z)},[b]),E=s.useCallback(($,z)=>{y(R=>{const j=[...R],I=j.find(P=>P.id===z);return I&&I.selected!==$?(I.selected=$,S(j),j):R})},[S]),L=s.useCallback(($,z)=>{const R=[...v],j=R.find(I=>I.id===z);j&&(j.selected=$===""?null:{text:$,value:$}),k(R),y(R)},[k,v]),_=s.useCallback(()=>{const $=[...v];$.forEach(z=>{z.selected!==null&&(z.selected=null)}),S($),y($)},[v,S]),T=s.useCallback(($,z,R)=>{y(j=>{const I=[...j],P=I.find(A=>A.id===$);if(P)if(Array.isArray(P.selected)&&z==="dropdown"){const A=P.selected.filter(D=>$e(D)&&$e(R)?D.value!==R.value:!0);P.selected=A.length===0?null:A}else P.selected=null;else return j;return S(I),I})},[S]),x=s.useCallback(($,z)=>{const R=[...v],j=R.find(I=>I.id===z);j&&(j.selected=$,S(v),y(R))},[v,S]);return s.useEffect(()=>{let $=!0;return $&&C.current&&y(z=>{const R=[...z];return R.forEach(j=>{const I=C.current.find(P=>P.id===j.id);if(I){if(Array.isArray(j.selected))j.selected.forEach(P=>{const A=I.list.find(D=>D.value===P.value);A&&(P.text=A.text)});else if($e(j.selected)){const P=I.list.find(A=>j.selected===null?!1:$e(j.selected)?A.value===j.selected.value:!1);P&&(j.selected.text=P.text)}}}),R}),()=>{$=!1}},[C.current]),i.jsxs(mw,{...p,children:[i.jsx(xw,{children:e}),i.jsx(aw,{hasShowMore:t,showMoreText:a,showLessText:l,searchFilters:yw(r,v,f,L),dropdownFilters:bw(C.current,v,f,E),datePickerFilters:o?ww(o,v,f,x):void 0}),i.jsx(kc,{resultTextTemplate:c,clearText:u,totalResults:h,resultsDateFormat:g,labelLists:kw(r,C.current,o,v),onClearAll:_,onRemoveFilter:T})]})},b6=({options:e,categoryLabel:t,selectedIndex:r,design:n="basic",onToggle:o,...a})=>{const l=s.useCallback(c=>{const u=c===1?0:1;o(u,e[u].value)},[o,e]);return r!==0&&r!==1?null:i.jsxs(mo,{icon:e[r].icon,onClick:()=>l(r),design:n,...a,children:[t&&`${t}: `,`${e[r].text}`]})},Sw=d.div`
  position: relative;
  display: inline-block;
`,Cw=d.div`
  position: absolute;
...
`,Ew=d.div`
  ...
  transition: background-color var(--speed-slow) var(--easing-primary-in-out);
  background-color: ${({theme:e,$color:t})=>t?e.colors.status[t]:"var(--grey-5)"};
`,$c=({icon:e,status:t,counter:r,maxCounter:n=999})=>i.jsxs(Sw,{children:[t&&r===void 0?i.jsx(Ew,{$color:t}):r===void 0?null:i.jsx(Cw,{$color:t,children:r>n?`${n}+`:r}),i.jsx(B,{icon:e,size:18,color:"dimmed"})]}),jw=Xe`
 0% {
    transform: scale(1);
 }
...
`;const Lw=d.video`
  /* width: 800px; */
`,zw=({id:e="1",enabled:t,peerAddress:r,maxConnectionAttempts:n=30,rtcConfiguration:o={},setStatus:a=()=>{},setError:l=()=>{},autoPlay:c=!0,muted:u=!0,children:h,...f})=>{const g=s.useRef(0),b=s.useRef(null),p=s.useRef(null),v=s.useRef(null),y=s.useRef(!1),C=s.useRef(null),k=s.useRef(null),S=s.useRef(t);function E(A){l(A),I()}const L=async A=>{if(!v.current||!p.current)return;try{A.type==="offer"&&v.current.signalingState!=="stable"?await Promise.all([v.current.setLocalDescription({type:"rollback"}),v.current.setRemoteDescription(A)]):(A.sdp&&(A.sdp=A.sdp.replace(/profile-level-id=(640028|64001f|64002a);/,"")),await v.current.setRemoteDescription(new RTCSessionDescription(A)),a("Remote Description set"))}catch(W){console.error("Error:",W),l("Error Setting remote description");return}if(A.type!=="offer")return;a("Creating Answer");try{const W=await v.current.createAnswer();console.debug("Got local description: "+JSON.stringify(W)),await v.current.setLocalDescription(W)}catch(W){console.error(W),W instanceof Error&&l(W.message);return}const D={sdp:v.current.localDescription};a("Sending Local Description");try{p.current.send(JSON.stringify(D)),a("Connected")}catch(W){console.error(W),W instanceof Error&&l(W.message)}};function _(A){if(!v.current){console.error("peerConnection.current not found onIncomingICE ");return}const D=new RTCIceCandidate(A);v.current.addIceCandidate(D).catch(l)}const T=({data:A=""})=>{if(A==="HELLO")console.debug("Received HELLO"),a("Registered with server, waiting for offer.");else if(A.startsWith("ERROR"))console.error("Received "+A),E(A);else{let D;try{D=JSON.parse(A)}catch(W){W instanceof SyntaxError?E("Error parsing incoming JSON: "+A):E("Unknown error parsing response: "+A);return}v.current||j(D),D.sdp!=null?(console.debug("Received Remote SDP:"+JSON.stringify(D.sdp)),L(D.sdp)):D.ice!=null?(console.debug("Received Remote ICE:"+JSON.stringify(D.ice)),_(D.ice)):E("Unknown incoming JSON: "+D)}};function x(A){console.debug("serverClose"),!(!p.current||A.target!==p.current)&&(a("Disconnected from server"),P(),A.code!==1e3&&S.current&&y.current&&(C.current!==null&&clearTimeout(C.current),C.current=setTimeout(z,3e3)))}function $(A){A.target===p.current&&(console.debug(A),l("Unable to connect to server"),I())}function z(){if(!y.current)return;if(console.debug("connectToPeer",g.current),g.current>=n){l("Too many connection attempts, aborting. Refresh page to try again");return}l(null);const A=Tw(e);a("Connecting to server "+r);const D=new WebSocket(r);p.current=D,D.addEventListener("open",()=>{k.current!==null&&clearInterval(k.current),k.current=setInterval(()=>{try{D.send("HELLO "+A),k.current!==null&&(clearInterval(k.current),k.current=null),a("Registering with server (sent HELLO) for peer id: "+A)}catch(W){console.debug(W)}},3e3)}),D.addEventListener("error",$),D.addEventListener("message",T),D.addEventListener("close",x),g.current+=1}function R(A){b.current&&b.current.srcObject!==A.streams[0]&&(console.debug("Incoming stream"),b.current.srcObject=A.streams[0],a("Adding Track"))}function j(A){if(g.current=0,console.debug("Creating RTCPeerConnection"),!A.sdp){console.debug("WARNING: First message wasn't an SDP message!?");return}const D=new RTCPeerConnection(o);v.current=D,D.addEventListener("track",R),D.addEventListener("icecandidate",({candidate:W=null})=>{if(!W){console.debug("All local ICE Candidates sent.");return}p.current?p.current.send(JSON.stringify({ice:W})):console.debug("no WS found on peer connection 'icecandidate' event... how?")}),a("RTCPeerConnection created, waiting for SDP")}const I=()=>{console.debug("closeWebSocket"),P(),p.current&&(p.current.close(),p.current=null)},P=()=>{console.debug("closePeerConnection"),v.current&&(v.current.close(),v.current=null)};return s.useEffect(()=>{S.current=t},[t]),s.useEffect(()=>(y.current=!0,t===!0?z():p.current&&p.current.close(1e3,"WebRTC Disabled"),()=>{console.debug("cleanup"),y.current=!1,C.current!==null&&(clearTimeout(C.current),C.current=null),k.current!==null&&(clearInterval(k.current),k.current=null),I()}),[t]),i.jsx(Lw,{...f,autoPlay:c,muted:u,ref:b,children:i.jsx(i.Fragment,{children:h})})};function Tw(e){return"WRP_"+e+"_"+Math.floor(Math.random()*8990+10).toString()}d.div`
  position: relative;
  line-height: 0;
  user-select: none;
  touch-action: none;
...
`;const Sc=24,Cc=20,_w=-Cc-Sc,Rw=d.div`
  position: relative;
  display: flex;
  flex-direction: column;
  gap: 8px;
...
`,Fw=({title:e,icon:t,areaTitle:r,areaHref:n,updateDocTitle:o=!0,hideAreaInDocTitle:a=!1,areaTitleBottom:l=!1,iconColor:c="dimmed",onAreaClick:u})=>(Q5(e,a?void 0:r||"",void 0,o),i.jsxs(Rw,{children:[t?i.jsx(Aw,{children:i.jsx(B,{size:Sc,color:c,icon:t})}):null,i.jsxs(Iw,{$areaTitleBottom:l,children:[r&&u?i.jsx(Ww,{onClick:u,type:"button",children:r}):r&&n?i.jsx(Dw,{to:n,children:r}):r?i.jsx(Ow,{children:r}):null,i.jsx(Pw,{children:e})]})]})),Bw=d.p`
  font-family: var(--font-ui);
  color: var(--grey-11);
  font-size: 14px;
  font-style: normal;
...
`,Xw=d.div`
  ...
  margin-bottom: 5px;
  margin-top: 29px;
`,Qw=d.div``,y6=({title:e,icon:t,iconColor:r="primary-9",introductionText:n,areaHref:o,areaTitle:a,updateDocTitle:l=!0,hideAreaInDocTitle:c,tagList:u,areaTitleBottom:h,rightContent:f,bottomLeftContent:g,onAreaClick:b})=>i.jsxs(Gw,{children:[i.jsxs(Yw,{children:[i.jsx(Fw,{iconColor:r,title:e,icon:t,areaHref:o,areaTitle:a,updateDocTitle:l,hideAreaInDocTitle:c,areaTitleBottom:h,onAreaClick:b,bottomLeftContent:g}),u?i.jsx(Xw,{children:u.map(({icon:p,label:v,linkTo:y,onTagClick:C})=>i.jsx(jc,{icon:p||"",noBorder:!0,tagSize:"compact",label:v,linkTo:y,onTagClick:C},"tag-"))}):null,n?i.jsx(qw,{children:i.jsx(Hw,{children:n})}):null,i.jsx(Qw,{children:i.jsx(i.Fragment,{children:g})})]}),f?i.jsx(Jw,{$iconLeftPanel:!!t,children:i.jsx(i.Fragment,{children:f})}):null]}),Zw=d.div`
  display: flex;
  flex-direction: column;
`,w6=({contentArray:e})=>i.jsx(Zw,{children:e.map((t,r)=>i.jsx("div",{children:t},`element-${r}`))}),Kw=d.div`
  position: relative;
  height: inherit;
  background: grey;
  border-radius: 3px;
...
`,n3=({hoverZoom:e=!0,image:t="",mediaUrl:r,mediaType:n,retryImageLoad:o=!1,retryLimit:a=5,closeText:l,onClickThumbnail:c})=>{const[u,h]=s.useState(!!t),[f,g]=s.useState(t),{createMediaModal:b}=dy(),[p,v]=s.useState(0),y=s.useRef(null),C=s.useRef(null),k=s.useCallback(async()=>{b({src:u&&r?r:"",mediaType:n||"img",minHeight:"240px",closeText:l})},[l,b,n,r,u]);s.useEffect(()=>{h(!1),v(0),g(t)},[t]),s.useEffect(()=>{y.current&&y.current.complete&&f!==""&&(C.current&&clearTimeout(C.current),C.current=null,h(!0))},[f]);const S=s.useCallback(()=>{C.current=null,g(`${t}?v=${Date.now()}`)},[t]),E=s.useCallback(()=>{if(h(!1),!o||p>=a||C.current)return;const T=1e3*(p**2+Math.random());v(x=>x+1),C.current=setTimeout(S,T)},[p,o,a,S]),L=s.useCallback(()=>{C.current&&clearTimeout(C.current),C.current=null,h(!0)},[]),_=(T,x)=>{if(!T){x(!1);return}const $=new Image;$.src=T,$.complete?x(!0):($.onload=()=>{x(!0)},$.onerror=()=>{x(!1)})};return s.useEffect(()=>{_(t,T=>{h(!!T)})},[t]),i.jsxs(Kw,{$hoverZoom:e,$mediaUrl:r,$aspect:"16:9",onClick:c||k,children:[u?i.jsx(e3,{ref:y,src:f,onError:E,onLoad:L}):i.jsx(t3,{children:i.jsx(lb,{})}),r&&n==="video"&&i.jsx(r3,{children:i.jsx(B,{size:12,icon:"Play",color:"inverse"})})]})},o3=d.div`
  height: 42px;
  width: 4px;
  border-radius: 3px;
  display: block;
...
`,Lr=({showUnit:e=!1,showStatus:t=!1,status:r,unit:n="",cellStyle:o="normalImportance",alignment:a="left",hideDivider:l,isLastRow:c,hasCopyButton:u,href:h,children:f})=>{l=c?!0:l;const{copyToClipboard:g}=Da();return i.jsx(i3,{$cellStyle:o,$alignment:a,$hideDivider:l,$hasCopyButton:u,children:i.jsxs(i.Fragment,{children:[t?i.jsx(l3,{$status:r}):null,h?i.jsx("a",{href:h,children:f}):f,e?i.jsx(s3,{children:n}):null,u?i.jsx(Mc,{onClick:()=>typeof f=="string"&&g(f),children:i.jsx(B,{icon:"Copy",size:16})}):null]})})},c3=d.div`
  ...
  ${({$isEmpty:e})=>e&&w`
    visibility: hidden;
  `};
`,d3=({selectable:e=!1,selectCallback:t,hasStatus:r,hasThumbnail:n,hasTypeIcon:o,rowData:a,isLastRow:l,columnConfig:c,closeText:u})=>{var g,b,p,v,y,C;const h=s.useCallback(k=>{t&&t(k,a.id)},[a.id,t]),f=a.columns.length===0;return i.jsxs(c3,{$isEmpty:f,children:[e?i.jsx(Lr,{hideDivider:!0,children:i.jsx(Bl,{checked:a._checked,disabled:a.checkboxDisabled,onChangeCallback:h})}):null,r?i.jsx(Lr,{hideDivider:!0,children:i.jsx(a3,{status:(g=a.header)==null?void 0:g.status})}):null,n?i.jsx(Lr,{hideDivider:!0,children:i.jsx(n3,{image:(b=a.header)==null?void 0:b.image,mediaUrl:(p=a.header)==null?void 0:p.mediaUrl,mediaType:(v=a.header)==null?void 0:v.mediaType,closeText:u,onClickThumbnail:(y=a.header)==null?void 0:y.onClickThumbnail})}):null,o?i.jsx(Lr,{hideDivider:!0,children:i.jsx(B,{icon:((C=a.header)==null?void 0:C.icon)||"",color:"dimmed",weight:"regular",size:16})}):null,a.columns.map((k,S)=>{const{cellStyle:E,alignment:L,showUnit:_,showStatus:T,hasCopyButton:x}=c[S],{unit:$,status:z,text:R,customComponent:j}=k;return i.jsx(Lr,{href:k.href,cellStyle:E,alignment:L,showUnit:_,showStatus:T,hasCopyButton:x,unit:$,status:z,isLastRow:l,children:j||R},S)})]})},u3=d.div`
  border-bottom-right-radius: 3px;
...
`,ss=d.div`
  ...
  ${({$isLastOfGroup:e})=>e&&w`
    margin-right: 15px;
  `};
`,x3=(e,t)=>{if(t<0)return null;let r=!0;return t<e.length-1&&(r=e[t].groupTitle!==e[t+1].groupTitle),e[t].groupTitle?t!==0&&e[t-1].groupTitle===e[t].groupTitle?i.jsxs(s.Fragment,{children:[i.jsx(is,{}),i.jsx(ss,{$isLastOfGroup:r})]}):i.jsxs(s.Fragment,{children:[i.jsx(v3,{children:e[t].groupTitle}),i.jsx(ss,{$isLastOfGroup:r})]}):i.jsx(is,{})},m3=({selectable:e,hasStatus:t,hasThumbnail:r,hasTypeIcon:n,allChecked:o,disableAllChecked:a,hasHeaderGroups:l,columnConfig:c,defaultAscending:u,toggleAllCallback:h=()=>{},sortCallback:f=()=>{}})=>{const[g,b]=s.useState(c),[p,v]=s.useState(u),y=s.useCallback(k=>{h(k)},[h]),C=s.useCallback((k,S)=>{if(g[k]===void 0||!g[k].sortable)return;const E=[...g];let L=null;E.forEach((x,$)=>{x.sortActive&&(L=$),$===k?x.sortActive=!0:x.sortActive=!1});const _=L===k?!p:p,T=S===void 0?`column_${k}`:S;f(_,T),b(E),v(_)},[p,f,g]);return i.jsxs(h3,{children:[e?i.jsx(zr,{$headerStyle:"header",$fixedWidth:30,children:i.jsx(Bl,{checked:o,disabled:a,onChangeCallback:y})}):null,t?i.jsx(zr,{$headerStyle:"header",$fixedWidth:10}):null,r?i.jsx(zr,{$headerStyle:"header",$fixedWidth:70}):null,n?i.jsx(zr,{$headerStyle:"header",$fixedWidth:35}):null,c.map((k,S,E)=>{const{header:L,alignment:_,hasCopyButton:T,sortActive:x,columnId:$,sortable:z,minWidth:R}=k;return i.jsx(zr,{$alignment:_,$hasCopyButton:T,$minWidth:R,$headerStyle:l?"subHeader":"header",$isSortActive:x,children:i.jsxs(g3,{$alignment:_,children:[l&&i.jsx(p3,{children:l&&x3(E,S)}),i.jsx(f3,{header:L,sortable:z,indexKey:S,columnId:$,isSortActive:x,ascending:p,toggleSort:C})]})},S)})]})},b3=d.div``,y3=d.div`
  display: table;
  width: 100%;
  position: relative;
`,Lc=d.div`
...
`,k3=d.div`
  ...
  color: var(--grey-10);
`,$3=({_checked:e=!1})=>e===!0,S3=({checkboxDisabled:e=!1})=>e===!0,k6=({columnConfig:e,selectable:t,rows:r=[],closeText:n,hasStatus:o=!1,hasThumbnail:a=!1,hasTypeIcon:l=!1,defaultAscending:c=!1,isLoading:u=!1,loadingText:h="Loading Data...",emptyTableTitle:f="",emptyTableText:g="",hasHeaderGroups:b=!1,sortCallback:p=()=>{},selectCallback:v=()=>{},toggleAllCallback:y=()=>{}})=>{const[C,k]=s.useState(!1),[S,E]=s.useState(!1),L=r.length===1&&r[0].columns.length===0&&!u;return s.useEffect(()=>{let _=!1,T=!1;r.every($3)&&r.length>0&&!L&&(_=!0),(r.some(S3)||L||u)&&(T=!0),k(_),E(T)},[L,u,r]),i.jsx(b3,{children:i.jsxs(y3,{children:[i.jsx(m3,{selectable:t,hasStatus:o,hasThumbnail:a,hasTypeIcon:l,defaultAscending:c,allChecked:C,disableAllChecked:S,hasHeaderGroups:b,columnConfig:e,toggleAllCallback:y,sortCallback:p}),u?i.jsxs(w3,{children:[i.jsx(bt,{size:"large",styling:"primary"}),i.jsx(Lc,{children:h})]}):null,L?i.jsxs(k3,{children:[i.jsx("h3",{children:f}),i.jsx("p",{children:g})]}):null,r.map((_,T)=>{const x=r.length-1===T;return i.jsx(d3,{rowData:_,isLastRow:x,selectable:t,selectCallback:v,columnConfig:e,hasStatus:o,hasThumbnail:a,hasTypeIcon:l,closeText:n},T)})]})})},C3=d.div`
  position: relative;
  ${({theme:e})=>w`
    font-family: ${e.fontFamily.ui};
  `}
...
`,$6=({type:e="text",placeholder:t="",defaultValue:r,rowKey:n,alignment:o="left",toLink:a="",saveCallback:l,...c})=>{const[u,h]=s.useState(!1),[f,g]=s.useState(r),[b,p]=s.useState(!1),v=s.useCallback(async S=>{p(!0),l&&await l(S,n),h(!1),p(!1)},[n,l]),y=s.useCallback(async S=>{const E=S.keyCode|S.which|parseInt(S.key,10);E===13&&v&&(await v(f),h(!1)),E===27&&(g(r),h(!1))},[v,f,r]),C=s.useRef(null);return rn(C,()=>{g(r),h(!1)}),i.jsx(C3,{children:u?i.jsxs(j3,{ref:C,children:[i.jsx(Zm,{...c,autoFocus:!0,label:"",disabled:b,type:e,placeholder:t,defaultValue:r,onKeyUp:S=>y(S),onChange:S=>{g(S.target.value)}}),i.jsx(Tc,{onClick:()=>{v(f)},size:"small",loading:b,children:b?"Saving":"Save"}),!b&&i.jsx(zc,{onClick:()=>h(!1),design:"secondary",size:"small",children:"Cancel"})]}):i.jsxs(M3,{$alignment:o,children:[a?i.jsx(E3,{to:a,children:f}):f,i.jsx(ga,{icon:"Edit",weight:"light",size:16,onClick:()=>h(!0)})]})})};s.createContext({state:{},dispatch:()=>{},actions:{}});d.g`
  opacity: 0;
...
`,P3=d.div`
  ...
  height: 3px;
  width: 100%;
`,O3=({isEmptyWithIcon:e=!1,status:t="neutral",noticeIcon:r,hasNotice:n=!1,noticeMessage:o,noticeTitle:a,emptyIcon:l,...c})=>i.jsxs(L3,{children:[e?i.jsx(z3,{$hasPadding:n,children:i.jsx(B,{icon:l||"PasswordHide",color:"dimmed",size:41})}):i.jsx(hc,{...c}),n&&i.jsxs(T3,{$color:t,children:[r&&i.jsx(I3,{children:i.jsx(B,{icon:r,size:20,color:"inverse"})}),i.jsxs(A3,{children:[a&&i.jsx(R3,{children:a}),o&&i.jsx(_3,{children:o})]})]}),i.jsx(P3,{$color:t})]}),D3=d.div`
  display: flex;
  height: 60px;
`,W3=d.div`
  ${({$hasRightData:e})=>e&&w`
...
`,q3=({streamProps:e,panelMetaData:t,customBottom:r,panelOnClick:n,...o})=>i.jsxs(Y3,{onClick:n,$hasOnClick:n!==void 0,...o,children:[i.jsx(O3,{...e}),r||t&&i.jsx(G3,{...t})]}),J3=d.div`
  ...
  gap: 20px 20px;
`,S6=({panels:e})=>i.jsx(J3,{children:e.map((t,r)=>i.jsx(q3,{...t},r))}),X3=d.div`
  display: flex;
  ${Ec} {
    margin-right: 10px;
    margin-bottom: 6px;
...
`,r4=d.div`
  ...
  color: var(--grey-10);
  font-size: 12px;
`,n4=(e,t,r)=>e.replace("[SELECTED]",`${t}`).replace("[TOTAL]",`${r}`),j6=({title:e="Actions:",finishTextButton:t="Finish",actionButtons:r=[],selectedTemplate:n="Selected [SELECTED] of [TOTAL] Results",totalSelected:o=0,totalAvailable:a=0,finishCallback:l=()=>{}})=>i.jsxs(Q3,{children:[i.jsx(Z3,{children:e}),i.jsxs(K3,{children:[i.jsx(e4,{children:r.map(({design:c,size:u,position:h,text:f,...g},b)=>i.jsx(Yr,{design:c||"secondary",size:u||"small",position:h||"left",...g,children:f},b))}),i.jsx(t4,{children:i.jsx(Se,{size:"small",onClick:l,children:t})})]}),i.jsx(r4,{children:n4(n,o,a)})]}),pa=12,o4=d.div`
  display: flex;
  justify-content: flex-end;
  align-items: center;
  padding-top: 20px;
...
`,M6=e=>{const{pageText:t="Page:",totalPages:r=1,activePage:n=1,buttonText:o="GO",itemsText:a="Items Per Page",itemsDefaultValue:l,selectId:c="paginationPages",selectWidth:u="60px",selectDisabled:h=!1,itemsOptions:f=[],onPageChange:g,onItemsChange:b}=e,[p,v]=s.useState("default"),[y,C]=s.useState(n?n.toString():"1"),[k,S]=s.useState(!(parseInt(y)>r&&p!=="")),[E,L]=s.useState(!1),_=s.useRef(null),T=s.useCallback(()=>`${r.toString().length*pa+pa/2}px`,[r]),x=s.useCallback(W=>!(Un(W)||parseInt(W)>r||parseInt(W)<=0||W===""),[r]),$=s.useCallback(({target:{value:W}})=>{if(L(!1),Un(W))return;const F=W===""?"":Number(W.slice(-r.toString().length)).toString();C(F),x(F)?(v("processing"),S(!1)):(v("invalid"),S(!0),L(!0))},[x,r]),z=s.useCallback(({target:{value:W}})=>{if(W==="")C(n.toString());else if(x(W)&&parseInt(W)!==n){S(!1),v("processing");return}else if(!x(W)){v("invalid"),S(!0);return}v("default")},[n,x]),R=W=>{W.key==="Enter"&&x(y)&&I()},j=({target:{value:W}})=>{x(W)?v("processing"):(v("invalid"),S(!0))},I=s.useCallback(()=>{g(parseInt(y)),_.current&&_.current.blur(),S(!0),v("default")},[g,y]),P=W=>{g(W),C(W.toString())},A=s.useCallback(W=>{b(Number(W))},[b]),D=W=>{const V=(W.clipboardData||window.clipboardData).getData("text");/^\d+$/.test(V)||W.preventDefault()};return s.useEffect(()=>{if(!n||!x(n?n.toString():"")){console.warn("Pagination: invalid activePage prop value was sent");return}C(n.toString())},[n,x]),i.jsxs(o4,{children:[i.jsx(u4,{$width:u,children:i.jsx(Gl,{disabled:h,label:{htmlFor:c,text:a,direction:"row"},defaultValue:l||f[0].value||1,changeCallback:A,children:i.jsx(s.Fragment,{children:f.map(({value:W,textValue:F},V)=>i.jsx("option",{value:W,children:F},V))})})}),i.jsxs(Ze,{labelText:t,htmlFor:"goButton",direction:"row",children:[i.jsxs(l4,{$borderColorState:p,$shouldShake:E,children:[i.jsx(i4,{ref:_,value:y,onChange:W=>$(W),onFocus:W=>j(W),onBlur:W=>z(W),onPaste:W=>D(W),onKeyDown:R,$maxWidth:T()}),i.jsx(a4,{children:"/ "+r.toString()}),i.jsx(c4,{id:"goButton",size:"small",design:"primary",disabled:k,onClick:I,children:o})]}),i.jsxs(d4,{children:[i.jsx(ls,{onClick:()=>P(n-1),disabled:n<=1,$active:p==="default"&&n>1,children:i.jsx(B,{icon:"Left",color:"input-lead-icon",size:8})}),i.jsx(ls,{onClick:()=>P(n+1),disabled:n>=r,$active:p==="default"&&n<r,children:i.jsx(B,{icon:"Right",color:"input-lead-icon",size:8})})]})]})]})},f4=d.div``,h4=d.div`
  font-size: 20px;
  font-weight: 400;
  text-align: left;
...
`,L4=({showBreadcrumbs:e=!0,breadcrumbs:t=[],showHomeIcon:r=!0,back:n,share:o,$iconInGutter:a})=>{const{isLarge:l}=Wa(),c=a!==void 0?a:l,u=e&&t.length>0;return i.jsxs(w4,{children:[i.jsxs(k4,{children:[n&&i.jsx(y4,{$showDivider:u,$iconInGutter:c,...n}),u?i.jsx($4,{children:t.map((h,f)=>{const{text:g,href:b,onClick:p}=h,v=f===0,y=f===t.length-1,C=i.jsxs(ge.Fragment,{children:[v&&r?i.jsx(Ac,{children:i.jsx(B,{icon:"Home",size:11,color:"grey-10"})}):null,g]});return i.jsx(ge.Fragment,{children:i.jsxs(S4,{children:[p?i.jsx(E4,{onClick:p,type:"button",children:C}):b?i.jsx(C4,{to:b,children:C}):i.jsx(j4,{children:C}),y?null:i.jsx(Ic,{children:i.jsx(B,{icon:"Right",size:6,color:"grey-8"})})]})},f)})}):null]}),i.jsx(M4,{children:i.jsx(x4,{...o})})]})},Ke=ge.createContext({selected:"",setSelected:()=>{}}),Na=({children:e})=>{const[t,r]=s.useState("");return i.jsx(Ke.Provider,{value:{selected:t,setSelected:r},children:e})},z4=d.div`
  display: flex;
  align-items: center;
  flex-direction: column;
  position: relative;
...
`,O4=d.div`
  ...
  `}
`,D4=({state:e="default",layout:t="horizontal",arrowDirection:r})=>i.jsx(O4,{$layout:t,children:i.jsxs(ma,{children:[i.jsx(Xn,{}),i.jsx(I4,{children:e==="default"?i.jsxs(A4,{$layout:t,width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[i.jsx("path",{d:"M13 14.875V5.125",strokeLinecap:"round",strokeLinejoin:"round"}),i.jsx("path",{d:"M10 14.875V5.125",strokeLinecap:"round",strokeLinejoin:"round"}),i.jsx("path",{d:"M7 14.875L7 5.125",strokeLinecap:"round",strokeLinejoin:"round"})]}):i.jsx(P4,{$direction:r,width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:i.jsx("path",{d:"M7.25 4.375L12.61 9.735C12.6803 9.80525 12.7199 9.90058 12.7199 10C12.7199 10.0994 12.6803 10.1948 12.61 10.265L7.25 15.625",stroke:"#9BA1A6",strokeLinecap:"round",strokeLinejoin:"round"})})}),i.jsx(Xn,{})]})}),W4=d.div`
  position: absolute;
  z-index: 10;
  bottom: 20px;
  left: 20px;
...
`,B4=d.section`
  ...
  ${({$reverse:e})=>e==="true"?w`
    ...
    ${ya}{ order: 1; }
  `:null}
`,H4=s.forwardRef(({mainArea:e,sideArea:t,layout:r="horizontal",reverse:n,dividerSize:o=16,persist:a=!1,persistenceKey:l="resizable_ui",showDebug:c},u)=>{const f="resizable_layout_"+l,g=1,b=50,p=t.defaultSize||350,v=t.minSize||0,y=t.maxSize,C=e.minSize,[k,S]=s.useState(!1),[E,L]=s.useState(),[_,T]=s.useState(),[x,$]=s.useState(),[z,R]=s.useState(t.defaultCollapsed?"collapsed":"open"),[j,I]=s.useState(p),[P,A]=s.useState(p),[D,W]=s.useState(p),F=s.useRef(null),V=s.useRef(null),[N,J]=Ho(`${f}_size`,null),[ve,se]=Ho(`${f}_state`,null),[Ie,ut]=Ho(`${f}_quick_open_size`,null);s.useEffect(()=>{k||(a&&(N&&I(N),ve&&R(ve),Ie&&W(Ie)),S(!0))},[k,a,ve,N,Ie]),s.useEffect(()=>{!k||!t.onSideAreaStateChange||t.onSideAreaStateChange(z)},[k,t,z]),s.useImperativeHandle(u,()=>({open:()=>{je()},close:()=>{Te()},reset:()=>{X()}}));const X=s.useCallback(()=>{I(p),R("open"),J(null),se(null)},[I,p,R,J,se]),Te=s.useCallback(()=>{R("collapsed"),I(g),A(g),a&&(J(g),se("collapsed"),ut(P))},[I,R,se,J,ut,P,a]),je=s.useCallback(()=>{R("open");let Ve;j>g&&V.current?Ve=r==="horizontal"?V.current.clientWidth:V.current.clientHeight:Ve=D,A(Ve),I(Ve),a&&(J(Math.round(j)),se("open"))},[a,se,J,D,j,r]),ue=s.useCallback(()=>{z==="collapsing"&&j<v-b?Te():(A(Math.round(j)),W(Math.round(j)),je()),$(!1)},[Te,je,v,j,z]),K=s.useCallback(Ve=>{Ve.preventDefault();const{clientX:At,clientY:Pt}=Ve;A(z==="collapsed"?j:Tr(j,v,y)),L({x:At,y:Pt}),T({x:0,y:0}),$(!0)},[j,y,v,z]),ae=()=>{x&&ue()},Ae=s.useCallback(Ve=>{var on,an;const{clientX:At,clientY:Pt}=Ve;let yt,wt=z;if(x&&E&&P){if(T({x:E.x-At,y:E.y-Pt}),r==="horizontal"){const Pe=(((on=F.current)==null?void 0:on.clientWidth)??0)-o-(C||0);n?yt=Tr(P-(E.x-At),null,Pe):yt=Tr(P+(E.x-At),null,Pe)}else{const Pe=(((an=F.current)==null?void 0:an.clientHeight)??0)-o-(C||0);n?yt=Tr(P-(E.y-Pt),null,Pe):yt=Tr(P+(E.y-Pt),null,Pe)}if(t.collapsable){const Pe=yt<v-b;z==="open"&&Pe||z==="opening"&&Pe?wt="collapsing":z==="collapsing"&&!Pe?wt="open":z==="collapsed"?wt="peeking":z==="peeking"&&!Pe&&(wt="opening")}I(yt),R(wt)}},[I,T,x,E,P,z,r,o,C,v,n,t.collapsable]),Me=s.useCallback(()=>{x&&ue()},[x,ue]);s.useEffect(()=>(document.addEventListener("mouseleave",Me),()=>{document.removeEventListener("mouseleave",Me)}),[Me]);const Ne=()=>z==="collapsed"||z==="peeking"?r==="horizontal"?n?"right":"left":n?"down":"up":r==="horizontal"?n?"left":"right":n?"up":"down",nn=()=>z==="collapsed"||z==="peeking"||z==="collapsing"?"arrow":"default",yo=i.jsxs(W4,{children:[i.jsxs("div",{children:[i.jsx("span",{children:"State:"})," ",z]}),i.jsxs("div",{children:[i.jsx("span",{children:"Position:"})," ",E==null?void 0:E.x,", ",E==null?void 0:E.y]}),i.jsxs("div",{children:[i.jsx("span",{children:"Difference:"})," ",_==null?void 0:_.x,", ",_==null?void 0:_.y]}),i.jsxs("div",{children:[i.jsx("span",{children:"sideAreaStartBasis:"})," ",P]}),i.jsxs("div",{children:[i.jsx("span",{children:"sideAreaBasis:"})," ",j]}),i.jsxs("div",{children:[i.jsx("span",{children:"lastOpenSize:"})," ",D]})]});return i.jsxs(B4,{ref:F,onPointerMove:Ae,onPointerUp:ae,$initialised:k?"true":"false",$layout:r,$reverse:n?"true":"false",children:[i.jsx(ba,{$layout:r,$minDimension:C,children:i.jsx(i.Fragment,{children:e.content})}),i.jsx(ya,{onPointerDown:K,onDoubleClick:X,$size:o,$fauxHover:x?"true":"false",children:i.jsx(D4,{state:nn(),layout:r,arrowDirection:Ne()})}),i.jsx(F4,{ref:V,style:{flexBasis:`${j}px`},$defaultSize:p,$minDimension:v,$maxDimension:y,$layout:r,$collapseState:z,children:i.jsx(Nt,{children:i.jsx(i.Fragment,{children:t.content})})}),c?yo:null]})}),Tr=(e,t,r)=>{let n=e;return n=r&&n>r?r:n,n=t&&n<t?t:n,n},Dc=50,Wc=68,N4=d.div`
  display: flex;
`,V4=d.div``;d.div`
  padding: 0;
  flex: 1;
...
`,pk=d.div`
  ...
  flex-direction: column;
  height: 100%;
`,vk=({content:e,home:t="/",logoMark:r,logoText:n,keepOpenText:o="Keep Open",autoHideText:a="Auto-Hide",supportUrl:l,supportText:c="Help & Support",defaultMenuOpen:u=!0,canAlwaysPin:h=!1,onMenuToggle:f=()=>{}})=>{const{menuState:g,setMenuOpen:b,setMenuClose:p,togglePinned:v}=K4(u,h),[y,C]=s.useState(0),k=dt(),S=s.useCallback(T=>{T.pointerType!=="touch"&&b()},[b]),E=s.useCallback(()=>{p()},[p]),L=s.useCallback(T=>{T.pointerType!=="touch"&&v()},[v]);s.useEffect(()=>{f(g.isMenuOpen)},[g.isMenuOpen,f]);const _=s.useCallback(T=>{T!==-1&&C(y!==T?T:-1)},[C,y]);return i.jsx(hk,{$isPinned:g.isMenuPinned,children:i.jsx(i.Fragment,{children:gr.createPortal(i.jsx(gk,{$open:g.isMenuOpen,$desktopSize:g.desktopSize,onPointerEnter:g.isMenuPinned?()=>{}:S,onTouchStart:()=>console.debug("touch"),onMouseLeave:g.isMenuPinned?()=>{}:E,children:i.jsxs(pk,{children:[i.jsxs(sk,{to:t,children:[i.jsx(lk,{children:r?i.jsx(ck,{type:"image/svg+xml",data:r}):i.jsx(Wl,{})}),i.jsx(Vc,{children:n?i.jsx(dk,{type:"image/svg+xml",data:n}):i.jsx(ib,{})})]}),i.jsx(uk,{children:e.items.map((T,x)=>i.jsx(Nc,{topLevelPath:Yl(k.pathname),contextKey:x,menuOpen:g.isMenuOpen,submenuOpen:x===y&&g.isMenuOpen,onClickCallback:_,item:T,focusedContext:y},x))}),i.jsxs(fk,{children:[l&&i.jsx(hs,{children:i.jsx(Qn,{compact:!0,isActive:!1,icon:"Question",title:c,href:l,menuOpen:g.isMenuOpen})}),g.canPin?i.jsx(hs,{children:i.jsx(Qn,{compact:!0,isActive:!1,icon:g.isMenuOpen&&g.isMenuPinned?"Left":"Menu",title:g.isMenuPinned?o:a,onClickCallback:L,menuOpen:g.isMenuOpen})}):null]})]})}),document.body)})})},xk=d.div`
  margin: 10px 10px;
...
`,Sk=d.pre`
  ...
  margin-top: -23px;
`,Ck=d.div`
`,Ek=({item:e,onUserDrawerMetaClick:t,copySuccessMessage:r,includeCopyTitle:n})=>{const{icon:o,title:a,subTitle:l,notes:c,hasCopyIcon:u}=e,{copyToClipboard:h}=Da(),[f,g]=s.useState(!1),[b,p]=s.useState("dimmed"),v=s.useCallback((k,S,E)=>{let L;n?L=(k||"")+`
`+(S||"")+`
`+(E||""):L=(S||"")+`
`+(E||""),h(L),g(!0),setTimeout(()=>{g(!1)},1500)},[n,h]),y=s.useCallback(()=>{p("mono")},[]),C=s.useCallback(()=>{p("dimmed")},[]);return i.jsx(s.Fragment,{children:a!==""&&i.jsx(Uc,{onClick:t,children:i.jsxs(xk,{children:[i.jsxs(kk,{children:[i.jsxs(wk,{children:[i.jsx(B,{icon:o,size:10,color:"dimmed"}),i.jsx(mk,{title:a,children:a})]}),i.jsxs(Ck,{children:[f&&i.jsx(Sk,{children:r!==""?r:"Copied!"}),u?i.jsx($k,{onClick:()=>v(a,l,c),onMouseEnter:y,onMouseLeave:C,children:i.jsx(B,{icon:"Copy",size:12,color:b})}):null]})]}),l!==""?i.jsx(bk,{title:l,children:l}):null,c!==""?i.jsx(yk,{title:c,children:c}):null]})})})},jk=d.div`
...
`,Wk=d.div`
  ...
  color: var(--grey-11);
  opacity: 0.5;
`,Fk=e=>{if(e)return document.documentElement.setAttribute("lang",e),e;const t=navigator.language.split("-")[0],r=document.documentElement.lang;return r||(document.documentElement.setAttribute("lang",t),t)},Gc=({hasLanguage:e=!1,selectedLanguageText:t="",languageOptionsText:r="LANGUAGE / 言語",selectedLangAttribute:n,hasLogout:o=!0,logoutLink:a="/logout",logoutText:l="Logout",hasCurrentUser:c=!0,currentUserText:u="Current User",accountOptionText:h="Account Options",userSubmenu:f=[],userDrawerBespoke:g,loggedInUser:b,hasSwitchTheme:p=!1,isLightMode:v=!0,switchThemeText:y="SWITCH THEME",selectedThemeText:C="",onLogout:k=()=>{},onLanguageToggle:S=()=>{},closeOnClick:E,onThemeToggle:L=()=>{},userDrawerFooter:_={icon:"",title:""},copySuccessMessage:T,includeCopyTitle:x,onUserDrawerMetaClick:$=()=>{},userDrawerMeta:z,hasUserDrawerMeta:R,hasUserDrawerFooter:j})=>{const{icon:I,title:P}=_,A=s.useCallback(async W=>{W.preventDefault(),await k(),window.location.assign(a),E&&E()},[E,a,k]),D=s.useCallback(()=>{E&&E()},[E]);return s.useEffect(()=>{Fk(n)},[n]),i.jsxs(s.Fragment,{children:[i.jsx(Tk,{children:i.jsxs(i.Fragment,{children:[c?i.jsxs(Rk,{children:[i.jsx(ps,{children:u}),b]}):null,R?i.jsx(Dk,{children:z==null?void 0:z.map((W,F)=>i.jsx(Ek,{onUserDrawerMetaClick:$,item:W,includeCopyTitle:x,copySuccessMessage:T},F))}):null,f.length>0?i.jsxs(Ik,{children:[i.jsx(ps,{children:h}),i.jsx(vs,{children:f.map(({text:W,href:F},V)=>i.jsx(xs,{children:i.jsx(ms,{to:F,onClick:D,children:W})},V))})]}):null,g||null,o?i.jsx(Ak,{children:i.jsx(vs,{children:i.jsx(xs,{children:i.jsx(ms,{onClick:A,to:a,children:l})})})}):null]})}),i.jsxs(_k,{children:[p&&i.jsx(gs,{icon:v?"LightMode":"DarkMode",title:y,subTitle:C,onClickCallback:L}),e&&i.jsx(gs,{icon:"Language",title:r,subTitle:t,onClickCallback:S}),j?i.jsxs(Ok,{title:P,icon:I,children:[I?i.jsx(Pk,{children:i.jsx(B,{icon:I,size:14,color:"dimmed"})}):null,i.jsx(Wk,{icon:I,children:P})]}):null]})]})},Bk=d.div`
  display: flex;
  flex-direction: row;
  align-items: center;
...
`,Kk=d.div`
  ...
  `};
`,e7=({text:e,color:t,linkHref:r,linkTo:n,linkText:o,onClick:a})=>{const l=s.useRef(null),c=s.useRef(null),[u,h]=s.useState(!1),[f,g]=s.useState(!1),[b,p]=s.useState(0);s.useEffect(()=>{h(!1);const S=setTimeout(()=>{var T,x;const E=((T=l.current)==null?void 0:T.getBoundingClientRect().width)??0,L=((x=c.current)==null?void 0:x.getBoundingClientRect().width)??0,_=E>=L?E:L;p(Math.ceil(_)),h(!0)},100);return()=>clearTimeout(S)},[e,o]);const v=s.useMemo(()=>i.jsx(Jc,{ref:l,children:e}),[e]),y=s.useMemo(()=>a||n||r?i.jsx(Xc,{ref:c,children:o||e}):null,[a,n,r,o,e]),C=s.useMemo(()=>u?i.jsx(s.Fragment,{children:f?y:v}):i.jsxs(s.Fragment,{children:[v,y]}),[u,f,v,y]),k=s.useMemo(()=>a?i.jsx(Zk,{$themeColor:t,children:i.jsx("button",{onClick:a,type:"button",children:C})}):n?i.jsx(ws,{$themeColor:t,children:i.jsx(Ee,{to:n,children:C})}):r?i.jsx(ws,{$themeColor:t,children:i.jsx("a",{href:r,children:C})}):i.jsx(Qk,{$themeColor:t,children:v}),[a,n,r,t,C,v]);return i.jsx(Kk,{$ready:u,$minWidth:b,onPointerEnter:()=>u&&g(!0),onPointerLeave:()=>u&&g(!1),children:k})},t7=d.div`
  z-index: 9;
  position: sticky;
  top: 0;
  height: 56px;
...
`,c7=d.div`
    overflow-y: scroll;
    margin-right: -17px;
`,d7=({hasNotifications:e=!1,hasLanguage:t=!1,selectedLanguageText:r="",languageOptionsText:n,selectedLangAttribute:o,hasLogout:a=!0,logoutLink:l="/logout",logoutText:c="Logout",hasSearch:u=!1,hasCurrentUser:h=!0,currentUserText:f="Current User",accountOptionText:g="Account Options",searchPlaceholder:b="Search for devices, analysis tasks, etc.",userSubmenu:p=[],userDrawerBespoke:v,loggedInUser:y,notificationsHistory:C,customDrawer:k,hasSwitchTheme:S=!1,isLightMode:E=!0,switchThemeText:L="SWITCH THEME",selectedThemeText:_="",onLogout:T=()=>{},onLanguageToggle:x=()=>{},onThemeToggle:$=()=>{},userDrawerFooter:z,userDrawerMeta:R,onUserDrawerMetaClick:j=()=>{},hasUserDrawerMeta:I,copySuccessMessage:P,includeCopyTitle:A,hasUserDrawerFooter:D,badge:W})=>{const[F,V]=s.useState(null),N=J=>{V(ve=>ve===J?null:J)};return i.jsx(t7,{children:i.jsxs(i.Fragment,{children:[u?i.jsxs(n7,{children:[i.jsx(o7,{children:i.jsx(B,{icon:"Search",size:16,color:"grey-6"})}),i.jsx(a7,{placeholder:b})]}):i.jsx("div",{}),i.jsxs(r7,{children:[W&&i.jsx(e7,{...W}),i.jsxs(i7,{children:[k&&i.jsx(Vo,{$isActive:F==="custom",onClick:()=>N("custom"),children:i.jsx($c,{...k})}),e&&i.jsx(Vo,{$isActive:F==="notifications",onClick:()=>N("notifications"),children:i.jsx(B,{icon:"Notifications",size:20,color:"dimmed"})}),i.jsx(Vo,{$isActive:F==="user",onClick:()=>N("user"),children:i.jsx(B,{icon:"UserProfile",size:20,color:"dimmed"})})]})]}),gr.createPortal(i.jsxs(l7,{children:[i.jsx(Uo,{$isOpen:F==="user",children:i.jsx(Gc,{hasLanguage:t,hasLogout:a,logoutLink:l,logoutText:c,hasCurrentUser:h,currentUserText:f,accountOptionText:g,userSubmenu:p,userDrawerBespoke:v,loggedInUser:y,onLogout:T,onLanguageToggle:x,selectedLanguageText:r,languageOptionsText:n,selectedLangAttribute:o,hasSwitchTheme:S,isLightMode:E,switchThemeText:L,selectedThemeText:_,onThemeToggle:$,onUserDrawerMetaClick:j,userDrawerFooter:z,userDrawerMeta:R,hasUserDrawerMeta:I,copySuccessMessage:P,includeCopyTitle:A,hasUserDrawerFooter:D})}),e?i.jsx(Uo,{$isOpen:F==="notifications",$baseWidth:"300px",children:i.jsx(c7,{children:C?i.jsx(Yc,{...C}):null})}):null,k&&i.jsx(Uo,{$isOpen:F==="custom",$baseWidth:k.width?k.width:"200px",children:i.jsx(i.Fragment,{children:k.customComponent})})]}),document.body)]})})},Zc=d.div`
  display: flex;
  flex-direction: row;
`,Kc=({children:e,defaultTabId:t})=>{const{setSelected:r}=s.useContext(Ke);return s.useEffect(()=>{r(t)},[t,r]),i.jsx(Zc,{children:i.jsx(i.Fragment,{children:e})})},u7=d.div`
  margin-right: 39px;
  display: flex;
  align-items: center;
  line-height: 20px;
`,f7=d.label`
  ...
  flex-shrink: 0;
  user-select: none;
`,T6=({children:e,tabFor:t,onClick:r,...n})=>{const{selected:o,setSelected:a}=s.useContext(Ke),l=s.useCallback(c=>{r&&r(c),a(t)},[r,a,t]);return i.jsx(u7,{...n,onClick:l,children:i.jsx(f7,{$active:o===t,children:i.jsx(i.Fragment,{children:e})})})},h7=d.div`
`,Wr=({children:e,tabId:t,...r})=>{const{selected:n}=s.useContext(Ke);return n===t?i.jsx(h7,{...r,children:i.jsx(i.Fragment,{children:e})}):null},g7=d.button`
  ${oe}
  flex-basis: auto;
  flex-grow: 1;
`,p7=d.div`
  ...
  `}
`,bn=({tabFor:e,icon:t,closeId:r,counter:n,status:o,customComponent:a,...l})=>{const{selected:c,setSelected:u}=s.useContext(Ke),h=s.useCallback(f=>{u(c===f?r:f)},[r,c,u]);return i.jsx(g7,{...l,onClick:()=>h(e),children:i.jsx(p7,{$isActive:c===e,children:i.jsx($c,{icon:t,status:o,counter:n})})})},v7=d.div`
  display: flex;
  align-items: center;
  margin-right: 22px;
  padding-bottom: 7px;
...
`,_6=({defaultTabId:e,tabList:t,paddingLeft:r})=>i.jsx(w7,{children:i.jsxs(Na,{children:[i.jsx(k7,{$paddingLeft:r,children:i.jsx(Kc,{defaultTabId:e,children:t.map(({icon:n,title:o,subtitle:a,tabFor:l})=>i.jsx(y7,{icon:n,title:o,subtitle:a,tabFor:l},`tabWithIcon-${l}`))})}),t.map(({tabFor:n,customComponent:o})=>i.jsx(Wr,{tabId:n,children:o},`TabContent-${n}`))]})}),$7=d.button`
  ${oe}
...
`,C7=d.div`
  text-transform: uppercase;
`,E7=({closeId:e,closeText:t="CLOSE MENU",children:r,formAction:n,...o})=>{const{setSelected:a}=s.useContext(Ke);return i.jsxs($7,{onClick:()=>a(e),...o,children:[i.jsx(S7,{children:i.jsx(B,{icon:"CloseCompact",color:"dimmed",size:16})}),i.jsx(C7,{children:t})]})},j7=d.div`
  position: relative;
...
`,M7=d.div`
  ...
  height: 100%;
  width: 100%;
`,L7=({closeId:e,children:t})=>{const{selected:r}=s.useContext(Ke);return r===e?null:i.jsx(j7,{children:i.jsx(M7,{children:i.jsx(i.Fragment,{children:t})})})},z7=d.div``,ks=d.div`
  padding: 14px 0;
  border-bottom: 1px solid var(--dividing-line);
`,T7=({content:e,supportUrl:t,supportText:r="Help & Support",closeId:n})=>{const[o,a]=s.useState(0),l=dt(),{setSelected:c}=s.useContext(Ke),u=s.useCallback(f=>{(f===-1||!e.items[f].submenu)&&c(n),f!==-1&&a(o!==f?f:-1)},[n,e.items,o,c]),h=s.useCallback(()=>{c(n)},[n,c]);return i.jsxs(z7,{children:[e.items.map((f,g)=>i.jsx(ks,{"data-key":g,children:i.jsx(Nc,{mobileMenu:!0,topLevelPath:Yl(l.pathname),contextKey:g,menuOpen:!0,submenuOpen:g===o,onClickCallback:u,item:f,focusedContext:o})},g)),t&&i.jsx(ks,{children:i.jsx(Qn,{compact:!0,isActive:!1,icon:"Question",title:r,href:t,menuOpen:!0,onClickCallback:h})})]})},_7=d(Ee)`
  ${oe};
  display: flex;
  flex-basis: 0;
  flex-grow: 1;
...
`,R7=d.div`
  margin-right: 15px;
`,I7=d.object``,A7=({home:e="/",logoMark:t,closeId:r})=>{const{setSelected:n}=s.useContext(Ke);return i.jsx(_7,{to:e,onClick:()=>n(r),children:i.jsx(R7,{children:t?i.jsx(I7,{type:"image/svg+xml",data:t}):i.jsx(Wl,{})})})},P7=d.div`
  background: var(--global-element-background);

  z-index: 100;
  display: flex;
  flex-direction: column;
`,O7=({closeId:e,hasLanguage:t,hasLogout:r,logoutLink:n,hasCurrentUser:o,userSubmenu:a,userDrawerBespoke:l,loggedInUser:c,onLogout:u,onLanguageToggle:h,...f})=>{const{setSelected:g}=s.useContext(Ke),b=s.useCallback(()=>{g(e)},[e,g]);return i.jsx(P7,{children:i.jsx(Gc,{hasLanguage:t,hasLogout:r,logoutLink:n,hasCurrentUser:o,userSubmenu:a,userDrawerBespoke:l,loggedInUser:c,onLogout:u,onLanguageToggle:h,...f,closeOnClick:b})})},rt="closeMenu",$s="notifications",Ss="user",Cs="menu",Es="custom",D7=d.nav`
  background-color: var(--global-element-background);
  position: sticky;
  top: 0;
  left: 0;
...
`,F7=({content:e,home:t,logoMark:r,supportUrl:n,defaultMenuOpen:o=!0,closeText:a,hasLanguage:l,hasLogout:c,logoutLink:u,hasCurrentUser:h,hasNotifications:f,userSubmenu:g,userDrawerBespoke:b,loggedInUser:p,notificationsHistory:v,customDrawer:y,supportText:C,onLogout:k,onLanguageToggle:S,...E})=>i.jsx(D7,{children:i.jsxs(Na,{children:[i.jsxs(W7,{children:[i.jsx(A7,{home:t,logoMark:r,closeId:rt}),i.jsxs(Kc,{defaultTabId:rt,children:[y&&i.jsx(bn,{...y,tabFor:Es,closeId:rt}),f?i.jsx(bn,{tabFor:$s,icon:"Notifications",closeId:rt}):null,i.jsx(bn,{tabFor:Ss,icon:"UserProfile",closeId:rt}),i.jsx(bn,{tabFor:Cs,icon:"Menu",closeId:rt})]})]}),i.jsxs(L7,{closeId:rt,children:[i.jsx(Wr,{tabId:Es,children:y&&y.customComponent}),i.jsx(Wr,{tabId:$s,children:v&&f?i.jsx(Yc,{...v}):null}),i.jsx(Wr,{tabId:Ss,children:i.jsx(O7,{hasLanguage:l,hasLogout:c,logoutLink:u,hasCurrentUser:h,userSubmenu:g,userDrawerBespoke:b,loggedInUser:p,onLogout:k,onLanguageToggle:S,...E,closeId:rt})}),i.jsx(Wr,{tabId:Cs,children:i.jsx(T7,{content:e,supportUrl:n,supportText:C,defaultMenuOpen:o,closeId:rt})}),i.jsx(E7,{closeText:a,closeId:rt})]})]})}),R6=({content:e,home:t,openWidth:r,logoMark:n,logoText:o,supportUrl:a,defaultMenuOpen:l,canAlwaysPin:c,paddingOverride:u,maxWidth:h,legacyLayout:f,children:g,keepOpenText:b,autoHideText:p,supportText:v,onMenuToggle:y,...C})=>{const{isLarge:k}=Wa();return k?i.jsxs(N4,{children:[i.jsx(vk,{content:e,home:t,openWidth:r,logoMark:n,logoText:o,supportUrl:a,defaultMenuOpen:l,canAlwaysPin:c,onMenuToggle:y,keepOpenText:b,autoHideText:p,supportText:v}),i.jsxs(U4,{children:[i.jsx(d7,{...C}),i.jsx(us,{$maxWidth:h,$paddingOverride:u,$legacyLayout:f,children:i.jsx(i.Fragment,{children:g})})]})]}):i.jsxs(V4,{children:[i.jsx(F7,{content:e,home:t,logoMark:n,supportUrl:a,defaultMenuOpen:l,supportText:v,...C}),i.jsx(us,{children:i.jsx(i.Fragment,{children:g})})]})};d.div`
  width: 286px;
...
`;d(Ee)`
  ...
  text-decoration: none;
  padding: 7px 20px;
`;H4.__docgenInfo={description:"",methods:[],displayName:"SplitLayout",props:{layout:{defaultValue:{value:'"horizontal"',computed:!1},required:!1},dividerSize:{defaultValue:{value:"16",computed:!1},required:!1},persist:{defaultValue:{value:"false",computed:!1},required:!1},persistenceKey:{defaultValue:{value:'"resizable_ui"',computed:!1},required:!1}}};export{e6 as $,Q7 as A,J7 as B,L6 as C,Fy as D,g6 as E,c6 as F,Bl as G,l6 as H,s6 as I,E5 as J,Kl as K,Zs as L,U7 as M,u6 as N,Ql as O,o6 as P,r6 as Q,n6 as R,v6 as S,q7 as T,t6 as U,Ze as V,Xl as W,Zm as X,i6 as Y,Gl as Z,Nl as _,cc as a,R6 as a0,h6 as a1,z6 as a2,Kc as a3,T6 as a4,p6 as a5,G7 as a6,Rv as a7,V7 as a8,vk as a9,N4 as aa,d7 as ab,L4 as ac,X7 as ad,H4 as ae,bt as af,B as ag,$c as ah,Jn as ai,y7 as aj,Na as ak,jc as al,E6 as am,M6 as an,_6 as ao,Hw as ap,$6 as aq,f3 as ar,n3 as as,w6 as at,K7 as au,j6 as av,Se as b,d6 as c,a6 as d,Tl as e,hc as f,Z7 as g,Fw as h,Y7 as i,S6 as j,C6 as k,Y3 as l,mo as m,b6 as n,xo as o,L2 as p,y6 as q,oe as r,aw as s,vw as t,f6 as u,$e as v,x6 as w,m6 as x,k6 as y,Yr as z};

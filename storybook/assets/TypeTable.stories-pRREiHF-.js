import{f as T,r as t,d as a,j as i,n as E,a as j}from"./iframe-BQPDKgpJ.js";import{u as A,w as M}from"./data_samples-CN1iUX41.js";import{r as m,s as h}from"./sample_table_helpers-CCJBIzXE.js";import{e as u}from"./index-BKA4gAcn.js";import"./preload-helper-C1FmrZbK.js";import"@storybook/preview-api";import"./placeholder-BcVwUhHh.js";const B=j.div`
  padding: 100px;
`,z={title:"Tables/molecules",component:T,decorators:[],parameters:{jsx:{skip:2}}},G=M,p=h(G,"deviceName",!0),n=()=>{const[r,y]=t.useState(p),[s,l]=t.useState(m(p)),g=a.boolean("Has Device Status",!0),f=a.boolean("Has Thumbnail",!0),D=a.text("Close Text","CLOSE"),x=a.boolean("Has Device Type Icon",!0),S=a.boolean("Has Header Groups",!0),R=a.boolean("Selectable Rows",!0),v=a.object("Column Configuration",A),I=t.useCallback((c,o)=>{const e=[...s],b=e.findIndex(d=>d.id===o);e[b]._checked=c,l(e)},[s,l]),H=t.useCallback(c=>{const o=[...s];o.forEach(e=>{e._checked=c}),l(o)},[s,l]),_=t.useCallback((c,o)=>{const e=[...r],d=h(e,o,c);y(d)},[r]);return t.useEffect(()=>{l(m(r))},[r]),i.jsx(B,{children:i.jsx(E,{children:i.jsx(T,{columnConfig:v,selectable:R,rows:s,hasStatus:g,hasThumbnail:f,closeText:D,hasTypeIcon:x,defaultAscending:!0,hasHeaderGroups:S,selectCallback:u(I),toggleAllCallback:u(H),sortCallback:u(_)})})})};n.__docgenInfo={description:"",methods:[],displayName:"_TypeTable"};var w,C,k;n.parameters={...n.parameters,docs:{...(w=n.parameters)==null?void 0:w.docs,source:{originalSource:`() => {
...
}`,...(k=(C=n.parameters)==null?void 0:C.docs)==null?void 0:k.source}}};const J=["_TypeTable"];export{n as _TypeTable,J as __namedExportsOrder,z as default};

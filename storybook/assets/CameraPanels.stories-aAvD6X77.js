...
`,k=x.div`
  ...
  font-size: 14px;
  margin-bottom: 10px;
`,b=i.jsxs(V,{children:[i.jsx(k,{children:"Custom Component Example"}),i.jsx(L,{tagsConfig:[{icon:"MetaCategories",label:"Shop A",weight:"light",size:12},{icon:"MetaTags",label:"Example",weight:"light",size:12},{icon:"MetaTags",label:"Smart",weight:"light",size:12}]})]}),a=()=>{const o={"":"",...W()},s=e.boolean("Show Custom Component Example",!1),c=e.select("Type",{Error:"error",Warning:"warning",Info:"info",Success:"success",Neutral:"neutral"},"neutral"),l=e.select("Status Icon",o,"Information"),m=e.boolean("Has Notice",!1),r=e.text("Notice Message","Please wait while the first stream is processed."),p=e.text("Notice Title","Initial Stream Pending"),g=e.boolean("Has Empty Stream with Icon",!1),u=e.select("Empty stream icon",o,""),h=e.select("Device Icon",o,"Camera"),d=e.boolean("Hide Panel Data Icon",!1),I=e.text("Left Title","Location - Zone"),C=e.text("Left SubTitle","Camera Name"),f=e.text("Right Title","Analysis"),T=e.text("Right Subtitle","PeopleCount"),y=j("Changing to camera page"),t=P.useMemo(()=>({streamProps:{src:R,mediaType:"img",isEmptyWithIcon:g,noticeTitle:p,noticeMessage:r,status:c,noticeIcon:l,hasNotice:m,emptyIcon:u},panelMetaData:{deviceIcon:h,leftSubTitle:C,leftTitle:I,rightTitle:f,rightSubTitle:T,hideIcon:d},customBottom:s?b:void 0,panelOnClick:()=>{y()}}),[g,p,r,c,l,m,u,h,C,I,f,T,d,s,y]),n=P.useMemo(()=>({streamProps:{src:"https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4",mediaType:"video",videoOptions:{autoPlay:!1,controls:!0},isEmptyWithIcon:g,noticeTitle:p,noticeMessage:r,status:c,noticeIcon:l,hasNotice:m,emptyIcon:u},panelMetaData:{deviceIcon:h,leftSubTitle:C,leftTitle:I,rightTitle:f,rightSubTitle:T,hideIcon:d},customBottom:s?b:void 0}),[g,p,r,c,l,m,u,h,C,I,f,T,d,s]),E=P.useMemo(()=>[t,n,t,n,t,n,t,n,t,n,t],[t,n]);return i.jsx(D,{$showCustomComponent:s,children:i.jsx(M,{panels:E})})};a.__docgenInfo={description:"",methods:[],displayName:"_CameraPanels"};var S,w,v;a.parameters={...a.parameters,docs:{...(S=a.parameters)==null?void 0:S.docs,source:{originalSource:`() => {
  const iconList = {
    '': '',
    ...generateIconList()
  };
...
}`,...(v=(w=a.parameters)==null?void 0:w.docs)==null?void 0:v.source}}};const K=["_CameraPanels"];export{a as _CameraPanels,K as __namedExportsOrder,J as default};

import{j as m}from"./emotion-unitless.esm-y1ruXoeO.js";import{r as o}from"./index-Dh2lLoQQ.js";import{c as H}from"./styled-components.browser.esm-D8a0uvnT.js";import{d as i}from"./index-BtgrC99a.js";import{a as h}from"./chunk-D5ZWXAHU-Dm3eDOzv.js";import{x as Y,y as $,v as p}from"./index.modern-BCxVMgPd.js";import{e as R,b as k,s as S,a as F,g as A,o as ee,p as ae,q as te,t as se,k as ne,m as le,r as oe,n as ie,f as re,h as ce,i as ge,j as de,u as he,v as pe,w as D,x as v}from"./data_samples-CN1iUX41.js";import{r as I,s as c,f as ue,a as me,b as Te,c as De,d as be}from"./sample_table_helpers-BuwRaEhk.js";import{a as ye,d as xe,I as we}from"./datePicker_sample-C5PvquPq.js";import"./iframe-CQb0CZlC.js";import"./v4-CtRu48qb.js";import"./index-Dz_aA26r.js";import"./placeholder-BcVwUhHh.js";const Me={title:"Filters/Organism",component:"FilterBar",decorators:[]},Ce=H.div`
  margin: 20px;
`,fe=H.div`
margin: 60px 0 20px 0
`,P=new Date;P.setDate(P.getDate()-5);const E=c(D,"deviceName",!0),J=(e,r)=>Array.isArray(e)&&e.length>0?e.reduce((t,a)=>a.selected===null?t:a.id==="dropdownForStatus"&&(p(a.selected)||Array.isArray(a.selected))?ue(t,a.selected):a.id==="priceFilter"&&p(a.selected)?me(t,a.selected):a.id==="inputForDeviceName"&&p(a.selected)?Te(t,a.selected):a.id==="inputForDate"&&p(a.selected)?De(t,a.selected):a.id==="datePickerForRuntime"&&!p(a.selected)&&!Array.isArray(a.selected)?be(t,a.selected):t,r):r,g=()=>{const e=i.select("Language",{English:"english",Japanese:"japanese"},"japanese"),[r,d]=o.useState(E),[t,a]=o.useState(I(E)),[b,y]=o.useState([]),_=i.boolean("Single Filter",!1),O=i.boolean("Has Show More",!0),V=i.text("Results date format","yyyy-MM-dd HH:mm"),K=i.boolean("Datepicker has Apply",!0),z=h("Status Reset was pressed"),U=h("Status Cancel was pressed"),W=h("Price Reset was pressed"),G=h("Price Cancel pressed"),Z=o.useCallback((s,n)=>{const l=[...t],u=l.findIndex(T=>T.id===n);l[u]._checked=s,a(l)},[t,a]),q=o.useCallback(s=>{const n=[...t];n.forEach(l=>{l._checked=s}),a(n)},[t,a]),Q=o.useCallback((s,n)=>{const l=[...r],T=c(l,n,s);d(T)},[r]),x=[{id:"inputForDeviceName",placeholder:e==="english"?"Filter by Device Name...":"デバイス名前 フィルター",name:e==="english"?"Device Name":"デバイス名前"},{id:"inputForDate",placeholder:e==="english"?"Filter by Date":"年月日 フィルター",name:e==="english"?"Date":"年月日",canHide:!0,showFieldText:e==="english"?"Show Date Input":"年月日 みる"}],w=[{id:"dropdownForStatus",buttonText:e==="english"?"Status":"ステータス",list:e==="english"?ee:ae,buttonIcon:"Camera",optionType:"checkbox",loadingText:e==="english"?"Loading Status ...":A,searchPlaceholder:e==="english"?"Status...":"ステータス...",searchResultText:e==="english"?S:F,emptyResultText:e==="english"?R:k,onResetCallback:z,onCancelCallback:U,hasReset:!0,hasApply:!0,resetText:e==="english"?"Reset":"リセット",cancelText:e==="english"?"Cancel":"キャンセル",closeText:e==="english"?"Close":"閉じる",applyText:e==="english"?"Apply":"適用",descendingText:e==="english"?"Descending":"降順",ascendingText:e==="english"?"Ascending":"昇順",isListAscending:!0,hasOptionsFilter:!0},{id:"priceFilter",canHide:!0,buttonText:e==="english"?"Cost":"価格",list:e==="english"?te:se,buttonIcon:"Usage",optionType:"radio",loadingText:e==="english"?"Loading Cost...":A,searchPlaceholder:e==="english"?"Cost...":"価格...",searchResultText:e==="english"?S:F,emptyResultText:e==="english"?R:k,onResetCallback:W,onCancelCallback:G,hasReset:!0,hasApply:!0,resetText:e==="english"?"Reset":"リセット",cancelText:e==="english"?"Cancel":"キャンセル",closeText:e==="english"?"Close":"閉じる",applyText:e==="english"?"Apply":"適用",descendingText:e==="english"?"Descending":"降順",ascendingText:e==="english"?"Ascending":"昇順",isListAscending:!0,hasOptionsFilter:!0}],C=[{id:"datePickerForRuntime",dateMode:"interval",buttonText:e==="english"?"Date Range":"日付範囲",buttonIcon:"DateTime",dateTimeTextUpper:e==="english"?"From":"から",dateTimeTextLower:e==="english"?"To":"まで",timeZoneTitle:e==="english"?"Timezone":"時間帯",cancelText:e==="english"?"Cancel":"キャンセル",applyText:e==="english"?"Apply":"完了",lang:e==="english"?"en":"ja",selected:we,availableRange:xe,contentDays:ye,hasApply:K}];i.object("Search Filters",x),i.object("DropdownFilters",w),i.object("DatePickers",C);const f=h("onChangeCallback"),X=o.useCallback(s=>{f(s);const n=e==="english"?c(D,"deviceName",!0):c(v,"deviceName",!0),l=[...n];if(s.length===0)d(n),y([]);else{const u=J(s,l);d(u),y(s)}},[f,e]);return o.useEffect(()=>{const s=e==="english"?c(D,"deviceName",!0):c(v,"deviceName",!0),n=J(b,s);d(n)},[b,e]),o.useEffect(()=>{a(I(r))},[r]),m.jsxs(Ce,{children:[m.jsx(Y,{singleFilter:_,hasShowMore:O,searchersConfig:x,dropdownsConfig:w,datePickersConfig:C,onChangeCallback:X,totalResults:t.length,showMoreText:e==="english"?ge:de,showLessText:e==="english"?re:ce,filtersTitle:e==="english"?"Filters":"フィルター",resultTextTemplate:e==="english"?oe:ie,clearText:e==="english"?ne:le,resultsDateFormat:V}),m.jsx(fe,{children:m.jsx($,{selectCallback:Z,toggleAllCallback:q,rows:t,sortCallback:Q,columnConfig:e==="english"?he:pe,hasStatus:!0,selectable:!0,hasThumbnail:!0,hasTypeIcon:!0,defaultAscending:!0,hasHeaderGroups:!0})})]})};g.__docgenInfo={description:"Filter Bar Story Starts",methods:[],displayName:"_FilterBar"};var L,j,B,M,N;g.parameters={...g.parameters,docs:{...(L=g.parameters)==null?void 0:L.docs,source:{originalSource:`() => {
...
}`,...(B=(j=g.parameters)==null?void 0:j.docs)==null?void 0:B.source},description:{story:"Filter Bar Story Starts",...(N=(M=g.parameters)==null?void 0:M.docs)==null?void 0:N.description}}};const Ne=["_FilterBar"];export{g as _FilterBar,Ne as __namedExportsOrder,Me as default};

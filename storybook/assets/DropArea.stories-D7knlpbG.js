import{a1 as i,d as o,j as n,a as h}from"./iframe-B-FWgcWl.js";import"./preload-helper-C1FmrZbK.js";const{action:m}=__STORYBOOK_MODULE_ACTIONS__,d=h.div`
  max-width: 500px;
`,_={title:"Form/File Management",component:i,decorators:[]},e=()=>{const c=o.text("Text","Drop a file"),p=o.text("Height","300px"),a=m("Input Callback"),x=t=>{console.log("file",t),t.length===1?a(t[0].name):a(t)};return n.jsx(d,{children:n.jsx(i,{height:p,text:c,dropCallback:x})})};e.__docgenInfo={description:"",methods:[],displayName:"_DropArea"};var r,s,l;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`() => {
...
}`,...(l=(s=e.parameters)==null?void 0:s.docs)==null?void 0:l.source}}};const C=["_DropArea"];export{e as _DropArea,C as __namedExportsOrder,_ as default};

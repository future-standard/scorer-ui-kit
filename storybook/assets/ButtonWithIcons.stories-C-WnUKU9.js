import{X as a,d as t,j as p}from"./iframe-B-FWgcWl.js";import{g as x}from"./index-K08NWMu6.js";import"./preload-helper-C1FmrZbK.js";const{action:I}=__STORYBOOK_MODULE_ACTIONS__,O={title:"Form/Buttons",component:a,decorators:[]},o=()=>{const n=x(),c=t.text("Button Text","Example Title"),l=t.select("Design",{Primary:"primary",Secondary:"secondary",Danger:"danger",TextOnly:"text-only",Outline:"outline"},"primary"),r=t.select("Size",{Xsmall:"xsmall",Small:"small",Normal:"normal",Large:"large"},"normal"),u=t.boolean("Disabled",!1),d=t.select("Icon",n,Object.keys(n)[0]),b=t.select("Icon Position",{Left:"left",Right:"right"},"right"),m=t.boolean("Loading",!1),g=t.boolean("Shadow",!1),h=I("button-click");return p.jsx(a,{design:l,size:r,shadow:g,onClick:h,icon:d,position:b,disabled:u,loading:m,children:c})};o.__docgenInfo={description:"",methods:[],displayName:"_WithIcon"};var e,s,i;o.parameters={...o.parameters,docs:{...(e=o.parameters)==null?void 0:e.docs,source:{originalSource:`() => {
...
}`,...(i=(s=o.parameters)==null?void 0:s.docs)==null?void 0:i.source}}};const f=["_WithIcon"];export{o as _WithIcon,f as __namedExportsOrder,O as default};

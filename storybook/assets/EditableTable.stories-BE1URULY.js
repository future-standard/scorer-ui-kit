import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{Ft as n,H as r,It as i,Nt as a,St as o,T as s,Ut as c,Wt as l,bt as u}from"./iframe-CW3QRQX7.js";import{n as d,t as f}from"./placeholder-Bsx_gz26.js";import{n as p,r as m}from"./helpers-ChWV1T_Y.js";var h,g,_,v,y,b,x,S,C;e((()=>{h=c(),g=t(l()),o(),i(),f(),p(),_=a(),v={title:`Tables/molecules`,component:u,decorators:[]},y=n.div`
  padding: 100px;
`,b=[{header:`Job Number`,sortable:!1,cellStyle:`firstColumn`},{header:`Camera Name`,sortable:!1,cellStyle:`normalImportance`,alignment:`left`},{header:`When`,sortable:!1,cellStyle:`normalImportance`,alignment:`center`},{header:`Status`,sortable:!1,cellStyle:`normalImportance`,showStatus:!0},{header:`Temperature`,sortable:!1,cellStyle:`normalImportance`,showStatus:!0}],x=[{id:`device-1`,jobName:`capture123`,cameraName:`Camera1`,jobTime:`Just Now`,status:`good`,statusText:`OK`,temperature:`38.2ºC`},{id:`device-2`,jobName:`capture234`,cameraName:`Camera2`,jobTime:`Just Now`,status:`good`,statusText:`OK`,temperature:`38.2ºC`},{id:`device-3`,jobName:`capture345`,cameraName:`Camera3`,jobTime:`3 mins ago`,status:`danger`,statusText:`Warning`,temperature:`38.2ºC`},{id:`device-4`,jobName:`capture456`,cameraName:`Camera4`,jobTime:`12 mins ago`,status:`danger`,statusText:`Warning`,temperature:`38.2ºC`}],S=()=>{let[e,t]=(0,g.useState)(x),[n,i]=(0,g.useState)([]),a=(0,h.object)(`ColumConfig`,b),o=(0,g.useCallback)(async(n,r)=>{let i=[...e],a=i.find(({id:e})=>e===r);a&&n.length>0&&(a.cameraName=n,await m(3e3),t(i))},[e]),c=(0,g.useCallback)(e=>e.map(({id:e,jobName:t,cameraName:n,jobTime:r,status:i,statusText:a,temperature:c})=>({id:e,header:{image:d,mediaUrl:d,mediaType:`img`},columns:[{text:t},{customComponent:(0,_.jsx)(s,{alignment:`left`,defaultValue:n,rowKey:e,saveCallback:o,toLink:`/`})},{text:r},{text:a,status:i},{text:c}]})),[o]);return(0,g.useEffect)(()=>(i(c(e)),()=>{i([])}),[e,c]),(0,_.jsx)(y,{children:(0,_.jsx)(r,{children:(0,_.jsx)(u,{columnConfig:a,rows:n,hasThumbnail:!0})})})},S.__docgenInfo={description:``,methods:[],displayName:`_EditableTable`},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`() => {

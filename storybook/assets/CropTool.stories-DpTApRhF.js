import{a as e,n as t}from"./chunk-BneVvdWh.js";import{Et as n,Ft as r,Lt as i,Pt as a,Rt as o,g as s,vt as c}from"./iframe-BHdSP_o9.js";import{n as l,t as u}from"./placeholder-DnTErttm.js";var d,f,p,m,h,g,_,v,y,b;t((()=>{d=e(o()),r(),c(),f=a(),u(),p=n(),{action:m}=__STORYBOOK_MODULE_ACTIONS__,h=i.div`
    margin: 20px;
`,g=i.img`
`,_=i.div``,v={title:`Form/File Management`,component:s,decorators:[],escapeHTML:!1},y=()=>{let e=(0,f.boolean)(`Is Resizable`,!0),[t,n]=(0,d.useState)(``),[r,i]=(0,d.useState)(!0),a=(0,f.text)(`Title`,`Crop Image`),o=(0,f.text)(`Cancel Button Text`,`Cancel`),c=(0,f.text)(`Crop Button Text`,`Crop and Save`),u=(0,f.number)(`Canvas Height`,400),v=(0,f.number)(`Canvas Width`,450),y=(0,f.number)(`Crop Height`,300),b=(0,f.number)(`Crop Width`,300),x=(0,f.number)(`Aspect Ratio`,0),S=m(`Error`);return(0,p.jsxs)(h,{children:[r?(0,p.jsx)(s,{imgUrl:l,title:a,onCrop:e=>{n(e),i(!1)},onClose:()=>{i(!1)},cancelBtnTxt:o,cropBtnTxt:c,isResizable:e,canvasHeight:u,canvasWidth:v,cropHeight:y,cropWidth:b,onError:e=>{console.log(e),S(e)},aspectRatio:x},`${e} - ${u} - ${v} - ${y} - ${b} - ${x}`):null,(0,p.jsxs)(_,{children:[(0,p.jsx)(`h3`,{children:`Cropped Area`}),(0,p.jsx)(g,{src:t})]})]})},y.__docgenInfo={description:``,methods:[],displayName:`_CropTool`},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`() => {

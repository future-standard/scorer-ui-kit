import{i as e}from"./preload-helper-xPQekRTU.js";import{Ct as t,I as n,It as r,Lt as i,P as a,Pt as o,Wt as s,it as c,y as l}from"./iframe-BMz55O8f.js";var u,d,f,p,m,h,g;e((()=>{u=s(),t(),i(),d=o(),{action:f}=__STORYBOOK_MODULE_ACTIONS__,p={title:`Global/organisms`,component:n,decorators:[]},m=r.div`
  position: absolute;
  top: 0;
  bottom: 0;
  left: 0;
...
`,h=()=>{let e=(0,u.boolean)(`Side Area A - Default Collapsed`,!1),t=f(`Side Area A State`),n=(0,u.boolean)(`Side Area B - Default Collapsed`,!1),r=f(`Side Area B State`);return(0,d.jsx)(m,{children:(0,d.jsx)(l,{layout:`dashboard`,children:(0,d.jsx)(c,{layout:`horizontal`,persist:!0,persistenceKey:`my_unique_layout_key`,reverse:!1,mainArea:{content:(0,d.jsx)(c,{layout:`vertical`,persist:!0,persistenceKey:`my_nested_key`,reverse:!1,mainArea:{content:(0,d.jsx)(a,{title:`Main Area`}),minSize:120},sideArea:{content:(0,d.jsx)(a,{title:`Side Area A`}),collapsable:!0,minSize:200,onSideAreaStateChange:t,defaultCollapsed:e}}),minSize:120},sideArea:{content:(0,d.jsx)(a,{title:`Side Area B`}),collapsable:!0,minSize:200,onSideAreaStateChange:r,defaultCollapsed:n}})})})},h.__docgenInfo={description:``,methods:[],displayName:`_SplitLayoutNested`},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`() => {
  const reverse = false;

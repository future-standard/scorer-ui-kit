import{j as a}from"./emotion-unitless.esm-y1ruXoeO.js";import{c as f}from"./styled-components.browser.esm-D8a0uvnT.js";import{d as e}from"./index-BtgrC99a.js";import{P as i}from"./index.modern-BCxVMgPd.js";import"./index-Dh2lLoQQ.js";import"./iframe-CQb0CZlC.js";import"./index-Dz_aA26r.js";const h=f.div`
    margin: 20px;
`,q={title:"Form/Input",component:i,decorators:[]},t=()=>{const n=e.text("Input Name","my_input"),r=e.text("Label","My Input"),l=e.text("Value","Test"),c=e.text("Placeholder","Placeholder..."),u=e.boolean("Required",!1),p=e.boolean("Show Feedback",!1),m=e.text("Feedback","This is a feedback message."),b=e.select("State",{Default:"default",Disabled:"disabled",Required:"required",Valid:"valid",Invalid:"invalid",Processing:"processing"},"default");return a.jsx(h,{children:a.jsx(i,{name:n,label:r,defaultValue:l,placeholder:c,fieldState:b,showFeedback:p,feedbackMessage:m,required:u})})};t.__docgenInfo={description:"",methods:[],displayName:"PasswordInput"};var s,o,d;t.parameters={...t.parameters,docs:{...(s=t.parameters)==null?void 0:s.docs,source:{originalSource:`() => {
...
}`,...(d=(o=t.parameters)==null?void 0:o.docs)==null?void 0:d.source}}};const S=["PasswordInput"];export{t as PasswordInput,S as __namedExportsOrder,q as default};

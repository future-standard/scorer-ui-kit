import{B as e,Ft as t,Lt as n,Rt as r,Wt as i,d as a,q as o,st as s,wt as c}from"./iframe-C-UcmyvH.js";import{n as l,t as u}from"./helpers-Cktaogyc.js";import{n as d}from"./rolldown-runtime-DkW27tQK.js";var f,p,m,h,g,_,v,y,b;function x(){return(x=d((()=>{f=i(),c(),r(),l(),p=t(),{action:m}=__STORYBOOK_MODULE_ACTIONS__,h=n.div`
  margin: 100px;
`,g={title:`Pages/molecules`,component:o,decorators:[]},_=[{label:`Shop A`,icon:`MetaCategories`,linkTo:`/`},{label:`Example`,icon:`MetaTags`},{label:`Smart`,icon:`MetaTags`},{label:`Shop B`,icon:`MetaCategories`},{label:`Example`,icon:`MetaTags`},{label:`Smart`,icon:`MetaTags`},{label:`Shop C`,icon:`MetaCategories`},{label:`Example`,icon:`MetaTags`},{label:`Smart`,icon:`MetaTags`},{label:`Edit`,icon:`Edit`,onTagClick:m(`Edit tag clicked`)}],v=[{id:`primaryBase0`,buttonType:`default`,text:`Example Action 1`},{id:`secondaryBase1`,buttonType:`default`,text:`Example Action 2`,design:`secondary`},{id:`buttonWithIcon2`,buttonType:`icon-button`,text:`Delete Instance`,design:`danger`,icon:`DevicesScorerEdge`}],y=()=>{let t=Object.assign({None:null},u()),n=(0,f.text)(`Page Title`,`My Page Title`),r=(0,f.text)(`Page Area`,`Area Name`),i=(0,f.text)(`Page Area Href`,`#`),c=(0,f.select)(`Icon`,t,`Link`),l=(0,f.select)(`Icon Color`,{Mono:`mono`,Dimmed:`dimmed`,Subtle:`subtle`,Inverse:`inverse`,Primary:`primary`,Danger:`danger`,Undefined:void 0},void 0),d=(0,f.boolean)(`Update Doc Title`,!0),g=(0,f.boolean)(`No tags Example`,!1),y=(0,f.boolean)(`Area Title Bottom`,!1),b=(0,f.boolean)(`No Buttons Example`,!1),x=(0,f.boolean)(`No Icon`,!1),S=m(`Custom onAreaClick was used`),C=(0,f.text)(`Text`,`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam sodales non mauris sed fermentum. Proin non elit at lectus semper lacinia a sed nisi. Sed nibh neque, sagittis at laoreet non, sodales non nisl. Nam nec lectus erat. Etiam bibendum tristique ipsum eu dictum. Nam egestas felis in mauris molestie tristique.`),w=(0,f.object)(`Tag List`,_),T=(0,f.object)(`Buttons Stack`,v),E=(0,f.boolean)(`Example with area on Click`,!1),D=(0,f.boolean)(`Has Bottom Left Bottom`,!1);return d&&console.info(`Note: Updating document.title in Storybook has no effect though it should work in projects.`),(0,p.jsx)(h,{children:(0,p.jsx)(o,{icon:x?void 0:c||void 0,iconColor:l,introductionText:C,title:n,areaTitle:r,areaHref:i,onAreaClick:E?S:void 0,updateDocTitle:d,tagList:g?void 0:w,rightContent:b?void 0:(0,p.jsx)(a,{buttons:T}),areaTitleBottom:y,bottomLeftContent:D?(0,p.jsx)(e,{htmlFor:`id-switch`,labelText:`Enable`,direction:`row`,children:(0,p.jsx)(s,{},`id-switch`)}):void 0})})},y.__docgenInfo={description:``,methods:[],displayName:`_PageHeader`},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`() => {
...
}`,...y.parameters?.docs?.source}}},b=[`_PageHeader`]})))()}x();export{y as _PageHeader,b as __namedExportsOrder,g as default};
import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{Ct as n,E as r,Gt as i,It as a,Lt as o,Pt as s,Wt as c,_ as l,bt as ee,g as u,h as d,m as f,rt as p,s as m}from"./iframe-FLpC4IdY.js";import{n as h,r as g}from"./helpers-BJkmT8eL.js";var _,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N;e((()=>{_=c(),v=t(i()),n(),o(),h(),y=s(),{action:b}=__STORYBOOK_MODULE_ACTIONS__,x={title:`Chips/organisms`,component:f,decorators:[]},S=a.div`
  display: flex;
  flex-shrink: 0;
  align-items: center;
  height: 56px;

import{t as e}from"./react-BZJXY1be.js";import{D as t,Ft as n,Lt as r,Rt as i,Wt as a,_ as o,c as s,g as c,h as l,it as ee,v as u,wt as d,xt as te}from"./iframe-DFQHAkQ-.js";import{n as f,r as p}from"./helpers-CXAXeTVq.js";import{n as m}from"./rolldown-runtime-DkW27tQK.js";var h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M;function N(){return(N=m((()=>{h=a(),g=e(),d(),i(),f(),_=n(),{action:v}=__STORYBOOK_MODULE_ACTIONS__,y={title:`Chips/organisms`,component:l,decorators:[]},b=r.div`
  display: flex;
  flex-shrink: 0;
  align-items: center;
  height: 56px;

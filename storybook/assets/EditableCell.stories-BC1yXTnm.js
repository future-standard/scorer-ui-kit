import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{Ft as n,It as r,Nt as i,St as a,T as o,Ut as s,Wt as c}from"./iframe-CW3QRQX7.js";import{n as l,r as u}from"./helpers-ChWV1T_Y.js";var d,f,p,m,h,g,_,v;e((()=>{d=s(),f=t(c()),a(),r(),l(),p=i(),m={title:`Tables/atoms`,component:o,decorators:[]},h=n.div`
  ...
  line-height: 30px;
  padding: 0 2px;
`,g={id:`id-1`,cameraName:`Camera1`},_=()=>{let[e,t]=(0,f.useState)(g),n=(0,d.select)(`Alignment`,{Left:`left`,Center:`center`,Right:`right`},`left`),r=(0,d.text)(`ToLink`,`/`);return(0,p.jsx)(h,{children:(0,p.jsx)(o,{defaultValue:e.cameraName,rowKey:e.id,saveCallback:async(n,r)=>{if(r===`id-1`){let r={...e};r.cameraName=n,await u(2e3),t(r)}},alignment:n,toLink:r})})},_.__docgenInfo={description:``,methods:[],displayName:`_EditCell`},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`() => {

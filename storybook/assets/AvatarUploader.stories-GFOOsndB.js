import{$ as s,d as o,j as r,a as A}from"./iframe-BQPDKgpJ.js";import"./preload-helper-C1FmrZbK.js";import"@storybook/preview-api";const{action:n}=__STORYBOOK_MODULE_ACTIONS__,I=A.div``,S={title:"Form/File Management",component:s,decorators:[]},e=()=>{const p=o.text("Uploader Title","Photograph"),T=o.text("Photo Text","Drop Photo"),x=o.text("Button Text","Select File"),i=o.text("Button Text Replace","Replace Photo"),m=o.text("Uploader Crop Text","Crop Image"),d=o.text("CropTool Title","Crop utility"),u=o.text("CropTool Cancel Text","Cancel"),C=o.text("CropTool Confirm Text","Crop and Save"),h=o.text("Delete Photo Text","Remove"),g=o.boolean("Current Image",!1),v=o.boolean("Has Crop",!0),R=n("Update Callback"),b=n("On Error"),U=n("On Remove"),P=t=>{console.log("file",t),R(t.name)},_=t=>{console.log(t),b(t)},f=()=>{U("The user has deleted Avatar image")};return r.jsx(I,{children:r.jsx(s,{onAvatarUpdate:P,currentImg:g?"https://placekitten.com/g/200/300":"",title:p,photoText:T,buttonText:x,buttonTextReplace:i,onError:_,onRemove:f,uploaderCropText:m,hasCrop:v,cropToolTitle:d,cropToolCancelTxt:u,cropToolConfirmTxt:C,deletePhotoText:h})})};e.__docgenInfo={description:"",methods:[],displayName:"_AvatarUploader"};var a,l,c;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`() => {
...
}`,...(c=(l=e.parameters)==null?void 0:l.docs)==null?void 0:c.source}}};const y=["_AvatarUploader"];export{e as _AvatarUploader,y as __namedExportsOrder,S as default};

...
`),({theme:theme})=>theme.colors.pureBase,LoadingText),EmptyTableBox=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$s||(_t5$s=_$N`
  position: absolute;
  left: 0;
  z-index: 99;
  padding: 20px;
...
`),TagWrapper),TagList=({tagsConfig:tagsConfig})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TagListWrapper,null,tagsConfig.map((tagProps,index)=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Tag,Object.assign({key:"tag-"+index},tagProps))));let _t$Y,_t2$R,_t3$H,_t4$E,_t5$A,_$Y=t=>t;const Container$C=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$Y||(_t$Y=_$Y`
  ...
  display: flex;
  border-radius: 3px;
`),({theme:theme,hasBorder:hasBorder})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$R||(_t2$R=_$Y`
    ${0};
  `),hasBorder&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$H||(_t3$H=_$Y`
      border: 1px solid ${0}
    `),theme.styles.form.input.default.normal.borderColor)),IconWrapper),StyledInput$2=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.input(_t4$E||(_t4$E=_$Y`
  ${0};
...
`),({theme:theme,color:color})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$A||(_t5$A=_$Y`
    ${0};
    &::placeholder {
      ${0};
      color: ${0};
  ...
  letter-spacing: normal;
  color: hsl(210, 6%, 47%);
`)),MessageBox$1=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$I||(_t3$I=_$Z`
  font-size: 14px;
  font-weight: 500;
  font-stretch: normal;
  font-style: normal;
...
`)),MobileLayout=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$T||(_t2$T=_$_``)),MainContainer=(styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$J||(_t3$J=_$_`
  ...
  ${0}
`),({padBottom:_padBottom=!0})=>_padBottom?"70px 90px":"70px 90px 0",({maxWidth:maxWidth})=>maxWidth&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$G||(_t4$G=_$_`
      & > div {
        max-width: ${0};
      }
    `),maxWidth)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$C||(_t5$C=_$_`
  flex: 1;
  display: flex;
  flex-direction: column;
`))),ContentArea=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$p||(_t6$p=_$_`
  flex: 1;
  width: 100%;
  padding: ${0};
  margin-left: auto;
...
`),({paddingOverride:paddingOverride})=>paddingOverride||"40px 20px",deviceMediaQuery.medium,({paddingOverride:paddingOverride})=>paddingOverride||"40px",deviceMediaQuery.large,({maxWidth:maxWidth})=>maxWidth||"1200px",({paddingOverride:paddingOverride})=>paddingOverride||"70px 90px");let _t$$,_t2$U,_t3$K,_t4$H,_t5$D,_t6$q,_t7$n,_t8$l,_t9$j,_t10$g,_t11$d,_t12$7,_t13$6,_t14$5,_t15$4,_t16$3,_t17$3,_$$=t=>t;const ContextTitle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$$||(_t$$=_$$`
  opacity: 0;

  ${0}

  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$U||(_t2$U=_$$`
    transition: opacity ${0} ${0};
  `),theme.animation.speed.fast,theme.animation.easing.primary.easeInOut),({compact:compact})=>compact&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$K||(_t3$K=_$$`
    font-size:14px;
  `))),ContextIcon=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$H||(_t4$H=_$$`
  ${0};
  ...
  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$D||(_t5$D=_$$`
    ${0};
    transition: background ${0} ${0};
  `),theme.styles.global.mainMenu.iconBackground.default,theme.animation.speed.fast,theme.animation.easing.primary.easeInOut),({compact:compact})=>compact&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$q||(_t6$q=_$$`
    // width: 24px;
    // height: 24px;
    // flex: 0 0 24px;
    // margin: 0 28px 0 28px;
  `))),ContextIndicator=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$n||(_t7$n=_$$`
  width: 12px;
  height: 12px;
  flex: 0 0 14px;
...
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$l||(_t8$l=_$$`
    transition: opacity 0 ${0};
  `),theme.animation.easing.primary.easeInOut)),ContextActionBaseCSS=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t9$j||(_t9$j=_$$`
  -webkit-tap-highlight-color: transparent;
  border: none;
  background: none;
  display: flex;
  ...
  padding: 0;
  text-decoration: none;
`)),ContextActionA=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_27__.a)(_t10$g||(_t10$g=_$$`
  ${0}
  ${0}
  ...
  ${0}
`),ContextActionBaseCSS,({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t11$d||(_t11$d=_$$`
    font-family: ${0};
    ${0};
  `),theme.fontFamily.ui,theme.typography.global.mainMenu.menuItem.default),({$menuOpen:$menuOpen})=>$menuOpen&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t12$7||(_t12$7=_$$`
    ${0}{
      opacity: 1;
    }
  `),ContextTitle),ContextIcon,({theme:theme})=>theme.styles.global.mainMenu.iconBackground.hover,IconWrapper,({theme:theme})=>theme.colors.icons.inverse,({$isActive:$isActive})=>$isActive&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t13$6||(_t13$6=_$$`
    ${0},
    &:hover ${0}{
      ${0};
    }
  `),ContextIcon,ContextIcon,({theme:theme})=>theme.styles.global.mainMenu.iconBackground.active)),ContextActionButton=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t14$5||(_t14$5=_$$`
  ${0}
...
`),ContextActionBaseCSS,({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t15$4||(_t15$4=_$$`
    font-family: ${0};
    ${0};
  `),theme.fontFamily.ui,theme.typography.global.mainMenu.menuItem.default),({menuOpen:menuOpen,theme:theme})=>menuOpen&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t16$3||(_t16$3=_$$`
    ${0}{
      opacity: 1;
    }
...
`),({theme:{colors:colors}})=>colors.divider,SubmenuItemLink,({theme:theme,isActive:isActive})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t7$o||(_t7$o=_$10`
      font-family: ${0};
      ${0};
    ...
    `),theme.fontFamily.ui,theme.typography.global.mainMenu.subItem.default,theme.typography.global.mainMenu.subItem.hover,isActive&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$m||(_t8$m=_$10`
        &, &:hover {
          ${0};
        }
      `),theme.typography.global.mainMenu.subItem.active))),SubmenuContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t9$k||(_t9$k=_$10`
  ${0};
...
`),({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t10$h||(_t10$h=_$10`
    transition:
      max-height ${0} ${0},
      opacity ${0} ${0};
  `),theme.animation.speed.normal,theme.animation.easing.primary.easeOut,theme.animation.speed.fast,theme.animation.easing.primary.easeOut),({theme:{colors:colors}})=>colors.divider),ContextContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t11$e||(_t11$e=_$10`
  min-height: ${0};
  width: inherit;
...
`),({minHeight:minHeight})=>minHeight?minHeight+"px":"70px",SubmenuContainer,({open:open,maxHeight:maxHeight,theme:theme})=>open&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t12$8||(_t12$8=_$10`
    ${0}{
      transition:
        max-height ${0} ${0},
        opacity ${0} ${0};
...
`)),LogoMark=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$W||(_t2$W=_$11`
  height: 50px;
  flex: 0 0 50px;
  margin-right: 15px;
  display: flex;
...
`)),LogoType=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$M||(_t3$M=_$11`
  opacity: 0;
  flex: 1;
  height: 50px;
  display: flex;
  justify-content: left;
  align-items: center;
`)),SVGObject=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.object(_t4$J||(_t4$J=_$11``)),SVGObjectText=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.object(_t5$F||(_t5$F=_$11`
  max-width: 180px;
`)),NavigationContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$s||(_t6$s=_$11``)),MenuFooter=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$p||(_t7$p=_$11`
  ${0};
  display: flex;
  flex-direction: column;
  flex: 1;
  justify-content: flex-end;
`),({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$n||(_t8$n=_$11`
    ${0}
  `),theme.styles.global.mainMenu.footerBackground)),FooterItemContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t9$l||(_t9$l=_$11`
  min-height: 70px;
`)),PushContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t10$i||(_t10$i=_$11`
  position: relative;
  height: 100%;
  ${0};
`),({theme:theme,isPinned:isPinned})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t11$f||(_t11$f=_$11`
    width: ${0};
  `),isPinned?theme.dimensions.global.mainMenu.width.open:theme.dimensions.global.mainMenu.width.closed)),Container$E=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t12$9||(_t12$9=_$11`
  z-index: 99;
  position: fixed;
  top: 0;
  left: 0;
  ...
  padding: 20px 0 0 0;
  overflow: hidden;
`),({theme:theme,open:open,desktopSize:desktopSize})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t13$8||(_t13$8=_$11`
    ${0}
    ${0};
    width: ${0};
  ...
  `),theme.styles.global.mainMenu.background,"xxlarge"===desktopSize?"":Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t14$6||(_t14$6=_$11`
...
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$N||(_t3$N=_$12`
  ...
  `),theme.deviceMediaQuery.large)),DrawerHeader=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.h2(_t4$K||(_t4$K=_$12`
  ${0};
  padding: 0;
  margin: 0 0 5px;
`),({theme:theme})=>theme.typography.global.mainMenu.subheader),CurrentUser=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$G||(_t5$G=_$12`
  padding: 20px 20px 15px;

  ${0};
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$t||(_t6$t=_$12`
    border-bottom: ${0} 1px solid;
    ${0};
  `),theme.colors.divider,theme.typography.global.mainMenu.identity)),UserOptions=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$q||(_t7$q=_$12`
  padding: 20px 20px 10px 20px;
  border-bottom: ${0} 1px solid;
`),({theme:{colors:colors}})=>colors.divider),Logout=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t8$o||(_t8$o=_$12`
    padding: 0 20px;
`)),LinkMenu=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.ul(_t9$m||(_t9$m=_$12`
  padding: 0;
  margin: 12px 0 0 0;
  list-style: none;
`)),LinkMenuItem=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.li(_t10$j||(_t10$j=_$12`
  padding: 10px 0;
`)),IconWrapper$3=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t11$g||(_t11$g=_$12`
  flex: 0 40px;
  width: 5px;
  display: flex;
  justify-content: center;
...
`)),LinkMenuItemA=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_27__.a)(_t12$a||(_t12$a=_$12`
  ${0};
  display: block;
  width: 100%;
  ...
  ${0};
`),resetButtonStyles,({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t13$9||(_t13$9=_$12`
    ${0};

    &:hover {
      ${0};
    }
  `),theme.typography.global.mainMenu.subItem.default,theme.typography.global.mainMenu.subItem.hover),({theme:theme,isActive:isActive})=>isActive&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t14$7||(_t14$7=_$12`
    &, &:hover {
      ${0};
    }
  `),theme.typography.global.mainMenu.subItem.active)),LanguageMenu=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t15$6||(_t15$6=_$12`
  ${0};
...
`)),Image$3=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$L||(_t4$L=_$13`
  ...
  background-repeat: no-repeat; 
  display: ${0};
`),p=>p.image,p=>p.image?"block":"none"),InfoContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$H||(_t5$H=_$13`
  margin-left: 20px;
`)),Title$3=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$u||(_t6$u=_$13`
  font-size: 16px;
  font-weight: 500;
  color: hsl(0, 0%, 34%);
`)),Message=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$r||(_t7$r=_$13`
  font-size: 13px;
  font-weight: 500;
  overflow: hidden;
  color: hsl(0, 0%, 34%);
...
`),({theme:{colors:colors}})=>colors.divider),renderNotifications=(items,type)=>items.map((item,index)=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NotificationWrapper,{key:`alert-${type}-${index}`},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NotificationItem,Object.assign({},item)))),NotificationsHistory=({read:read,unread:unread,noNotificationsText:_noNotificationsText="No new notifications",readNotificationsText:_readNotificationsText="New",unreadNotificationsText:_unreadNotificationsText="Read"})=>0===read.length&&0===unread.length?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$G,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StatusContainer,null,_noNotificationsText)):react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$G,null,unread&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StatusContainer,null,_readNotificationsText),renderNotifications(unread,"unread")),read&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StatusContainer,null,_unreadNotificationsText),renderNotifications(read,"read")));let _t$15,_t2$_,_t3$Q,_t4$M,_t5$I,_t6$v,_t7$s,_t8$q,_t9$n,_t10$k,_t11$h,_t12$b,_t13$a,_t14$8,_$15=t=>t;const Container$H=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$15||(_t$15=_$15`
  ...
  ${0}
`),({theme:theme,theme:{colors:colors}})=>colors&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$_||(_t2$_=_$15`
    border-bottom: ${0} 1px solid;
    box-shadow: 5px 7px 10px 0 hsla(205, 16%, 77%, 0.1);
    background-color:${0};
  `),colors.divider,theme.styles.global.mainMenu.background.backgroundColor)),SearchBar=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$Q||(_t3$Q=_$15`
  margin-left: 25px;
  flex: 0 1 500px;
  display: flex;
  justify-content: center;
  align-items: center;
`)),IconWrapper$4=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$M||(_t4$M=_$15`
  flex: 0 40px;
  width: 5px;
  display: flex;
  justify-content: center;
...
`)),SearchInput=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.input(_t5$I||(_t5$I=_$15`
  font-family: ${0};
  flex: 1;
  height: 35px;
  line-height: 35px;
...
`),({theme:theme})=>theme.fontFamily.data,({theme:{typography:typography}})=>typography.global.topBar.search.value,({theme:{typography:typography}})=>typography.global.topBar.search.placeholder),ButtonArea=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$v||(_t6$v=_$15`
  height: inherit;
  padding-right: 10px;
  display: flex;
`)),DrawerToggle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button.attrs({type:"button"})(_t7$s||(_t7$s=_$15`
  width: 60px;
  margin: 0 5px;
  height: inherit;
  background: none;
  ...
  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$q||(_t8$q=_$15`
  ...
  `),theme.colors.menu.indicator,theme.colors.menu.hover,theme.animation.speed.normal,theme.animation.easing.primary.easeInOut),({isActive:isActive,theme:theme})=>isActive&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t9$n||(_t9$n=_$15`
    &, &:hover {
      border-bottom-color: ${0};
    }
  `),theme.colors.menu.active)),DrawerPortalWrapper=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t10$k||(_t10$k=_$15``)),Drawer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t11$h||(_t11$h=_$15`
  font-family: ${0};
...
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.label(_t2$$||(_t2$$=_$17`
  ...
  padding-bottom: 14px;
  flex-shrink: 0;
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$R||(_t3$R=_$17`
    font-family: ${0};
  `),theme.fontFamily.ui),({active:active})=>active?"600":"500",({active:active})=>active?"#0097ce":"#787878",({active:active})=>active?"2px solid #0097ce":"2px solid transparent");let _t$18;const Container$I=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$18||(_t$18=(t=>t)`
`)),TabContent=({children:children,tabId:tabId,...props})=>{const{selected:selected}=Object(react__WEBPACK_IMPORTED_MODULE_1__.useContext)(TabContext);return selected===tabId?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$I,Object.assign({},props),children):null};let _t$19,_t2$10,_t3$S,_t4$N,_$19=t=>t;const Container$J=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t$19||(_t$19=_$19`
  ${0}
  flex-basis: auto;
  flex-grow: 1;
`),resetButtonStyles),LinkTab=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$10||(_t2$10=_$19`
    display: flex;
    justify-content: center;
    align-items: center;
    height: 100%;
  ...
  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$S||(_t3$S=_$19`
    transition: border ${0} ${0};
    border-bottom: 5px solid ${0};
...
`),({active:active})=>active?Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$11||(_t2$11=_$1a`
    border-bottom: 3px solid hsl(196, 100%, 40%);
    `)):Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$T||(_t3$T=_$1a`
    border-bottom: 3px solid transparent;
  `)),IconWrapper),Title$4=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$O||(_t4$O=_$1a`
  font-size: 14px;
  font-family: ${0};
  letter-spacing: 0.09px;
  font-weight: 500;
  ...
  white-space: nowrap;
  text-overflow: ellipsis;
`),({theme:theme})=>theme.fontFamily.ui,({active:active})=>active?"hsl(196, 100%, 40%)":"hsl(0, 0%, 46%)"),SubTitle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$J||(_t5$J=_$1a`
  font-size: 12px;
  font-family: ${0};
  font-style: italic;
  color: hsla(195, 10%, 52%, 0.72);
...
`),resetButtonStyles,({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$13||(_t2$13=_$1c`
    font-family: ${0};
    ${0};
    ${0};
    border-top: 1px solid ${0};
  `),theme.fontFamily.ui,theme.typography.global.mainMenu.menuItem.default,theme.styles.global.mainMenu.background,theme.colors.divider),50),IconContainer$2=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$U||(_t3$U=_$1c`
  height: inherit;
  position: absolute;
  top: 0;
  left: 0;
...
`),({theme:theme})=>theme.styles.global.mainMenu.background),MobileUserMenu=({closeId:closeId,hasLanguage:hasLanguage,hasLogout:hasLogout,logoutLink:logoutLink,hasCurrentUser:hasCurrentUser,userSubmenu:userSubmenu,userDrawerBespoke:userDrawerBespoke,loggedInUser:loggedInUser,onLogout:onLogout,onLanguageToggle:onLanguageToggle})=>{const{setSelected:setSelected}=Object(react__WEBPACK_IMPORTED_MODULE_1__.useContext)(TabContext),handleCloseMenu=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(()=>{setSelected(closeId)},[closeId,setSelected]);return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$O,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(UserMenu,Object.assign({},{hasLanguage:hasLanguage,hasLogout:hasLogout,logoutLink:logoutLink,hasCurrentUser:hasCurrentUser,userSubmenu:userSubmenu,userDrawerBespoke:userDrawerBespoke,loggedInUser:loggedInUser,onLogout:onLogout,onLanguageToggle:onLanguageToggle},{closeOnClick:handleCloseMenu})))};let _t$1h,_t2$17,_$1h=t=>t;const CLOSE_ID="closeMenu",Container$P=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.nav(_t$1h||(_t$1h=_$1h`
  ...
  width: 100%;
  z-index: 99;
`),({theme:theme})=>theme.styles.global.mainMenu.background.backgroundColor),HeaderContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$17||(_t2$17=_$1h`
  display: flex;
  flex-direction: row;
  height: ${0}px;
  border-bottom: ${0} 1px solid;
...
`),68,({theme:theme})=>theme.colors.divider,TabListWrapper),MobileNavbar=({content:content,home:home,logoMark:logoMark,supportUrl:supportUrl,defaultMenuOpen:_defaultMenuOpen=!0,closeText:closeText,hasLanguage:hasLanguage,hasLogout:hasLogout,logoutLink:logoutLink,hasCurrentUser:hasCurrentUser,hasNotifications:hasNotifications,userSubmenu:userSubmenu,userDrawerBespoke:userDrawerBespoke,loggedInUser:loggedInUser,notificationsHistory:notificationsHistory,customDrawer:customDrawer,onLogout:onLogout,onLanguageToggle:onLanguageToggle})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$P,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Tabs,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(HeaderContainer,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileLogoLink,Object.assign({},{home:home,logoMark:logoMark},{closeId:CLOSE_ID})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TabList,{defaultTabId:CLOSE_ID},customDrawer&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileTab,Object.assign({},customDrawer,{tabFor:"custom",closeId:CLOSE_ID})),hasNotifications?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileTab,{tabFor:"notifications",icon:"Notifications",closeId:CLOSE_ID}):null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileTab,{tabFor:"user",icon:"UserProfile",closeId:CLOSE_ID}),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileTab,{tabFor:"menu",icon:"Menu",closeId:CLOSE_ID}))),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileNavbarContent,{closeId:CLOSE_ID},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TabContent,{tabId:"custom"},customDrawer&&customDrawer.customComponent),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TabContent,{tabId:"notifications"},notificationsHistory&&hasNotifications?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NotificationsHistory,Object.assign({},notificationsHistory)):null),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TabContent,{tabId:"user"},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileUserMenu,Object.assign({},{hasLanguage:hasLanguage,hasLogout:hasLogout,logoutLink:logoutLink,hasCurrentUser:hasCurrentUser,userSubmenu:userSubmenu,userDrawerBespoke:userDrawerBespoke,loggedInUser:loggedInUser,onLogout:onLogout,onLanguageToggle:onLanguageToggle},{closeId:CLOSE_ID}))),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TabContent,{tabId:"menu"},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileMenu,Object.assign({},{content:content,supportUrl:supportUrl,defaultMenuOpen:_defaultMenuOpen},{closeId:CLOSE_ID}))),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(CloseButton$1,Object.assign({},{closeText:closeText},{closeId:CLOSE_ID}))))),GlobalUI=({content:content,home:home,openWidth:openWidth,logoMark:logoMark,logoText:logoText,supportUrl:supportUrl,defaultMenuOpen:defaultMenuOpen,paddingOverride:paddingOverride,maxWidth:maxWidth,children:children,...props})=>{const{isLarge:isLarge}=useBreakpoints();return isLarge?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Layout,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MainMenu,Object.assign({},{content:content,home:home,openWidth:openWidth,logoMark:logoMark,logoText:logoText,supportUrl:supportUrl,defaultMenuOpen:defaultMenuOpen})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MainContainer,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TopBar,Object.assign({},{...props})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ContentArea,Object.assign({},{maxWidth:maxWidth,paddingOverride:paddingOverride}),children))):react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileLayout,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileNavbar,Object.assign({},{content:content,home:home,logoMark:logoMark,supportUrl:supportUrl,defaultMenuOpen:defaultMenuOpen,...props})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ContentArea,null,children))};let _t$1i,_t2$18,_t3$X,_t4$Q,_t5$K,_t6$x,_t7$t,_t8$r,_t9$o,_$1i=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$1i||(_t$1i=_$1i`
  ...
  display: flex;
  flex-direction: column;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$18||(_t2$18=_$1i`
  height: 84px;
  color: hsl(205, 7%, 35%);
  ...
  padding-top: 18px;
  padding-bottom: 15px;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$X||(_t3$X=_$1i`
  height: 31px;
  font-family: Monorale;
  font-size: 18px;
  font-weight: 500;
  ...
  text-align: center;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$Q||(_t4$Q=_$1i`
  height: 19px;
  font-family: Monorale;
  font-size: 16px;
  font-weight: 300;
  ...
  text-align: center;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$K||(_t5$K=_$1i`
  position: relative;
  border-bottom: 1px solid hsla(0, 0%, 84%, 50%);
  padding: 22px 20px 21px 20px;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$x||(_t6$x=_$1i`
  font-size: 14px;
  font-weight: 500;
  letter-spacing: 0.35px;
  color: hsl(0, 0%, 50%);
  margin-bottom: 18px;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$t||(_t7$t=_$1i`
  font-size: 14px;
  font-weight: 500;
  letter-spacing: 0.35px;
  color: hsl(0, 0%, 50%);
`)),Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_27__.a)(_t8$r||(_t8$r=_$1i`
  font-size: 14px;
  font-weight: 500;
  letter-spacing: 0.35px;
  color: hsl(0, 0%, 50%);
`)),Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_27__.a)(_t9$o||(_t9$o=_$1i`
  position: absolute;
  right: 30px;
  top: 15px;
  /* width: 80px; */

...
`)),ContentBox=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$r||(_t3$r=_$z`
  ...
  ${0};
`),({min_width:min_width})=>min_width,({openState:openState,disabled:disabled})=>openState&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$n||(_t4$n=_$z`
    display: ${0};
    display: ${0};
  ...
  `),openState.isOpen?"inline-block":"none",disabled&&"none","bottom-right"===openState.position&&"\n      bottom: 0;\n      left: 0;\n      transform: translateY(calc(100% + 5px ));\n    ","bottom-left"===openState.position&&"\n      bottom: 0;\n      right: 0;\n      transform: translateY(calc(100% + 5px ));\n    ","top-left"===openState.position&&"\n      top: 0;\n      right: 0;\n      transform: translateY(calc( -100% - 5px ));\n    ","top-right"===openState.position&&"\n      top: 0;\n      left: 0;\n      transform: translateY(calc( -100% - 5px ));\n    ")),FilterDropHandler=({buttonIcon:buttonIcon,buttonText:buttonText,disabled:_disabled=!1,min_width:_min_width=270,min_height:_min_height=190,children:children,onToggleOpenCallback:_onToggleOpenCallback=(()=>{}),onCloseCallback:_onCloseCallback=(()=>{}),...props})=>{const[openState,setOpenState]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)({isOpen:!1,position:"bottom-right"}),buttonWrapperRef=Object(react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null),mainRef=Object(react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);useClickOutside(mainRef,Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(()=>{openState.isOpen&&_onCloseCallback(),setOpenState(prev=>({...prev,isOpen:!1}))},[_onCloseCallback,openState.isOpen]));const handleToggleOpen=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)((min_width,min_height)=>{if(!buttonWrapperRef.current)return;const buttonRect=buttonWrapperRef.current.getBoundingClientRect();if(!buttonRect)return;const position=((buttonRect,min_width,min_height)=>{let position="bottom-right";const openLeft=buttonRect.left+min_width>window.innerWidth,openTop=buttonRect.bottom+min_height>window.innerHeight,spaceTop=buttonRect.bottom>min_height;return openLeft&&openTop&&spaceTop&&(position="top-left"),openTop&&!openLeft&&spaceTop&&(position="top-right"),!openTop&&openLeft&&(position="bottom-left"),position})(buttonRect,min_width,min_height);_onToggleOpenCallback(openState.isOpen),setOpenState(prev=>{const isOpen=!prev.isOpen;return{...prev,isOpen:isOpen,position:position}})},[_onToggleOpenCallback,openState.isOpen]);return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$m,Object.assign({ref:mainRef},props),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ButtonWrapper,{ref:buttonWrapperRef},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(FilterButton,Object.assign({icon:buttonIcon,isOpen:openState.isOpen,hasFlipArrow:!0,onClick:()=>handleToggleOpen(_min_width,_min_height)},{disabled:_disabled}),buttonText)),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ContentBox,Object.assign({},{openState:openState,disabled:_disabled,min_width:_min_width}),children))};let _t$A,_t2$y,_t3$s,_t4$o,_t5$l,_t6$j,_t7$i,_t8$h,_t9$g,_t10$d,_t11$9,_$A=t=>t;const Container$n=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$A||(_t$A=_$A`
  display: inline-block;
  position: relative;
`)),TopLine$1=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$y||(_t2$y=_$A`
  ${0};
  height: 3px;
  border-top-left-radius: 3px;
  border-top-right-radius: 3px;
`),({theme:theme})=>theme.styles.filters.dropdownContainer.topBorder),InnerBox=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$s||(_t3$s=_$A`
  border-bottom-left-radius: 3px;
  border-bottom-right-radius: 3px;
  box-shadow: 0 4px 9px 0 hsla(204, 22%, 67%, 0.07);
  ...
  background-color: hsl(200, 23%, 97%);
`)),LoadingBox=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$o||(_t4$o=_$A`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`)),StatusCounter=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$C||(_t2$C=_$F`
  ...
  ${0}
  background-color: ${0};
`),({theme:{animation:animation}})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$w||(_t3$w=_$F`
    transition: background-color ${0} ${0};
  `),animation.speed.slow,animation.easing.primary.easeInOut),({theme:theme,color:color})=>color?theme.colors.status[color]:"hsla(0, 0%, 91.8%, 0)"),StatusDot=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$r||(_t4$r=_$F`
  width: 10px;
  height: 10px;
  ...
  ${0}
  background-color: ${0};
`),({theme:{animation:animation}})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$o||(_t5$o=_$F`
    transition: background-color ${0} ${0};
  `),animation.speed.slow,animation.easing.primary.easeInOut),({theme:theme,color:color})=>color?theme.colors.status[color]:"hsla(0, 0%, 91.8%, 0)"),StatusIcon=({icon:icon,status:status,counter:counter})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$s,null,status&&void 0===counter?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StatusDot,{color:status}):void 0===counter?null:react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StatusCounter,{color:status},counter),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Icon,{icon:icon,size:18,color:"dimmed"}));let _t$G,_t2$D,_t3$x,_t4$s,_t5$p,_t6$m,_t7$l,_t8$k,_t9$h,_t10$e,_t11$a,_t12$5,_t13$4,_t14$3,_t15$2,_t16$2,_t17$2,_$G=t=>t;const HandleTouchReactionKeyframes=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.e)(_t$G||(_t$G=_$G`
 0% {
    transform: scale(1);
 }
...
`)),HandleMouseReactionKeyframes=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.e)(_t2$D||(_t2$D=_$G`
 0% {
    transform: scale(1);
 }
...
`));styled_components__WEBPACK_IMPORTED_MODULE_2__.d.svg(_t3$x||(_t3$x=_$G`
  touch-action: none;
  user-select: none;
  overflow: visible;
  cursor: pointer;
  fill: ${0};
  appearance: none;
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].handleBase.fill),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.circle(_t4$s||(_t4$s=_$G`
  fill: none;
  stroke: ${0};
  mask: url(#${0});
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].handleRingLayer.stroke,props=>props.maskID),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t5$p||(_t5$p=_$G`
  opacity: 0.65;
  cursor: pointer;
  transform: scale(1);
...
`),props=>props.touchDragging&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$m||(_t6$m=_$G`
    animation: ${0} 0.5s forwards cubic-bezier(0.175, 0.885, 0.32, 1.275) 1;
  `),HandleTouchReactionKeyframes),props=>props.mouseDragging&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t7$l||(_t7$l=_$G`
    animation: ${0} 0.25s forwards cubic-bezier(0.175, 0.885, 0.32, 1.275) 1;
  `),HandleMouseReactionKeyframes)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.circle(_t8$k||(_t8$k=_$G`
  mix-blend-mode: multiply;
  fill: ${0};
  stroke: none;
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].handleReactiveFill.fill),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.circle(_t9$h||(_t9$h=_$G`
  fill: none;
  stroke: ${0};
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].handleReactiveRing.stroke),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.circle(_t10$e||(_t10$e=_$G`
  overflow: visible;
  mix-blend-mode: multiply;
  fill: none;
  stroke: ${0};
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].handleContrastLayer.stroke),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.circle(_t11$a||(_t11$a=_$G`
    mix-blend-mode: multiply;
    fill: url(#${0});
`),props=>props.fillID),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t12$5||(_t12$5=_$G`
  opacity: 0;
  pointer-events: none;
  ${0};

`),props=>props.showIndex&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t13$4||(_t13$4=_$G`
    opacity: 1;
  `))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.stop(_t14$3||(_t14$3=_$G`
  stop-color: ${0};
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].stopStart.stopColor),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.stop(_t15$2||(_t15$2=_$G`
  stop-color: ${0};
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].stopEnd.stopColor),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.text(_t16$2||(_t16$2=_$G`
...
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].grabHandleText.stroke),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t17$2||(_t17$2=_$G`

`));let _t$H,_t2$E,_t3$y,_t4$t,_t5$q,_t6$n,_t7$m,_t8$l,_t9$i,_t10$f,_t11$b,_$H=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.line(_t$H||(_t$H=_$H`
  pointer-events: none;
  stroke: ${0};
  mix-blend-mode: multiply;
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].contrastLine.stroke),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.line(_t2$E||(_t2$E=_$H`
  pointer-events: none;
  stroke: ${0};
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].highlightLine.stroke);const GrabHandle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.circle(_t3$y||(_t3$y=_$H`
  fill: ${0};
  stroke: ${0};
  opacity: 1;
  transition: opacity 250ms ease;
  ...
  ${0};
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].grabHandle.fill,({theme:theme,styling:styling})=>theme.custom.lines[styling].grabHandle.stroke,props=>props.hide&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$t||(_t4$t=_$H`
    pointer-events: none;
    opacity: 0;
  `))),GrabHandleContrast=(styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t5$q||(_t5$q=_$H`
  opacity: 0;
  pointer-events: none;
  ${0};

`),props=>props.showIndex&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$n||(_t6$n=_$H`
    opacity: 1;
  `))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.text(_t7$m||(_t7$m=_$H`
  font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
  text-align: center;
  fill: ${0};
  font-weight: bold;
  transition: opacity 250ms ease;
  pointer-events: none;
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].grabHandleText.stroke),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.text(_t8$l||(_t8$l=_$H`
  text-align: center;
  fill: ${0};
  font-weight: bold;
  transition: opacity 250ms ease;
  pointer-events: none;
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].label.fill),Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(GrabHandle)(_t9$i||(_t9$i=_$H`
  fill: none;
  stroke: ${0};
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].grabHandleContrast.stroke));styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t10$f||(_t10$f=_$H`
  ...
  ${0};
`),GrabHandle,GrabHandleContrast,props=>props.showIndex&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t11$b||(_t11$b=_$H`
    ${0}, ${0} {
      pointer-events: none;
      r: ${0};
    }
  `),GrabHandle,GrabHandleContrast,1.75*props.originalRadius)),Object(react__WEBPACK_IMPORTED_MODULE_1__.createContext)({});let _t$I,_t2$F,_$I=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.circle(_t$I||(_t$I=_$I`
  fill: ${0};
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].point.fill),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.text(_t2$F||(_t2$F=_$I`
  text-align: center;
  fill: ${0};
  font-weight: bold;
  transition: opacity 250ms ease;
  pointer-events: none;
`),({theme:theme,styling:styling})=>theme.custom.lines[styling].label.fill);let _t$J,_t2$G,_t3$z,_t4$u,_t5$r,_$J=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$J||(_t$J=_$J`
  position: relative;
  line-height: 0;
  user-select: none;
  touch-action: none;
...
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$G||(_t2$G=_$J`
  position: absolute;
  top:0;
  bottom: 0;
  left: 0;
  ...
  align-items: center;
  justify-content: center;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.svg(_t3$z||(_t3$z=_$J`
  touch-action: none;
  user-select: none;
  margin: 0;
...
`),props=>props.transculent&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$u||(_t4$u=_$J`
    background: hsla(0deg, 0%, 0%, 35%);
  `))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.img(_t5$r||(_t5$r=_$J`
  object-fit: contain;
  width:  100%;
  height: 100%;
`));let _t$K,_t2$H,_t3$A,_t4$v,_t5$s,_$K=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$K||(_t$K=_$K`
  ...
  width: auto;
  /* transform: translateY(-70%); */
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.video(_t2$H||(_t2$H=_$K`
  width:  100%;
  height: 100%;
  border-radius: 3px;
...
`),props=>props.transcalent&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$s||(_t5$s=_$K`
    background: hsla(0deg, 0%, 0%, 35%);
  `)));let _t$L;const Video$1=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.video(_t$L||(_t$L=(t=>t)`
  /* width: 800px; */
`));let _t$M,_t2$I,_t3$B,_t4$w,_t5$t,_$M=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$M||(_t$M=_$M`
  position: relative;
  line-height: 0;
  user-select: none;
  touch-action: none;
...
`)),Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(({id:_id="1",enabled:enabled,peerAddress:peerAddress,maxConnectionAttempts:_maxConnectionAttempts=30,rtcConfiguration:_rtcConfiguration={},setStatus:_setStatus=(()=>{}),setError:_setError=(()=>{}),autoPlay:_autoPlay=!0,muted:_muted=!0,...props})=>{const[connectionAttempts,setConnectionAttempts]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)(0),videoRef=Object(react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null),webSocket=Object(react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null),peerConnection=Object(react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);function handleIncomingError(error){_setError(error),closeWebSocket()}const onServerMessage=({data:_data=""})=>{if("HELLO"===_data)console.debug("Received HELLO"),_setStatus("Registered with server, waiting for offer.");else if(_data.startsWith("ERROR"))console.error("Received "+_data),handleIncomingError(_data);else{let msg;try{msg=JSON.parse(_data)}catch(e){return void(e instanceof SyntaxError?handleIncomingError("Error parsing incoming JSON: "+_data):handleIncomingError("Unknown error parsing response: "+_data))}peerConnection.current||function createCall(msg){if(setConnectionAttempts(0),console.debug("Creating RTCPeerConnection"),!msg.sdp)return void console.debug("WARNING: First message wasn't an SDP message!?");const pc=new RTCPeerConnection(_rtcConfiguration);peerConnection.current=pc,pc.addEventListener("track",onRemoteTrack),pc.addEventListener("icecandidate",({candidate:_candidate=null})=>{_candidate?webSocket.current?webSocket.current.send(JSON.stringify({ice:_candidate})):console.debug("no WS found on peer connection 'icecandidate' event... how?"):console.debug("All local ICE Candidates sent.")}),_setStatus("RTCPeerConnection created, waiting for SDP")}(msg),null!=msg.sdp?(console.debug("Received Remote SDP:"+JSON.stringify(msg.sdp)),(async description=>{if(!peerConnection.current||!webSocket.current)return;try{"offer"===description.type&&"stable"!==peerConnection.current.signalingState?await Promise.all([peerConnection.current.setLocalDescription({type:"rollback"}),peerConnection.current.setRemoteDescription(description)]):(description.sdp&&(description.sdp=description.sdp.replace(/profile-level-id=(640028|64001f|64002a);/,"")),await peerConnection.current.setRemoteDescription(new RTCSessionDescription(description)),_setStatus("Remote Description set"))}catch(error){return console.error("Error:",error),void _setError("Error Setting remote description")}if("offer"!==description.type)return;_setStatus("Creating Answer");try{const answer=await peerConnection.current.createAnswer();console.debug("Got local description: "+JSON.stringify(answer)),await peerConnection.current.setLocalDescription(answer)}catch(error){return console.error("Error:",error.message),void _setError("Error Creating Answer")}const message={sdp:peerConnection.current.localDescription};_setStatus("Sending Local Description");try{await webSocket.current.send(JSON.stringify(message)),_setStatus("Connected")}catch(error){console.error(error.name+": "+error.message),_setError(error.message)}})(msg.sdp)):null!=msg.ice?(console.debug("Received Remote ICE:"+JSON.stringify(msg.ice)),function onIncomingICE(ice){if(!peerConnection.current)return void console.error("peerConnection.current not found onIncomingICE ");const candidate=new RTCIceCandidate(ice);peerConnection.current.addIceCandidate(candidate).catch(_setError)}(msg.ice)):handleIncomingError("Unknown incoming JSON: "+msg)}};function onServerClose(event){console.debug("serverClose"),webSocket.current&&(_setStatus("Disconnected from server"),closePeerConnection(),null!==event&&1e3!==event.code&&enabled&&window.setTimeout(connectToPeer,3e3))}function onServerError(event){console.debug(event),_setError("Unable to connect to server"),closeWebSocket()}function connectToPeer(){if(console.debug("connectToPeer",connectionAttempts),connectionAttempts>=_maxConnectionAttempts)return void _setError("Too many connection attempts, aborting. Refresh page to try again");_setError(null);const peerId=function getPeerId(id){return"WRP_"+id+"_"+Math.floor(8990*Math.random()+10).toString()}(_id);_setStatus("Connecting to server "+peerAddress);const ws=new WebSocket(peerAddress);webSocket.current=ws,ws.addEventListener("open",()=>{const interval=setInterval(()=>{try{ws.send("HELLO "+peerId),clearInterval(interval),_setStatus("Registering with server (sent HELLO) for peer id: "+peerId)}catch(error){console.debug(error)}},3e3)}),ws.addEventListener("error",onServerError),ws.addEventListener("message",onServerMessage),ws.addEventListener("close",onServerClose),setConnectionAttempts(connectionAttempts+1)}function onRemoteTrack(event){videoRef.current&&videoRef.current.srcObject!==event.streams[0]&&(console.debug("Incoming stream"),videoRef.current.srcObject=event.streams[0],_setStatus("Adding Track"))}const closeWebSocket=async()=>{console.debug("closeWebSocket"),await closePeerConnection(),webSocket.current&&(await webSocket.current.close(),webSocket.current=null)},closePeerConnection=async()=>{console.debug("closePeerConnection"),peerConnection.current&&(await peerConnection.current.close(),peerConnection.current=null)};return Object(react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>(!0===enabled?connectToPeer():webSocket.current&&webSocket.current.close(1e3,"WebRTC Disabled"),()=>{console.debug("cleanup"),closeWebSocket()}),[enabled]),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Video$1,Object.assign({},props,{autoPlay:_autoPlay,muted:_muted,ref:videoRef}))})(_t2$I||(_t2$I=_$M`
  ...
  border-radius: 3px;
  background-color: hsla(0deg, 0%, 0%, 35%);
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$B||(_t3$B=_$M`
  position: absolute;
  top:0;
  bottom: 0;
  left: 0;
...
`),props=>props.transcalent&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$t||(_t5$t=_$M`
    background: hsla(0deg, 0%, 0%, 35%);
  `)));const makeTitle=(parts,delimiter="|")=>{let title="";return delimiter=" "+delimiter+" ",parts.forEach((part,key)=>{title+=part,parts.length-1!==key&&(title+=delimiter)}),title};let _t$N,_t2$J,_t3$C,_t4$x,_t5$u,_t6$o,_t7$n,_t8$m,_$N=t=>t;const Container$w=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$N||(_t$N=_$N`
  position: relative;
`)),IconContainer$1=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$J||(_t2$J=_$N`
  position: absolute;
  left: -45px;
  bottom: 0;
  height: 30px;
...
`)),Title$3=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.h1(_t3$C||(_t3$C=_$N`
  ${0}
  margin: 0 0 20px;
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$x||(_t4$x=_$N`
    font-family: ${0};
    ${0};
  `),theme.fontFamily.ui,theme.typography.pageHeader.mainTitle)),AreaTitleCss=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$u||(_t5$u=_$N`
  ${0}
  margin: 0;
  position: absolute;
  top: -18px;
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$o||(_t6$o=_$N`
  font-family: ${0};
  ${0};
  `),theme.fontFamily.ui,theme.typography.pageHeader.areaTitle)),AreaTitle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$n||(_t7$n=_$N`
  ${0}
`),AreaTitleCss),AreaLinkTitle=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_27__.a)(_t8$m||(_t8$m=_$N`
  ${0}
  &:hover {
    text-decoration: underline;
  }
`),AreaTitleCss),PageTitle=({title:title,icon:icon,areaTitle:areaTitle,areaHref:areaHref,updateDocTitle:_updateDocTitle=!0})=>(_updateDocTitle&&((title,area,delimiter)=>{const[baseTitle]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)(document.title);Object(react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{document.title=makeTitle([...title?[title]:[],...area?[area]:[],baseTitle],delimiter)},[title,area])})(title,areaTitle||""),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$w,null,areaTitle&&areaHref?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(AreaLinkTitle,{to:areaHref},areaTitle):areaTitle&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(AreaTitle,null,areaTitle),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Title$3,null,title),icon?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(IconContainer$1,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Icon,Object.assign({size:24,color:"dimmed"},{icon:icon}))):null));let _t$O,_t2$K,_$O=t=>t;const Container$x=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.p(_t$O||(_t$O=_$O`
  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$K||(_t2$K=_$O`
    font-family: ${0};
    ${0};
  `),theme.fontFamily.ui,theme.typography.pageHeader.introduction)),IntroductionText=({children:children})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$x,null,children);let _t$P;const Container$y=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$P||(_t$P=(t=>t)``)),PageHeader=({title:title,icon:icon,introductionText:introductionText,areaHref:areaHref,areaTitle:areaTitle,updateDocTitle:_updateDocTitle=!0})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$y,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(PageTitle,Object.assign({},{title:title,icon:icon,areaHref:areaHref,areaTitle:areaTitle,updateDocTitle:_updateDocTitle})),introductionText?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(IntroductionText,null,introductionText):null);let _t$Q;const Container$z=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$Q||(_t$Q=(t=>t)`
  display: flex;
  flex-direction: column;
`)),MultilineContent=({contentArray:contentArray})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$z,null,contentArray.map((element,index)=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div",{key:"element-"+index},element)));let _t$R,_t2$L,_t3$D,_t4$y,_t5$v,_t6$p,_t7$o,_t8$n,_$R=t=>t;const Container$A=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$R||(_t$R=_$R`
  position: relative;
  line-height: 0;
`)),mediaStyle="\n  max-width:  100%;\n  max-height: 100%;\n  border-radius: 3px;\n  background-color: hsla(0deg, 0%, 0%, 35%);\n",LoadingOverlay$3=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$L||(_t2$L=_$R`
  position: absolute;
  top:0;
  bottom: 0;
  left: 0;
...
`),mediaStyle,({theme:theme,isLoaded:isLoaded,hasModalLimits:hasModalLimits})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t7$o||(_t7$o=_$R`
  ...
  font-family: ${0};
  z-index: 999;
`),({theme:theme})=>theme.fontFamily.ui),CloseIcon=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(Icon)(_t2$M||(_t2$M=_$S``)),CloseButton=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t3$E||(_t3$E=_$S`
  ${0};
  display: flex;
  align-items: center;
  justify-content: center;
...
`),resetButtonStyles,({theme:theme})=>theme.colors.icons.dimmed,IconWrapper,({selected:_selected=!1})=>_selected&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$z||(_t4$z=_$S`
    border-bottom: 5px solid hsl(207, 80%, 64%);
  `)),({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$w||(_t5$w=_$S`
      opacity: .8;
      transition: transform ${0} ${0};
    `),theme.animation.speed.normal,theme.animation.easing.primary.inOut)),LightBox=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$q||(_t6$q=_$S`
  position: relative;
  margin: 27px 0 0;
...
`),({aspect:aspect})=>"16:9"===aspect&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$N||(_t2$N=_$T`
      padding-left: 56.25%;
    `)),({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$F||(_t3$F=_$T`
    transition:
      opacity ${0} ${0},
      transform ${0} ${0};
  `),theme.animation.speed.normal,theme.animation.easing.primary.easeOut,theme.animation.speed.fast,theme.animation.easing.primary.easeOut),({mediaUrl:mediaUrl,hasPreview:hasPreview})=>mediaUrl&&hasPreview&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$A||(_t4$A=_$T`
      cursor: pointer;
    `)),({theme:theme,hoverZoom:hoverZoom,isImageValid:isImageValid})=>theme&&hoverZoom&&isImageValid&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$x||(_t5$x=_$T`
      transform: scale(1.5);
      opacity: 1;
      transition: transform ${0} ${0};
    `),theme.animation.speed.normal,theme.animation.easing.primary.easeOut)),Image$2=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$r||(_t6$r=_$T`
  position: absolute;
  left: 0;
  top: 0;
  right: 0;
  ...
  display: ${0};
`),p=>p.image,p=>p.image?"block":"none"),PlayableDrop=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$p||(_t7$p=_$T`
  position: absolute;
  left: 50%;
  top: 50%;
...
`),({status:status,theme:{colors:colors}})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$O||(_t2$O=_$U`
    background: ${0};
    content:'${0}';
  `),colors.status[status],status)),TypeTableDeviceStatus=({status:_status="neutral"})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$D,{status:_status});let _t$V,_t2$P,_t3$G,_t4$B,_t5$y,_t6$s,_t7$q,_t8$o,_t9$j,_t10$g,_t11$c,_$V=t=>t;const CopyToClipboard=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t$V||(_t$V=_$V`
...
`),({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$P||(_t2$P=_$V`
    transition: ${0} ${0};
  `),theme.animation.speed.normal,theme.animation.easing.easeOut)),CellContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$G||(_t3$G=_$V`
  display: table-cell;
  height: 50px;
  vertical-align: middle;
  position: relative;
  ...
  ${0}
`),p=>p.theme.fontFamily.data,CopyToClipboard,({theme:theme,cellStyle:cellStyle,alignment:alignment})=>"firstColumn"===cellStyle?Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$B||(_t4$B=_$V`
      ${0};
    `),theme.typography.table.columnData[cellStyle]):Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$y||(_t5$y=_$V`
      ${0};
    `),theme.typography.table.columnData[cellStyle][alignment]),({hasCopyButton:hasCopyButton})=>hasCopyButton&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$s||(_t6$s=_$V`
    padding-right: 20px;
  `)),({hideDivider:hideDivider})=>!hideDivider&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t7$q||(_t7$q=_$V`
    &::after {
      content: '';
      display: block;
      height: 1px;
  ...
  `))),UnitText=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.span(_t8$o||(_t8$o=_$V`
  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t9$j||(_t9$j=_$V`
    ${0};
  `),theme.typography.table.columnData.unit)),StatusBlip=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t10$g||(_t10$g=_$V`
  display: inline-block;
  width: 10px;
  height: 10px;
  border-radius: 50%;
...
`),({isEmpty:isEmpty})=>isEmpty&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$Q||(_t2$Q=_$W`
  ...
  ${0}
`),IconWrapper,({ascending:ascending})=>ascending&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$R||(_t2$R=_$X`
      ...
      border-top-left-radius: 0;
      top: 0;
    `)),({isSortActive:isSortActive})=>isSortActive&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$H||(_t3$H=_$X`
    &:not(hover) {
      ${0} {
        display: inline-flex;
      }
    }
  `),IconWrapper),({sortable:sortable})=>sortable&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$C||(_t4$C=_$X`
    &:hover {
...
`)),HeaderItem=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$S||(_t2$S=_$Y`
  ...
  ${0};
`),p=>p.theme.fontFamily.ui,({hasCopyButton:hasCopyButton})=>hasCopyButton&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$I||(_t3$I=_$Y`
    padding-right: 20px;
  `)),({theme:theme,alignment:alignment,headerStyle:headerStyle})=>alignment?Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$D||(_t4$D=_$Y`
    ${0};
  `),theme.typography.table[headerStyle][alignment]):Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$z||(_t5$z=_$Y`
    ${0};
  `),theme.typography.table[headerStyle].left),p=>p.fixedWidth&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$t||(_t6$t=_$Y`
    width: ${0}px;
  `),p.fixedWidth),({minWidth:minWidth})=>minWidth&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t7$r||(_t7$r=_$Y`
    min-width:${0}px;
  `),minWidth),({headerStyle:headerStyle,isSortActive:isSortActive})=>"subHeader"===headerStyle&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$p||(_t8$p=_$Y`
  padding-bottom: 15px;
...
`),isSortActive?"-15px":"0",isSortActive?"calc(100% + 15px)":"100%")),TitleItems=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t9$k||(_t9$k=_$Y`
  display: flex;
  flex-direction: column;
  align-items: flex-start;
  ${0};
`),({alignment:alignment})=>alignment&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t10$h||(_t10$h=_$Y`
      ${0};
      ${0};
  `),"right"===alignment?"align-items: flex-end":null,"center"===alignment?"align-items: center":null)),GroupTitle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t11$d||(_t11$d=_$Y`
  display: flex;
  flex-direction: row;
  align-items: center;
  align-self: stretch;
  margin-bottom: 4px;
`)),Title$4=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t12$6||(_t12$6=_$Y`
  padding-left: 2px;
  padding-right: 8px;
...
`),({theme:theme})=>theme.colors.pureBase,LoadingText$1),EmptyTableBox=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$A||(_t5$A=_$Z`
  position: absolute;
  left: 0;
  z-index: 99;
  padding: 20px;
...
`)),EditContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$u||(_t6$u=_$_`
  min-width: 320px;
  background-color: hsl(0, 0%, 100%);
  z-index: 99;
  position: absolute;
...
`),StyledLabel,StyledButton$4,StyledLoadingButton),StyledIconButton$1=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(IconButton$2)(_t7$s||(_t7$s=_$_``)),TextContainer$2=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t8$q||(_t8$q=_$_`
  display: flex;
  justify-content: space-between;
  align-items: center;
  padding-right: 18px;
...
`),({alignment:alignment})=>"center"===alignment&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t9$l||(_t9$l=_$_`
    justify-content: center;
  `)),({alignment:alignment})=>"right"===alignment&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t10$i||(_t10$i=_$_`
    justify-content: flex-end;
`)),StyledIconButton$1,StyledIconButton$1),EditCell=({type:_type="text",placeholder:_placeholder="",defaultValue:defaultValue,rowKey:rowKey,alignment:_alignment="left",toLink:_toLink="",saveCallback:saveCallback,...props})=>{const[isEditMode,setIsEditMode]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)(!1),[updatedValue,setUpdatedValue]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)(defaultValue),[loading,setLoading]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)(!1),handleSave=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(async value=>{setLoading(!0),saveCallback&&await saveCallback(value,rowKey),setIsEditMode(!1),setLoading(!1)},[rowKey,saveCallback]),verifyKeyPress=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(async eve=>{const code=eve.keyCode|eve.which|parseInt(eve.key,10);13===code&&handleSave&&(await handleSave(updatedValue),setIsEditMode(!1)),27===code&&(setUpdatedValue(defaultValue),setIsEditMode(!1))},[handleSave,updatedValue,defaultValue]),editContainerRef=Object(react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);return useClickOutside(editContainerRef,()=>{setUpdatedValue(defaultValue),setIsEditMode(!1)}),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$F,null,isEditMode?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(EditContainer,{ref:editContainerRef},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(SmallInput,Object.assign({},props,{autoFocus:!0,label:"",disabled:loading,type:_type,placeholder:_placeholder,defaultValue:defaultValue,onKeyUp:eve=>verifyKeyPress(eve),onChange:e=>{setUpdatedValue(e.target.value)}})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledLoadingButton,{onClick:()=>{handleSave(updatedValue)},size:"small",loading:loading},loading?"Saving":"Save"),!loading&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledButton$4,{onClick:()=>setIsEditMode(!1),design:"secondary",size:"small"},"Cancel")):react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TextContainer$2,{alignment:_alignment},_toLink?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledLink,{to:_toLink},updatedValue):updatedValue,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StyledIconButton$1,{icon:"Edit",weight:"light",size:16,onClick:()=>setIsEditMode(!0)})))};Object(react__WEBPACK_IMPORTED_MODULE_1__.createContext)({state:{},dispatch:()=>{},actions:{}});let _t$$,_t2$V,_t3$L,_t4$G,_t5$C,_$$=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t$$||(_t$$=_$$`
  opacity: 0;
  ${0}

`),({active:active})=>active&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$V||(_t2$V=_$$`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t3$L||(_t3$L=_$$`
  opacity: 0;
  ${0}
`),({hover:hover})=>hover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$G||(_t4$G=_$$`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t5$C||(_t5$C=_$$`
`));let _t$10,_t2$W,_t3$M,_t4$H,_t5$D,_t6$v,_$10=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t$10||(_t$10=_$10`
  opacity: 0;
  ${0}

`),({active:active})=>active&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$W||(_t2$W=_$10`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t3$M||(_t3$M=_$10`
  opacity: 0;
  ${0}
`),({hover:hover})=>hover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$H||(_t4$H=_$10`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t5$D||(_t5$D=_$10`
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t6$v||(_t6$v=_$10`

`));let _t$11,_t2$X,_t3$N,_t4$I,_t5$E,_$11=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t$11||(_t$11=_$11`
  opacity: 0;
  ${0}

`),({active:active})=>active&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$X||(_t2$X=_$11`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t3$N||(_t3$N=_$11`
  opacity: 0;
  ${0}
`),({hover:hover})=>hover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$I||(_t4$I=_$11`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t5$E||(_t5$E=_$11`
`));let _t$12,_t2$Y,_t3$O,_t4$J,_t5$F,_$12=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t$12||(_t$12=_$12`
  opacity: 0;
  ${0}

`),({active:active})=>active&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$Y||(_t2$Y=_$12`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t3$O||(_t3$O=_$12`
  opacity: 0;
  ${0}
`),({hover:hover})=>hover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$J||(_t4$J=_$12`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t5$F||(_t5$F=_$12`
`));let _t$13,_t2$Z,_t3$P,_t4$K,_t5$G,_$13=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t$13||(_t$13=_$13`
  opacity: 0;
  ${0}

`),({active:active})=>active&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$Z||(_t2$Z=_$13`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t3$P||(_t3$P=_$13`
  opacity: 0;
  ${0}
`),({hover:hover})=>hover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$K||(_t4$K=_$13`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t5$G||(_t5$G=_$13`
`));let _t$14,_t2$_,_t3$Q,_t4$L,_t5$H,_$14=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t$14||(_t$14=_$14`
  opacity: 0;
  ${0}

`),({active:active})=>active&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$_||(_t2$_=_$14`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t3$Q||(_t3$Q=_$14`
  opacity: 0;
  ${0}
`),({hover:hover})=>hover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$L||(_t4$L=_$14`opacity: 1;`))),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.g(_t5$H||(_t5$H=_$14`
`));let _t$15;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$15||(_t$15=(t=>t)`
  user-select: none;
  display: flex;
  flex-direction: column;
`));let _t$16,_t2$$,_t3$R,_t4$M,_$16=t=>t;const TextContainer$3=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$16||(_t$16=_$16`
  user-select: none;
`)),StyledLink$1=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_27__.a)(_t2$$||(_t2$$=_$16`
  text-decoration: none;
`)),TagWrapper=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$R||(_t3$R=_$16`
  font-family: ${0};
  font-size: ${0}px;
  font-weight: 500;
  color: hsl(200, 3%, 39%);
  ...
  ${0};
`),({theme:theme})=>theme.fontFamily.ui,({size:size})=>size,IconWrapper,({theme:theme})=>theme.colors.icons.dimmed,({theme:theme,hoverColor:hoverColor,enableHover:enableHover})=>enableHover&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$M||(_t4$M=_$16`
    &:hover {
      cursor: pointer;
      border-color: ${0};
      color: ${0};
...
`),TagWrapper),TagList=({tagsConfig:tagsConfig})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TagListWrapper,null,tagsConfig.map((tagProps,index)=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Tag,Object.assign({key:"tag-"+index},tagProps))));const defaultContext$1={sendNotification:()=>console.log("This is the context initialization should not appear")},NotificationContext=react__WEBPACK_IMPORTED_MODULE_1___default.a.createContext(defaultContext$1),notificationList=[],NotificationProvider=({children:children})=>{const[activeNotification,setActiveNotification]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)(null),showNotification=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(()=>{const nextNotification=notificationList.shift();if(!nextNotification)return;const displayedNotification={...nextNotification,closeCallback:()=>{nextNotification.closeCallback&&nextNotification.closeCallback(),setActiveNotification(null),showNotification()}};setActiveNotification(displayedNotification)},[]);return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NotificationContext.Provider,{value:{sendNotification:async newNotification=>{const validNotification={message:newNotification.message,type:newNotification.type};newNotification.actionTextButton&&(validNotification.actionTextButton=newNotification.actionTextButton),newNotification.onTextButtonClick&&(validNotification.onTextButtonClick=newNotification.onTextButtonClick),newNotification.closeCallback&&(validNotification.closeCallback=newNotification.closeCallback),newNotification.isPinned&&(validNotification.isPinned=newNotification.isPinned),notificationList.push(validNotification),1===notificationList.length&&null===activeNotification&&showNotification()}}},activeNotification?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Notification,Object.assign({},activeNotification)):null,children)},useNotification=()=>react__WEBPACK_IMPORTED_MODULE_1___default.a.useContext(NotificationContext);function useMediaQuery(query){const[matches,setMatches]=Object(react__WEBPACK_IMPORTED_MODULE_1__.useState)(!1);return Object(react__WEBPACK_IMPORTED_MODULE_1__.useLayoutEffect)(()=>{const mediaQuery=window.matchMedia(query);setMatches(mediaQuery.matches);const handler=event=>setMatches(event.matches);return mediaQuery.addEventListener("change",handler),()=>mediaQuery.removeEventListener("change",handler)},[]),matches}function useBreakpoints(){const breakpoints={isSmall:useMediaQuery(deviceMediaQuery.small),isMedium:useMediaQuery(deviceMediaQuery.medium),isLarge:useMediaQuery(deviceMediaQuery.large),isXLarge:useMediaQuery(deviceMediaQuery.xlarge),isXXLarge:useMediaQuery(deviceMediaQuery.xxlarge),activeScreen:"small"};return breakpoints.isSmall&&(breakpoints.activeScreen="small"),breakpoints.isMedium&&(breakpoints.activeScreen="medium"),breakpoints.isLarge&&(breakpoints.activeScreen="large"),breakpoints.isXLarge&&(breakpoints.activeScreen="xlarge"),breakpoints.isXXLarge&&(breakpoints.activeScreen="xxlarge"),breakpoints}let _t$18,_t2$10,_t3$S,_t4$N,_t5$I,_$18=t=>t;const Container$N=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$18||(_t$18=_$18``)),Title$5=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$10||(_t2$10=_$18`
  ...
  letter-spacing: normal;
  color: hsl(210, 6%, 47%);
`)),MessageBox$1=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$S||(_t3$S=_$18`
  font-size: 14px;
  font-weight: 500;
  font-stretch: normal;
  font-style: normal;
...
`)),MobileLayout=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$11||(_t2$11=_$19``)),MainContainer=(styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$T||(_t3$T=_$19`
  ...
  ${0}
`),({padBottom:_padBottom=!0})=>_padBottom?"70px 90px":"70px 90px 0",({maxWidth:maxWidth})=>maxWidth&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t4$O||(_t4$O=_$19`
      & > div {
        max-width: ${0};
      }
    `),maxWidth)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$J||(_t5$J=_$19`
  flex: 1;
  display: flex;
  flex-direction: column;
`))),ContentArea=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$w||(_t6$w=_$19`
  flex: 1;
  width: 100%;
  padding: ${0};
  margin-left: auto;
...
`),({paddingOverride:paddingOverride})=>paddingOverride||"40px 20px",deviceMediaQuery.medium,({paddingOverride:paddingOverride})=>paddingOverride||"40px",deviceMediaQuery.large,({maxWidth:maxWidth})=>maxWidth||"1200px",({paddingOverride:paddingOverride})=>paddingOverride||"70px 90px");let _t$1a,_t2$12,_t3$U,_t4$P,_t5$K,_t6$x,_t7$t,_t8$r,_t9$m,_t10$j,_t11$e,_t12$7,_t13$6,_t14$5,_t15$4,_t16$3,_t17$3,_t18$2,_t19$2,_t20$2,_t21$2,_$1a=t=>t;const ContextTitle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$1a||(_t$1a=_$1a`
  opacity: 0;

  ${0}

  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$12||(_t2$12=_$1a`
    transition: opacity ${0} ${0};
  `),theme.animation.speed.fast,theme.animation.easing.primary.easeInOut),({compact:compact})=>compact&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$U||(_t3$U=_$1a`
    font-size:14px;
  `))),ContextIcon=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$P||(_t4$P=_$1a`
  ${0};
...
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t5$K||(_t5$K=_$1a`
    ${0};
    transition: background ${0} ${0};
  `),theme.styles.global.mainMenu.iconBackground.default,theme.animation.speed.fast,theme.animation.easing.primary.easeInOut)),ContextIndicator=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$x||(_t6$x=_$1a`
  width: 12px;
  height: 12px;
  flex: 0 0 14px;
...
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t7$t||(_t7$t=_$1a`
    transition: opacity 0 ${0};
  `),theme.animation.easing.primary.easeInOut)),ContextActionBaseCSS=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$r||(_t8$r=_$1a`
  -webkit-tap-highlight-color: transparent;
  border: none;
  background: none;
  display: flex;
  ...
  padding: 0;
  text-decoration: none;
`)),StyledAnchor=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.a(_t9$m||(_t9$m=_$1a`
  display: flex;
  text-decoration: none;
`)),ExternalIconWrapper=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t10$j||(_t10$j=_$1a`
  margin-left: 15px;
`)),ContextWrapper=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t11$e||(_t11$e=_$1a`
  ${0}
  ${0}
...
`),ContextActionBaseCSS,({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t12$7||(_t12$7=_$1a`
    font-family: ${0};
    ${0};
  `),theme.fontFamily.ui,theme.typography.global.mainMenu.menuItem.default),({$menuOpen:$menuOpen})=>$menuOpen&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t13$6||(_t13$6=_$1a`
  ${0}{
    opacity: 1;
  }
`),ContextTitle),ContextIcon,({theme:theme})=>theme.styles.global.mainMenu.iconBackground.hover,IconWrapper,({theme:theme})=>theme.colors.icons.inverse),ContextActionA=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_27__.a)(_t14$5||(_t14$5=_$1a`
  ${0}
  ${0}
  ...
  ${0}
`),ContextActionBaseCSS,({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t15$4||(_t15$4=_$1a`
    font-family: ${0};
    ${0};
  `),theme.fontFamily.ui,theme.typography.global.mainMenu.menuItem.default),({$menuOpen:$menuOpen})=>$menuOpen&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t16$3||(_t16$3=_$1a`
    ${0}{
      opacity: 1;
    }
  `),ContextTitle),ContextIcon,({theme:theme})=>theme.styles.global.mainMenu.iconBackground.hover,IconWrapper,({theme:theme})=>theme.colors.icons.inverse,({$isActive:$isActive})=>$isActive&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t17$3||(_t17$3=_$1a`
    ${0},
    &:hover ${0}{
      ${0};
    }
  `),ContextIcon,ContextIcon,({theme:theme})=>theme.styles.global.mainMenu.iconBackground.active)),ContextActionButton=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t18$2||(_t18$2=_$1a`
  ${0}
  ...
  ${0}
`),ContextActionBaseCSS,({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t19$2||(_t19$2=_$1a`
    font-family: ${0};
    ${0};
  `),theme.fontFamily.ui,theme.typography.global.mainMenu.menuItem.default),({menuOpen:menuOpen,theme:theme})=>menuOpen&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t20$2||(_t20$2=_$1a`
    ${0}{
      opacity: 1;
    }
...
`),({theme:{colors:colors}})=>colors.divider,SubmenuItemLink,SubmenuItemAnchor,({theme:theme,isActive:isActive})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t9$n||(_t9$n=_$1b`
      font-family: ${0};
      ${0};
    ...
    `),theme.fontFamily.ui,theme.typography.global.mainMenu.subItem.default,theme.typography.global.mainMenu.subItem.hover,isActive&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t10$k||(_t10$k=_$1b`
        &, &:hover {
          ${0};
        }
      `),theme.typography.global.mainMenu.subItem.active))),SubmenuContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t11$f||(_t11$f=_$1b`
  ${0};
...
`),({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t12$8||(_t12$8=_$1b`
    transition:
      max-height ${0} ${0},
      opacity ${0} ${0};
  `),theme.animation.speed.normal,theme.animation.easing.primary.easeOut,theme.animation.speed.fast,theme.animation.easing.primary.easeOut),({theme:{colors:colors}})=>colors.divider),ContextContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t13$7||(_t13$7=_$1b`
  min-height: ${0};
  width: inherit;
...
`),({minHeight:minHeight})=>minHeight?minHeight+"px":"70px",SubmenuContainer,({open:open,maxHeight:maxHeight,theme:theme})=>open&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t14$6||(_t14$6=_$1b`
    ${0}{
      transition:
        max-height ${0} ${0},
        opacity ${0} ${0};
...
`)),LogoMark=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$14||(_t2$14=_$1c`
  height: 50px;
  flex: 0 0 50px;
  margin-right: 15px;
  display: flex;
...
`)),LogoType=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$W||(_t3$W=_$1c`
  opacity: 0;
  flex: 1;
  height: 50px;
  display: flex;
  justify-content: left;
  align-items: center;
`)),SVGObject=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.object(_t4$R||(_t4$R=_$1c``)),SVGObjectText=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.object(_t5$M||(_t5$M=_$1c`
  max-width: 180px;
`)),NavigationContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$z||(_t6$z=_$1c``)),MenuFooter=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$v||(_t7$v=_$1c`
  ${0};
  display: flex;
  flex-direction: column;
  flex: 1;
  justify-content: flex-end;
`),({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$t||(_t8$t=_$1c`
    ${0}
  `),theme.styles.global.mainMenu.footerBackground)),FooterItemContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t9$o||(_t9$o=_$1c`
  min-height: 70px;
`)),PushContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t10$l||(_t10$l=_$1c`
  position: relative;
  height: 100%;
  ${0};
`),({theme:theme,isPinned:isPinned})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t11$g||(_t11$g=_$1c`
    width: ${0};
  `),isPinned?theme.dimensions.global.mainMenu.width.open:theme.dimensions.global.mainMenu.width.closed)),Container$O=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t12$9||(_t12$9=_$1c`
  z-index: 99;
  position: fixed;
  top: 0;
  left: 0;
  ...
  padding: 20px 0 0 0;
  overflow: hidden;
`),({theme:theme,open:open,desktopSize:desktopSize})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t13$8||(_t13$8=_$1c`
    ${0}
    ${0};
    width: ${0};
...
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$X||(_t3$X=_$1d`
  ...
  `),theme.deviceMediaQuery.large)),DrawerHeader=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.h2(_t4$S||(_t4$S=_$1d`
  ${0};
  padding: 0;
  margin: 0 0 5px;
`),({theme:theme})=>theme.typography.global.mainMenu.subheader),CurrentUser=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$N||(_t5$N=_$1d`
  padding: 20px 20px 15px;

  ${0};
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t6$A||(_t6$A=_$1d`
    border-bottom: ${0} 1px solid;
    ${0};
  `),theme.colors.divider,theme.typography.global.mainMenu.identity)),UserOptions=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$w||(_t7$w=_$1d`
  padding: 20px 20px 10px 20px;
  border-bottom: ${0} 1px solid;
`),({theme:{colors:colors}})=>colors.divider),Logout=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t8$u||(_t8$u=_$1d`
    padding: 0 20px;
`)),LinkMenu=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.ul(_t9$p||(_t9$p=_$1d`
  padding: 0;
  margin: 12px 0 0 0;
  list-style: none;
`)),LinkMenuItem=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.li(_t10$m||(_t10$m=_$1d`
  padding: 10px 0;
`)),IconWrapper$3=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t11$h||(_t11$h=_$1d`
  flex: 0 40px;
  width: 5px;
  display: flex;
  justify-content: center;
...
`)),LinkMenuItemA=Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_27__.a)(_t12$a||(_t12$a=_$1d`
  ${0};
  display: block;
  width: 100%;
  ...
  ${0};
`),resetButtonStyles,({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t13$9||(_t13$9=_$1d`
    ${0};

    &:hover {
      ${0};
    }
  `),theme.typography.global.mainMenu.subItem.default,theme.typography.global.mainMenu.subItem.hover),({theme:theme,isActive:isActive})=>isActive&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t14$8||(_t14$8=_$1d`
    &, &:hover {
      ${0};
    }
  `),theme.typography.global.mainMenu.subItem.active)),LanguageMenu=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t15$7||(_t15$7=_$1d`
  ${0};
...
`)),Image$3=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$T||(_t4$T=_$1e`
  ...
  background-repeat: no-repeat; 
  display: ${0};
`),p=>p.image,p=>p.image?"block":"none"),InfoContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$O||(_t5$O=_$1e`
  margin-left: 20px;
`)),Title$6=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$B||(_t6$B=_$1e`
  font-size: 16px;
  font-weight: 500;
  color: hsl(0, 0%, 34%);
`)),Message=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$x||(_t7$x=_$1e`
  font-size: 13px;
  font-weight: 500;
  overflow: hidden;
  color: hsl(0, 0%, 34%);
...
`),({theme:{colors:colors}})=>colors.divider),renderNotifications=(items,type)=>items.map((item,index)=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NotificationWrapper,{key:`alert-${type}-${index}`},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NotificationItem,Object.assign({},item)))),NotificationsHistory=({read:read,unread:unread,noNotificationsText:_noNotificationsText="No new notifications",readNotificationsText:_readNotificationsText="New",unreadNotificationsText:_unreadNotificationsText="Read"})=>0===read.length&&0===unread.length?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$Q,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StatusContainer,null,_noNotificationsText)):react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$Q,null,unread&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StatusContainer,null,_readNotificationsText),renderNotifications(unread,"unread")),read&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StatusContainer,null,_unreadNotificationsText),renderNotifications(read,"read")));let _t$1g,_t2$18,_t3$_,_t4$U,_t5$P,_t6$C,_t7$y,_t8$w,_t9$q,_t10$n,_t11$i,_t12$b,_t13$a,_t14$9,_$1g=t=>t;const Container$R=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$1g||(_t$1g=_$1g`
  ...
  ${0}
`),({theme:theme,theme:{colors:colors}})=>colors&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$18||(_t2$18=_$1g`
    border-bottom: ${0} 1px solid;
    box-shadow: 5px 7px 10px 0 hsla(205, 16%, 77%, 0.1);
    background-color:${0};
  `),colors.divider,theme.styles.global.mainMenu.background.backgroundColor)),SearchBar=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$_||(_t3$_=_$1g`
  margin-left: 25px;
  flex: 0 1 500px;
  display: flex;
  justify-content: center;
  align-items: center;
`)),IconWrapper$4=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$U||(_t4$U=_$1g`
  flex: 0 40px;
  width: 5px;
  display: flex;
  justify-content: center;
...
`)),SearchInput=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.input(_t5$P||(_t5$P=_$1g`
  font-family: ${0};
  flex: 1;
  height: 35px;
  line-height: 35px;
...
`),({theme:theme})=>theme.fontFamily.data,({theme:{typography:typography}})=>typography.global.topBar.search.value,({theme:{typography:typography}})=>typography.global.topBar.search.placeholder),ButtonArea=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$C||(_t6$C=_$1g`
  height: inherit;
  padding-right: 10px;
  display: flex;
`)),DrawerToggle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button.attrs({type:"button"})(_t7$y||(_t7$y=_$1g`
  width: 60px;
  margin: 0 5px;
  height: inherit;
  background: none;
  ...
  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$w||(_t8$w=_$1g`
  ...
  `),theme.colors.menu.indicator,theme.colors.menu.hover,theme.animation.speed.normal,theme.animation.easing.primary.easeInOut),({isActive:isActive,theme:theme})=>isActive&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t9$q||(_t9$q=_$1g`
    &, &:hover {
      border-bottom-color: ${0};
    }
  `),theme.colors.menu.active)),DrawerPortalWrapper=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t10$n||(_t10$n=_$1g``)),Drawer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t11$i||(_t11$i=_$1g`
  font-family: ${0};
...
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$$||(_t3$$=_$1i`
    font-family: ${0};
  `),theme.fontFamily.ui),({active:active})=>active?"600":"500",({active:active})=>active?"#0097ce":"#787878",({active:active})=>active?"2px solid #0097ce":"2px solid transparent");let _t$1j;const Container$S=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$1j||(_t$1j=(t=>t)`
`)),TabContent=({children:children,tabId:tabId,...props})=>{const{selected:selected}=Object(react__WEBPACK_IMPORTED_MODULE_1__.useContext)(TabContext);return selected===tabId?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$S,Object.assign({},props),children):null};let _t$1k,_t2$1a,_t3$10,_t4$V,_$1k=t=>t;const Container$T=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t$1k||(_t$1k=_$1k`
  ${0}
  flex-basis: auto;
  flex-grow: 1;
`),resetButtonStyles),LinkTab=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$1a||(_t2$1a=_$1k`
    display: flex;
    justify-content: center;
    align-items: center;
    height: 100%;
  ...
  ${0}
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$10||(_t3$10=_$1k`
    transition: border ${0} ${0};
    border-bottom: 5px solid ${0};
...
`),({active:active})=>active?Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$1b||(_t2$1b=_$1l`
    border-bottom: 3px solid hsl(196, 100%, 40%);
    `)):Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$11||(_t3$11=_$1l`
    border-bottom: 3px solid transparent;
  `)),IconWrapper),Title$7=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$W||(_t4$W=_$1l`
  font-size: 14px;
  font-family: ${0};
  letter-spacing: 0.09px;
  font-weight: 500;
  ...
  white-space: nowrap;
  text-overflow: ellipsis;
`),({theme:theme})=>theme.fontFamily.ui,({active:active})=>active?"hsl(196, 100%, 40%)":"hsl(0, 0%, 46%)"),SubTitle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$Q||(_t5$Q=_$1l`
  font-size: 12px;
  font-family: ${0};
  font-style: italic;
  color: hsla(195, 10%, 52%, 0.72);
...
`),resetButtonStyles,({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t2$1d||(_t2$1d=_$1n`
    font-family: ${0};
    ${0};
    ${0};
    border-top: 1px solid ${0};
  `),theme.fontFamily.ui,theme.typography.global.mainMenu.menuItem.default,theme.styles.global.mainMenu.background,theme.colors.divider),50),IconContainer$2=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$12||(_t3$12=_$1n`
  height: inherit;
  position: absolute;
  top: 0;
  left: 0;
...
`),({theme:theme})=>theme.styles.global.mainMenu.background),MobileUserMenu=({closeId:closeId,hasLanguage:hasLanguage,hasLogout:hasLogout,logoutLink:logoutLink,hasCurrentUser:hasCurrentUser,userSubmenu:userSubmenu,userDrawerBespoke:userDrawerBespoke,loggedInUser:loggedInUser,onLogout:onLogout,onLanguageToggle:onLanguageToggle})=>{const{setSelected:setSelected}=Object(react__WEBPACK_IMPORTED_MODULE_1__.useContext)(TabContext),handleCloseMenu=Object(react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(()=>{setSelected(closeId)},[closeId,setSelected]);return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$Y,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(UserMenu,Object.assign({},{hasLanguage:hasLanguage,hasLogout:hasLogout,logoutLink:logoutLink,hasCurrentUser:hasCurrentUser,userSubmenu:userSubmenu,userDrawerBespoke:userDrawerBespoke,loggedInUser:loggedInUser,onLogout:onLogout,onLanguageToggle:onLanguageToggle},{closeOnClick:handleCloseMenu})))};let _t$1s,_t2$1h,_$1s=t=>t;const CLOSE_ID="closeMenu",Container$Z=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.nav(_t$1s||(_t$1s=_$1s`
  ...
  width: 100%;
  z-index: 99;
`),({theme:theme})=>theme.styles.global.mainMenu.background.backgroundColor),HeaderContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$1h||(_t2$1h=_$1s`
  display: flex;
  flex-direction: row;
  height: ${0}px;
  border-bottom: ${0} 1px solid;
...
`),68,({theme:theme})=>theme.colors.divider,TabListWrapper),MobileNavbar=({content:content,home:home,logoMark:logoMark,supportUrl:supportUrl,defaultMenuOpen:_defaultMenuOpen=!0,closeText:closeText,hasLanguage:hasLanguage,hasLogout:hasLogout,logoutLink:logoutLink,hasCurrentUser:hasCurrentUser,hasNotifications:hasNotifications,userSubmenu:userSubmenu,userDrawerBespoke:userDrawerBespoke,loggedInUser:loggedInUser,notificationsHistory:notificationsHistory,customDrawer:customDrawer,onLogout:onLogout,onLanguageToggle:onLanguageToggle})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$Z,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Tabs,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(HeaderContainer,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileLogoLink,Object.assign({},{home:home,logoMark:logoMark},{closeId:CLOSE_ID})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TabList,{defaultTabId:CLOSE_ID},customDrawer&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileTab,Object.assign({},customDrawer,{tabFor:"custom",closeId:CLOSE_ID})),hasNotifications?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileTab,{tabFor:"notifications",icon:"Notifications",closeId:CLOSE_ID}):null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileTab,{tabFor:"user",icon:"UserProfile",closeId:CLOSE_ID}),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileTab,{tabFor:"menu",icon:"Menu",closeId:CLOSE_ID}))),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileNavbarContent,{closeId:CLOSE_ID},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TabContent,{tabId:"custom"},customDrawer&&customDrawer.customComponent),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TabContent,{tabId:"notifications"},notificationsHistory&&hasNotifications?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NotificationsHistory,Object.assign({},notificationsHistory)):null),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TabContent,{tabId:"user"},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileUserMenu,Object.assign({},{hasLanguage:hasLanguage,hasLogout:hasLogout,logoutLink:logoutLink,hasCurrentUser:hasCurrentUser,userSubmenu:userSubmenu,userDrawerBespoke:userDrawerBespoke,loggedInUser:loggedInUser,onLogout:onLogout,onLanguageToggle:onLanguageToggle},{closeId:CLOSE_ID}))),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TabContent,{tabId:"menu"},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileMenu,Object.assign({},{content:content,supportUrl:supportUrl,defaultMenuOpen:_defaultMenuOpen},{closeId:CLOSE_ID}))),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(CloseButton$1,Object.assign({},{closeText:closeText},{closeId:CLOSE_ID}))))),GlobalUI=({content:content,home:home,openWidth:openWidth,logoMark:logoMark,logoText:logoText,supportUrl:supportUrl,defaultMenuOpen:defaultMenuOpen,paddingOverride:paddingOverride,maxWidth:maxWidth,children:children,...props})=>{const{isLarge:isLarge}=useBreakpoints();return isLarge?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Layout,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MainMenu,Object.assign({},{content:content,home:home,openWidth:openWidth,logoMark:logoMark,logoText:logoText,supportUrl:supportUrl,defaultMenuOpen:defaultMenuOpen})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MainContainer,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TopBar,Object.assign({},{...props})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ContentArea,Object.assign({},{maxWidth:maxWidth,paddingOverride:paddingOverride}),children))):react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileLayout,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MobileNavbar,Object.assign({},{content:content,home:home,logoMark:logoMark,supportUrl:supportUrl,defaultMenuOpen:defaultMenuOpen,...props})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ContentArea,null,children))};let _t$1t,_t2$1i,_t3$15,_t4$Y,_t5$R,_t6$E,_t7$z,_t8$x,_t9$r,_$1t=t=>t;styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$1t||(_t$1t=_$1t`
  ...
  display: flex;
  flex-direction: column;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t2$1i||(_t2$1i=_$1t`
  height: 84px;
  color: hsl(205, 7%, 35%);
  ...
  padding-top: 18px;
  padding-bottom: 15px;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$15||(_t3$15=_$1t`
  height: 31px;
  font-family: Monorale;
  font-size: 18px;
  font-weight: 500;
  ...
  text-align: center;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$Y||(_t4$Y=_$1t`
  height: 19px;
  font-family: Monorale;
  font-size: 16px;
  font-weight: 300;
  ...
  text-align: center;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$R||(_t5$R=_$1t`
  position: relative;
  border-bottom: 1px solid hsla(0, 0%, 84%, 50%);
  padding: 22px 20px 21px 20px;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$E||(_t6$E=_$1t`
  font-size: 14px;
  font-weight: 500;
  letter-spacing: 0.35px;
  color: hsl(0, 0%, 50%);
  margin-bottom: 18px;
`)),styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$z||(_t7$z=_$1t`
  font-size: 14px;
  font-weight: 500;
  letter-spacing: 0.35px;
  color: hsl(0, 0%, 50%);
`)),Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_27__.a)(_t8$x||(_t8$x=_$1t`
  font-size: 14px;
  font-weight: 500;
  letter-spacing: 0.35px;
  color: hsl(0, 0%, 50%);
`)),Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_27__.a)(_t9$r||(_t9$r=_$1t`
  position: absolute;
  right: 30px;
  top: 15px;
  /* width: 80px; */

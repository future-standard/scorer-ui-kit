...
`)),StatusLine=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t9$n||(_t9$n=_$18`
  ...
  height: 3px;
  width: 100%;
`),({theme:theme,color:color})=>color&&theme.colors.feedback[color]),MediaStream=({hasCustomState:_hasCustomState=!1,status:_status="neutral",noticeIcon:_noticeIcon="Information",hasNotice:_hasNotice=!1,noticeMessage:noticeMessage,noticeTitle:noticeTitle,...props})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$O,null,_hasCustomState?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(EmptyWithIcon,{hasPadding:_hasNotice},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Icon,{icon:"PasswordHide",color:"dimmed",size:41})):react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(MediaBox,Object.assign({},{...props})),_hasNotice&&react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Notice,{color:_status},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NoticeIcon,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Icon,{icon:_noticeIcon,size:20,color:"inverse"})),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NoticeTextGroup,{color:_status},react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NoticeTitle,null,noticeTitle),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NoticeMessage,null,noticeMessage))),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StatusLine,{color:_status}));let _t$19,_t2$13,_t3$W,_t4$Q,_t5$L,_t6$z,_t7$w,_t8$t,_$19=t=>t;const Container$P=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$19||(_t$19=_$19`
  display: flex;
...
`),({theme:theme})=>theme.colors.divider,IconWrapper),RightData=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t3$W||(_t3$W=_$19`
  padding: 17px 12px 12px 16px;
`)),DeviceDataGroup=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t4$Q||(_t4$Q=_$19`
  display: flex;
  flex-direction: column;
  margin-left: 14px;
`)),LeftTitle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t5$L||(_t5$L=_$19`
  ${0};
  max-width: 140px;
  color: hsla(195, 10%, 52%, 0.72);
  font-size: 10px;
  margin-bottom: 1px;
`),EllipsisStyles),LeftSubTitle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t6$z||(_t6$z=_$19`
  font-family: ${0};
  ${0};
  max-width: 140px;
  color: hsl(208, 8%, 38%);
  font-size: 16px;
`),({theme:theme})=>theme.fontFamily.data,EllipsisStyles),Title$5=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t7$w||(_t7$w=_$19`
  ${0};
  max-width: 80px;
  color: hsla(195, 10%, 52%, 0.72);
  font-size: 10px;
  margin-bottom: 6px;
`),EllipsisStyles),SubTitle=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t8$t||(_t8$t=_$19`
  ${0};
  max-width: 80px;
  color: hsl(195, 10%, 52%);
  font-size: 12px;
`),EllipsisStyles),PanelMetaData=({deviceIcon:_deviceIcon="Camera",leftSubTitle:leftSubTitle,leftTitle:leftTitle,rightTitle:rightTitle,rightSubTitle:rightSubTitle})=>react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$P,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(LeftData,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Icon,{icon:_deviceIcon,color:"dimmed",size:18}),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(DeviceDataGroup,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(LeftTitle,null,leftTitle),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(LeftSubTitle,null,leftSubTitle))),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(RightData,null,react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Title$5,null,rightTitle),react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(SubTitle,null,rightSubTitle)));let _t$1a;const Container$Q=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$1a||(_t$1a=(t=>t)`
  width: 300px;
  height: 230px;
  border-radius: 3px;
...
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t7$x||(_t7$x=_$1h`
  ...
  padding: 0;
  text-decoration: none;
`)),StyledAnchor=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.a(_t9$o||(_t9$o=_$1h`
  display: flex;
  text-decoration: none;
...
`),({theme:{colors:colors}})=>colors.divider,SubmenuItemLink,SubmenuItemAnchor,({theme:theme,isActive:isActive})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t9$p||(_t9$p=_$1i`
      font-family: ${0};
      ${0};
...
`),({theme:theme})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$w||(_t8$w=_$1j`
    ${0}
  `),theme.styles.global.mainMenu.footerBackground)),FooterItemContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t9$q||(_t9$q=_$1j`
  min-height: 70px;
...
`),({theme:theme,isPinned:isPinned})=>theme&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t11$f||(_t11$f=_$1j`
    width: ${0};
  `),isPinned?theme.dimensions.global.mainMenu.width.open:theme.dimensions.global.mainMenu.width.closed)),Container$T=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t12$a||(_t12$a=_$1j`
  z-index: 99;
  position: fixed;
  top: 0;
  left: 0;
...
`),({theme:{colors:colors}})=>colors.divider),Logout=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t8$x||(_t8$x=_$1k`
    padding: 0 20px;
`)),LinkMenu=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.ul(_t9$r||(_t9$r=_$1k`
  padding: 0;
  margin: 12px 0 0 0;
  list-style: none;
...
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t8$z||(_t8$z=_$1n`
  ...
  `),theme.colors.menu.indicator,theme.colors.menu.hover,theme.animation.speed.normal,theme.animation.easing.primary.easeInOut),({isActive:isActive,theme:theme})=>isActive&&Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t9$s||(_t9$s=_$1n`
    &, &:hover {
      border-bottom-color: ${0};
    }
...
`),({theme:theme})=>Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.c)(_t3$16||(_t3$16=_$1p`
    font-family: ${0};
  `),theme.fontFamily.ui),({active:active})=>active?"600":"500",({active:active})=>active?"#0097ce":"#787878",({active:active})=>active?"2px solid #0097ce":"2px solid transparent");let _t$1q;const Container$X=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.div(_t$1q||(_t$1q=(t=>t)`
`)),TabContent=({children:children,tabId:tabId,...props})=>{const{selected:selected}=Object(react__WEBPACK_IMPORTED_MODULE_1__.useContext)(TabContext);return selected===tabId?react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container$X,Object.assign({},props),children):null};let _t$1r,_t2$1g,_t3$17,_t4$$,_$1r=t=>t;const Container$Y=styled_components__WEBPACK_IMPORTED_MODULE_2__.d.button(_t$1r||(_t$1r=_$1r`
  ${0}
  flex-basis: auto;
  flex-grow: 1;
...
`)),Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_29__.a)(_t8$A||(_t8$A=_$1A`
  ...
  letter-spacing: 0.35px;
  color: hsl(0, 0%, 50%);
`)),Object(styled_components__WEBPACK_IMPORTED_MODULE_2__.d)(react_router_dom__WEBPACK_IMPORTED_MODULE_29__.a)(_t9$t||(_t9$t=_$1A`
  position: absolute;
  right: 30px;
  top: 15px;
  /* width: 80px; */

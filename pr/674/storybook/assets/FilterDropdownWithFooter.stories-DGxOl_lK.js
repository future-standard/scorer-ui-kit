import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{Bt as n,Mt as r,V as i,jt as a,kt as o,vt as s,w as c,zt as l}from"./iframe-cNP1dtGl.js";import{n as u,t as d}from"./helpers-D7M4tyZO.js";import{S as f,f as p,h as m,p as h,x as g}from"./data_samples-BIGHHJEJ.js";var _,v,y,b,x,S,C,w,T,E,D;e((()=>{_=l(),v=t(n()),s(),r(),u(),m(),y=o(),{action:b}=__STORYBOOK_MODULE_ACTIONS__,x={title:`Filters/molecules/FilterDropdown`,component:c,parameters:{componentSubtitle:`FilterDropdown component with footer controls`}},S=a.div`
  margin: 100px;
...
`,C=a.div`
  ...
  gap: 20px;
`,w=[{text:`Ramen`,value:0},{text:`Takoyaki`,value:1},{text:`Gyoza`,value:2},{text:`Tempura`,value:3},{text:`Sushi`,value:4},{text:`Natto`,value:5},{text:`Sashimi`,value:6}],T=[{text:`ラーメン`,value:0},{text:`蛸焼き`,value:1},{text:`餃子`,value:2},{text:`天婦羅`,value:3},{text:`すし`,value:4},{text:`納豆`,value:5},{text:`お造り`,value:6}],E=()=>{let e=(0,_.select)(`Language`,{English:`english`,Japanese:`japanese`},`japanese`),t=d(),n=(0,_.select)(`Icon`,t,Object.keys(t)[0]),r=(0,_.boolean)(`Disabled`,!1),a=(0,_.boolean)(`Has Options Filter`,!0),[o,s]=(0,v.useState)(null),l=b(`Reset clicked`),u=b(`Cancel/Close clicked`),m=b(`Item selected`),x=(0,_.boolean)(`Has Apply`,!0),E=(0,_.boolean)(`Has Reset`,!0),D=(0,v.useCallback)(e=>{m(e),s(e)},[m]),O=(0,v.useCallback)(()=>{l()},[l]),k=(0,v.useCallback)(()=>{u()},[u]);return(0,y.jsx)(C,{children:(0,y.jsxs)(S,{children:[(0,y.jsx)(i,{title:`FilterDropdown with Footer Controls`,introductionText:`This example demonstrates the FilterDropdown component with both Reset and Apply buttons.`}),(0,y.jsx)(c,{buttonIcon:n,buttonText:e===`japanese`?`メニュー`:`Menu`,list:e===`japanese`?T:w,selected:o,disabled:r,hasOptionsFilter:a,searchPlaceholder:e===`japanese`?`メニュー...`:`Menu options...`,searchResultText:e===`japanese`?f:g,optionType:`checkbox`,onSelect:D,onResetCallback:O,onCancelCallback:k,hasReset:E,hasApply:x,resetText:e===`japanese`?`リセット`:`Reset`,cancelText:e===`japanese`?`キャンセル`:`Cancel`,closeText:e===`japanese`?`閉じる`:`Close`,applyText:e===`japanese`?`適用`:`Apply`,descendingText:e===`japanese`?`降順`:`Descending`,ascendingText:e===`japanese`?`昇順`:`Ascending`,emptyResultText:e===`english`?p:h,isListAscending:!0})]})})},E.__docgenInfo={description:``,methods:[],displayName:`DropdownWithApplyAndReset`},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`() => {

import{i as e}from"./preload-helper-xPQekRTU.js";import{Mt as t,V as n,i as r,jt as i,kt as a,vt as o,zt as s}from"./iframe-cNP1dtGl.js";var c,l,u,d,f,p,m,h,g;e((()=>{c=s(),o(),t(),l=a(),{action:u}=__STORYBOOK_MODULE_ACTIONS__,d={title:`Form/File Management`,component:r,decorators:[]},f=i.div`
  margin: 20px
`,p=[`MonitoringProfile`,`RetryJob`],m=[`image/jpeg`,`image/png`,`text/csv`],h=()=>{let e=(0,c.boolean)(`Show Custom Component`,!1),t=(0,c.text)(`Title`,`Select Files`),i=(0,c.text)(`Select Files Text`,`Select Files`),a=(0,c.text)(`Description`,`To begin, drop your CSV and Images files here to continue or click Select Files below.`),o=(0,c.text)(`Add More Files Text`,`Add More files`),s=(0,c.object)(`File Icons`,p),d=u(`Input Callback`),h=(0,c.text)(`Message`,`Cleared all selected files`),g=u(`Action was clicked`),_=(0,c.object)(`Allowed File Types`,m),v=u(`Begin Upload Button Click`);return(0,l.jsx)(f,{children:(0,l.jsx)(r,{selectFilesText:i,title:t,fileIcons:s,description:a,allowedFileTypes:_,addMoreFilesText:o,onChangeCallback:(e,t)=>{console.debug(`good Files`,e),console.debug(`rejected`,t),d({goodFiles:e,rejectedFiles:t})},clearFilesCallback:()=>{g(h)},beginUploadCallback:v,customComponent:e?(0,l.jsx)(n,{title:`CustomComponent Example`,introductionText:`This is a page header component that was sent as an example of a custom component. Select multiple files`}):void 0})})},h.__docgenInfo={description:``,methods:[],displayName:`_AreaUploadManager`},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`() => {

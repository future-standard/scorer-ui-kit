import{i as e}from"./preload-helper-xPQekRTU.js";import{Ct as t,It as n,Lt as r,Pt as i,Wt as a,X as o}from"./iframe-a2YLqPZY.js";var s,c,l,u,d,f,p,m;e((()=>{s=a(),t(),r(),c=i(),{action:l}=__STORYBOOK_MODULE_ACTIONS__,u={title:`Form/Input`,component:o,decorators:[]},d=n.div`
    margin: 20px;
    width: 268px;
`,f=[{value:0,label:`0%`},{value:20},{value:40},{value:60},{value:80},{value:100,label:`100%`}],p=()=>{let e=(0,s.text)(`Title`,`Duration`),t=(0,s.boolean)(`Disabled`,!1),n=(0,s.number)(`Default value`,30),r=(0,s.boolean)(`Custom colors function`,!1),i=(0,s.boolean)(`Custom Title function`,!1),a=l(`Input Callback`),u=(0,s.object)(`Marks`,f),p=(0,s.boolean)(`Show Value`,!0),m=(0,s.boolean)(`Center all mark values`,!1);return(0,c.jsx)(d,{children:(0,c.jsx)(o,{disabled:t,inputCallback:e=>{console.debug(`updated value`,e),a(`Returned value: ${e}`,e)},marks:u,defaultValue:n,title:e,updateThumbColor:r?e=>e<=20?`neutral`:e>20&&e<=80?`info`:`error`:void 0,updateTitle:i?e=>e<=20?`Small sound`:e>20&&e<=80?`Normal sound`:`Dangerous sound`:void 0,showValue:p,allMarkCentered:m})})},p.__docgenInfo={description:``,methods:[],displayName:`_PercentageSlider`},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`() => {

import{i as e}from"./preload-helper-xPQekRTU.js";import{Ct as t,Et as n,It as r,Lt as i,Pt as a,U as o,Wt as s,s as c,v as l}from"./iframe-BMz55O8f.js";var u,d,f,p,m,h,g,_;e((()=>{u=s(),t(),i(),d=a(),{action:f}=__STORYBOOK_MODULE_ACTIONS__,p=r.div``,m={title:`Alerts/Modals`,components:l,decorator:[]},h=({message:e=`Hello`,leftButtonDesign:t,rightButtonDesign:r,title:i=``,leftButtonText:a=`Back`,leftButtonCallback:o=()=>{},rightButtonText:s=`Accept`,rightButtonCallback:u=()=>{}})=>{let{createModal:f}=n(),p=()=>{console.debug(`creatingModal`),f({isCloseEnable:!1,customComponent:m})},m=(0,d.jsx)(l,{title:i,message:e,leftButtonText:a,leftButtonDesign:t,leftButtonCallback:o,rightButtonDesign:r,rightButtonText:s,rightButtonCallback:u});return(0,d.jsx)(c,{design:`secondary`,onClick:p,children:`Open Modal`})},g=()=>(0,d.jsx)(p,{children:(0,d.jsx)(o,{children:(0,d.jsx)(h,{title:(0,u.text)(`Title`,`Modal Title`),message:(0,u.text)(`Message`,`This is an example of some information provided to the customer to confirm an option`),leftButtonText:(0,u.text)(`Left Button Text`,`Back`),leftButtonDesign:(0,u.select)(`Left Button Design`,{Primary:`primary`,Secondary:`secondary`,Danger:`danger`},`secondary`),leftButtonCallback:f(`Back button pressed`),rightButtonText:(0,u.text)(`Right Button Text`,`I understand`),rightButtonDesign:(0,u.select)(`Right Button Design`,{Primary:`primary`,Secondary:`secondary`,Danger:`danger`},`primary`),rightButtonCallback:f(`Accept button pressed`)})})}),g.__docgenInfo={description:``,methods:[],displayName:`_ConfirmationTemplate`},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`() => {

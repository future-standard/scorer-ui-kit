import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{At as n,Bt as r,Mt as i,g as a,kt as o,vt as s,zt as c}from"./iframe-Bwz4qBV9.js";import{n as l,t as u}from"./placeholder-Bsx_gz26.js";var d,f,p,m,h,g,_,v,y,b;e((()=>{d=c(),f=t(r()),s(),n(),u(),p=o(),{action:m}=__STORYBOOK_MODULE_ACTIONS__,h=i.div`
    margin: 20px;
`,g=i.img`
`,_=i.div``,v={title:`Form/File Management`,component:a,decorators:[],escapeHTML:!1},y=()=>{let e=(0,d.boolean)(`Is Resizable`,!0),[t,n]=(0,f.useState)(``),[r,i]=(0,f.useState)(!0),o=(0,d.text)(`Title`,`Crop Image`),s=(0,d.text)(`Cancel Button Text`,`Cancel`),c=(0,d.text)(`Crop Button Text`,`Crop and Save`),u=(0,d.number)(`Canvas Height`,400),v=(0,d.number)(`Canvas Width`,450),y=(0,d.number)(`Crop Height`,300),b=(0,d.number)(`Crop Width`,300),x=(0,d.number)(`Aspect Ratio`,0),S=m(`Error`);return(0,p.jsxs)(h,{children:[r?(0,p.jsx)(a,{imgUrl:l,title:o,onCrop:e=>{n(e),i(!1)},onClose:()=>{i(!1)},cancelBtnTxt:s,cropBtnTxt:c,isResizable:e,canvasHeight:u,canvasWidth:v,cropHeight:y,cropWidth:b,onError:e=>{console.debug(e),S(e)},aspectRatio:x},`${e} - ${u} - ${v} - ${y} - ${b} - ${x}`):null,(0,p.jsxs)(_,{children:[(0,p.jsx)(`h3`,{children:`Cropped Area`}),(0,p.jsx)(g,{src:t||void 0})]})]})},y.__docgenInfo={description:``,methods:[],displayName:`_CropTool`},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`() => {

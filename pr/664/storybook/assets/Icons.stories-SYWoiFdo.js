import{i as e}from"./preload-helper-xPQekRTU.js";import{At as t,Dt as n,Mt as r,Ot as i,kt as a,vt as o,wt as s,zt as c}from"./iframe-Bwz4qBV9.js";import{n as l,t as u}from"./helpers-BQTUgwHa.js";var d,f,p,m,h,g,_;e((()=>{i(),d=c(),o(),t(),l(),f=a(),p={title:`Misc`,component:s,decorators:[]},m=r.div`
  padding: 12px 24px;
  width: 100px;
  border-radius: 3px;
...
`,h=r.div`
  ...
  row-gap: 24px;
  text-align: center;
`,g=()=>{let e=u(),t=(0,d.boolean)(`Show All`,!1),r=(0,d.boolean)(`For SVG Usage`,!1),i=(0,d.select)(`Name`,e,Object.keys(e)[0]),a=(0,d.select)(`Color`,{Mono:`mono`,Dimmed:`dimmed`,Subtle:`subtle`,Inverse:`inverse`,Primary:`primary`,Danger:`danger`},`mono`),o=(0,d.select)(`Weight`,{Light:`light`,Regular:`regular`,Heavy:`heavy`,Strong:`strong`},`regular`),c=(0,d.number)(`Size`,24);return(0,f.jsx)(m,{children:t?(0,f.jsx)(h,{children:(e=>Object.keys(n).map(t=>(0,f.jsx)(`div`,{title:t,children:(0,f.jsx)(s,{icon:t,...e})},t)))({color:a,weight:o,size:c,forSvgUsage:r})}):(0,f.jsx)(s,{icon:i,weight:o,color:a,size:c,forSvgUsage:r})})},g.__docgenInfo={description:``,methods:[],displayName:`_Icons`},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`() => {

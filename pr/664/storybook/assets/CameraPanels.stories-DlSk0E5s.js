import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{At as n,Bt as r,Mt as i,d as a,f as o,jt as s,kt as c,ut as l,vt as u,zt as d}from"./iframe-Bwz4qBV9.js";import{n as f,t as p}from"./placeholder-Bsx_gz26.js";import{n as m,t as h}from"./helpers-BQTUgwHa.js";var g,_,v,y,b,x,S,C,w;e((()=>{g=d(),_=t(r()),u(),n(),p(),m(),v=c(),{action:y}=__STORYBOOK_MODULE_ACTIONS__,b={title:`CameraPanels/organisms`,component:o,decorators:[]},x=i.div`
  max-width: 1200px;

  ${({$showCustomComponent:e})=>e&&s`
    ${a} {
      height: 250px;
    }
  `};
...
`,{children:[(0,v.jsx)(i.div`
  ...
  font-size: 14px;
  margin-bottom: 10px;
`,{children:`Custom Component Example`}),(0,v.jsx)(l,{tagsConfig:[{icon:`MetaCategories`,label:`Shop A`,weight:`light`,size:12},{icon:`MetaTags`,label:`Example`,weight:`light`,size:12},{icon:`MetaTags`,label:`Smart`,weight:`light`,size:12}]})]}),C=()=>{let e={"":``,...h()},t=(0,g.boolean)(`Show Custom Component Example`,!1),n=(0,g.select)(`Type`,{Error:`error`,Warning:`warning`,Info:`info`,Success:`success`,Neutral:`neutral`},`neutral`),r=(0,g.select)(`Status Icon`,e,`Information`),i=(0,g.boolean)(`Has Notice`,!1),a=(0,g.text)(`Notice Message`,`Please wait while the first stream is processed.`),s=(0,g.text)(`Notice Title`,`Initial Stream Pending`),c=(0,g.boolean)(`Has Empty Stream with Icon`,!1),l=(0,g.select)(`Empty stream icon`,e,``),u=(0,g.select)(`Device Icon`,e,`Camera`),d=(0,g.boolean)(`Hide Panel Data Icon`,!1),p=(0,g.text)(`Left Title`,`Location - Zone`),m=(0,g.text)(`Left SubTitle`,`Camera Name`),b=(0,g.text)(`Right Title`,`Analysis`),C=(0,g.text)(`Right Subtitle`,`PeopleCount`),w=y(`Changing to camera page`),T=(0,_.useMemo)(()=>({streamProps:{src:f,mediaType:`img`,isEmptyWithIcon:c,noticeTitle:s,noticeMessage:a,status:n,noticeIcon:r,hasNotice:i,emptyIcon:l},panelMetaData:{deviceIcon:u,leftSubTitle:m,leftTitle:p,rightTitle:b,rightSubTitle:C,hideIcon:d},customBottom:t?S:void 0,panelOnClick:()=>{w()}}),[c,s,a,n,r,i,l,u,m,p,b,C,d,t,w]),E=(0,_.useMemo)(()=>({streamProps:{src:`https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4`,mediaType:`video`,videoOptions:{autoPlay:!1,controls:!0},isEmptyWithIcon:c,noticeTitle:s,noticeMessage:a,status:n,noticeIcon:r,hasNotice:i,emptyIcon:l},panelMetaData:{deviceIcon:u,leftSubTitle:m,leftTitle:p,rightTitle:b,rightSubTitle:C,hideIcon:d},customBottom:t?S:void 0}),[c,s,a,n,r,i,l,u,m,p,b,C,d,t]);return(0,v.jsx)(x,{$showCustomComponent:t,children:(0,v.jsx)(o,{panels:(0,_.useMemo)(()=>[T,E,T,E,T,E,T,E,T,E,T],[T,E])})})},C.__docgenInfo={description:``,methods:[],displayName:`_CameraPanels`},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`() => {
  const iconList = {
    '': '',
    ...generateIconList()
  };

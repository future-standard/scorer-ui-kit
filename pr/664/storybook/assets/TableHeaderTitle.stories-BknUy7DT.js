import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{At as n,Bt as r,Mt as i,at as a,kt as o,vt as s,zt as c}from"./iframe-Bwz4qBV9.js";var l,u,d,f,p,m,h;e((()=>{l=c(),u=t(r()),s(),n(),d=o(),f={title:`Tables/atoms`,component:a,decorators:[]},p=i.div`
  ...
  position: relative;
  margin: 100px;
`,m=()=>{let[e,t]=(0,u.useState)(!0),n=(0,l.boolean)(`isSortActive`,!0),r=(0,l.boolean)(`sortable`,e),i=(0,l.boolean)(`ascending`,e),o=(0,l.text)(`header`,`Device Name`);return(0,u.useEffect)(()=>{t(i)},[i]),(0,d.jsx)(p,{children:(0,d.jsx)(a,{sortable:r,isSortActive:n,ascending:e,columnId:`firstColumn`,indexKey:1,header:o,toggleSort:(0,u.useCallback)(n=>{console.debug(`arriving ${n}`,e),t(e=>!e)},[e])})})},m.__docgenInfo={description:``,methods:[],displayName:`_TableHeaderTitle`},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`() => {

import{i as e}from"./preload-helper-xPQekRTU.js";import{At as t,Mt as n,Tt as r,kt as i,vt as a,zt as o}from"./iframe-Bwz4qBV9.js";var s,c,l,u,d,f;e((()=>{s=o(),a(),t(),c=i(),l={title:`Misc`,component:r,decorators:[]},u=n.div`
  border-radius: 3px;
...
`,d=()=>{let e=(0,s.select)(`Size`,{Small:`small`,Medium:`medium`,Large:`large`,XLarge:`xlarge`},`medium`),t=(0,s.select)(`Style`,{Primary:`primary`,Secondary:`grey`,Warning:`warning`},`primary`),n=(0,s.number)(`Custom Size`,0),i=(0,s.text)(`Custom Base Color`,``),a=(0,s.text)(`Custom Top Color`,``),o=i===``?void 0:i,l=a===``?void 0:a;return o=i.indexOf(`(`)!==-1&&i.indexOf(`)`)===-1?`${i})`:i,l=a.indexOf(`(`)!==-1&&a.indexOf(`)`)===-1?`${a})`:a,(0,c.jsx)(u,{$styling:t,children:(0,c.jsx)(r,{size:e,styling:t,custom:{size:n,baseColor:o,topColor:l}})})},d.__docgenInfo={description:``,methods:[],displayName:`LoadingSpinner`},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`() => {

import{t as e}from"./react-BZJXY1be.js";import{D as t,Gt as n,It as r,Rt as i,_ as a,c as o,g as s,h as c,it as ee,v as l,wt as u,xt as d,zt as f}from"./iframe-e8M63JKD.js";import{n as p,r as m}from"./helpers-BR7btOUd.js";import{n as h}from"./rolldown-runtime-DkW27tQK.js";var g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N;function P(){return(P=h((()=>{g=n(),_=e(),u(),f(),p(),v=r(),{action:y}=__STORYBOOK_MODULE_ACTIONS__,b={title:`Chips/organisms`,component:c,decorators:[]},x=i.div`
  display: flex;
  flex-shrink: 0;
  align-items: center;
  height: 56px;

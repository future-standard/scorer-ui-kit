import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{Bt as n,Mt as r,jt as i,kt as a,vt as o,x as s,zt as c}from"./iframe-C59WqszT.js";import{n as l,r as u}from"./helpers-CwEyVb6O.js";var d,f,p,m,h,g,_,v;e((()=>{d=c(),f=t(n()),o(),r(),l(),p=a(),m={title:`Tables/atoms`,component:s,decorators:[]},h=i.div`
  ...
  line-height: 30px;
  padding: 0 2px;
`,g={id:`id-1`,cameraName:`Camera1`},_=()=>{let[e,t]=(0,f.useState)(g),n=(0,d.select)(`Alignment`,{Left:`left`,Center:`center`,Right:`right`},`left`),r=(0,d.text)(`ToLink`,`/`);return(0,p.jsx)(h,{children:(0,p.jsx)(s,{defaultValue:e.cameraName,rowKey:e.id,saveCallback:async(n,r)=>{if(r===`id-1`){let r={...e};r.cameraName=n,await u(2e3),t(r)}},alignment:n,toLink:r})})},_.__docgenInfo={description:``,methods:[],displayName:`_EditCell`},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`() => {

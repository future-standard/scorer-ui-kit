import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{Bt as n,U as r,kt as i,vt as a,zt as o}from"./iframe-C59WqszT.js";var s,c,l,u,d,f,p,m;e((()=>{s=o(),c=t(n()),a(),l=i(),{action:u}=__STORYBOOK_MODULE_ACTIONS__,d={title:`Misc/Molecules`,component:r,decorators:[]},f=[{value:5,textValue:`5`},{value:10,textValue:`10`},{value:20,textValue:`20`},{value:30,textValue:`30`},{value:100,textValue:`100`}],p=()=>{let e=(0,s.number)(`Active Page`,1),[t,n]=(0,c.useState)(e),i=u(`Page changed`),a=u(`Items Per Page`),o=(0,s.text)(`Page Text`,`Page:`),d=(0,s.text)(`Button Text`,`GO`),p=(0,s.text)(`Items Per Page`,`Items Per Page:`),m=(0,s.number)(`Items Default Value`,10),h=(0,s.text)(`Select Width`,`70px`),g=(0,s.text)(`SelectId`,`UniqID23`),_=(0,s.number)(`Total Pages`,20),v=(0,s.boolean)(`Select Disabled`,!1),y=(0,s.object)(`Items Options`,f);return(0,c.useEffect)(()=>{n(e)},[e]),(0,l.jsx)(r,{selectId:g,pageText:o,totalPages:_,activePage:t,buttonText:d,itemsText:p,selectWidth:h,selectDisabled:v,itemsDefaultValue:m,itemsOptions:y,onPageChange:e=>{i(e),n(e)},onItemsChange:e=>{a(e)}})},p.__docgenInfo={description:``,methods:[],displayName:`_Pagination`},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`() => {

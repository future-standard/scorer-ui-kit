import{Et as e,It as t,K as n,Ot as r,Rt as i,W as a,c as o,kt as s,wt as c,zt as l}from"./iframe-C28gtL4u.js";import{n as u}from"./rolldown-runtime-DkW27tQK.js";var d,f,p,m,h,g,_,v;function y(){return(y=u((()=>{l(),c(),d=t(),f=i.button`
  ${e};
  color: var(--grey-9);
  font-size: 14px;
  font-weight: 500;
...
`,v=()=>{let{sendNotification:e}=s(),{setModalOpen:t}=r(),n={type:`info`,message:`You have enabled that requested process`};return(0,d.jsxs)(_,{children:[(0,d.jsx)(m,{}),(0,d.jsxs)(g,{children:[(0,d.jsx)(h,{children:`Welcome To Modal`}),(0,d.jsx)(`p`,{children:`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam pharetra porta mi, eget sollicitudin orci blandit eget. Morbi risus tortor.`}),(0,d.jsx)(`p`,{children:`Vivamus condimentum mi ac nibh faucibus, ac vehicula libero fermentum. Aenean et nisl non enim elementum vestibulum sed sit.`}),(0,d.jsxs)(p,{children:[(0,d.jsx)(o,{onClick:()=>{e(n),t(!1)},children:`Enable Now`}),(0,d.jsx)(f,{onClick:()=>{t(!1)},children:`Enable Later`})]})]})]})},v.__docgenInfo={description:``,methods:[],displayName:`CardModalExample`}})))()}var b,x,S,C,w,T,E;function D(){return(D=u((()=>{c(),l(),y(),b=t(),x=i.div`
  margin: 100px 20px 20px 20px;
  display: grid;
  grid-template-columns: 200px;
  row-gap: 15px;
`,S={title:`Alerts/Mix`,components:s,decorator:[]},C=(0,b.jsx)(v,{}),w=()=>{let{createModal:e}=r(),t=()=>{e({isCloseEnable:!1,width:`480px`,padding:!1,customComponent:C})};return(0,b.jsx)(o,{design:`secondary`,size:`small`,onClick:()=>{t()},children:`Open Welcome Modal`})},T=()=>(0,b.jsx)(x,{children:(0,b.jsx)(n,{children:(0,b.jsx)(a,{children:(0,b.jsx)(w,{})})})}),T.__docgenInfo={description:``,methods:[],displayName:`_MixAlertsExample`},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`() => {

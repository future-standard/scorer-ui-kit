import{Gt as e,It as t,Rt as n,Z as r,wt as i,zt as a}from"./iframe-C28gtL4u.js";import{n as o}from"./rolldown-runtime-DkW27tQK.js";var s,c,l,u,d,f,p,m;function h(){return(h=o((()=>{s=e(),i(),a(),c=t(),{action:l}=__STORYBOOK_MODULE_ACTIONS__,u={title:`Form/Input`,component:r,decorators:[]},d=n.div`
    margin: 20px;
    width: 268px;
`,f=[{value:0,label:`0%`},{value:20},{value:40},{value:60},{value:80},{value:100,label:`100%`}],p=()=>{let e=(0,s.text)(`Title`,`Duration`),t=(0,s.boolean)(`Disabled`,!1),n=(0,s.number)(`Default value`,30),i=(0,s.boolean)(`Custom colors function`,!1),a=(0,s.boolean)(`Custom Title function`,!1),o=l(`Input Callback`),u=(0,s.object)(`Marks`,f),p=(0,s.boolean)(`Show Value`,!0),m=(0,s.boolean)(`Center all mark values`,!1);return(0,c.jsx)(d,{children:(0,c.jsx)(r,{disabled:t,inputCallback:e=>{console.debug(`updated value`,e),o(`Returned value: ${e}`,e)},marks:u,defaultValue:n,title:e,updateThumbColor:i?e=>e<=20?`neutral`:e>20&&e<=80?`info`:`error`:void 0,updateTitle:a?e=>e<=20?`Small sound`:e>20&&e<=80?`Normal sound`:`Dangerous sound`:void 0,showValue:p,allMarkCentered:m})})},p.__docgenInfo={description:``,methods:[],displayName:`_PercentageSlider`},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`() => {

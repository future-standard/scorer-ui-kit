import{Gt as e,It as t,g as n,wt as r}from"./iframe-C8iM32yd.js";import{n as i,t as a}from"./helpers-Cvr4c3Xq.js";import{n as o}from"./rolldown-runtime-DkW27tQK.js";var s,c,l,u,d,f;function p(){return(p=o((()=>{s=e(),r(),i(),c=t(),{action:l}=__STORYBOOK_MODULE_ACTIONS__,u={title:`Chips/atoms`,component:n,decorators:[]},d=()=>{let e=a(),t=(0,s.select)(`Variant`,{Icon:`icon`,Text:`text`,"Icon + text":`icon-text`},`text`),r=(0,s.select)(`Icon`,e,`LayoutGrid`),i=(0,s.text)(`Label`,`1`),o=(0,s.boolean)(`Compact`,!1),u=(0,s.boolean)(`Selected`,!1),d=(0,s.boolean)(`Bar only (no wash, needs Selected)`,!1),f=(0,s.boolean)(`No divider`,!1),p=l(`chip-click`);return(0,c.jsx)(n,{variant:t,icon:r,label:i,isCompact:o,selected:u,barOnly:d,noDivider:f,onClick:p,"aria-label":t===`icon`?`Workspace`:t===`text`?`Space ${i}`:void 0})},d.__docgenInfo={description:``,methods:[],displayName:`_ChipButton`},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`() => {

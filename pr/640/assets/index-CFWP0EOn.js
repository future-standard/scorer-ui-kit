...
`,Fl=z.g`
  ${Pl};
`,J=({icon:e,size:t=24,weight:n=`regular`,color:r=`grey-12`,forSvgUsage:i=!1})=>{let a=Tl.icons.weights[n],o=Un[e];return o==null?null:i?(0,G.jsx)(Fl,{children:o({size:t,weight:a,color:`var(--${r}, var(--grey-12))`})}):(0,G.jsx)(q,{children:o({size:t,weight:a,color:`var(--${r}, var(--grey-12))`})})},Il=z.div`
  position: absolute;
  width: 10px;
  height: 10px;
...
`,Ll=z.div`
  ...
  color: var(--grey-10);
`,Y=({title:e=`Placeholder`})=>(0,G.jsxs)(Ll,{children:[e,(0,G.jsx)(Il,{className:`t l`,style:{transform:`rotate(-90deg)`}}),(0,G.jsx)(Il,{className:`t r`,style:{transform:`rotate(0deg)`}}),(0,G.jsx)(Il,{className:`b r`,style:{transform:`rotate(90deg)`}}),(0,G.jsx)(Il,{className:`b l`,style:{transform:`rotate(180deg)`}})]});R`
  position:relative;
  display: flex;
  flex-direction: row;
  align-items:center;
...
`,Hl={error:`Critical`,warning:`BigWarning`,success:`Success`,info:`Information`,neutral:`Information`},Ul=z.div`
  margin: 5px 0px 5px 15px;
  flex: 1;
`,Wl=({type:e=`info`,message:t,hideCloseButton:n=!1})=>{let[r,i]=(0,_.useState)(!1);return(0,_.useEffect)(()=>{i(!1)},[t]),t&&!r?(0,G.jsxs)(Vl,{$type:e,children:[(0,G.jsx)(J,{icon:Hl[e],color:`inverse`}),(0,G.jsx)(Ul,{children:t}),!n&&(0,G.jsx)(Bl,{onClick:()=>i(!0),children:(0,G.jsx)(J,{icon:`CloseCompact`,color:`inverse`})})]}):null},Gl=z.div`
  min-height: 50px;
...
`,Kl={error:`Critical`,warning:`BigWarning`,success:`Success`,info:`Information`,neutral:`Information`},ql=z.div`
  ${X};
  ${({$selected:e=!1})=>e&&R`
    border-bottom: 5px solid var(--primary-7);
  `}
...
`,xu=z.div`
  ...
  `};
`,Su=({design:e=`primary`,size:t=`normal`,loading:n=!1,shadow:r=!1,onClick:i,disabled:a,position:o,icon:s,weight:c=`regular`,children:l,...u})=>(0,G.jsx)(gu,{children:(0,G.jsx)(su,{noPadding:!0,disabled:a||n,design:e,size:t,shadow:r,onClick:i,loading:n,...u,children:(0,G.jsxs)(xu,{$disabled:a,children:[(0,G.jsx)(_u,{$size:t,$position:o,$weight:c,children:(0,G.jsx)(G.Fragment,{children:l})}),(0,G.jsxs)(bu,{$loading:n,$position:o,children:[(0,G.jsx)(vu,{children:(0,G.jsx)(J,{icon:s,weight:c})}),(0,G.jsx)(yu,{children:(0,G.jsx)(hu,{size:t===`xsmall`||t===`small`?`xsmall`:`small`,styling:e})})]})]})})}),Cu=z.div`
  display: inline;
`,wu=z.div`
  height: inherit;
  flex: 1;
...
`,Eu=z.div`
  ...
  `}
`,Du=({design:e=`primary`,size:t=`normal`,shadow:n=!1,onClick:r,disabled:i,position:a,loading:o=!1,children:s,...c})=>(0,G.jsx)(Cu,{children:(0,G.jsx)(su,{noPadding:!0,disabled:i||o,design:e,size:t,shadow:n,onClick:r,loading:o,...c,children:(0,G.jsxs)(Eu,{$loading:o,$design:e,$size:t,children:[(0,G.jsx)(wu,{children:(0,G.jsx)(G.Fragment,{children:s})}),(0,G.jsx)(Tu,{$design:e,$position:a,children:(0,G.jsx)(hu,{size:t===`xsmall`||t===`small`?`xsmall`:`small`,styling:e})})]})})}),Ou=z.button`
  ${X};
  [stroke]{
    stroke: ${({$color:e})=>e};
  }
...
`,ku=({icon:e,size:t=20,weight:n=`regular`,color:r=`dimmed`,hoverColor:i=`mono`,children:a,formAction:o,...s})=>(0,G.jsx)(Ou,{type:`button`,$color:r,$hoverColor:i,...s,children:(0,G.jsx)(J,{icon:e,size:t,weight:n})}),Au=z(ku)``;z.div`
  display: flex;
  ${Au} {
    margin-left: 15px;
  }
...
`,zu=({type:e=`text`,placeholder:t=``,defaultValue:n,fieldState:r=`default`,showFeedback:i=!1,feedbackMessage:a,actionCallback:o,actionIcon:s,postfix:c,children:l,formAction:u,...d})=>{let f=o!==void 0,p=e=>{switch(e){case`default`:break;case`disabled`:break;case`required`:return(0,G.jsx)(J,{icon:`Required`,size:16});case`valid`:return(0,G.jsx)(J,{icon:`Success`,size:16});case`invalid`:return(0,G.jsx)(J,{icon:`Invalid`,size:16});case`processing`:return(0,G.jsx)(hu,{size:`medium`,styling:`primary`})}};return(0,G.jsxs)(Ru,{$fieldState:r||`default`,$showFeedback:i,children:[(0,G.jsxs)(Lu,{$hasAction:f,children:[(0,G.jsx)(Iu,{$fieldState:r||`default`,disabled:r===`disabled`||r===`processing`,type:e,placeholder:t,defaultValue:n,...d}),f?(0,G.jsx)(ju,{children:(0,G.jsx)(Mu,{onClick:o,children:(0,G.jsx)(J,{icon:s||`NoIcon`,color:`primary`})})}):null]}),r&&i?(0,G.jsxs)(Nu,{children:[(0,G.jsx)(Fu,{children:p(r)}),a?(0,G.jsx)(Pu,{children:a}):null]}):null]})},Bu=z.span`
  display: flex;
  flex: 1;
  align-items: center;
  gap: 8px;
...
`,z.div`
  ...
  `};
`;var Z=function(e){return e[e.Off=0]=`Off`,e[e.On=1]=`On`,e[e.Neutral=2]=`Neutral`,e[e.Locked=3]=`Locked`,e}(Z||{}),Gu=e=>{switch(e){case Z.Off:return`off`;case Z.On:return`on`;case Z.Neutral:return`neutral`;case Z.Locked:return`locked`;default:return`off`}},Ku=z.input`
  display: none;
`,qu=z.div`
...
`,dd=z.label`
  ...
  ${({$visualState:e,$disabled:t})=>e===od.Off&&R`
    /* Unchecked */
    ${cd}{
  ...
  ${({$visualState:e,$disabled:t})=>e===od.On&&R`
    /* Checked */
    ${cd}{
  ...
  ${({$visualState:e,$disabled:t})=>e===od.Indeterminate&&R`
    ${cd}{
...
`,fd=({indeterminate:e=!1,disabled:t,checked:n=!1,onChangeCallback:r})=>{let[i,a]=(0,_.useState)(n),[o,s]=(0,_.useState)(n?od.On:od.Off),c=e=>{let t=e.target.checked;a(t),r&&r(t)};(0,_.useEffect)(()=>{s(n?od.On:od.Off)},[n,i,s]),(0,_.useEffect)(()=>{a(n)},[n,a]);let l=Tl.icons.weights.regular;return(0,G.jsxs)(dd,{onChange:c,$disabled:t,$visualState:o,children:[(0,G.jsx)(cd,{children:(0,G.jsx)(ld,{children:o===od.On?(0,G.jsx)(ud,{$color:`input-toggle-icon-color`,children:(0,G.jsx)(id,{color:`input-toggle-icon-color`,stroke:`inverse`,size:12,weight:l})}):null})}),(0,G.jsx)(sd,{type:`checkbox`,checked:i,readOnly:!0,disabled:t}),` `]})},pd=z.div`
  width: 10px;
  height: 10px;
  border-radius: 50%;
  user-select: none;
...
`;var yd=e=>{let t=e.split(`/`).filter(String);return t.length>0?`/`+t[0]:`/`},Q=()=>String(Date.now().toString(32)+Math.random().toString(16)).replace(/\./g,``),bd=e=>{let t=Number(e);return t!==t},xd=(e,t)=>e===null&&t===null||e===void 0&&t===null?!0:Sd(e)&&Sd(t)?so(e?.start,t?.start)&&so(e?.end,t?.end):e instanceof Date&&t instanceof Date?so(e,t):!1,Sd=e=>e==null||e.start===null||e.start===void 0||e.end===null||e.end===void 0?!1:e.start instanceof Date&&e.end instanceof Date,Cd=16;z.div`
...
`,z(Hu)`
  font-family: ${({theme:e})=>e.fontFamily.data};
`;var Od=({name:e,label:t,fieldState:n,feedbackMessage:r,required:i,children:a,formAction:o,...s})=>{let[c,l]=(0,_.useState)(!1),[u,d]=(0,_.useState)(`PasswordHide`);return(0,G.jsx)(Hu,{htmlFor:e,labelText:t,required:i,children:(0,G.jsx)(zu,{type:c?`text`:`password`,actionCallback:()=>{let e=!c;l(e),d(e?`PasswordShow`:`PasswordHide`)},actionIcon:u,name:e,fieldState:n,feedbackMessage:r,required:i,...s})})},kd=({name:e,label:t,fieldState:n=`default`,feedbackMessage:r,required:i,type:a,...o})=>(0,G.jsx)(Hu,{htmlFor:e,labelText:t,required:i,children:(0,G.jsx)(zu,{type:`text`,fieldState:n,feedbackMessage:r,required:i,name:e,...o})}),Ad=z.div`
...
`;var zd=z.form`
  ...
  `}
`,Bd=({children:e,spacing:t=`45px;`,action:n,...r})=>(0,G.jsx)(zd,{$spacing:t,action:typeof n==`string`?n:void 0,...r,children:(0,G.jsx)(G.Fragment,{children:e})}),Vd=z.button`
  ${X}
...
`,gf=z.img`
  ...
  ${({$isLoaded:e,$hasModalLimits:t})=>R`
    ...
    `};
  `};
`,_f=({src:e,alt:t,videoOptions:n={},mediaType:r,hasModalLimits:i,retryLoading:a=!1,retryLimit:o=5,minWidth:s,minHeight:c,onError:l=()=>{},onMediaLoad:u=()=>{}})=>{let[d,f]=(0,_.useState)(0),[p,m]=(0,_.useState)(e),[h,g]=(0,_.useState)(!1),[v,y]=(0,_.useState)(!1),{loop:b=!1,autoPlay:x=!0,controls:S=!1,muted:C=!0,children:w,...T}=n,E=(0,_.useCallback)(t=>{if(!a||d>=o)l(t.nativeEvent),y(!0),g(!0);else{let t=1e3*(d**2+Math.random());f(e=>e+1),setTimeout(()=>{m(`${e}?v=${Date.now()}`)},t)}},[e,l,d,a,o]),D=(0,_.useCallback)(()=>{u(),y(!0)},[u,y]);return(0,G.jsxs)(ff,{$minWidth:s,$minHeight:c,children:[r===`video`?(0,G.jsx)(hf,{loop:b,autoPlay:x,controls:S,muted:C,onError:E,...T,$hasModalLimits:i,src:h?``:p,$isLoaded:v&&!h,preload:`metadata`,onCanPlayThrough:D,children:(0,G.jsx)(G.Fragment,{children:w})}):(0,G.jsx)(gf,{alt:t,onError:E,$hasModalLimits:i,src:h?``:p,onLoad:D,$isLoaded:v&&!h}),!v&&(0,G.jsx)(mf,{children:(0,G.jsx)(hu,{size:`large`,styling:`primary`})}),h&&(0,G.jsx)(df,{})]})},vf={controls:!0},yf=()=>{let{createModal:e,isModalOpen:t,setModalOpen:n}=af();async function r(e,t){let n=!1;if(t===`img`){let t=new Image;t.src=e;try{await new Promise((e,r)=>{t.onload=()=>e(n=!0),t.onerror=r})}catch{n=!1}}if(t===`video`){let t=document.createElement(`video`);t.src=e;try{await new Promise((e,r)=>{t.oncanplaythrough=()=>e(n=!0),t.onerror=r})}catch{n=!1}}return n}return{createMediaModal:(0,_.useCallback)(async t=>{let{src:n,mediaType:r,alt:i,videoOptions:a=vf,onError:o,onMediaLoad:s,closeText:c,dismissCallback:l,retryLoading:u=!1,retryLimit:d=5,minHeight:f=`300px`,minWidth:p=`300px`}=t;e({padding:!1,width:`auto`,closeText:c,dismissCallback:l,customComponent:(0,G.jsx)(_f,{src:n,mediaType:r,alt:i,videoOptions:a,onError:o,onMediaLoad:s,retryLoading:u,retryLimit:d,minHeight:f,minWidth:p,hasModalLimits:!0})})},[e]),isMediaUrlValid:r,isMediaModalOpen:t,setMediaModalOpen:n}},bf=`(prefers-color-scheme: dark)`,xf=e=>{e?(document.body.classList.add(`light-theme`),document.body.classList.remove(`dark-theme`)):(document.body.classList.add(`dark-theme`),document.body.classList.remove(`light-theme`))},Sf=()=>{let e=localStorage.getItem(`isDarkThemeEnabled`),t=!0;return t=e===null?window.matchMedia(bf)&&window.matchMedia(bf).matches:e!==`false`,xf(!t),t},Cf=()=>{let[e,t]=(0,_.useState)(Sf),n=(0,_.useCallback)(()=>{t(e=>(localStorage.isDarkThemeEnabled=!e,xf(e),!e))},[]),r=(0,_.useCallback)(e=>{if(localStorage.getItem(`isDarkThemeEnabled`)!==null)return;let n=e.matches;t(()=>(xf(!n),n))},[]);return(0,_.useEffect)(()=>{let e=window.matchMedia(bf);return e.addEventListener(`change`,r),()=>{e.removeEventListener(`change`,r)}},[n,r]),{isDarkThemeEnabled:e,setIsDarkThemeEnabled:t,onThemeToggle:n,isLightMode:!e}},wf=30,Tf=z.div`
  height: var(--button-height);
  overflow: visible;
`,Ef=z.div`
...
`,kf=(e,t)=>{if(t)return t;if(e)return`${e-wf}px`},Af=({mainButtonId:e,buttonList:t,design:n=`primary`,size:r,textMaxWidth:i,disabled:a=!1,...o})=>{let[s,c]=(0,_.useState)(!1),l=(0,_.useRef)(null),u=(0,_.useRef)(null),d=(0,_.useCallback)(()=>{c(e=>!e)},[]),f=(0,_.useCallback)(()=>{c(!1)},[]);return Xd(u,f),(0,G.jsx)(Tf,{children:(0,G.jsxs)(Ef,{ref:u,className:`split-button-${n} split-button-size-${r}`,$isOpen:s,...o,children:[(0,G.jsxs)(Df,{ref:l,children:[t.filter(t=>t.id===e).map(({id:e,text:t,icon:r,disabled:i,...o})=>(0,G.jsx)(Gd,{noBorderTop:!0,disabled:a||i,closeCallback:f,icon:r||`NoIcon`,text:t,design:n,...o},e)),(0,G.jsx)(Of,{onClick:d,disabled:a,children:(0,G.jsx)(J,{icon:s?`Close`:`Down`,size:8})})]}),s&&!a?(0,G.jsx)(_.Fragment,{children:t.filter(t=>t.id!==e).map(({id:e,text:t,icon:r,disabled:a,...o})=>(0,G.jsx)(Gd,{icon:r||`NoIcon`,text:t,design:n,disabled:a,textMaxWidth:kf(l.current?.clientWidth,i),...o,closeCallback:f},e))}):null]})})},jf=z.div`
  display: flex;
  flex-direction: column;
  gap: 8px;
  button {
...
`,Mf=({buttons:e})=>(0,G.jsx)(jf,{children:e.map(({id:e,buttonType:t,icon:n,text:r,iconPosition:i,size:a,...o})=>t===`icon-button`?(0,G.jsx)(Su,{size:a||`small`,icon:n||``,position:i,...o,children:r},e||`button-stack-${e}`):(0,G.jsx)(su,{size:a||`small`,...o,children:r},e||`button-stack-${e}`))}),Nf=z.div`
  display: flex;
  flex-direction: column;
...
`,Bf=({allowAfterMidnight:e=!1,title:t,hasDate:n,hasTime:r,isTimeRangeValid:i=!0,date:a=new Date,setDateCallback:o=()=>{}})=>{let s=(e,t,n,r)=>{let i=Number(e.slice(-2)),a=Number(t.slice(-2)),o=i>24?Number(e.slice(-1)):i,s=a>60?Number(t.slice(-1)):a;return o>=24&&s!==-1&&r?{newHour:24,newMin:0}:o===0&&s===0&&r&&!n?{newHour:0,newMin:1}:o===23&&s===60&&!r?{newHour:23,newMin:59}:o>=24&&!r?{newHour:23,newMin:s}:s===60?{newHour:o+1,newMin:0}:o>0&&s===-1?{newHour:o-1,newMin:59}:o===0&&s===-1?{newHour:o,newMin:0}:o===-1?{newHour:0,newMin:s}:{newHour:o,newMin:s}},[c,l]=(0,_.useState)(no(a,`mm`)),[u,d]=(0,_.useState)(no(a,`HH`)),f=(0,_.useCallback)(({target:{value:t}})=>{if(bd(t))return;let{newHour:r,newMin:i}=s(t,u,n,e);o(Gi([aa(a),fo(a,{hours:r,minutes:i,seconds:0,milliseconds:0})]))},[e,a,u,n,o]),p=(0,_.useCallback)(({target:{value:t}})=>{if(bd(t))return;let{newHour:r,newMin:i}=s(c,t,n,e);o(Gi([aa(a),fo(a,{hours:r,minutes:i,seconds:0,milliseconds:0})]))},[e,a,c,n,o]);return(0,_.useEffect)(()=>{e&&so(a,aa(a))?(l(`24`),d(`00`)):(d(no(a,`mm`)),l(no(a,`HH`)))},[a,e]),(0,G.jsxs)(Nf,{$hide:!n&&!r,children:[(0,G.jsx)(Pf,{children:t}),n&&(0,G.jsxs)(Ff,{children:[(0,G.jsx)(If,{children:(0,G.jsx)(J,{icon:`Date`,color:`dimmed`,size:14,weight:`light`})}),(0,G.jsx)(zf,{children:(0,G.jsx)(Lf,{type:`text`,readOnly:!0,value:no(a,`yyyy/MM/dd`),$isTimeRangeValid:i})})]}),r&&(0,G.jsxs)(Ff,{children:[(0,G.jsx)(If,{children:(0,G.jsx)(J,{icon:`Time`,color:`dimmed`,size:14,weight:`light`})}),(0,G.jsxs)(zf,{children:[(0,G.jsx)(Lf,{name:`hours`,type:`number`,min:`-1`,max:e?24:23,value:c,onChange:f,$isTimeRangeValid:i,autoComplete:`off`,$isTimeInput:!0}),(0,G.jsx)(Rf,{children:`:`}),(0,G.jsx)(Lf,{name:`minutes`,type:`number`,min:`-1`,max:`60`,value:u,onChange:p,$isTimeRangeValid:i,autoComplete:`off`,$isTimeInput:!0})]})]})]})},Vf=e=>({start:fo(e,{seconds:0,milliseconds:0}),end:aa(e)}),Hf=new Date,Uf=Vf(Vi(new Date)),Wf=z.div`
  display: flex;
`,Gf=z.div`
...
`,up=[`S`,`M`,`T`,`W`,`T`,`F`,`S`],dp=[`日`,`月`,`火`,`水`,`木`,`金`,`土`],fp=({dateMode:e=`interval`,timeMode:t=`interval`,dateTimeTextUpper:n=`From`,dateTimeTextLower:r=`To`,timeZoneTitle:i=`Timezone`,timeZoneValueTitle:a=`JST`,hasEmptyValue:o=!1,updateCallback:s=()=>{},initialValue:c,availableRange:l,contentDays:u,lang:d=`en`,cancelText:f=`Cancel`,applyText:p=`Apply`,hasApply:m=!1,disableApply:h=!1,applyCallback:g=()=>{},cancelCallback:v=()=>{}})=>{let[y,b]=(0,_.useState)(hp(o,c)),[x,S]=(0,_.useState)(y===null?Hf:y.start),[C,w]=(0,_.useState)(`start`),[T,E]=(0,_.useState)([]),D=(0,_.useRef)(!0),[O,k]=(0,_.useState)(!0),ee=d===`ja`?dp:up;(0,_.useEffect)(()=>{if(D.current)D.current=!1;else{let e=new Date;b(Vf(Vi(e))),S(e)}},[e,t]),(0,_.useEffect)(()=>{E(pa({start:ma(x),end:oa(x)}))},[x]),(0,_.useEffect)(()=>{y!==null&&s(e===`interval`||t===`interval`?y:y.start)},[e,y,t,s]);let A=(0,_.useCallback)(t=>{let n=y||Uf;if(e===`single`)b({start:mp(n.start,t),end:mp(n.end,t)});else if(C===`end`&&oo(t,n.start)){let e=mp(n.end,t);b({...n,end:e}),w(`done`)}else (C===`start`||C===`end`||C===`done`)&&(b({start:mp(n.start,t),end:mp(n.end,t)}),w(`end`))},[e,y,C]);(0,_.useEffect)(()=>{let{start:e,end:n}=y||Uf;t===`interval`&&oo(Ni(e,{minutes:1}),n)?so(n,aa(e))&&n.getSeconds()>0?k(!0):k(!1):k(!0)},[y,t]);let te=(0,_.useCallback)(e=>{let{end:t}=y||Uf;b({start:e,end:t})},[y]),j=(0,_.useCallback)(e=>{let{start:t}=y||Uf;b({start:t,end:e})},[y]);return(0,G.jsxs)(Wf,{children:[(0,G.jsxs)(Gf,{children:[(0,G.jsx)(Bf,{isTimeRangeValid:O,title:n,hasDate:!0,hasTime:t!==`off`,date:y?y.start:Uf.start,setDateCallback:te}),(0,G.jsx)(Bf,{isTimeRangeValid:O,title:r,hasDate:e===`interval`,hasTime:t===`interval`,date:y?y.end:Uf.end,allowAfterMidnight:!0,setDateCallback:j}),(0,G.jsxs)(Kf,{children:[(0,G.jsx)(qf,{children:i}),(0,G.jsx)(Jf,{children:a})]})]}),(0,G.jsxs)(Yf,{children:[(0,G.jsxs)(Xf,{children:[(0,G.jsxs)($f,{type:`button`,disabled:gp(x,l),onClick:()=>S(Mi(x,-1)),children:[(0,G.jsx)(Qf,{children:(0,G.jsx)(J,{icon:`Left`,color:`dimmed`,size:10})}),no(Mi(x,-1),`MMM`,{locale:d===`ja`?_l:ka})]}),(0,G.jsxs)(Zf,{children:[(0,G.jsx)(`span`,{children:no(x,`yyyy`)}),no(x,`MMMM`,{locale:d===`ja`?_l:ka})]}),(0,G.jsxs)($f,{type:`button`,disabled:_p(x,l),onClick:()=>S(Mi(x,1)),children:[no(Mi(x,1),`MMM`,{locale:d===`ja`?_l:ka}),(0,G.jsx)(Qf,{children:(0,G.jsx)(J,{icon:`Right`,color:`dimmed`,size:10})})]})]}),(0,G.jsx)(ip,{children:ee.map((e,t)=>(0,G.jsx)(op,{children:e},t))}),(0,G.jsx)(ep,{children:T.map((e,t)=>(0,G.jsx)(rp,{children:fa({start:e,end:ga(e)}).map((e,t)=>{let n=pp(e,y),r=W(e);return(0,G.jsxs)(lp,{disabled:vp(e,l),onClick:()=>A(e),$state:n,$thisMonth:co(e,x),$isToday:r,children:[(0,G.jsx)(cp,{children:no(e,`d`)}),(0,G.jsx)(sp,{$hasContent:yp(e,u),$state:n,$isToday:r})]},t)})},t))}),m&&(0,G.jsx)(tp,{children:m&&(0,G.jsxs)(np,{children:[(0,G.jsx)(su,{design:`secondary`,onClick:v,children:f}),(0,G.jsx)(su,{onClick:g,disabled:!O||y===null||h,children:p})]})})]})]})},pp=(e,t,n)=>{let r=`off`,i=!1;if(t===null)return r;let a=ao(t).days===0;try{i=lo(e,t)}catch{i=!1}return(i||Ji(t.start,e))&&(r=a?`single`:Ji(t.start,e)?`start`:Ji(t.end,e)?`end`:`inside`),r},mp=(e,t)=>fo(t,{hours:e.getHours(),minutes:e.getMinutes(),seconds:e.getSeconds(),milliseconds:e.getMilliseconds()}),hp=(e,t)=>{if(e&&t===void 0)return null;let n=t||Vf(Vi(new Date));return n instanceof Date?Vf(n):n},gp=(e,t)=>{if(!t?.start)return!1;try{let n=t.start.getFullYear(),r=t.start.getMonth();if(e.getFullYear()<n||e.getFullYear()===n&&e.getMonth()<=r)return!0}catch(e){console.warn(`Invalid available range:`,t,e)}return!1},_p=(e,t)=>{if(!t?.end)return!1;try{let n=t.end.getFullYear(),r=t.end.getMonth();if(e.getFullYear()>n||e.getFullYear()===n&&e.getMonth()>=r)return!0}catch(e){console.warn(`Invalid available range:`,t,e)}return!1},vp=(e,t)=>{if(!t)return!1;let{start:n,end:r}=t;try{if(n&&e<n&&!Ji(e,n)||r&&e>r&&!Ji(e,r))return!0}catch(e){console.warn(`Invalid available range:`,t,e)}return!1},yp=(e,t)=>t?t.some(t=>Ji(e,t)):!1,bp=z.div`
...
`,xp=z.div`
  display: inline-flex;
  flex-direction: column;
`,Sp=({children:e,...t})=>(0,G.jsx)(bp,{...t,children:(0,G.jsx)(xp,{children:(0,G.jsx)(G.Fragment,{children:e})})}),Cp=z.div`
...
`,Dp=z.div`
  ...
  align-items: center;
  gap: 4px;
`,Op=z.div``,kp=({icon:e,hasFlipArrow:t=!1,isSortAscending:n=!1,isOpen:r,design:i=`default`,children:a,formAction:o,...s})=>(0,G.jsx)(Ep,{type:`button`,...s,$isOpen:r,$hasFlipArrow:t,$design:i,children:(0,G.jsxs)(Dp,{children:[(0,G.jsx)(Cp,{$isSortAscending:n,children:(0,G.jsx)(J,{icon:e,size:12,weight:`light`,color:`filter-button-icon-color`})}),(0,G.jsx)(Op,{$hasFlipArrow:t,children:(0,G.jsx)(G.Fragment,{children:a})}),t&&(0,G.jsx)(Tp,{$design:i,children:(0,G.jsx)(J,{icon:r?`Up`:`Down`,size:6,color:`grey-11`})})]})}),Ap=z.div`
  font-family: var(--font-ui);
  display: block;
  color: var(--grey-12);
  font-size: 14px;
...
`,Ip=z.div`
  ...
  `};
`,Lp=({title:e,value:t,optionType:n=`text`,selected:r=!1,disabled:i=!1,onClick:a=()=>{},...o})=>{let s=Tl.icons.weights.regular;return(0,G.jsxs)(Ip,{onClick:a,$disabled:i,$selected:r,...o,children:[n===`checkbox`&&(0,G.jsx)(jp,{children:(0,G.jsx)(Mp,{children:r&&(0,G.jsx)(Np,{children:(0,G.jsx)(id,{color:`inverse`,stroke:`inverse`,size:12,weight:s})})})}),n===`radio`&&(0,G.jsx)(Pp,{children:(0,G.jsx)(Fp,{})}),(0,G.jsx)(Ap,{children:e})]})},Rp=z.div`
  padding: 0 2px;
`,zp=z.div`
...
`,Hp=({color:e=`subtle`,hasBorder:t=!0,iconSize:n=12,disabled:r=!1,noBackground:i=!1,hasCrossButton:a=!1,onCrossClick:o=()=>{},width:s,children:c,formAction:l,...u})=>(0,G.jsxs)(zp,{$hasBorder:t,$disabled:r,$noBackground:i,$width:s,children:[(0,G.jsx)(Rp,{children:(0,G.jsx)(J,{color:e,icon:`Search`,weight:`regular`,size:n})}),(0,G.jsx)(Vp,{$color:e,disabled:r,...u}),a&&(0,G.jsxs)(Bp,{onClick:o,children:[` `,(0,G.jsx)(J,{icon:`CloseCompact`,color:`dimmed`,size:12})]})]}),Up=e=>e==null||e.value===void 0||e.value===null||e.text===null?!1:(typeof e.value==`number`||typeof e.value==`string`)&&typeof e.text==`string`,Wp=z.div`
  position: relative;
`,Gp=z.div`
  display: inline-block;
`,Kp=z.div`
...
`,Xp=z.div`
  ...
  padding: 15px 0;
`,Zp=({loadingText:e})=>(0,G.jsxs)(Yp,{children:[(0,G.jsx)(hu,{size:`large`,styling:`primary`}),(0,G.jsx)(Xp,{children:e})]}),Qp=z.div`
  display: flex;
  padding: 8px;
  justify-content: space-between;
  align-items: flex-start;
...
`,em=z.div`
  ...
  align-items: center;
  gap: 8px;
`,tm=({resetText:e=`Reset`,cancelText:t=`Cancel`,closeText:n=`Close`,applyText:r=`Apply`,hasReset:i=!1,hasApply:a=!1,disableApply:o=!1,disableReset:s=!0,onReset:c=()=>{},onCancel:l=()=>{},onApply:u=()=>{}})=>(0,G.jsxs)(Qp,{children:[(0,G.jsx)($p,{children:i&&(0,G.jsx)(su,{size:`small`,design:`text-only`,disabled:s,onClick:c,children:e})}),a&&(0,G.jsxs)(em,{children:[(0,G.jsx)(su,{size:`small`,design:`secondary`,onClick:l,children:o?n:t}),(0,G.jsx)(su,{size:`small`,onClick:u,disabled:o,children:r})]})]}),nm=z.div`
  display: inline-block;
  position: relative;
`,rm=z(Lp)`
  letter-spacing: 0.2px;
...
`;var wm=470,Tm=360,Em=z.div``,Dm=({buttonIcon:e,buttonText:t,disabled:n,initialValue:r,dateMode:i,timeMode:a,selected:o,dateTimeTextUpper:s,dateTimeTextLower:c,timeZoneTitle:l,timeZoneValueTitle:u,lang:d,hasEmptyValue:f,availableRange:p,contentDays:m,cancelText:h=`Cancel`,applyText:g=`Apply`,hasApply:v=!0,onCloseCallback:y=()=>{},onUpdateCallback:b=()=>{},onToggleCallback:x=()=>{},onCancelCallback:S=()=>{},onApplyCallback:C=()=>{},...w})=>{let T=(0,_.useRef)(null),[E,D]=(0,_.useState)({initialValue:r,isMount:!0}),[O,k]=(0,_.useState)(!1),ee=(0,_.useRef)(null),A=(0,_.useCallback)(e=>{T.current=e,b(e),k(xd(o,e))},[b,o]),te=(0,_.useCallback)(()=>{T.current&&T.current!==o&&y(T.current)},[y,o]),j=(0,_.useCallback)(e=>{!v&&T.current&&T.current!==o&&x(T.current,e),e&&!E.isMount&&D(e=>({...e,isMount:!0}))},[v,E.isMount,x,o]),M=(0,_.useCallback)(()=>{T.current&&T.current!==o&&(T.current=o===void 0?null:o,D({initialValue:o===null?void 0:o,isMount:!1})),S(),ee.current?.imperativeClose()},[S,o]),ne=(0,_.useCallback)(()=>{T.current&&T.current!==o&&C(T.current),ee.current?.imperativeClose()},[C,o]);return(0,_.useEffect)(()=>{let e=!0;return e&&o===null&&T.current!==null&&(T.current=o,D({initialValue:void 0,isMount:!1})),()=>{e=!1}},[o]),(0,G.jsx)(Em,{...w,children:(0,G.jsx)(Jp,{ref:ee,minWidth:wm,minHeight:Tm,onCloseCallback:te,onToggleOpenCallback:j,noCloseOnClickOutside:v,buttonIcon:e,buttonText:t,disabled:n,children:(0,G.jsx)(Sp,{children:E.isMount&&(0,G.jsx)(fp,{dateMode:i,timeMode:a,dateTimeTextUpper:s,dateTimeTextLower:c,timeZoneTitle:l,timeZoneValueTitle:u,lang:d,availableRange:p,contentDays:m,cancelText:h,applyText:g,hasApply:v,updateCallback:A,cancelCallback:M,applyCallback:ne,hasEmptyValue:!0,initialValue:E.initialValue,disableApply:O})})})})},Om=Bn`
  0% {
    width: 50%;
    opacity: .5;
  }
...
`,Am=z.div`
  ...
  `};
`,jm=z(kp)``,Mm=z(ym)``,Nm=z(Dm)``,Pm=z.div`
  display: flex;
  flex-wrap: wrap;
  gap: 8px 6px;
`,Fm=(e,t,n)=>e.map(({id:e,canHide:r,...i})=>!r||!t||r&&!n?(0,G.jsx)(Mm,{...i},`dropdownFilter-id-${e}`):null),Im=(e,t,n)=>e.map(({id:e,canHide:r,showFieldText:i,selected:a,...o})=>t.includes(e)?(0,G.jsx)(km,{children:r?(0,G.jsx)(Am,{children:(0,G.jsx)(Hp,{...o,hasCrossButton:!0,onCrossClick:()=>n(e)})}):(0,G.jsx)(Hp,{...o})},`searchFilter-id-${e}`):null),Lm=e=>e.map(({id:e,canHide:t,...n})=>(0,G.jsx)(Nm,{...n},`datePicker-filter-${e}`)),Rm=(e,t,n)=>e.map(e=>{if(e.canHide&&!t.includes(e.id)){let t=e.id;return(0,G.jsx)(jm,{icon:`Add`,onClick:()=>n(t),children:e.showFieldText},`search-button-id-${e.id}`)}return null}),zm=e=>{let t=[];return e.forEach(e=>{e.canHide||t.push(e.id)}),t},Bm=({hasShowMore:e=!1,searchFilters:t=[],datePickerFilters:n=[],dropdownFilters:r=[],showMoreText:i=`Show More`,showLessText:a=`Show Less`,...o})=>{let[s,c]=(0,_.useState)(zm(t)),[l,u]=(0,_.useState)(!!e),d=(0,_.useCallback)(()=>{u(e=>!e)},[]),f=(0,_.useCallback)(e=>{s.includes(e)?c(s.filter(t=>e!==t)):c([...s,e])},[s]);return(0,G.jsxs)(Pm,{...o,children:[Im(t,s,f),Lm(n),Fm(r,l,e),(!e||!l)&&Rm(t,s,f),e&&(0,G.jsx)(kp,{icon:`FilterEllipsis`,onClick:d,children:l?i:a})]})},Vm=z.div`
  display: flex;
  align-items: center;
  font-size: 12px;
  min-height: 22px;
...
`,qm=z.div`
  ...
  align-items: center;
  margin-left: 10px;
`,Jm=(e,t)=>e.getHours()===23&&e.getSeconds()>0?no(Ni(Vi(e),{days:1}),t):no(e,t),Ym=e=>{let t=!1;if(e!==``)try{no(new Date,e),t=!0}catch{t=!1}return t},Xm=(e,t)=>e.replace(`[TOTAL_RESULTS]`,`${t}`),Zm=(e,t,n,r)=>{let i=``,a=Ym(t);return r&&Up(e)?i=`${r}: ${e.text}`:r&&e instanceof Date?i=a?`${r}: ${no(e,t)}`:`${r}: ${e.toDateString()}`:r&&Sd(e)?i=a?`${r}: ${no(e.start,t)} - ${Jm(e.end,t)}`:`${r}: ${e.start.toDateString()} - ${e.end.toDateString()}`:!r&&Up(e)?i=e.text:!r&&e instanceof Date?i=a?no(e,t):e.toDateString():!r&&Sd(e)&&(i=a?`${no(e.start,t)} - ${Jm(e.end,t)}`:`${e.start.toDateString()} - ${e.end.toDateString()}`),(0,G.jsx)(Wm,{$hasIcon:!!n,children:i})},Qm=({labelLists:e,totalResults:t,resultTextTemplate:n=`Showing Results ([TOTAL_RESULTS]):`,clearText:r=`CLEAR ALL`,resultsDateFormat:i=``,onRemoveFilter:a=()=>{},onClearAll:o=()=>{},...s})=>(0,G.jsxs)(Vm,{...s,children:[(0,G.jsx)(Hm,{children:Xm(n,t)}),(0,G.jsxs)(qm,{children:[e.map(({icon:e,item:t,filterName:n,filterId:r,type:o},s)=>(0,G.jsxs)(Um,{children:[e&&(0,G.jsx)(J,{icon:e,color:`dimmed`,size:10,weight:`light`}),Zm(t,i,e,n),(0,G.jsx)(Km,{onClick:()=>a(r,o,t),children:(0,G.jsx)(J,{icon:`CloseCompact`,color:`dimmed`,size:10,weight:`light`})})]},`Filter-Label-id-${s}`)),e.length>0&&(0,G.jsx)(Gm,{onClick:o,children:r})]})]}),$m=z.div`
  font-family: var(--font-ui);
  color: var(--grey-10);
  font-size: 12px;
  font-weight: 700;
...
`,dh=z.div`
  ...
  transition: background-color var(--speed-slow) var(--easing-primary-in-out);
  background-color: ${({theme:e,$color:t})=>t?e.colors.status[t]:`var(--grey-5)`};
`,fh=({icon:e,status:t,counter:n,maxCounter:r=999})=>(0,G.jsxs)(lh,{children:[t&&n===void 0?(0,G.jsx)(dh,{$color:t}):n===void 0?null:(0,G.jsx)(uh,{$color:t,children:n>r?`${r}+`:n}),(0,G.jsx)(J,{icon:e,size:18,color:`dimmed`})]}),ph=Bn`
 0% {
    transform: scale(1);
 }
...
`,wg=({title:e,icon:t,areaTitle:n,areaHref:r,updateDocTitle:i=!0,hideAreaInDocTitle:a=!1,areaTitleBottom:o=!1,iconColor:s=`dimmed`,onAreaClick:c})=>(Kd(e,a?void 0:n||``,void 0,i),(0,G.jsxs)(gg,{children:[t?(0,G.jsx)(vg,{children:(0,G.jsx)(J,{size:pg,color:s,icon:t})}):null,(0,G.jsxs)(_g,{$areaTitleBottom:o,children:[n&&c?(0,G.jsx)(Cg,{onClick:c,type:`button`,children:n}):n&&r?(0,G.jsx)(Sg,{to:r,children:n}):n?(0,G.jsx)(xg,{children:n}):null,(0,G.jsx)(yg,{children:e})]})]})),Tg=z.p`
  font-family: var(--font-ui);
  color: var(--grey-11);
  font-size: 14px;
  font-style: normal;
...
`,Eg=({children:e})=>(0,G.jsx)(Tg,{children:(0,G.jsx)(G.Fragment,{children:e})}),Dg=z.div`
  user-select: none;
`,Og=z(K)`
  text-decoration: none;
  display: flex;
...
`,Ag=z.div`
  ...
  `};
`,jg=({icon:e=``,size:t=12,weight:n=`regular`,label:r=``,linkTo:i,noBorder:a=!1,tagSize:o,onTagClick:s,...c})=>{let l=(0,_.useMemo)(()=>o===`compact`?8:10,[o]),u=(0,_.useMemo)(()=>o===`compact`?12:14,[o]),d=()=>(0,G.jsxs)(Ag,{$hoverColor:`primary`,$enableHover:!!(s||i),$size:o?u:t,$tagSize:o,$noBorder:a,children:[e&&(0,G.jsx)(J,{icon:e,size:o?l:t,weight:n,...c}),(0,G.jsx)(Dg,{children:r})]});return s?(0,G.jsx)(kg,{onClick:s,type:`button`,children:d()}):i?(0,G.jsx)(Og,{to:i,children:d()}):d()},Mg=z.div`
  display: flex;
  justify-content: space-between;
  gap: 32px;
`,Ng=z.div`
...
`,Ig=z.div`
  ...
  margin-bottom: 5px;
  margin-top: 29px;
`,Lg=z.div``,Rg=({title:e,icon:t,iconColor:n=`primary-9`,introductionText:r,areaHref:i,areaTitle:a,updateDocTitle:o=!0,hideAreaInDocTitle:s,tagList:c,areaTitleBottom:l,rightContent:u,bottomLeftContent:d,onAreaClick:f})=>(0,G.jsxs)(Mg,{children:[(0,G.jsxs)(Ng,{children:[(0,G.jsx)(wg,{iconColor:n,title:e,icon:t,areaHref:i,areaTitle:a,updateDocTitle:o,hideAreaInDocTitle:s,areaTitleBottom:l,onAreaClick:f,bottomLeftContent:d}),c?(0,G.jsx)(Ig,{children:c.map(({icon:e,label:t,linkTo:n,onTagClick:r})=>(0,G.jsx)(jg,{icon:e||``,noBorder:!0,tagSize:`compact`,label:t,linkTo:n,onTagClick:r},`tag-`))}):null,r?(0,G.jsx)(Pg,{children:(0,G.jsx)(Eg,{children:r})}):null,(0,G.jsx)(Lg,{children:(0,G.jsx)(G.Fragment,{children:d})})]}),u?(0,G.jsx)(Fg,{$iconLeftPanel:!!t,children:(0,G.jsx)(G.Fragment,{children:u})}):null]});z.div`
  display: flex;
  flex-direction: column;
`;var zg=z.div`
  position: relative;
...
`,Gg=({status:e=`neutral`})=>(0,G.jsx)(Wg,{$status:e}),Kg=z.button`
...
`,Yg=z.div`
  ...
  ${({$status:e=`neutral`,theme:{colors:t}})=>R`
    background: ${t.status[e]};
  `}
`,Xg=({showUnit:e=!1,showStatus:t=!1,status:n,unit:r=``,cellStyle:i=`normalImportance`,alignment:a=`left`,hideDivider:o,isLastRow:s,hasCopyButton:c,href:l,children:u})=>{o=s?!0:o;let{copyToClipboard:d}=Jd();return(0,G.jsx)(qg,{$cellStyle:i,$alignment:a,$hideDivider:o,$hasCopyButton:c,children:(0,G.jsxs)(G.Fragment,{children:[t?(0,G.jsx)(Yg,{$status:n}):null,l?(0,G.jsx)(`a`,{href:l,children:u}):u,e?(0,G.jsx)(Jg,{children:r}):null,c?(0,G.jsx)(Kg,{onClick:()=>typeof u==`string`&&d(u),children:(0,G.jsx)(J,{icon:`Copy`,size:16})}):null]})})},Zg=z.div`
  display: table-row;
  ${({$isEmpty:e})=>e&&R`
    visibility: hidden;
  `};
`,Qg=({selectable:e=!1,selectCallback:t,hasStatus:n,hasThumbnail:r,hasTypeIcon:i,rowData:a,isLastRow:o,columnConfig:s,closeText:c})=>{let l=(0,_.useCallback)(e=>{t&&t(e,a.id)},[a.id,t]);return(0,G.jsxs)(Zg,{$isEmpty:a.columns.length===0,children:[e?(0,G.jsx)(Xg,{hideDivider:!0,children:(0,G.jsx)(fd,{checked:a._checked,disabled:a.checkboxDisabled,onChangeCallback:l})}):null,n?(0,G.jsx)(Xg,{hideDivider:!0,children:(0,G.jsx)(Gg,{status:a.header?.status})}):null,r?(0,G.jsx)(Xg,{hideDivider:!0,children:(0,G.jsx)(Ug,{image:a.header?.image,mediaUrl:a.header?.mediaUrl,mediaType:a.header?.mediaType,closeText:c,onClickThumbnail:a.header?.onClickThumbnail})}):null,i?(0,G.jsx)(Xg,{hideDivider:!0,children:(0,G.jsx)(J,{icon:a.header?.icon||``,color:`dimmed`,weight:`regular`,size:16})}):null,a.columns.map((e,t)=>{let{cellStyle:n,alignment:r,showUnit:i,showStatus:a,hasCopyButton:c}=s[t],{unit:l,status:u,text:d,customComponent:f}=e;return(0,G.jsx)(Xg,{href:e.href,cellStyle:n,alignment:r,showUnit:i,showStatus:a,hasCopyButton:c,unit:l,status:u,isLastRow:o,children:f||d},t)})]})},$g=z.div`
  border-bottom-right-radius: 3px;
  ...
  `}
`,e_=({header:e,sortable:t,isSortActive:n,ascending:r,columnId:i,indexKey:a,toggleSort:o})=>{let s=(e,t)=>{o(e,t)};return(0,G.jsxs)($g,{$sortable:t,$isSortActive:n,$ascending:r,onClick:()=>{s(a,i)},children:[t&&(0,G.jsx)(J,{icon:`FilterSorting`,size:14,color:`dimmed`}),e]})},t_=z.div`
  display: table-row;
  height: 50px;
`,n_=z.div`
  display: table-cell;
...
`,s_=z.div`
  ...
  ${({$isLastOfGroup:e})=>e&&R`
    margin-right: 15px;
  `};
`,c_=(e,t)=>{if(t<0)return null;let n=!0;return t<e.length-1&&(n=e[t].groupTitle!==e[t+1].groupTitle),e[t].groupTitle?t!==0&&e[t-1].groupTitle===e[t].groupTitle?(0,G.jsxs)(_.Fragment,{children:[(0,G.jsx)(o_,{}),(0,G.jsx)(s_,{$isLastOfGroup:n})]}):(0,G.jsxs)(_.Fragment,{children:[(0,G.jsx)(a_,{children:e[t].groupTitle}),(0,G.jsx)(s_,{$isLastOfGroup:n})]}):(0,G.jsx)(o_,{})},l_=({selectable:e,hasStatus:t,hasThumbnail:n,hasTypeIcon:r,allChecked:i,disableAllChecked:a,hasHeaderGroups:o,columnConfig:s,defaultAscending:c,toggleAllCallback:l=()=>{},sortCallback:u=()=>{}})=>{let[d,f]=(0,_.useState)(s),[p,m]=(0,_.useState)(c),h=(0,_.useCallback)(e=>{l(e)},[l]),g=(0,_.useCallback)((e,t)=>{if(d[e]===void 0||!d[e].sortable)return;let n=[...d],r=null;n.forEach((t,n)=>{t.sortActive&&(r=n),n===e?t.sortActive=!0:t.sortActive=!1});let i=r===e?!p:p;u(i,t===void 0?`column_${e}`:t),f(n),m(i)},[p,u,d]);return(0,G.jsxs)(t_,{children:[e?(0,G.jsx)(n_,{$headerStyle:`header`,$fixedWidth:30,children:(0,G.jsx)(fd,{checked:i,disabled:a,onChangeCallback:h})}):null,t?(0,G.jsx)(n_,{$headerStyle:`header`,$fixedWidth:10}):null,n?(0,G.jsx)(n_,{$headerStyle:`header`,$fixedWidth:70}):null,r?(0,G.jsx)(n_,{$headerStyle:`header`,$fixedWidth:35}):null,s.map((e,t,n)=>{let{header:r,alignment:i,hasCopyButton:a,sortActive:s,columnId:c,sortable:l,minWidth:u}=e;return(0,G.jsx)(n_,{$alignment:i,$hasCopyButton:a,$minWidth:u,$headerStyle:o?`subHeader`:`header`,$isSortActive:s,children:(0,G.jsxs)(r_,{$alignment:i,children:[o&&(0,G.jsx)(i_,{children:o&&c_(n,t)}),(0,G.jsx)(e_,{header:r,sortable:l,indexKey:t,columnId:c,isSortActive:s,ascending:p,toggleSort:g})]})},t)})]})},u_=z.div``,d_=z.div`
  display: table;
  width: 100%;
  position: relative;
`,f_=z.div`
...
`,k_=z.button`
  ...
  `}
`,A_=({show:e=!0,link:t,label:n=`Back`,$showDivider:r,$iconInGutter:i,onClick:a})=>{let o=(0,_.useMemo)(()=>(0,G.jsxs)(_.Fragment,{children:[(0,G.jsx)(T_,{children:(0,G.jsx)(J,{icon:`Back`,size:16,color:`grey-10`})}),n]}),[n]);return e?(0,G.jsx)(_.Fragment,{children:a?(0,G.jsx)(k_,{$showDivider:r,$iconInGutter:i,onClick:a,children:o}):t&&(0,G.jsx)(O_,{to:t,$showDivider:r,$iconInGutter:i,children:o})}):null},j_=z.div`
...
`,U_=({showBreadcrumbs:e=!0,breadcrumbs:t=[],showHomeIcon:n=!0,back:r,share:i,$iconInGutter:a})=>{let{isLarge:o}=uf(),s=a===void 0?o:a,c=e&&t.length>0;return(0,G.jsxs)(j_,{children:[(0,G.jsxs)(M_,{children:[r&&(0,G.jsx)(A_,{$showDivider:c,$iconInGutter:s,...r}),c?(0,G.jsx)(N_,{children:t.map((e,r)=>{let{text:i,href:a,onClick:o}=e,s=r===0,c=r===t.length-1,l=(0,G.jsxs)(_.Fragment,{children:[s&&n?(0,G.jsx)(I_,{children:(0,G.jsx)(J,{icon:`Home`,size:11,color:`grey-10`})}):null,i]});return(0,G.jsx)(_.Fragment,{children:(0,G.jsxs)(P_,{children:[o?(0,G.jsx)(B_,{onClick:o,type:`button`,children:l}):a?(0,G.jsx)(z_,{to:a,children:l}):(0,G.jsx)(V_,{children:l}),c?null:(0,G.jsx)(F_,{children:(0,G.jsx)(J,{icon:`Right`,size:6,color:`grey-8`})})]})},r)})}):null]}),(0,G.jsx)(H_,{children:(0,G.jsx)(w_,{...i})})]})},W_=_.createContext({selected:``,setSelected:()=>{}}),G_=({children:e})=>{let[t,n]=(0,_.useState)(``);return(0,G.jsx)(W_.Provider,{value:{selected:t,setSelected:n},children:e})},K_=z.div`
  display: flex;
  align-items: center;
  flex-direction: column;
  position: relative;
...
`,X_=z.div`
  ...
  flex: 1;
  flex-direction: column;
`,Z_=({layout:e=`default`,HeaderContent:t={},children:n})=>{let{PageHeaderArea:r,TabsElementArea:i,UtilityHeaderOptions:a}=t;return(0,G.jsxs)(K_,{className:`content-layout-`+e,children:[a?(0,G.jsx)(U_,{...a}):null,r?(0,G.jsx)(q_,{children:(0,G.jsx)(G.Fragment,{children:r})}):null,i?(0,G.jsxs)(G_,{children:[(0,G.jsx)(J_,{children:(0,G.jsx)(Y_,{children:(0,G.jsx)(G.Fragment,{children:i})})}),(0,G.jsx)(X_,{children:(0,G.jsx)(G.Fragment,{children:n})})]}):(0,G.jsx)(X_,{children:(0,G.jsx)(G.Fragment,{children:n})})]})},Q_=z.div`
...
`,$_=z.div`
  ...
  right: 0;
  input {width: 100%;}
`,ev=({children:e})=>{let t=(0,_.useRef)(null),[n,r]=(0,_.useState)(0);return(0,_.useEffect)(()=>{t&&t.current&&r(t.current.clientHeight)},[t,e]),(0,G.jsx)(Q_,{$contentHeight:n,children:(0,G.jsx)($_,{ref:t,children:(0,G.jsx)(G.Fragment,{children:e})})})},tv=z.div`
  display: flex;
  flex: 0 0 200px;
  justify-content: center;
  align-items: center;
...
`,ov=z.div`
  ...
  `}
`,sv=({state:e=`default`,layout:t=`horizontal`,arrowDirection:n})=>(0,G.jsx)(ov,{$layout:t,children:(0,G.jsxs)(tv,{children:[(0,G.jsx)(nv,{}),(0,G.jsx)(rv,{children:e===`default`?(0,G.jsxs)(iv,{$layout:t,width:`20`,height:`20`,viewBox:`0 0 20 20`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:[(0,G.jsx)(`path`,{d:`M13 14.875V5.125`,strokeLinecap:`round`,strokeLinejoin:`round`}),(0,G.jsx)(`path`,{d:`M10 14.875V5.125`,strokeLinecap:`round`,strokeLinejoin:`round`}),(0,G.jsx)(`path`,{d:`M7 14.875L7 5.125`,strokeLinecap:`round`,strokeLinejoin:`round`})]}):(0,G.jsx)(av,{$direction:n,width:`20`,height:`20`,viewBox:`0 0 20 20`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:(0,G.jsx)(`path`,{d:`M7.25 4.375L12.61 9.735C12.6803 9.80525 12.7199 9.90058 12.7199 10C12.7199 10.0994 12.6803 10.1948 12.61 10.265L7.25 15.625`,stroke:`#9BA1A6`,strokeLinecap:`round`,strokeLinejoin:`round`})})}),(0,G.jsx)(nv,{})]})}),cv=z.div`
  position: absolute;
  z-index: 10;
  bottom: 20px;
  left: 20px;
...
`,Uv=z.div`
  ...
  `};
`,Wv=({item:e,menuOpen:t,submenuOpen:n,contextKey:r,topLevelPath:i,mobileMenu:a=!1,onClickCallback:o})=>{let{icon:s,title:c,href:l,submenu:u,isExternalLink:d}=e,f=i===l,p=(0,_.useRef)(null),m=Gv(u,o)||[],h=m.length>0;return(0,G.jsxs)(Uv,{$open:n,$mobileMenu:a,children:[(0,G.jsx)(Av,{title:c,href:l,isActive:f,icon:s,hasSubmenu:h,isExternalLink:d,submenuOpen:n,menuOpen:t,onClickCallback:o,contextKey:r}),h?(0,G.jsx)(Hv,{ref:p,children:(0,G.jsx)(Iv,{children:m})}):null]})},Gv=(e,t)=>{if(!e)return;let n=[],r=[];return n.push([]),e.forEach((e,r)=>{let{title:i,href:a,isExternalLink:o}=e;a?o?n[n.length-1].push((0,G.jsx)(Vv,{$isActive:!1,children:(0,G.jsxs)(Bv,{href:a,target:`_blank`,children:[i,(0,G.jsx)(zv,{children:(0,G.jsx)(J,{icon:`ExternalLink`,color:`dimmed`,size:10})})]})},r)):n[n.length-1].push((0,G.jsx)(Vv,{$isActive:!1,children:(0,G.jsx)(Rv,{to:a,onClick:()=>t&&t(-1),children:i})},r)):(n[n.length-1].length>1&&n.push([]),n[n.length-1].push((0,G.jsx)(Fv,{children:(0,G.jsx)(Lv,{children:i})},r)))}),n.forEach((e,t)=>{r.push((0,G.jsx)(Pv,{children:e},t))}),r},Kv=z(K)`
  height: 50px;
...
`,ny=z.div`
  ...
  flex-direction: column;
  height: 100%;
`,ry=({content:e,home:t=`/`,logoMark:n,logoText:r,keepOpenText:i=`Keep Open`,autoHideText:a=`Auto-Hide`,supportUrl:o,supportText:s=`Help & Support`,defaultMenuOpen:c=!0,canAlwaysPin:l=!1,onMenuToggle:u=()=>{}})=>{let{menuState:d,setMenuOpen:f,setMenuClose:p,togglePinned:m}=Nv(c,l),[h,g]=(0,_.useState)(0),v=js(),y=(0,_.useCallback)(e=>{e.pointerType!==`touch`&&f()},[f]),b=(0,_.useCallback)(()=>{p()},[p]),x=(0,_.useCallback)(e=>{e.pointerType!==`touch`&&m()},[m]);(0,_.useEffect)(()=>{u(d.isMenuOpen)},[d.isMenuOpen,u]);let S=(0,_.useCallback)(e=>{e!==-1&&g(h===e?-1:e)},[g,h]);return(0,G.jsx)(ey,{$isPinned:d.isMenuPinned,children:(0,G.jsx)(G.Fragment,{children:po.createPortal((0,G.jsx)(ty,{$open:d.isMenuOpen,$desktopSize:d.desktopSize,onPointerEnter:d.isMenuPinned?()=>{}:y,onTouchStart:()=>console.debug(`touch`),onMouseLeave:d.isMenuPinned?()=>{}:b,children:(0,G.jsxs)(ny,{children:[(0,G.jsxs)(Kv,{to:t,children:[(0,G.jsx)(qv,{children:n?(0,G.jsx)(Yv,{type:`image/svg+xml`,data:n}):(0,G.jsx)(nd,{})}),(0,G.jsx)(Jv,{children:r?(0,G.jsx)(Xv,{type:`image/svg+xml`,data:r}):(0,G.jsx)(rd,{})})]}),(0,G.jsx)(Zv,{children:e.items.map((e,t)=>(0,G.jsx)(Wv,{topLevelPath:yd(v.pathname),contextKey:t,menuOpen:d.isMenuOpen,submenuOpen:t===h&&d.isMenuOpen,onClickCallback:S,item:e,focusedContext:h},t))}),(0,G.jsxs)(Qv,{children:[o&&(0,G.jsx)($v,{children:(0,G.jsx)(Av,{compact:!0,isActive:!1,icon:`Question`,title:s,href:o,menuOpen:d.isMenuOpen})}),d.canPin?(0,G.jsx)($v,{children:(0,G.jsx)(Av,{compact:!0,isActive:!1,icon:d.isMenuOpen&&d.isMenuPinned?`Left`:`Menu`,title:d.isMenuPinned?i:a,onClickCallback:x,menuOpen:d.isMenuOpen})}):null]})]})}),document.body)})})},iy=z.div`
  margin: 10px 10px;
...
`+(t||``)+`
`+(n||``):(t||``)+`
`+(n||``),l(i),d(!0),setTimeout(()=>{d(!1)},1500)},[r,l]),h=(0,_.useCallback)(()=>{p(`mono`)},[]),g=(0,_.useCallback)(()=>{p(`dimmed`)},[]);return(0,G.jsx)(_.Fragment,{children:a!==``&&(0,G.jsx)(ly,{onClick:t,children:(0,G.jsxs)(iy,{children:[(0,G.jsxs)(uy,{children:[(0,G.jsxs)(cy,{children:[(0,G.jsx)(J,{icon:i,size:10,color:`dimmed`}),(0,G.jsx)(ay,{title:a,children:a})]}),(0,G.jsxs)(py,{children:[u&&(0,G.jsx)(fy,{children:n===``?`Copied!`:n}),c?(0,G.jsx)(dy,{onClick:()=>m(a,o,s),onMouseEnter:h,onMouseLeave:g,children:(0,G.jsx)(J,{icon:`Copy`,size:12,color:f})}):null]})]}),o===``?null:(0,G.jsx)(oy,{title:o,children:o}),s===``?null:(0,G.jsx)(sy,{title:s,children:s})]})})})},hy=z.div`
...
`,vy=z.div`
  ...
  padding-top: 2px;
  opacity: 0.5;
`,yy=({icon:e=`Settings`,title:t,subTitle:n,onClickCallback:r=()=>{}})=>(0,G.jsxs)(hy,{onClick:r,children:[(0,G.jsx)(J,{icon:e,size:18,color:`dimmed`}),(0,G.jsxs)(gy,{children:[(0,G.jsx)(_y,{children:t}),(0,G.jsx)(vy,{children:n})]})]}),by=z.div``,xy=z.div`
  width: 100%;
  position: fixed;
  bottom: 50px;
  @media ${Ol.medium} {
...
`,Hy=z.div`
  ...
  color: var(--grey-12);
  margin-top: 15px;
`,Uy=({imgUrl:e,title:t,message:n,time:r})=>(0,G.jsxs)(Fy,{children:[(0,G.jsx)(Iy,{children:e?(0,G.jsx)(Ry,{$image:e}):(0,G.jsx)(Ly,{})}),(0,G.jsxs)(zy,{children:[(0,G.jsx)(By,{children:t}),(0,G.jsx)(Vy,{children:n}),(0,G.jsx)(Hy,{children:r})]})]}),Wy=z.div`
  display: flex;
  flex-direction: column;
`,Gy=z.h2`
    text-transform: uppercase;
...
`,Ky=z.div`
  border-bottom: var(--dividing-line) 1px solid;
`,qy=(e,t)=>e.map((e,n)=>(0,G.jsx)(Ky,{children:(0,G.jsx)(Uy,{...e})},`alert-${t}-${n}`)),Jy=({read:e,unread:t,noNotificationsText:n=`No new notifications`,readNotificationsText:r=`New`,unreadNotificationsText:i=`Read`})=>e.length===0&&t.length===0?(0,G.jsx)(Wy,{children:(0,G.jsx)(Gy,{children:n})}):(0,G.jsxs)(Wy,{children:[t&&(0,G.jsxs)(_.Fragment,{children:[(0,G.jsx)(Gy,{children:r}),qy(t,`unread`)]}),e&&(0,G.jsxs)(_.Fragment,{children:[(0,G.jsx)(Gy,{children:i}),qy(e,`read`)]})]}),Yy=R`
  display: flex;
  height: 32px;
  padding: 8px;
  align-items: center;
...
`,nb=z.div`
  ...
  `};
`,rb=({text:e,color:t,linkHref:n,linkTo:r,linkText:i,onClick:a})=>{let o=(0,_.useRef)(null),s=(0,_.useRef)(null),[c,l]=(0,_.useState)(!1),[u,d]=(0,_.useState)(!1),[f,p]=(0,_.useState)(0);(0,_.useEffect)(()=>{l(!1);let e=setTimeout(()=>{let e=o.current?.getBoundingClientRect().width??0,t=s.current?.getBoundingClientRect().width??0;p(Math.ceil(e>=t?e:t)),l(!0)},100);return()=>clearTimeout(e)},[e,i]);let m=(0,_.useMemo)(()=>(0,G.jsx)(Zy,{ref:o,children:e}),[e]),h=(0,_.useMemo)(()=>a||r||n?(0,G.jsx)(Qy,{ref:s,children:i||e}):null,[a,r,n,i,e]),g=(0,_.useMemo)(()=>c?(0,G.jsx)(_.Fragment,{children:u?h:m}):(0,G.jsxs)(_.Fragment,{children:[m,h]}),[c,u,m,h]);return(0,G.jsx)(nb,{$ready:c,$minWidth:f,onPointerEnter:()=>c&&d(!0),onPointerLeave:()=>c&&d(!1),children:(0,_.useMemo)(()=>a?(0,G.jsx)(tb,{$themeColor:t,children:(0,G.jsx)(`button`,{onClick:a,type:`button`,children:g})}):r?(0,G.jsx)(eb,{$themeColor:t,children:(0,G.jsx)(K,{to:r,children:g})}):n?(0,G.jsx)(eb,{$themeColor:t,children:(0,G.jsx)(`a`,{href:n,children:g})}):(0,G.jsx)(Xy,{$themeColor:t,children:m}),[a,r,n,t,g,m])})},ib=z.div`
  z-index: 9;
  position: sticky;
  top: 0;
  height: 56px;
...
`,mb=z.div`
    overflow-y: scroll;
    margin-right: -17px;
`,hb=({hasNotifications:e=!1,hasLanguage:t=!1,selectedLanguageText:n=``,languageOptionsText:r,selectedLangAttribute:i,hasLogout:a=!0,logoutLink:o=`/logout`,logoutText:s=`Logout`,hasSearch:c=!1,hasCurrentUser:l=!0,currentUserText:u=`Current User`,accountOptionText:d=`Account Options`,searchPlaceholder:f=`Search for devices, analysis tasks, etc.`,userSubmenu:p=[],userDrawerBespoke:m,loggedInUser:h,notificationsHistory:g,customDrawer:v,hasSwitchTheme:y=!1,isLightMode:b=!0,switchThemeText:x=`SWITCH THEME`,selectedThemeText:S=``,onLogout:C=()=>{},onLanguageToggle:w=()=>{},onThemeToggle:T=()=>{},userDrawerFooter:E,userDrawerMeta:D,onUserDrawerMetaClick:O=()=>{},hasUserDrawerMeta:k,copySuccessMessage:ee,includeCopyTitle:A,hasUserDrawerFooter:te,badge:j})=>{let[M,ne]=(0,_.useState)(null),N=e=>{ne(t=>t===e?null:e)};return(0,G.jsx)(ib,{children:(0,G.jsxs)(G.Fragment,{children:[c?(0,G.jsxs)(ob,{children:[(0,G.jsx)(sb,{children:(0,G.jsx)(J,{icon:`Search`,size:16,color:`grey-6`})}),(0,G.jsx)(cb,{placeholder:f})]}):(0,G.jsx)(`div`,{}),(0,G.jsxs)(ab,{children:[j&&(0,G.jsx)(rb,{...j}),(0,G.jsxs)(lb,{children:[v&&(0,G.jsx)(db,{$isActive:M===`custom`,onClick:()=>N(`custom`),children:(0,G.jsx)(fh,{...v})}),e&&(0,G.jsx)(db,{$isActive:M===`notifications`,onClick:()=>N(`notifications`),children:(0,G.jsx)(J,{icon:`Notifications`,size:20,color:`dimmed`})}),(0,G.jsx)(db,{$isActive:M===`user`,onClick:()=>N(`user`),children:(0,G.jsx)(J,{icon:`UserProfile`,size:20,color:`dimmed`})})]})]}),po.createPortal((0,G.jsxs)(fb,{children:[(0,G.jsx)(pb,{$isOpen:M===`user`,children:(0,G.jsx)(Py,{hasLanguage:t,hasLogout:a,logoutLink:o,logoutText:s,hasCurrentUser:l,currentUserText:u,accountOptionText:d,userSubmenu:p,userDrawerBespoke:m,loggedInUser:h,onLogout:C,onLanguageToggle:w,selectedLanguageText:n,languageOptionsText:r,selectedLangAttribute:i,hasSwitchTheme:y,isLightMode:b,switchThemeText:x,selectedThemeText:S,onThemeToggle:T,onUserDrawerMetaClick:O,userDrawerFooter:E,userDrawerMeta:D,hasUserDrawerMeta:k,copySuccessMessage:ee,includeCopyTitle:A,hasUserDrawerFooter:te})}),e?(0,G.jsx)(pb,{$isOpen:M===`notifications`,$baseWidth:`300px`,children:(0,G.jsx)(mb,{children:g?(0,G.jsx)(Jy,{...g}):null})}):null,v&&(0,G.jsx)(pb,{$isOpen:M===`custom`,$baseWidth:v.width?v.width:`200px`,children:(0,G.jsx)(G.Fragment,{children:v.customComponent})})]}),document.body)]})})},gb=z.div`
  display: flex;
  flex-direction: row;
`,_b=({children:e,defaultTabId:t})=>{let{setSelected:n}=(0,_.useContext)(W_);return(0,_.useEffect)(()=>{n(t)},[t,n]),(0,G.jsx)(gb,{children:(0,G.jsx)(G.Fragment,{children:e})})},vb=z.div`
  margin-right: 39px;
  display: flex;
  align-items: center;
  line-height: 20px;
`,yb=z.label`
  ...
  flex-shrink: 0;
  user-select: none;
`,bb=({children:e,tabFor:t,onClick:n,...r})=>{let{selected:i,setSelected:a}=(0,_.useContext)(W_),o=(0,_.useCallback)(e=>{n&&n(e),a(t)},[n,a,t]);return(0,G.jsx)(vb,{...r,onClick:o,children:(0,G.jsx)(yb,{$active:i===t,children:(0,G.jsx)(G.Fragment,{children:e})})})},xb=z.div`
`,Sb=({children:e,tabId:t,...n})=>{let{selected:r}=(0,_.useContext)(W_);return r===t?(0,G.jsx)(xb,{...n,children:(0,G.jsx)(G.Fragment,{children:e})}):null},Cb=z.button`
  ${X}
  flex-basis: auto;
  flex-grow: 1;
`,wb=z.div`
  ...
  `}
`,Tb=({tabFor:e,icon:t,closeId:n,counter:r,status:i,customComponent:a,...o})=>{let{selected:s,setSelected:c}=(0,_.useContext)(W_),l=(0,_.useCallback)(e=>{c(s===e?n:e)},[n,s,c]);return(0,G.jsx)(Cb,{...o,onClick:()=>l(e),children:(0,G.jsx)(wb,{$isActive:s===e,children:(0,G.jsx)(fh,{icon:t,status:i,counter:r})})})};z.div`
  display: flex;
  align-items: center;
  margin-right: 22px;
  padding-bottom: 7px;
...
`,Ob=z.div`
  text-transform: uppercase;
`,kb=({closeId:e,closeText:t=`CLOSE MENU`,children:n,formAction:r,...i})=>{let{setSelected:a}=(0,_.useContext)(W_);return(0,G.jsxs)(Eb,{onClick:()=>a(e),...i,children:[(0,G.jsx)(Db,{children:(0,G.jsx)(J,{icon:`CloseCompact`,color:`dimmed`,size:16})}),(0,G.jsx)(Ob,{children:t})]})},Ab=z.div`
  position: relative;
...
`,jb=z.div`
  ...
  height: 100%;
  width: 100%;
`,Mb=({closeId:e,children:t})=>{let{selected:n}=(0,_.useContext)(W_);return n===e?null:(0,G.jsx)(Ab,{children:(0,G.jsx)(jb,{children:(0,G.jsx)(G.Fragment,{children:t})})})},Nb=z.div``,Pb=z.div`
  padding: 14px 0;
  border-bottom: 1px solid var(--dividing-line);
`,Fb=({content:e,supportUrl:t,supportText:n=`Help & Support`,closeId:r})=>{let[i,a]=(0,_.useState)(0),o=js(),{setSelected:s}=(0,_.useContext)(W_),c=(0,_.useCallback)(t=>{(t===-1||!e.items[t].submenu)&&s(r),t!==-1&&a(i===t?-1:t)},[r,e.items,i,s]),l=(0,_.useCallback)(()=>{s(r)},[r,s]);return(0,G.jsxs)(Nb,{children:[e.items.map((e,t)=>(0,G.jsx)(Pb,{"data-key":t,children:(0,G.jsx)(Wv,{mobileMenu:!0,topLevelPath:yd(o.pathname),contextKey:t,menuOpen:!0,submenuOpen:t===i,onClickCallback:c,item:e,focusedContext:i})},t)),t&&(0,G.jsx)(Pb,{children:(0,G.jsx)(Av,{compact:!0,isActive:!1,icon:`Question`,title:n,href:t,menuOpen:!0,onClickCallback:l})})]})},Ib=z(K)`
  ${X};
  display: flex;
  flex-basis: 0;
  flex-grow: 1;
...
`,Lb=z.div`
  margin-right: 15px;
`,Rb=z.object``,zb=({home:e=`/`,logoMark:t,closeId:n})=>{let{setSelected:r}=(0,_.useContext)(W_);return(0,G.jsx)(Ib,{to:e,onClick:()=>r(n),children:(0,G.jsx)(Lb,{children:t?(0,G.jsx)(Rb,{type:`image/svg+xml`,data:t}):(0,G.jsx)(nd,{})})})},Bb=z.div`
  background: var(--global-element-background);

  z-index: 100;
  display: flex;
  flex-direction: column;
`,Vb=({closeId:e,hasLanguage:t,hasLogout:n,logoutLink:r,hasCurrentUser:i,userSubmenu:a,userDrawerBespoke:o,loggedInUser:s,onLogout:c,onLanguageToggle:l,...u})=>{let{setSelected:d}=(0,_.useContext)(W_),f=(0,_.useCallback)(()=>{d(e)},[e,d]);return(0,G.jsx)(Bb,{children:(0,G.jsx)(Py,{hasLanguage:t,hasLogout:n,logoutLink:r,hasCurrentUser:i,userSubmenu:a,userDrawerBespoke:o,loggedInUser:s,onLogout:c,onLanguageToggle:l,...u,closeOnClick:f})})},Hb=`closeMenu`,Ub=`notifications`,Wb=`user`,Gb=`menu`,Kb=`custom`,qb=z.nav`
  background-color: var(--global-element-background);
  position: sticky;
  top: 0;
  left: 0;
...
`,Yb=({content:e,home:t,logoMark:n,supportUrl:r,defaultMenuOpen:i=!0,closeText:a,hasLanguage:o,hasLogout:s,logoutLink:c,hasCurrentUser:l,hasNotifications:u,userSubmenu:d,userDrawerBespoke:f,loggedInUser:p,notificationsHistory:m,customDrawer:h,supportText:g,onLogout:_,onLanguageToggle:v,...y})=>(0,G.jsx)(qb,{children:(0,G.jsxs)(G_,{children:[(0,G.jsxs)(Jb,{children:[(0,G.jsx)(zb,{home:t,logoMark:n,closeId:Hb}),(0,G.jsxs)(_b,{defaultTabId:Hb,children:[h&&(0,G.jsx)(Tb,{...h,tabFor:Kb,closeId:Hb}),u?(0,G.jsx)(Tb,{tabFor:Ub,icon:`Notifications`,closeId:Hb}):null,(0,G.jsx)(Tb,{tabFor:Wb,icon:`UserProfile`,closeId:Hb}),(0,G.jsx)(Tb,{tabFor:Gb,icon:`Menu`,closeId:Hb})]})]}),(0,G.jsxs)(Mb,{closeId:Hb,children:[(0,G.jsx)(Sb,{tabId:Kb,children:h&&h.customComponent}),(0,G.jsx)(Sb,{tabId:Ub,children:m&&u?(0,G.jsx)(Jy,{...m}):null}),(0,G.jsx)(Sb,{tabId:Wb,children:(0,G.jsx)(Vb,{hasLanguage:o,hasLogout:s,logoutLink:c,hasCurrentUser:l,userSubmenu:d,userDrawerBespoke:f,loggedInUser:p,onLogout:_,onLanguageToggle:v,...y,closeId:Hb})}),(0,G.jsx)(Sb,{tabId:Gb,children:(0,G.jsx)(Fb,{content:e,supportUrl:r,supportText:g,defaultMenuOpen:i,closeId:Hb})}),(0,G.jsx)(kb,{closeText:a,closeId:Hb})]})]})}),Xb=({content:e,home:t,openWidth:n,logoMark:r,logoText:i,supportUrl:a,defaultMenuOpen:o,canAlwaysPin:s,paddingOverride:c,maxWidth:l,legacyLayout:u,children:d,keepOpenText:f,autoHideText:p,supportText:m,onMenuToggle:h,...g})=>{let{isLarge:_}=uf();return _?(0,G.jsxs)(gv,{children:[(0,G.jsx)(ry,{content:e,home:t,openWidth:n,logoMark:r,logoText:i,supportUrl:a,defaultMenuOpen:o,canAlwaysPin:s,onMenuToggle:h,keepOpenText:f,autoHideText:p,supportText:m}),(0,G.jsxs)(yv,{children:[(0,G.jsx)(hb,{...g}),(0,G.jsx)(bv,{$maxWidth:l,$paddingOverride:c,$legacyLayout:u,children:(0,G.jsx)(G.Fragment,{children:d})})]})]}):(0,G.jsxs)(_v,{children:[(0,G.jsx)(Yb,{content:e,home:t,logoMark:r,supportUrl:a,defaultMenuOpen:o,supportText:m,...g}),(0,G.jsx)(bv,{children:(0,G.jsx)(G.Fragment,{children:d})})]})},Zb=z.div`
  width: 286px;
...
`,z(K)`
  ...
  text-decoration: none;
  padding: 7px 20px;
`;var nx=({logoTextTop:e,logoTextBottom:t})=>(0,G.jsxs)(Qb,{children:[(0,G.jsx)($b,{children:e}),(0,G.jsxs)(ex,{children:[`•`,t,`•`]})]}),rx=({children:e,...t})=>(0,G.jsx)(Zb,{...t,children:(0,G.jsx)(G.Fragment,{children:e})}),ix=z.div`
  display: inline-block;
  padding: 0 4px;
  margin-top: 12px;
  border-radius: 3px;
...
`,sx=({children:e})=>(0,G.jsxs)(ax,{children:[(0,G.jsx)(ox,{children:(0,G.jsx)(K,{to:`/`,children:(0,G.jsx)(J,{size:12,icon:`Home`})})}),(0,G.jsx)(ix,{children:e})]}),cx=z.div`
    margin: 100px 200px;
`,lx=()=>(0,G.jsxs)(cx,{children:[(0,G.jsx)(sx,{children:`FormPage.tsx`}),(0,G.jsx)(Rg,{title:`Input State Examples`,areaTitle:`Forms`,areaHref:`/`}),(0,G.jsxs)(Bd,{children:[(0,G.jsx)(kd,{name:`my_field`,label:`Basic`,placeholder:`Placeholder...`,fieldState:`default`,showFeedback:!0}),(0,G.jsx)(kd,{name:`my_field`,label:`Required`,placeholder:``,fieldState:`required`,showFeedback:!0}),(0,G.jsx)(kd,{name:`my_field`,label:`Loading`,placeholder:``,fieldState:`processing`,showFeedback:!0}),(0,G.jsx)(kd,{name:`my_field`,label:`Valid`,placeholder:``,fieldState:`valid`,showFeedback:!0}),(0,G.jsx)(kd,{name:`my_field`,label:`Error`,placeholder:``,fieldState:`invalid`,showFeedback:!0}),(0,G.jsx)(kd,{name:`my_field`,label:`Error`,placeholder:``,fieldState:`invalid`,showFeedback:!0,feedbackMessage:`Error: Oh noes!!!`}),(0,G.jsx)(Od,{name:`my_field`,label:`My Field`,placeholder:``,fieldState:`default`,showFeedback:!0})]})]}),ux=`/scorer-ui-kit/pr/640/`,dx=()=>{let[e,t]=(0,_.useReducer)(fg,[]),[n]=(0,_.useState)(``),[r,i]=(0,_.useState)({showSetIndex:!0,pointIndexOffset:1,showPointHandle:!0,showPointLabel:!0,showLabelShadow:!0,setIndexOffset:1,showMoveHandle:!0,fixedImgDimensions:{x:2310,y:1535},boundaryOffset:0,showDirectionMark:!0,areaFillColor:``,areaTransparencyLevel:0}),a=(0,_.useCallback)(async()=>{t({type:`LOAD`,state:[{name:`Line 1`,points:[{x:600,y:200},{x:1100,y:450}],readOnly:!1,styling:`primary`}]})},[]),o=(0,_.useCallback)(async()=>{t({type:`LOAD`,state:[{name:`UP`,points:[{x:1048,y:456},{x:1613,y:584},{x:1322,y:985},{x:922,y:785}],showPointHandle:!0,showSmallDirectionMark:!0,readOnly:!1,styling:`primary`,areaFillColor:`#0B0B0B`,areaTransparencyLevel:40},{name:`DOWN`,points:[{x:841,y:700},{x:256,y:576}],showPointHandle:!1,showMoveHandle:!1,readOnly:!1,styling:`primary`}]})},[]),s=(0,_.useCallback)(({target:{value:e}})=>{t({type:`RENAME_SET`,index:0,data:{name:e}})},[]),c=(0,_.useCallback)((e,{target:{value:n}})=>{t({type:`RENAME_SET`,index:e,data:{name:n}})},[]),l=(0,_.useCallback)((e,{target:{value:n}})=>{t({type:`UPDATE_FILL_COLOR`,index:e,data:{areaFillColor:n}})},[]),u=(0,_.useCallback)((e,{target:{value:n}})=>{t({type:`UPDATE_TRANSPARENCY_LEVEL`,index:e,data:{areaTransparencyLevel:parseInt(n)}})},[]),d=(0,_.useCallback)((n=0)=>()=>{t({type:`UPDATE_SET_OPTIONS`,index:n,data:{readOnly:!e[0]?.readOnly}})},[e]),f=(0,_.useCallback)(n=>{t({type:`UPDATE_SET_OPTIONS`,index:e.findIndex(e=>e.showPointHandle),data:{showPointHandle:!1,showMoveHandle:!1}}),t({type:`UPDATE_SET_OPTIONS`,index:n,data:{showPointHandle:!0,showMoveHandle:!0}})},[e]),p=(0,_.useCallback)(e=>()=>{i({...r,[e]:!r[e]})},[r]);(0,_.useEffect)(()=>{r.showDirectionMark?o():a()},[a,o,r]);let m=(0,_.useCallback)(({target:{value:e}})=>{i({...r,boundaryOffset:parseInt(e)})},[r]);return(0,G.jsxs)(gv,{children:[(0,G.jsx)(sx,{children:`LinePage.tsx`}),(0,G.jsxs)(rx,{children:[(0,G.jsx)(nx,{logoTextTop:`SCORER`,logoTextBottom:`UI Kit`}),(0,G.jsx)(tx,{style:{flex:`1`},children:(0,G.jsx)(`pre`,{children:JSON.stringify(e,null,2)})}),(0,G.jsxs)(tx,{children:[(0,G.jsx)(Hu,{labelText:`Show Point Handle`,htmlFor:`showPointHandle`,children:(0,G.jsx)(`input`,{id:`showPointHandle`,type:`checkbox`,name:`showPointHandle`,checked:r.showPointHandle,onChange:p(`showPointHandle`)})}),(0,G.jsx)(Hu,{labelText:`Show Move Handle`,htmlFor:`showMoveHandle`,children:(0,G.jsx)(`input`,{id:`showMoveHandle`,type:`checkbox`,name:`showMoveHandle`,checked:r.showMoveHandle,onChange:p(`showMoveHandle`)})}),(0,G.jsx)(Hu,{labelText:`Show Point`,htmlFor:`showPoint`,children:(0,G.jsx)(`input`,{id:`showPoint`,type:`checkbox`,name:`showPoint`,checked:r.showPoint,onChange:p(`showPoint`)})}),(0,G.jsx)(Hu,{labelText:`Show Direction Mark`,htmlFor:`showDirectionMark`,children:(0,G.jsx)(`input`,{id:`showDirectionMark`,type:`checkbox`,name:`showDirectionMark`,checked:r.showDirectionMark,onChange:p(`showDirectionMark`)})}),(0,G.jsx)(Hu,{labelText:`Show Label Shadow`,htmlFor:`showLabelShadow`,children:(0,G.jsx)(`input`,{id:`showLabelShadow`,type:`checkbox`,name:`showLabelShadow`,checked:r.showLabelShadow,onChange:p(`showLabelShadow`)})})]}),(0,G.jsxs)(tx,{children:[r.showDirectionMark?(0,G.jsxs)(G.Fragment,{children:[(0,G.jsx)(kd,{id:`renameLine1`,label:`Rename UP Line`,fieldState:`default`,name:`renameLine1`,value:e[0]?.name||``,onChange:e=>c(0,e)}),(0,G.jsx)(kd,{id:`renameLine2`,label:`Rename DOWN Line`,fieldState:`default`,name:`renameLine2`,value:e[1]?.name||``,onChange:e=>c(1,e)})]}):(0,G.jsx)(kd,{id:`rename`,label:`Rename Line`,fieldState:`default`,name:`rename`,value:e[0]?.name||``,onChange:s}),(0,G.jsx)(Hu,{labelText:`Boundary Offset`,htmlFor:`boundaryOffset`,children:(0,G.jsx)(zu,{id:`boundaryOffset`,type:`number`,name:`boundaryOffset`,min:0,value:r.boundaryOffset,onChange:m})}),(0,G.jsx)(kd,{id:`fillColor`,label:`Area Fill Color`,fieldState:`default`,name:`fillColor`,value:e[0]?.areaFillColor||``,onChange:e=>l(0,e)}),(0,G.jsx)(kd,{id:`transparencyLevel`,label:`Area Tranparency Level`,fieldState:`default`,name:`transparencyLevel`,value:e[0]?.areaTransparencyLevel||``,onChange:e=>u(0,e)})]}),(0,G.jsx)(tx,{children:(0,G.jsx)(su,{design:`secondary`,onClick:d(),children:`Toggle Read Only`})})]}),(0,G.jsxs)(vv,{$padBottom:!1,children:[n&&(0,G.jsx)(`div`,{children:n}),(0,G.jsx)(zh.Provider,{value:{state:e,dispatch:t},children:(0,G.jsx)(Yh,{options:r,onLineClick:f,src:`${ux}images/line-ui-railyard.jpg`})})]})]})},fx=`https://devstreaming-cdn.apple.com/videos/streaming/examples/bipbop_16x9/bipbop_16x9_variant.m3u8`,px=z(Su)`
  width: 100%;
  margin-bottom: 15px;
`,mx=z.div`
  display: flex;
...
`,hx=z.p`
  ...
  margin: 8px 0 0;
  line-height: 1.5;
`,gx=()=>{let[e,t]=(0,_.useReducer)(fg,[]),[n,r]=(0,_.useState)(fx),[i,a]=(0,_.useState)(fx),[o,s]=(0,_.useState)({showSetIndex:!0,pointIndexOffset:1,showPointLabel:!0,setIndexOffset:1,showDirectionMark:!1,showLabelShadow:!1}),[c]=(0,_.useState)({loop:!1,autoPlay:!0,muted:!0,controls:!0}),l=(0,_.useCallback)(()=>{t({type:`LOAD`,state:[{name:`Line 1`,points:[{x:200,y:300},{x:900,y:400}],showPointHandle:!0,showSmallDirectionMark:!0,readOnly:!1,styling:`primary`}]})},[]);(0,_.useEffect)(()=>{l()},[l]);let u=(0,_.useCallback)(()=>{a(n)},[n]),d=(0,_.useCallback)(()=>{r(fx),a(fx)},[]),f=(0,_.useCallback)(e=>{s(t=>({...t,showDirectionMark:e}))},[]),p=(0,_.useCallback)(e=>{s(t=>({...t,showLabelShadow:e}))},[]),m=(0,_.useCallback)(n=>{t({type:`UPDATE_SET_OPTIONS`,index:e.findIndex(e=>e.showPointHandle),data:{showPointHandle:!1,showMoveHandle:!1}}),t({type:`UPDATE_SET_OPTIONS`,index:n,data:{showPointHandle:!0,showMoveHandle:!0}})},[e]);return(0,G.jsxs)(gv,{children:[(0,G.jsx)(sx,{children:`LineHLSPage.tsx`}),(0,G.jsxs)(rx,{children:[(0,G.jsx)(nx,{logoTextTop:`SCORER`,logoTextBottom:`UI Kit`}),(0,G.jsxs)(tx,{children:[(0,G.jsxs)(mx,{children:[(0,G.jsx)(Hu,{htmlFor:`hls-src`,labelText:`HLS source URL (.m3u8)`}),(0,G.jsx)(zu,{id:`hls-src`,type:`text`,value:n,onChange:e=>r(e.target.value),placeholder:`https://.../stream.m3u8`}),(0,G.jsx)(px,{icon:`Play`,design:`primary`,onClick:u,children:`Load Stream`}),(0,G.jsx)(px,{icon:`RetryJob`,design:`secondary`,onClick:d,children:`Reset to Default`})]}),(0,G.jsx)(ed,{checked:o.showDirectionMark,labelText:`Show Direction Mark`,leftTheme:`off`,onChangeCallback:f,rightTheme:`on`,state:`default`}),(0,G.jsx)(`br`,{}),(0,G.jsx)(ed,{checked:o.showLabelShadow,labelText:`Show Label Shadow`,leftTheme:`off`,onChangeCallback:p,rightTheme:`on`,state:`default`}),(0,G.jsxs)(hx,{children:[`Default stream is Apple's public BipBop HLS test. On Safari this plays via native HLS (no `,(0,G.jsx)(`code`,{children:`hls.js`}),` fetched). On Chrome/Firefox, `,(0,G.jsx)(`code`,{children:`hls.js`}),` is dynamically imported — open DevTools → Network and filter for`,(0,G.jsx)(`code`,{children:`hls`}),` to confirm it loads only on this page.`]})]}),(0,G.jsx)(tx,{style:{flex:`1`},children:(0,G.jsx)(`pre`,{children:JSON.stringify(e,null,2)})})]}),(0,G.jsx)(vv,{$padBottom:!1,children:(0,G.jsx)(zh.Provider,{value:{state:e,dispatch:t},children:(0,G.jsx)(ng,{options:o,onLineClick:m,videoOptions:c,src:i},i)})})]})},_x=z.div`
  margin-bottom: 15px;
`,vx=z.div`
  display: flex;
  margin: 20px 0;
  justify-content: flex-end;
`,yx=()=>{let[e,t]=(0,_.useReducer)(fg,[]),[n]=(0,_.useState)(``),[r,i]=(0,_.useState)(`localhost/wsapp`),[a,o]=(0,_.useState)(``),[s,c]=(0,_.useState)(!1),[l,u]=(0,_.useState)(!1),[d,f]=(0,_.useState)(400),[p,m]=(0,_.useState)(!1),{createMediaModal:h}=yf(),[g,v]=(0,_.useState)({loop:!0,autoPlay:!0}),y={showSetIndex:!0,showLabelShadow:!0,setIndexOffset:1,showDirectionMark:s},b=(0,_.useCallback)(async()=>{t({type:`LOAD`,state:[{name:`Line 1`,points:[{x:1407,y:869},{x:2293,y:531}],showPointHandle:!0,showMoveHandle:!0,readOnly:!1,styling:`primary`},{name:`Line 2`,points:[{x:1426,y:254},{x:2260,y:283}],showPointHandle:!1,showMoveHandle:!1,readOnly:!1,styling:`secondary`},{name:`Yikes!`,points:[{x:500,y:500},{x:1e3,y:1e3}],showPointHandle:!1,showMoveHandle:!1,readOnly:!1,styling:`danger`},{name:`Shape 1`,areaName:`Traffic Area`,points:[{x:502,y:453},{x:1067,y:581},{x:776,y:982},{x:376,y:782}],readOnly:!1,styling:`secondary`,areaFillColor:`#0B0B0B`,areaTransparencyLevel:40}]})},[]),x=(0,_.useCallback)(async()=>{},[]);(0,_.useEffect)(()=>{b()},[b]);let S=(0,_.useCallback)(()=>{r&&o(r)},[r]),C=(0,_.useCallback)(e=>{c(e)},[]),w=(0,_.useCallback)(e=>{m(e)},[]),T=(0,_.useCallback)(()=>{v({loop:!0,autoPlay:!0})},[]),E=(0,_.useCallback)(()=>{v({loop:!1,autoPlay:!1,muted:!0}),h({mediaType:`video`,src:`ws://${a}/`,dismissCallback:T})},[h,T,a]),D=(0,_.useCallback)(n=>{t({type:`UPDATE_SET_OPTIONS`,index:e.findIndex(e=>e.showPointHandle),data:{showPointHandle:!1,showMoveHandle:!1}}),t({type:`UPDATE_SET_OPTIONS`,index:n,data:{showPointHandle:!0,showMoveHandle:!0}})},[e]);return(0,G.jsxs)(gv,{children:[(0,G.jsx)(sx,{children:`LineRTCPage.tsx`}),(0,G.jsxs)(rx,{children:[(0,G.jsx)(nx,{logoTextTop:`SCORER`,logoTextBottom:`UI Kit`}),(0,G.jsx)(tx,{style:{flex:`1`},children:(0,G.jsx)(`pre`,{children:JSON.stringify(e,null,2)})}),(0,G.jsxs)(tx,{children:[(0,G.jsx)(_x,{children:(0,G.jsx)(ed,{checked:s,labelText:`Show Direction Mark`,leftTheme:`off`,onChangeCallback:C,rightTheme:`on`,state:`default`})}),(0,G.jsx)(_x,{children:(0,G.jsx)(ed,{checked:p,labelText:`Show Label Shadow`,leftTheme:`off`,onChangeCallback:w,rightTheme:`on`,state:`default`})}),(0,G.jsx)(su,{design:`secondary`,onClick:b,children:`Cancel`}),(0,G.jsx)(su,{style:{marginLeft:`10px`},onClick:x,children:`Save`})]})]}),(0,G.jsxs)(vv,{children:[n&&(0,G.jsx)(Wl,{message:n,type:`error`}),(0,G.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`10px`,marginBottom:`10px`},children:[(0,G.jsxs)(su,{design:`secondary`,onClick:()=>u(e=>!e),children:[l?`Hide`:`Show`,` Scroll Spacer`]}),l&&(0,G.jsx)(`input`,{type:`range`,min:100,max:2e3,step:50,value:d,onChange:e=>f(Number(e.target.value)),style:{width:`200px`}}),l&&(0,G.jsxs)(`span`,{style:{color:`#888`},children:[d,`px`]})]}),l&&(0,G.jsx)(`div`,{style:{height:`${d}px`,background:`repeating-linear-gradient(45deg, transparent, transparent 10px, rgba(255,255,255,0.03) 10px, rgba(255,255,255,0.03) 20px)`},children:(0,G.jsx)(`p`,{style:{padding:`20px`,color:`#888`},children:`TEMP: Scroll test spacer`})}),(0,G.jsx)(kd,{label:`Host`,name:`host`,fieldState:`default`,value:r,onChange:({target:{value:e}})=>i(e)}),(0,G.jsx)(su,{onClick:S,children:`Connect`}),a&&(0,G.jsxs)(G.Fragment,{children:[(0,G.jsx)(zh.Provider,{value:{state:e,dispatch:t},children:(0,G.jsx)(ug,{ws:`ws://${a}/`,videoOptions:g,options:y,onLineClick:D})}),(0,G.jsx)(vx,{children:(0,G.jsx)(su,{onClick:E,children:`Open Video Modal`})})]})]})]})},bx=z(Su)`
  width: 100%;
  margin-bottom: 15px;
`,xx=z.div`
  display: flex;
...
`,Ax=z.div`
  ...
  font-size: 14px;
  color: var(--grey-11);
`,jx=()=>(0,G.jsxs)(Cx,{children:[(0,G.jsx)(Tx,{children:`SCORER UI Kit`}),window.location.hostname===`localhost`?null:(0,G.jsxs)(wx,{children:[(0,G.jsx)(Ex,{children:`Key Resources`}),(0,G.jsx)(Dx,{children:(0,G.jsx)(Ox,{children:(0,G.jsxs)(`a`,{href:`${ux}storybook`,children:[(0,G.jsx)(kx,{children:`Storybook`}),(0,G.jsx)(Ax,{children:`All the key components of the SCORER UI Kit, previewable along with options using Storybook.`})]})})})]}),(0,G.jsxs)(wx,{children:[(0,G.jsx)(Ex,{children:`Examples`}),(0,G.jsxs)(Dx,{children:[(0,G.jsx)(Ox,{children:(0,G.jsxs)(K,{to:`/layouts`,children:[(0,G.jsx)(kx,{children:`Global UI - Layout`}),(0,G.jsx)(Ax,{children:`A basic implementation example of the page Layout component.`}),(0,G.jsx)(ix,{children:`Layouts.tsx`})]})}),(0,G.jsx)(Ox,{children:(0,G.jsxs)(K,{to:`/split-layouts`,children:[(0,G.jsx)(kx,{children:`Split Layout`}),(0,G.jsx)(Ax,{children:`A page layout with the drag-to-resize layout component.`}),(0,G.jsx)(ix,{children:`SplitLayout.tsx`})]})}),(0,G.jsx)(Ox,{children:(0,G.jsxs)(K,{to:`/customdrawer`,children:[(0,G.jsx)(kx,{children:`Custom User Drawer`}),(0,G.jsx)(Ax,{children:`Shows how to add custom injected section to the user drawer.`}),(0,G.jsx)(ix,{children:`CustomUserDrawerPage.tsx`})]})}),(0,G.jsx)(Ox,{children:(0,G.jsxs)(K,{to:`/tabs`,children:[(0,G.jsx)(kx,{children:`Tabs Example`}),(0,G.jsx)(Ax,{children:`A simple implementation of tabs.`}),(0,G.jsx)(ix,{children:`TabsPage.tsx`})]})}),(0,G.jsx)(Ox,{children:(0,G.jsxs)(K,{to:`/table`,children:[(0,G.jsx)(kx,{children:`Table Example`}),(0,G.jsx)(Ax,{children:`A TypeTable implementation with examples on setup and how to use selections.`}),(0,G.jsx)(ix,{children:`TablePage.tsx`})]})}),(0,G.jsx)(Ox,{children:(0,G.jsxs)(K,{to:`/line`,children:[(0,G.jsx)(kx,{children:`Line`}),(0,G.jsx)(Ax,{children:`The line tool used commonly for setting up of areas of interest used in system configurations.`}),(0,G.jsx)(ix,{children:`LinePage.tsx`})]})}),(0,G.jsx)(Ox,{children:(0,G.jsxs)(K,{to:`/linertc`,children:[(0,G.jsx)(kx,{children:`Line WebRTC`}),(0,G.jsx)(Ax,{children:`A variation of the Line tool using a WebRTC video background instead of a static image.`}),(0,G.jsx)(ix,{children:`LineRTCPage.tsx`})]})}),(0,G.jsx)(Ox,{children:(0,G.jsxs)(K,{to:`/linevideo`,children:[(0,G.jsx)(kx,{children:`Line Video`}),(0,G.jsx)(Ax,{children:`A variation of the Line tool using a video background instead of a static image.`}),(0,G.jsx)(ix,{children:`LineVideoPage.tsx`})]})}),(0,G.jsx)(Ox,{children:(0,G.jsxs)(K,{to:`/linehls`,children:[(0,G.jsx)(kx,{children:`Line HLS`}),(0,G.jsx)(Ax,{children:`The Line tool over an HLS (.m3u8) stream. Uses Safari's native HLS when available, falls back to dynamically-imported hls.js otherwise.`}),(0,G.jsx)(ix,{children:`LineHLSPage.tsx`})]})}),(0,G.jsx)(Ox,{children:(0,G.jsxs)(K,{to:`/forms`,children:[(0,G.jsx)(kx,{children:`Forms`}),(0,G.jsx)(Ax,{children:`Form inputs and state examples.`}),(0,G.jsx)(ix,{children:`FormPage.tsx`})]})}),(0,G.jsx)(Ox,{children:(0,G.jsxs)(K,{to:`/login`,children:[(0,G.jsx)(kx,{children:`Login`}),(0,G.jsx)(Ax,{children:`A code sample of our commonly used login view.`}),(0,G.jsx)(ix,{children:`Login.tsx`})]})}),(0,G.jsx)(Ox,{children:(0,G.jsxs)(K,{to:`/customalert`,children:[(0,G.jsx)(kx,{children:`Component Theme Override Example`}),(0,G.jsx)(Ax,{children:`Override CSS based theme for components.`}),(0,G.jsx)(ix,{children:`CustomAlertsPage.tsx`})]})}),(0,G.jsx)(Ox,{children:(0,G.jsxs)(K,{to:`/switch-test`,children:[(0,G.jsx)(kx,{children:`Switch Example`}),(0,G.jsx)(Ax,{children:`A demonstration of the Switch component with API integration.`}),(0,G.jsx)(ix,{children:`SwitchTest.tsx`})]})}),(0,G.jsx)(Ox,{children:(0,G.jsxs)(K,{to:`/usepoll-test`,children:[(0,G.jsx)(kx,{children:`usePoll — StrictMode Fix`}),(0,G.jsx)(Ax,{children:`Side-by-side comparison of usePoll before and after the React StrictMode canceled-ref fix.`}),(0,G.jsx)(ix,{children:`UsePollTestPage.tsx`})]})})]})]}),(0,G.jsxs)(wx,{children:[(0,G.jsx)(Ex,{children:`Deprecated`}),(0,G.jsx)(Dx,{children:(0,G.jsx)(Ox,{children:(0,G.jsxs)(K,{to:`/globalUI`,children:[(0,G.jsx)(kx,{children:`Global UI (Deprecated)`}),(0,G.jsx)(Ax,{children:`The legacy implementation used for page layouts.`}),(0,G.jsx)(ix,{children:`GlobalUIPage.tsx`})]})})})]})]}),Mx=`data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='1076'%20height='1076'%20viewBox='0%200%201076%201076'%3e%3cdefs%3e%3clinearGradient%20id='a'%20x1='19.655%25'%20x2='80.649%25'%20y1='39.035%25'%20y2='55.792%25'%3e%3cstop%20offset='0%25'%20stop-color='%23FFF'%20stop-opacity='.84'/%3e%3cstop%20offset='100%25'%20stop-color='%23FFF'%20stop-opacity='.5'/%3e%3c/linearGradient%3e%3clinearGradient%20id='b'%20x1='-51.504%25'%20x2='143.512%25'%20y1='-10.887%25'%20y2='120.691%25'%3e%3cstop%20offset='0%25'%20stop-color='%23FFF'%20stop-opacity='.84'/%3e%3cstop%20offset='100%25'%20stop-color='%23FFF'%20stop-opacity='.5'/%3e%3c/linearGradient%3e%3clinearGradient%20id='c'%20x1='25.133%25'%20x2='83.065%25'%20y1='38.102%25'%20y2='61.898%25'%3e%3cstop%20offset='0%25'%20stop-color='%23FFF'/%3e%3cstop%20offset='100%25'%20stop-color='%23FFF'%20stop-opacity='.364'/%3e%3c/linearGradient%3e%3clinearGradient%20id='d'%20x1='90.238%25'%20x2='44.369%25'%20y1='106.126%25'%20y2='-19.277%25'%3e%3cstop%20offset='0%25'%20stop-color='%23FFF'/%3e%3cstop%20offset='100%25'%20stop-color='%23FFF'%20stop-opacity='.772'/%3e%3c/linearGradient%3e%3clinearGradient%20id='e'%20x1='20.916%25'%20x2='83.944%25'%20y1='39.373%25'%20y2='61.232%25'%3e%3cstop%20offset='0%25'%20stop-color='%23FFF'/%3e%3cstop%20offset='100%25'%20stop-color='%23FFF'%20stop-opacity='.648'/%3e%3c/linearGradient%3e%3c/defs%3e%3cg%20fill='none'%20fill-rule='nonzero'%20opacity='.2'%20style='mix-blend-mode:overlay'%3e%3cpath%20fill='url(%23a)'%20d='M36.923%20804.572L538%20551.122l538%20262.439v1.54l-518.664%20258.264c-7.056%203.513-15.748%203.513-22.804%200l-497.61-247.78c-4.352-2.167-7.033-6.172-7.033-10.506%200-4.335%202.681-8.34%207.034-10.507z'%20opacity='.746'/%3e%3cpath%20fill='url(%23b)'%20d='M538%20551.122v-262.44l538%20262.44v262.439z'%20opacity='.4'/%3e%3cpath%20fill='url(%23c)'%20d='M0%20551.122l538-262.44%20538%20262.44-538%20262.439z'%20opacity='.799'/%3e%3cpath%20fill='url(%23d)'%20d='M.357%20260.627L538%20524.878v288.683L0%20551.122z'/%3e%3cpath%20fill='url(%23e)'%20d='M0%20261.124L518.618%202.276c6.078-3.035%2013.568-3.035%2019.646%200l502.461%20250.784c3.333%201.664%205.386%204.738%205.386%208.065%200%203.327-2.053%206.401-5.386%208.065L538%20524.878%200%20261.124z'%20opacity='.9'/%3e%3c/g%3e%3c/svg%3e`;(0,_.forwardRef)(({title:e,titleId:t,...n},r)=>(0,G.jsxs)(`svg`,{width:35,height:35,xmlns:`http://www.w3.org/2000/svg`,ref:r,"aria-labelledby":t,...n,children:[e?(0,G.jsx)(`title`,{id:t,children:e}):null,(0,G.jsxs)(`defs`,{children:[(0,G.jsxs)(`linearGradient`,{x1:`0%`,y1:`0%`,x2:`100%`,y2:`100%`,id:`prefix__a`,children:[(0,G.jsx)(`stop`,{stopColor:`#7DB8DB`,offset:`0%`}),(0,G.jsx)(`stop`,{stopColor:`#5CA0D1`,offset:`100%`})]}),(0,G.jsx)(`style`,{children:`
            @font-face {
                font-family: Monorale;
                font-weight: 700;
                font-style: normal;
...
`,kC=z.div`
  ...
  background-color: ${({$type:e})=>`var(--${e}, var(--primary-9))`};
    ...
    `}
`,AC=({statusList:e})=>{let t=(0,_.useRef)([]);return t.current=e.map(()=>_.createRef()),(0,G.jsx)(OC,{children:e.map(({type:e,tooltipMessage:n,tooltipIcon:r,tooltipType:i,tooltipPosition:a},o)=>(0,G.jsxs)(_.Fragment,{children:[(0,G.jsx)(kC,{ref:t.current[o],$type:e,$tooltipMessage:n}),n&&(0,G.jsx)(iu,{tooltipFor:t.current[o],message:n,icon:r,type:i,tooltipPosition:a})]},o))})},jC=z.div`
  margin: 100px 200px;
`,MC=z.pre`
  color: var(--grey-11);
  margin-top: 75px;
...
`,VC=z.div`
  ...
  line-height: 20px;
  color: var(--grey-9);
`,HC=`full.name@example.com`,UC=!0,WC=!0,GC=!0,KC=`#`,qC=()=>{let{onThemeToggle:e,isLightMode:t}=Cf(),{t:n}=DC([`GlobalUI`,`Common`]),r=(0,_.useCallback)(()=>{let e=tC.language===`ja`?`en`:`ja`;tC.changeLanguage(e),localStorage.setItem(`language`,e)},[]),i=(0,G.jsx)(BC,{children:(0,G.jsxs)(VC,{children:[(0,G.jsx)(`p`,{children:n(`Common:userDrawerTextP1`)}),(0,G.jsx)(`p`,{children:n(`Common:userDrawerTextP2`)})]})});return(0,G.jsxs)(zC,{children:[(0,G.jsx)(sx,{children:`CustomUserDrawerPage.tsx`}),(0,G.jsx)(hb,{userDrawerBespoke:i,loggedInUser:HC,hasSearch:UC,useNotifications:WC,logoutLink:KC,searchPlaceholder:n(`Common:searchPlaceholder`),isLightMode:t,switchThemeText:n(`GlobalUI:theme.switchTheme`),selectedThemeText:n(t?`GlobalUI:theme.lightMode`:`GlobalUI:theme.darkMode`),onThemeToggle:e,hasLanguage:GC,onLanguageToggle:r,selectedLangAttribute:tC.language,selectedLanguageText:n(`GlobalUI:theme.${tC.language}`),accountOptionText:n(`Common:accountOptions`),currentUserText:n(`GlobalUI:currentUser`),userSubmenu:[{href:`/user/accounts`,text:n(`Common:accounts`)},{href:`/user/billing`,text:n(`Common:billing`)},{href:`/user/payments`,text:n(`Common:payments`)}]})]})},JC=z.div`
  margin: 100px 200px;
`,YC=z.div`
  height: 1px;
  border-radius: 3px;
...
`,ZC=z.div`
  margin-top: 20px;
`,QC=()=>(0,G.jsxs)(JC,{children:[(0,G.jsx)(sx,{children:`TabsPage.tsx`}),(0,G.jsxs)(vv,{children:[(0,G.jsx)(Rg,{title:`Tabs Example`,areaTitle:`Examples`,areaHref:`/`}),(0,G.jsxs)(G_,{children:[(0,G.jsxs)(_b,{defaultTabId:`tab1`,children:[(0,G.jsx)(bb,{tabFor:`tab1`,children:`Tab 1`}),(0,G.jsx)(bb,{tabFor:`tab2`,children:`Tab 2`})]}),(0,G.jsx)(YC,{}),(0,G.jsx)(Sb,{tabId:`tab1`,children:(0,G.jsxs)(XC,{children:[(0,G.jsx)(Hu,{htmlFor:`fullname`,labelText:`Content of tab 1`}),(0,G.jsx)(kd,{fieldState:`default`,required:!0,label:`Full Name`,name:`fullname`,id:`fullname`}),(0,G.jsx)(kd,{fieldState:`default`,required:!0,label:`Department`,name:`department`,id:`department`}),(0,G.jsx)(su,{design:`primary`,size:`small`,children:` Save `})]})}),(0,G.jsx)(Sb,{tabId:`tab2`,children:(0,G.jsxs)(ZC,{children:[(0,G.jsx)(Hu,{htmlFor:`content2`,labelText:`Content of tab 2`}),(0,G.jsx)(Hu,{htmlFor:`lorem`,labelText:`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sit amet erat et sapien pulvinar efficitur. Quisque tristique massa at auctor rhoncus. Ut venenatis sem id gravida volutpat. Phasellus faucibus accumsan sapien, id pellentesque dolor consectetur quis. Duis non rhoncus nunc. Suspendisse et rhoncus tortor.`}),(0,G.jsx)(su,{design:`primary`,size:`small`,children:` OK `})]})})]})]})]}),$C=z.div`
  h2 {
    font-family: var(--font-ui);
    font-weight: 500;
    color: var(--grey-11);
...
`,fw=z.div`
  margin-top: 10px;
`,pw=e=>new Promise((t,n)=>{setTimeout(()=>{e?n(Error(`Simulated fetch failure`)):t([{id:1,title:`Mock Product 1`},{id:2,title:`Mock Product 2`},{id:3,title:`Mock Product 3`}])},1500)}),mw=()=>{let[e,t]=(0,_.useState)(!1),[n,r]=(0,_.useState)(null),[i,a]=(0,_.useState)(!1),[o,s]=(0,_.useState)(null),[c,l]=(0,_.useState)(`default`),[u,d]=(0,_.useState)(!1),f=(0,_.useCallback)(async()=>{if(l(`default`),e||o!==null){t(!1),r(null),s(null);return}a(!0),l(`loading`),s(null);try{r(await pw(u)),t(!0),l(`default`)}catch{r(null),s(`Failed to fetch data`),l(`failure`)}finally{a(!1)}},[e,u,o]),p=(0,_.useCallback)(e=>{d(e),t(!1),r(null),s(null),l(`default`)},[]);return(0,G.jsxs)(cw,{children:[(0,G.jsx)(Rg,{title:`Switch Component Examples`,icon:`Settings`}),(0,G.jsxs)(uw,{children:[(0,G.jsx)(Rg,{title:`Uncontrolled Component`,introductionText:`This switch uses defaultChecked prop and manages its own state internally`}),(0,G.jsx)(lw,{children:(0,G.jsx)(ed,{labelText:`Toggle Switch (Uncontrolled)`,defaultChecked:!0,onChangeCallback:e=>console.log(`Uncontrolled switch changed:`,e)})})]}),(0,G.jsxs)(uw,{children:[(0,G.jsx)(Rg,{title:`Controlled Component`,introductionText:`This switch uses checked and onChangeCallback props to control its state`}),(0,G.jsx)(Hu,{labelText:`Show Fail Scenario`,htmlFor:`example1`,direction:`row`,children:(0,G.jsx)(fd,{checked:u,onChangeCallback:p},`example1`)}),(0,G.jsxs)(lw,{children:[(0,G.jsx)(ed,{labelText:`Fetch Data (Controlled)`,checked:e,onChangeCallback:f,state:c}),i&&(0,G.jsx)(`p`,{children:`Loading...`}),n&&(0,G.jsxs)(fw,{children:[(0,G.jsx)(dw,{children:`API Response`}),(0,G.jsx)(`ul`,{children:n.map(e=>(0,G.jsx)(`li`,{children:e.username||e.title},e.id))})]}),o&&(0,G.jsx)(`p`,{style:{color:`red`},children:o})]})]})]})},hw=2e3,gw=(e=()=>{},t=1e3)=>{let n=(0,_.useRef)(null),r=(0,_.useRef)(e),i=(0,_.useRef)(!1),a=(0,_.useCallback)(async()=>{n.current!==null&&(clearTimeout(n.current),n.current=null),await r.current(),i.current||(n.current=setTimeout(a,t))},[t]);(0,_.useEffect)(()=>{r.current=e},[e]),(0,_.useEffect)(()=>(a(),()=>{i.current=!0,n.current!==null&&(clearTimeout(n.current),n.current=null)}),[a])},_w=z.div`
  padding: 50px;
`,vw=z.div`
  display: grid;
...
`,Fw=z.span`
  color: var(--grey-11);
`,Iw=e=>{let[t,n]=(0,_.useState)(!1),r=(0,_.useRef)(null);return(0,_.useEffect)(()=>{if(e!==0)return n(!0),r.current&&clearTimeout(r.current),r.current=setTimeout(()=>n(!1),Math.round(hw*1.4)),()=>{r.current&&clearTimeout(r.current)}},[e]),t},Lw=({count:e,lastPolled:t,isPolling:n})=>(0,G.jsxs)(xw,{children:[(0,G.jsxs)(Sw,{children:[(0,G.jsx)(Cw,{children:`Poll count`}),(0,G.jsx)(ww,{children:e})]}),(0,G.jsxs)(Sw,{children:[(0,G.jsx)(Cw,{children:`Last polled`}),(0,G.jsx)(Tw,{children:t})]}),(0,G.jsxs)(Sw,{children:[(0,G.jsx)(Cw,{children:`Status`}),(0,G.jsx)(jg,{tagSize:`compact`,label:e===0?`Waiting…`:n?`Polling continuously`:`Stopped`,icon:e===0?``:n?`Success`:`BigWarning`})]})]}),Rw=()=>{let[e,t]=(0,_.useState)(0),[n,r]=(0,_.useState)(`—`),i=Iw(e);return gw((0,_.useCallback)(()=>{t(e=>e+1),r(new Date().toLocaleTimeString())},[]),hw),(0,G.jsx)(Lw,{count:e,lastPolled:n,isPolling:i})},zw=()=>{let[e,t]=(0,_.useState)(0),[n,r]=(0,_.useState)(`—`),i=Iw(e);return cf((0,_.useCallback)(()=>{t(e=>e+1),r(new Date().toLocaleTimeString())},[]),hw),(0,G.jsx)(Lw,{count:e,lastPolled:n,isPolling:i})},Bw=()=>{let[e,t]=(0,_.useState)(!0),[n,r]=(0,_.useState)(!0);return(0,G.jsxs)(_w,{children:[(0,G.jsx)(Rg,{title:`usePoll — StrictMode Fix`,introductionText:`Side-by-side comparison of usePoll before and after the StrictMode canceled-ref fix. In development (StrictMode active), the Before panel polls once then stops; the After panel polls continuously. Use Unmount / Remount to reset and replay.`}),(0,G.jsxs)(Ow,{children:[(0,G.jsx)(kw,{children:`⚠️ The difference is only visible in development builds with React StrictMode active. In production both panels behave identically.`}),(0,G.jsxs)(kw,{children:[(0,G.jsx)(`strong`,{children:`React 16 & 17:`}),` StrictMode double-invokes `,(0,G.jsx)(`em`,{children:`render functions`}),` only.`,` `,(0,G.jsx)(Aw,{children:`useEffect`}),` callbacks run `,(0,G.jsx)(`strong`,{children:`once`}),` on mount. `,(0,G.jsx)(Aw,{children:`canceled.current`}),` starts as `,(0,G.jsx)(Aw,{children:`false`}),`, `,(0,G.jsx)(Aw,{children:`pollOnce()`}),` fires, the check `,(0,G.jsx)(Aw,{children:`if (!canceled.current)`}),` passes, and the chain keeps scheduling. No bug.`]}),(0,G.jsxs)(kw,{children:[(0,G.jsx)(`strong`,{children:`React 18 & 19:`}),` StrictMode was extended to also double-invoke `,(0,G.jsx)(`em`,{children:`effects`}),` — it simulates mount → cleanup → remount to help surface bugs. The sequence becomes:`]}),(0,G.jsxs)(Mw,{children:[(0,G.jsxs)(Nw,{children:[(0,G.jsx)(Pw,{children:`1. Mount`}),(0,G.jsxs)(Fw,{children:[`→ `,(0,G.jsx)(Aw,{children:`useEffect`}),` runs → `,(0,G.jsx)(Aw,{children:`canceled.current`}),` is false → `,(0,G.jsx)(Aw,{children:`pollOnce()`}),` starts`]})]}),(0,G.jsxs)(Nw,{children:[(0,G.jsx)(Pw,{children:`2. Cleanup`}),(0,G.jsxs)(Fw,{children:[`→ `,(0,G.jsx)(Aw,{children:`canceled.current`}),` = true (timer cleared)`]})]}),(0,G.jsxs)(Nw,{children:[(0,G.jsx)(Pw,{children:`3. Remount`}),(0,G.jsxs)(Fw,{children:[`→ `,(0,G.jsx)(Aw,{children:`useEffect`}),` runs again → `,(0,G.jsx)(Aw,{children:`pollOnce()`}),` called`]})]}),(0,G.jsxs)(Nw,{children:[(0,G.jsx)(`span`,{}),(0,G.jsx)(Fw,{children:`→ callback fires (async await)`})]}),(0,G.jsxs)(Nw,{children:[(0,G.jsx)(`span`,{}),(0,G.jsxs)(Fw,{children:[`→ checks `,(0,G.jsx)(Aw,{children:`canceled.current`}),` → still true `,(0,G.jsx)(jw,{children:`← bug stops here`})]})]}),(0,G.jsxs)(Nw,{children:[(0,G.jsx)(`span`,{}),(0,G.jsx)(Fw,{children:`→ never schedules next poll`})]})]})]}),(0,G.jsxs)(vw,{children:[(0,G.jsxs)(yw,{$variant:`broken`,children:[(0,G.jsx)(bw,{children:`Before — broken pattern`}),(0,G.jsxs)(Dw,{children:[(0,G.jsx)(Aw,{children:`canceled.current`}),` is never reset on remount. In StrictMode the cleanup sets it to `,(0,G.jsx)(Aw,{children:`true`}),`; on remount`,` `,(0,G.jsx)(Aw,{children:`pollOnce()`}),` runs once, sees `,(0,G.jsx)(Aw,{children:`canceled === true`}),`, and never schedules the next poll.`]}),e?(0,G.jsx)(Rw,{}):(0,G.jsx)(Ew,{children:`Component unmounted — click Remount to replay`}),(0,G.jsx)(su,{design:`secondary`,size:`small`,onClick:()=>t(e=>!e),children:e?`Unmount`:`Remount`})]}),(0,G.jsxs)(yw,{$variant:`fixed`,children:[(0,G.jsx)(bw,{children:`After — fixed pattern`}),(0,G.jsxs)(Dw,{children:[(0,G.jsx)(Aw,{children:`canceled.current = false`}),` is set at the top of the effect, before `,(0,G.jsx)(Aw,{children:`pollOnce()`}),` is called. The StrictMode remount resets the flag and polling continues on schedule.`]}),n?(0,G.jsx)(zw,{}):(0,G.jsx)(Ew,{children:`Component unmounted — click Remount to replay`}),(0,G.jsx)(su,{design:`secondary`,size:`small`,onClick:()=>r(e=>!e),children:n?`Unmount`:`Remount`})]})]}),(0,G.jsx)(sx,{children:`UsePollTestPage.tsx`})]})},Vw=()=>(0,G.jsx)(qc,{children:(0,G.jsxs)(sc,{children:[(0,G.jsx)(ac,{path:`/`,element:(0,G.jsx)(jx,{})}),(0,G.jsx)(ac,{path:`/line`,element:(0,G.jsx)(dx,{})}),(0,G.jsx)(ac,{path:`/linevideo`,element:(0,G.jsx)(Sx,{})}),(0,G.jsx)(ac,{path:`/linehls`,element:(0,G.jsx)(gx,{})}),(0,G.jsx)(ac,{path:`/linertc`,element:(0,G.jsx)(yx,{})}),(0,G.jsx)(ac,{path:`/login`,element:(0,G.jsx)(tS,{onLogin:()=>{}})}),(0,G.jsx)(ac,{path:`/forms`,element:(0,G.jsx)(lx,{})}),(0,G.jsx)(ac,{path:`/table`,element:(0,G.jsx)(LC,{})}),(0,G.jsx)(ac,{path:`/customdrawer`,element:(0,G.jsx)(qC,{})}),(0,G.jsx)(ac,{path:`/tabs`,element:(0,G.jsx)(QC,{})}),(0,G.jsx)(ac,{path:`/customalert`,element:(0,G.jsx)(iw,{})}),(0,G.jsx)(ac,{path:`/globalUI`,element:(0,G.jsx)(tw,{})}),(0,G.jsx)(ac,{path:`/layouts`,element:(0,G.jsx)(ow,{})}),(0,G.jsx)(ac,{path:`/split-layouts`,element:(0,G.jsx)(sw,{})}),(0,G.jsx)(ac,{path:`/switch-test`,element:(0,G.jsx)(mw,{})}),(0,G.jsx)(ac,{path:`/usepoll-test`,element:(0,G.jsx)(Bw,{})})]})}),Hw={madeby:`Powered By:`,pageTitle:`Welcome`,badgeTitle:`Guest`,share:`Share`,home:`Home`,exampleAction:`Example Action`,pageIntroduction:`Thanks for using our UI library.`,example1:`Example 1`,example2:`Example 2`,accountOptions:`Account Options`,aboutUs:`About us`,team:`Team`,contact:`Contact`,company:`Company`,tableExample:`Table Example`,externalLink:`External link`,onlineServices:`Online Services`,serviceCustom:`Service custom`,serviceSpecial:`Service special`,serviceExtraSpecial:`Service Extra Special`,onSiteServices:`On site Services`,services:`Services`,helloDrawer:`Example Drawer`,noNotificationsText:`No new notifications`,readNotificationsText:`Read`,unreadNotificationsText:`UnRead`,searchPlaceholder:`Search area names, etc.`,accounts:`Accounts`,billing:`Billing`,payments:`Payments`,descriptionTab1:`The below line uses the FullWidthContentBlock component to break out of the layout and span the full width of the browser.`,titleTab2:`Content Tab 2`,titleTab3:`Content Tab 3`,formName:`Name`,formDepartment:`Department`,userDrawerTextP1:`Custom content can be injected under the user menu like this.`,userDrawerTextP2:`The styling for this is left to you to include, keeping it flexible.`,filterBar:{title:`Filters:`,resultTemplate:`Showing Results ([TOTAL_RESULTS]):`,clearAll:`Clear All`,status:`Status`,reset:`Reset`,cancel:`Cancel`,close:`Close`,apply:`Apply`,statusSuccess:`Success`,statusWarning:`Warning`,statusError:`Error`,statusNeutral:`Neutral`,switchLang:`Switch to Japanese`,tip:`Tip: select a Status filter, then switch language — the selected filter tag label updates.`},breadcrumbs:{back:`Back`,firstText:`Examples`,secondText:`Two`,thirdText:`Third`,fourText:`Four`,fiveText:`Five`}},Uw={madeby:`Powered By:`,pageTitle:`ようこそ`,badgeTitle:`ゲスト`,share:`共有`,home:`ホーム`,example1:`サンプル 1`,example2:`サンプル 2`,exampleAction:`例1のアクション`,pageIntroduction:`UIライブラリのご利用ありがとうございます。`,accountOptions:`アカウントオプション`,aboutUs:`会社概要`,team:`チーム`,contact:`コンタクト`,company:`会社概要`,tableExample:`テーブル例`,externalLink:`外部リンク`,onlineServices:`オンラインサービス`,serviceCustom:`サービスカスタム`,serviceSpecial:`サービススペシャル`,serviceExtraSpecial:`特別なサービス`,onSiteServices:`オンサイトサービス`,services:`サービス`,helloDrawer:`例ドラウェ`,noNotificationsText:`新着通知なし`,readNotificationsText:`既読通知`,unreadNotificationsText:`未読通知`,searchPlaceholder:`検索エリア名など`,accounts:`アカウント一覧`,billing:`請求`,payments:`支払い`,descriptionTab1:`以下の行では、FullWidthContentBlock コンポーネントを使用してレイアウトの制約を解除し、ブラウザーの全幅に広げています。`,titleTab2:`タブ2の内容`,titleTab3:`タブ3の内容`,formName:`名`,formDepartment:`部門`,userDrawerTextP1:`カスタムコンテンツは、このようにユーザーメニューの下に挿入することができます`,userDrawerTextP2:`スタイリングは自由に設定できます`,filterBar:{title:`フィルター:`,resultTemplate:`結果 ([TOTAL_RESULTS]):`,clearAll:`すべてクリア`,status:`ステータス`,reset:`リセット`,cancel:`キャンセル`,close:`閉じる`,apply:`適用`,statusSuccess:`成功`,statusWarning:`警告`,statusError:`エラー`,statusNeutral:`中立`,switchLang:`英語に切替`,tip:`ヒント：ステータスフィルターを選択してから言語を切り替えると、選択中のタグのラベルが更新されます。`},breadcrumbs:{back:`戻る`,firstText:`実例`,secondText:`第2`,thirdText:`第3`,fourText:`第4`,fiveText:`第5`}},Ww={login:`Login`,logout:`Logout`,currentUser:`Current User`,keepOpenText:`Keep Open`,autoHideText:`Auto-Hide`,supportText:`Help & Support`,noNotificationsText:`No new notifications`,readNotificationsText:`Read`,unreadNotificationsText:`UnRead`,theme:{darkMode:`DARK MODE`,lightMode:`LIGHT MODE`,switchTheme:`SWITCH THEME`,en:`English`,ja:`Japanese`}},Gw={login:`ログイン`,logout:`ログアウト`,currentUser:`現在のユーザー`,keepOpenText:`開いた状態を維持`,autoHideText:`自動で隠す`,supportText:`ヘルプとサポート`,noNotificationsText:`新着通知なし`,readNotificationsText:`既読通知`,unreadNotificationsText:`未読通知`,theme:{darkMode:`ダークモード`,lightMode:`ライトモード`,switchTheme:`テーマの変更`,en:`英語`,ja:`日本語`}},{slice:Kw,forEach:qw}=[];function Jw(e){return qw.call(Kw.call(arguments,1),t=>{if(t)for(let n in t)e[n]===void 0&&(e[n]=t[n])}),e}function Yw(e){return typeof e==`string`?[/<\s*script.*?>/i,/<\s*\/\s*script\s*>/i,/<\s*img.*?on\w+\s*=/i,/<\s*\w+\s*on\w+\s*=.*?>/i,/javascript\s*:/i,/vbscript\s*:/i,/expression\s*\(/i,/eval\s*\(/i,/alert\s*\(/i,/document\.cookie/i,/document\.write\s*\(/i,/window\.location/i,/innerHTML/i].some(t=>t.test(e)):!1}var Xw=/^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,Zw=function(e,t){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{path:`/`},r=`${e}=${encodeURIComponent(t)}`;if(n.maxAge>0){let e=n.maxAge-0;if(Number.isNaN(e))throw Error(`maxAge should be a Number`);r+=`; Max-Age=${Math.floor(e)}`}if(n.domain){if(!Xw.test(n.domain))throw TypeError(`option domain is invalid`);r+=`; Domain=${n.domain}`}if(n.path){if(!Xw.test(n.path))throw TypeError(`option path is invalid`);r+=`; Path=${n.path}`}if(n.expires){if(typeof n.expires.toUTCString!=`function`)throw TypeError(`option expires is invalid`);r+=`; Expires=${n.expires.toUTCString()}`}if(n.httpOnly&&(r+=`; HttpOnly`),n.secure&&(r+=`; Secure`),n.sameSite)switch(typeof n.sameSite==`string`?n.sameSite.toLowerCase():n.sameSite){case!0:r+=`; SameSite=Strict`;break;case`lax`:r+=`; SameSite=Lax`;break;case`strict`:r+=`; SameSite=Strict`;break;case`none`:r+=`; SameSite=None`;break;default:throw TypeError(`option sameSite is invalid`)}return n.partitioned&&(r+=`; Partitioned`),r},Qw={create(e,t,n,r){let i=arguments.length>4&&arguments[4]!==void 0?arguments[4]:{path:`/`,sameSite:`strict`};n&&(i.expires=new Date,i.expires.setTime(i.expires.getTime()+n*60*1e3)),r&&(i.domain=r),document.cookie=Zw(e,t,i)},read(e){let t=`${e}=`,n=document.cookie.split(`;`);for(let e=0;e<n.length;e++){let r=n[e];for(;r.charAt(0)===` `;)r=r.substring(1,r.length);if(r.indexOf(t)===0)return r.substring(t.length,r.length)}return null},remove(e,t){this.create(e,``,-1,t)}},$w={name:`cookie`,lookup(e){let{lookupCookie:t}=e;if(t&&typeof document<`u`)return Qw.read(t)||void 0},cacheUserLanguage(e,t){let{lookupCookie:n,cookieMinutes:r,cookieDomain:i,cookieOptions:a}=t;n&&typeof document<`u`&&Qw.create(n,e,r,i,a)}},eT={name:`querystring`,lookup(e){let{lookupQuerystring:t}=e,n;if(typeof window<`u`){let{search:e}=window.location;!window.location.search&&window.location.hash?.indexOf(`?`)>-1&&(e=window.location.hash.substring(window.location.hash.indexOf(`?`)));let r=e.substring(1).split(`&`);for(let e=0;e<r.length;e++){let i=r[e].indexOf(`=`);i>0&&r[e].substring(0,i)===t&&(n=r[e].substring(i+1))}}return n}},tT={name:`hash`,lookup(e){let{lookupHash:t,lookupFromHashIndex:n}=e,r;if(typeof window<`u`){let{hash:e}=window.location;if(e&&e.length>2){let i=e.substring(1);if(t){let e=i.split(`&`);for(let n=0;n<e.length;n++){let i=e[n].indexOf(`=`);i>0&&e[n].substring(0,i)===t&&(r=e[n].substring(i+1))}}if(r)return r;if(!r&&n>-1){let t=e.match(/\/([a-zA-Z-]*)/g);return Array.isArray(t)?t[typeof n==`number`?n:0]?.replace(`/`,``):void 0}}}return r}},nT=null,rT=()=>{if(nT!==null)return nT;try{if(nT=typeof window<`u`&&window.localStorage!==null,!nT)return!1;let e=`i18next.translate.boo`;window.localStorage.setItem(e,`foo`),window.localStorage.removeItem(e)}catch{nT=!1}return nT},iT={name:`localStorage`,lookup(e){let{lookupLocalStorage:t}=e;if(t&&rT())return window.localStorage.getItem(t)||void 0},cacheUserLanguage(e,t){let{lookupLocalStorage:n}=t;n&&rT()&&window.localStorage.setItem(n,e)}},aT=null,oT=()=>{if(aT!==null)return aT;try{if(aT=typeof window<`u`&&window.sessionStorage!==null,!aT)return!1;let e=`i18next.translate.boo`;window.sessionStorage.setItem(e,`foo`),window.sessionStorage.removeItem(e)}catch{aT=!1}return aT},sT={name:`sessionStorage`,lookup(e){let{lookupSessionStorage:t}=e;if(t&&oT())return window.sessionStorage.getItem(t)||void 0},cacheUserLanguage(e,t){let{lookupSessionStorage:n}=t;n&&oT()&&window.sessionStorage.setItem(n,e)}},cT={name:`navigator`,lookup(e){let t=[];if(typeof navigator<`u`){let{languages:e,userLanguage:n,language:r}=navigator;if(e)for(let n=0;n<e.length;n++)t.push(e[n]);n&&t.push(n),r&&t.push(r)}return t.length>0?t:void 0}},lT={name:`htmlTag`,lookup(e){let{htmlTag:t}=e,n,r=t||(typeof document<`u`?document.documentElement:null);return r&&typeof r.getAttribute==`function`&&(n=r.getAttribute(`lang`)),n}},uT={name:`path`,lookup(e){let{lookupFromPathIndex:t}=e;if(typeof window>`u`)return;let n=window.location.pathname.match(/\/([a-zA-Z-]*)/g);if(Array.isArray(n))return n[typeof t==`number`?t:0]?.replace(`/`,``)}},dT={name:`subdomain`,lookup(e){let{lookupFromSubdomainIndex:t}=e,n=typeof t==`number`?t+1:1,r=typeof window<`u`&&window.location?.hostname?.match(/^(\w{2,5})\.(([a-z0-9-]{1,63}\.[a-z]{2,6})|localhost)/i);if(r)return r[n]}},fT=!1;try{document.cookie,fT=!0}catch{}var pT=[`querystring`,`cookie`,`localStorage`,`sessionStorage`,`navigator`,`htmlTag`];fT||pT.splice(1,1);var mT=()=>({order:pT,lookupQuerystring:`lng`,lookupCookie:`i18next`,lookupLocalStorage:`i18nextLng`,lookupSessionStorage:`i18nextLng`,caches:[`localStorage`],excludeCacheFor:[`cimode`],convertDetectedLanguage:e=>e}),hT=class{constructor(e){let t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};this.type=`languageDetector`,this.detectors={},this.init(e,t)}init(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{languageUtils:{}},t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{};this.services=e,this.options=Jw(t,this.options||{},mT()),typeof this.options.convertDetectedLanguage==`string`&&this.options.convertDetectedLanguage.indexOf(`15897`)>-1&&(this.options.convertDetectedLanguage=e=>e.replace(`-`,`_`)),this.options.lookupFromUrlIndex&&(this.options.lookupFromPathIndex=this.options.lookupFromUrlIndex),this.i18nOptions=n,this.addDetector($w),this.addDetector(eT),this.addDetector(iT),this.addDetector(sT),this.addDetector(cT),this.addDetector(lT),this.addDetector(uT),this.addDetector(dT),this.addDetector(tT)}addDetector(e){return this.detectors[e.name]=e,this}detect(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:this.options.order,t=[];return e.forEach(e=>{if(this.detectors[e]){let n=this.detectors[e].lookup(this.options);n&&typeof n==`string`&&(n=[n]),n&&(t=t.concat(n))}}),t=t.filter(e=>e!=null&&!Yw(e)).map(e=>this.options.convertDetectedLanguage(e)),this.services&&this.services.languageUtils&&this.services.languageUtils.getBestMatchFromCodes?t:t.length>0?t[0]:null}cacheUserLanguage(e){let t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:this.options.caches;t&&(this.options.excludeCacheFor&&this.options.excludeCacheFor.indexOf(e)>-1||t.forEach(t=>{this.detectors[t]&&this.detectors[t].cacheUserLanguage(e,this.options)}))}};hT.type=`languageDetector`;var gT={en:{Common:Hw,GlobalUI:Ww},ja:{Common:Uw,GlobalUI:Gw}};tC.use(hT).use(bC).init({resources:gT,fallbackLng:`ja`,lng:localStorage.getItem(`language`)||navigator.language,keySeparator:`.`,interpolation:{escapeValue:!1},defaultNS:`GlobalUI`,ns:[`Common`,`GlobalUI`]});var _T=`/scorer-ui-kit/pr/640/assets/Lato3Upr3M-VF-BS60sTW_.woff2`,vT=`/scorer-ui-kit/pr/640/assets/Lato3Ita3M-VF-C8KUZ9bO.woff2`,yT=Rn`

@font-face {
    font-family: "Lato";
    src: url(${_T}) format("woff2 supports variations"),
        url(${_T}) format("woff2-variations");
    font-weight: 100 900;
  }
  ...
  @font-face {
    font-family: "Lato";
    font-style: italic;
    src: url(${vT}) format("woff2 supports variations"),
        url(${vT}) format("woff2-variations");
    font-weight: 100 900;
  }
  ...
  @font-face {
    ...
    font-weight: 100;
    font-style: normal;
    src: url(${`/scorer-ui-kit/pr/640/assets/Monorale-Thin-BQKHXPxk.woff`}) format('woff');
    font-display: fallback;
  }
  ...
  @font-face {
    ...
    font-weight: 100;
    font-style: italic;
    src: url(${`/scorer-ui-kit/pr/640/assets/Monorale-ThinItalic-DxjjXtaw.woff`}) format('woff');
    font-display: fallback;
  }
  ...
  @font-face {
    ...
    font-weight: 200;
    font-style: normal;
    src: url(${`/scorer-ui-kit/pr/640/assets/Monorale-ExtraLight-ao5tsxV8.woff`}) format('woff');
    font-display: fallback;
  }
  ...
  @font-face {
    ...
    font-weight: 200;
    font-style: italic;
    src: url(${`/scorer-ui-kit/pr/640/assets/Monorale-ExtraLightItalic-6yY0Bdrq.woff`}) format('woff');
    font-display: fallback;
  }
  ...
  @font-face {
    ...
    font-weight: 300;
    font-style: normal;
    src: url(${`/scorer-ui-kit/pr/640/assets/Monorale-Light-T7gpP2n1.woff`}) format('woff');
    font-display: fallback;
  }
  ...
  @font-face {
    ...
    font-weight: 300;
    font-style: italic;
    src: url(${`/scorer-ui-kit/pr/640/assets/Monorale-LightItalic-f797-kPY.woff`}) format('woff');
    font-display: fallback;
  }
  ...
  @font-face {
    ...
    font-weight: 400;
    font-style: normal;
    src: url(${`/scorer-ui-kit/pr/640/assets/Monorale-Regular-DOtBvWqV.woff`}) format('woff');
    font-display: fallback;
  }
  ...
  @font-face {
    ...
    font-weight: 400;
    font-style: italic;
    src: url(${`/scorer-ui-kit/pr/640/assets/Monorale-Italic-bzXvo1D-.woff`}) format('woff');
    font-display: fallback;
  }
  ...
  @font-face {
    ...
    font-weight: 500;
    font-style: normal;
    src: url(${`/scorer-ui-kit/pr/640/assets/Monorale-Medium-CVfjkY1Z.woff`}) format('woff');
    font-display: fallback;
  }
  ...
  @font-face {
    ...
    font-weight: 500;
    font-style: italic;
    src: url(${`/scorer-ui-kit/pr/640/assets/Monorale-MediumItalic-BEsxtezO.woff`}) format('woff');
    font-display: fallback;
  }
  ...
  @font-face {
    ...
    font-weight: 600;
    font-style: normal;
    src: url(${`/scorer-ui-kit/pr/640/assets/Monorale-SemiBold-BVVp1RRO.woff`}) format('woff');
    font-display: fallback;
  }
  ...
  @font-face {
    ...
    font-weight: 600;
    font-style: italic;
    src: url(${`/scorer-ui-kit/pr/640/assets/Monorale-SemiBoldItalic-nEmp39Cb.woff`}) format('woff');
    font-display: fallback;
  }
  ...
  @font-face {
    ...
    font-weight: 700;
    font-style: normal;
    src: url(${`/scorer-ui-kit/pr/640/assets/Monorale-Bold-CtnTlBZA.woff`}) format('woff');
    font-display: fallback;
  }
  ...
  @font-face {
    ...
    font-weight: 800;
    font-style: normal;
    src: url(${`/scorer-ui-kit/pr/640/assets/Monorale-ExtraBold-C9ejQABg.woff`}) format('woff');
    font-display: fallback;
  }
  ...
  @font-face {
    ...
    font-weight: 900;
    font-style: normal;
    src: url(${`/scorer-ui-kit/pr/640/assets/Monorale-Black-COwa-Bp6.woff`}) format('woff');
    font-display: fallback;
  }
...
`;jl.custom.lines.weird={label:{fill:`#fff`},contrastLine:{stroke:`transparent;`},highlightLine:{stroke:`transparent;`},grabHandle:{fill:`transparent;`,stroke:`transparent;`},point:{fill:`hsla(205deg, 45%, 90%, 100%)`},grabHandleText:{fill:`transparent`},grabHandleContrast:{fill:`transparent`},handleBase:{fill:`transparent`},handleRingLayer:{stroke:`hsla(205deg, 100%, 89%, 100%);`},handleReactiveFill:{stroke:`transparent;`},handleReactiveRing:{stroke:`transparent;`},handleContrastLayer:{stroke:`transparent;`},stopStart:{stopColor:` hsla(0, 100%, 15%, 35%);`},stopEnd:{stopColor:`hsla(0, 100%, 15%, 0%);`}},(0,v.createRoot)(document.getElementById(`root`),{onUncaughtError:(e,t)=>{console.error(`Uncaught render error:`,e,t.componentStack)}}).render((0,G.jsx)(_.StrictMode,{children:(0,G.jsx)(()=>(Cf(),(0,G.jsx)(kn,{theme:jl,children:(0,G.jsx)(rf,{children:(0,G.jsxs)(sf,{children:[(0,G.jsx)(Vw,{}),(0,G.jsx)(yT,{}),(0,G.jsx)(Ml,{}),(0,G.jsx)(xT,{}),(0,G.jsx)(bT,{})]})})})),{})}));
//# sourceMappingURL=index-CFWP0EOn.js.map
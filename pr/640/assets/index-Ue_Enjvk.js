...
`,hx=z.p`
  ...
  margin: 8px 0 0;
  line-height: 1.5;
`,gx=()=>{let[e,t]=(0,_.useReducer)(fg,[]),[n,r]=(0,_.useState)(fx),[i,a]=(0,_.useState)(fx),[o,s]=(0,_.useState)(`10`),[c,l]=(0,_.useState)({showSetIndex:!0,pointIndexOffset:1,showPointLabel:!0,setIndexOffset:1,showDirectionMark:!1,showLabelShadow:!1}),[u]=(0,_.useState)({loop:!1,autoPlay:!0,muted:!0,controls:!0}),d=(0,_.useCallback)(({width:e,height:n})=>{s(String(Math.max(4,Math.round(Math.min(e,n)*.015)))),t({type:`LOAD`,state:[{name:`Line 1`,points:[{x:e*.2,y:n*.55},{x:e*.8,y:n*.55}],showPointHandle:!0,showMoveHandle:!0,showSmallDirectionMark:!0,readOnly:!1,styling:`primary`},{name:`Line 2`,points:[{x:e*.25,y:n*.75},{x:e*.75,y:n*.75}],showPointHandle:!1,showMoveHandle:!1,readOnly:!1,styling:`secondary`}]})},[]),f=(0,_.useCallback)(()=>{a(n)},[n]),p=(0,_.useCallback)(()=>{r(fx),a(fx)},[]),m=(0,_.useCallback)(e=>{l(t=>({...t,showDirectionMark:e}))},[]),h=(0,_.useCallback)(e=>{l(t=>({...t,showLabelShadow:e}))},[]),g=(0,_.useCallback)(n=>{t({type:`UPDATE_SET_OPTIONS`,index:e.findIndex(e=>e.showPointHandle),data:{showPointHandle:!1,showMoveHandle:!1}}),t({type:`UPDATE_SET_OPTIONS`,index:n,data:{showPointHandle:!0,showMoveHandle:!0}})},[e]);return(0,G.jsxs)(gv,{children:[(0,G.jsx)(sx,{children:`LineHLSPage.tsx`}),(0,G.jsxs)(rx,{children:[(0,G.jsx)(nx,{logoTextTop:`SCORER`,logoTextBottom:`UI Kit`}),(0,G.jsxs)(tx,{children:[(0,G.jsxs)(mx,{children:[(0,G.jsx)(Hu,{htmlFor:`hls-src`,labelText:`HLS source URL (.m3u8)`}),(0,G.jsx)(zu,{id:`hls-src`,type:`text`,value:n,onChange:e=>r(e.target.value),placeholder:`https://.../stream.m3u8`}),(0,G.jsx)(px,{icon:`Play`,design:`primary`,onClick:f,children:`Load Stream`}),(0,G.jsx)(px,{icon:`RetryJob`,design:`secondary`,onClick:p,children:`Reset to Default`})]}),(0,G.jsx)(ed,{checked:c.showDirectionMark,labelText:`Show Direction Mark`,leftTheme:`off`,onChangeCallback:m,rightTheme:`on`,state:`default`}),(0,G.jsx)(`br`,{}),(0,G.jsx)(ed,{checked:c.showLabelShadow,labelText:`Show Label Shadow`,leftTheme:`off`,onChangeCallback:h,rightTheme:`on`,state:`default`}),(0,G.jsxs)(hx,{children:[`Default stream is Apple's public BipBop HLS test. Safari plays it natively; other browsers dynamically load `,(0,G.jsx)(`code`,{children:`hls.js`}),`. Open DevTools → Network and filter for `,(0,G.jsx)(`code`,{children:`hls`}),` to confirm the chunk is only fetched on this page.`]})]}),(0,G.jsx)(tx,{style:{flex:`1`},children:(0,G.jsx)(`pre`,{children:JSON.stringify(e,null,2)})})]}),(0,G.jsx)(vv,{$padBottom:!1,children:(0,G.jsx)(zh.Provider,{value:{state:e,dispatch:t},children:(0,G.jsx)(ng,{options:c,onLineClick:g,onLoaded:d,videoOptions:u,lineClickSensingBorder:o,src:i},i)})})]})},_x=z.div`
  margin-bottom: 15px;
`,vx=z.div`
  display: flex;
  margin: 20px 0;
...
//# sourceMappingURL=index-Ue_Enjvk.js.map
import{a as e,n as t}from"./chunk-BneVvdWh.js";import{Ct as n,Et as r,Ft as i,Lt as a,Pt as o,Rt as s,bt as c,et as l,z as u}from"./iframe-BJPFMC_k.js";var d,f,p,m,h,g,_,v,y,b;t((()=>{d=o(),f=e(s()),c(),i(),p=r(),{action:m}=__STORYBOOK_MODULE_ACTIONS__,h={title:`Form/Buttons`,component:l,decorators:[]},g=a.div`
`,_=(0,p.jsx)(`h1`,{children:`Main Action Modal`}),v=e=>{let[t,r]=(0,f.useState)(e),{createModal:i}=n(),a=m(`Main pressed, modal opened`),o=m(`日本語の場合はランダム pressed`),s=m(`Save Action pressed`),c=m(`Download pressed`),u=[{id:`a0`,text:`Main Action Open Modal`,icon:`Success`,onClickCallback:()=>{i({customComponent:_,padding:!0,width:`auto`}),a()}},{id:`a1`,text:`日本語の場合はランダム`,onClickCallback:o},{id:`a2`,text:`Save Action`,icon:`Analyse`,hasOnSelectLoading:!0,onClickCallback:s},{id:`a3`,text:`Download Action`,icon:`Download`,onClickCallback:c,disabled:!0}];return(0,f.useEffect)(()=>{r(e)},[e]),(0,p.jsx)(g,{children:(0,p.jsx)(l,{...t,buttonList:u})})},y=()=>{let e=(0,d.select)(`Design`,{Primary:`primary`,Secondary:`secondary`,Danger:`danger`,Custom:`custom`},`primary`),t=(0,d.boolean)(`Disabled`,!1);return(0,p.jsx)(u,{children:(0,p.jsx)(v,{mainButtonId:`a0`,design:e,size:(0,d.select)(`Size`,{Small:`small`,Normal:`normal`,Large:`large`},`normal`),disabled:t,buttonList:[]})})},y.__docgenInfo={description:``,methods:[],displayName:`_SplitButton`},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`() => {

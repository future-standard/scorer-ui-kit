import{n as e}from"./rolldown-runtime-DkW27tQK.js";var t;function n(){return(n=e((()=>{t=`<svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35">
    <defs>
        <linearGradient id="logo-mark-gradient" x1="36.708%" x2="69.959%" y1="2.579%" y2="98.009%">
            <stop offset="0%" stop-color="#7DB8DB"/>
            <stop offset="100%" stop-color="#5CA0D1"/>
        </linearGradient>
    </defs>
    <g fill="none" fill-rule="evenodd">
        <rect width="35" height="35" fill="url(#logo-mark-gradient)" rx="5"/>
...
`})))()}var r;function i(){return(i=e((()=>{r=`<svg xmlns="http://www.w3.org/2000/svg" width="71" height="30" viewBox="0 0 71 30">
    <g fill="#93A5B2">

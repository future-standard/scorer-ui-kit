import{i as e}from"./preload-helper-xPQekRTU.js";import{Ft as t,It as n,Nt as r,St as i,Ut as a,kt as o}from"./iframe-DB8xyy-s.js";var s,c,l,u,d,f;e((()=>{s=a(),i(),n(),c=r(),l={title:`Misc`,component:o,decorators:[]},u=t.div`
  border-radius: 3px;
...
`,d=()=>{let e=(0,s.select)(`Size`,{Small:`small`,Medium:`medium`,Large:`large`,XLarge:`xlarge`},`medium`),t=(0,s.select)(`Style`,{Primary:`primary`,Secondary:`grey`,Warning:`warning`},`primary`),n=(0,s.number)(`Custom Size`,0),r=(0,s.text)(`Custom Base Color`,``),i=(0,s.text)(`Custom Top Color`,``),a=r===``?void 0:r,l=i===``?void 0:i;return a=r.indexOf(`(`)!==-1&&r.indexOf(`)`)===-1?`${r})`:r,l=i.indexOf(`(`)!==-1&&i.indexOf(`)`)===-1?`${i})`:i,(0,c.jsx)(u,{$styling:t,children:(0,c.jsx)(o,{size:e,styling:t,custom:{size:n,baseColor:a,topColor:l}})})},d.__docgenInfo={description:``,methods:[],displayName:`LoadingSpinner`},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`() => {

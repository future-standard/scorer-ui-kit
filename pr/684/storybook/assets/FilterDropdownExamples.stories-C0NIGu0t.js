import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{Ft as n,G as r,It as i,Nt as a,O as o,St as s,Ut as c,Wt as l}from"./iframe-CW3QRQX7.js";import{n as u,t as d}from"./helpers-ChWV1T_Y.js";import{S as f,f as p,g as m,h,m as g,p as _,x as v}from"./data_samples-BIGHHJEJ.js";var y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I;e((()=>{y=c(),b=t(l()),s(),i(),u(),h(),x=a(),{action:S}=__STORYBOOK_MODULE_ACTIONS__,C={title:`Filters/molecules/FilterDropdown`,component:o,decorators:[]},w=n.div``,T=n.div``,E=n.div`
  margin: 100px;
  display: inline-block;
`,D=[{text:`Ramen`,value:0},{text:`Takoyaki`,value:1},{text:`Gyoza`,value:2},{text:`Tempura`,value:3},{text:`Sushi`,value:4},{text:`Natto`,value:5},{text:`Sashimi`,value:6}],O=[{text:`ラーメン`,value:0},{text:`蛸焼き`,value:1},{text:`餃子`,value:2},{text:`天婦羅`,value:3},{text:`すし`,value:4},{text:`納豆`,value:5},{text:`お造り`,value:6}],k=[{text:`Super Spicy`,value:0},{text:`Spicy`,value:1},{text:`Mild`,value:2},{text:`Sweet`,value:3}],A=[{text:`超辛い`,value:0},{text:`辛い`,value:1},{text:`中華い`,value:2},{text:`甘口`,value:3}],j=[{text:`1900`,value:1900},{text:`1910`,value:1920},{text:`1930`,value:1930},{text:`1950`,value:1950},{text:`1960`,value:1960},{text:`1970`,value:1970},{text:`1980`,value:1980},{text:`1990`,value:1990},{text:`2000`,value:2e3},{text:`2010`,value:2010},{text:`2020`,value:2020}],M=[{text:`Card`,value:0},{text:`Cash`,value:1},{text:`IC Card`,value:2}],N=[{text:`カード`,value:0},{text:`現金`,value:1},{text:`IC カード`,value:2}],P=[{text:`Adipiscing`,value:0},{text:`Amet`,value:1},{text:`Consectetur`,value:2},{text:`Dolor sit`,value:3},{text:`Lorem ipsum`,value:4},{text:`Vestibulum`,value:5},{text:`Minim Veniam`,value:6},{text:`Consequat`,value:7},{text:`Fugiat Nulla`,value:8}],F=()=>{let e=d(),t=(0,y.select)(`Language`,{English:`english`,Japanese:`japanese`},`japanese`),n=(0,y.text)(`Text`,`Department`),i=(0,y.select)(`Button Icon`,e,e.MetaCategories),a=(0,y.boolean)(`disable`,!1),s=(0,y.boolean)(`Is Loading`,!1),c=(0,y.select)(`Design type`,{Default:`default`,Basic:`basic`},`default`),l=(0,y.select)(`Option Type`,{text:`text`,checkbox:`checkbox`,radio:`radio`},`checkbox`),u=(0,y.text)(`Loading Text`,`Loading Tags...`),h=(0,y.number)(`Max Displayed Items`,6),C=S(`Currently Selected`),F=S(`Food selected`),I=S(`Spicy level`),L=S(`Payment type`),R=S(`Years`),[z,B]=(0,b.useState)(null),[V,H]=(0,b.useState)(null),[U,W]=(0,b.useState)(t===`english`?{text:`Card`,value:0}:{text:`カード`,value:0}),[G,K]=(0,b.useState)([{text:`1990`,value:1990}]),[q,J]=(0,b.useState)(null),Y=(0,b.useCallback)(e=>{F(e),B(e)},[F]),X=(0,b.useCallback)(e=>{I(e),H(e)},[I]),Z=(0,b.useCallback)(e=>{R(e),K(e)},[R]),Q=(0,b.useCallback)(e=>{L(e),W(e)},[L]),$=(0,b.useCallback)(e=>{C(e),J(e)},[C]);return(0,x.jsxs)(w,{children:[(0,x.jsxs)(E,{children:[(0,x.jsx)(r,{title:`Base Example`,introductionText:`This example doesn't have filter for options.`}),(0,x.jsx)(o,{disabled:a,isLoading:s,buttonText:n,maxDisplayedItems:h,buttonIcon:i,design:c,list:P,onSelect:$,optionType:`checkbox`,selected:q,loadingText:t===`english`?m:g})]},`eje-0`),(0,x.jsxs)(E,{children:[(0,x.jsx)(r,{title:`Data Object`,introductionText:`Array of IFilterList [{text: 'Option1', value: 1 }, {text: 'Option2', value: 2 }]`}),(0,x.jsx)(o,{buttonIcon:i,disabled:a,isLoading:s,design:c,loadingText:u,maxDisplayedItems:h,list:t===`english`?D:O,buttonText:t===`english`?`Menu`:`メニュー`,selected:z,optionType:l,onSelect:Y,searchResultText:t===`english`?v:f,searchPlaceholder:t===`english`?`Menu options...`:`メニュー...`,loadingText:t===`english`?m:g,hasOptionsFilter:!0})]},`eje-1`),(0,x.jsx)(T,{}),(0,x.jsxs)(E,{children:[(0,x.jsx)(r,{title:`Text type`,introductionText:`.`}),(0,x.jsx)(o,{buttonIcon:i,disabled:a,isLoading:s,design:c,loadingText:u,maxDisplayedItems:h,list:t===`english`?k:A,buttonText:t===`english`?`Spice level`:`ピリ辛`,selected:V,onSelect:X,optionType:`text`,loadingText:t===`english`?m:g,searchResultText:t===`english`?v:f,searchPlaceholder:t===`english`?`Spice options...`:`ピリ辛...`,hasOptionsFilter:!0})]},`eje-2`),(0,x.jsxs)(E,{children:[(0,x.jsx)(r,{title:`Radio type`,introductionText:`.`}),(0,x.jsx)(o,{buttonIcon:i,disabled:a,isLoading:s,design:c,loadingText:u,maxDisplayedItems:h,list:t===`english`?M:N,buttonText:t===`english`?`Pay Method`:`支払方法`,selected:U,onSelect:Q,optionType:`radio`,loadingText:t===`english`?m:g,searchResultText:t===`english`?v:f,searchPlaceholder:t===`english`?`Pay Methods...`:`支払方法...`,hasOptionsFilter:!0})]},`eje-3`),(0,x.jsxs)(E,{children:[(0,x.jsx)(r,{title:`Checkbox type`,introductionText:`Array of IFilterList with numbers [{text: '1900', value:1910}, {text:'1910', value: 1910}]`}),(0,x.jsx)(o,{buttonIcon:i,disabled:a,isLoading:s,design:c,loadingText:u,maxDisplayedItems:h,buttonText:t===`english`?`Year`:`年`,selected:G,list:j,onSelect:Z,optionType:`checkbox`,loadingText:t===`english`?m:g,searchPlaceholder:t===`english`?`Years...`:`2020...`,searchResultText:t===`english`?v:f,hasOptionsFilter:!0})]},`eje-4`),(0,x.jsxs)(E,{children:[(0,x.jsx)(r,{title:`Empty Example`,introductionText:`Empty list is been sent.`}),(0,x.jsx)(o,{buttonIcon:i,disabled:a,isLoading:s,design:c,loadingText:u,maxDisplayedItems:h,buttonText:t===`english`?`Tags`:`タグー`,selected:G,list:[],onSelect:Z,optionType:`checkbox`,loadingText:t===`english`?m:g,searchPlaceholder:t===`english`?`Filter tags…`:`フィルタータグ...`,searchResultText:t===`english`?v:f,emptyResultText:t===`english`?p:_,hasOptionsFilter:!0})]},`eje-5`)]})},F.__docgenInfo={description:``,methods:[],displayName:`MultipleDropdownExamples`},F.parameters={...F.parameters,docs:{...F.parameters?.docs,source:{originalSource:`() => {

import{i as e}from"./preload-helper-xPQekRTU.js";import{$ as t,Ft as n,It as r,Nt as i,St as a,Ut as o}from"./iframe-CW3QRQX7.js";var s,c,l,u,d,f,p,m;e((()=>{s=o(),a(),r(),c=i(),{action:l}=__STORYBOOK_MODULE_ACTIONS__,u={title:`Form/Input`,component:t,decorators:[]},d=n.div`
    margin: 20px;
    width: 268px;
`,f=[{value:1,label:`1H`},{value:2,label:`2H`},{value:3,label:`3H`},{value:4,label:`4H`},{value:5,label:`5H`},{value:6,label:`6H`},{value:7,label:`7H`},{value:8,label:`8H`}],p=()=>{let e=(0,s.boolean)(`Disabled`,!1),n=(0,s.number)(`Max`,8),r=(0,s.number)(`Min`,1),i=(0,s.number)(`Default value`,6),a=l(`Input Callback`),o=(0,s.object)(`Marks`,f),u=(0,s.boolean)(`Center aligned end numbers`,!1);return(0,c.jsx)(d,{children:(0,c.jsx)(t,{max:n,min:r,disabled:e,inputCallback:e=>{console.debug(`updated value`,e),a(`Returned value: ${e}`,e)},marks:o,defaultValue:i,allMarkCentered:u})})},p.__docgenInfo={description:``,methods:[],displayName:`_SliderInput`},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`() => {

import{i as e}from"./preload-helper-xPQekRTU.js";import{$ as t,Mt as n,h as r,j as i,jt as a,k as o,kt as s,vt as c,zt as l}from"./iframe-cNP1dtGl.js";var u,d,f,p,m,h,g;e((()=>{u=l(),c(),n(),d=s(),{action:f}=__STORYBOOK_MODULE_ACTIONS__,p={title:`Global/organisms`,component:i,decorators:[]},m=a.div`
  position: absolute;
  top: 0;
  bottom: 0;
  left: 0;
...
`,h=()=>{let e=(0,u.boolean)(`Side Area A - Default Collapsed`,!1),n=f(`Side Area A State`),i=(0,u.boolean)(`Side Area B - Default Collapsed`,!1),a=f(`Side Area B State`);return(0,d.jsx)(m,{children:(0,d.jsx)(r,{layout:`dashboard`,children:(0,d.jsx)(t,{layout:`horizontal`,persist:!0,persistenceKey:`my_unique_layout_key`,reverse:!1,mainArea:{content:(0,d.jsx)(t,{layout:`vertical`,persist:!0,persistenceKey:`my_nested_key`,reverse:!1,mainArea:{content:(0,d.jsx)(o,{title:`Main Area`}),minSize:120},sideArea:{content:(0,d.jsx)(o,{title:`Side Area A`}),collapsable:!0,minSize:200,onSideAreaStateChange:n,defaultCollapsed:e}}),minSize:120},sideArea:{content:(0,d.jsx)(o,{title:`Side Area B`}),collapsable:!0,minSize:200,onSideAreaStateChange:a,defaultCollapsed:i}})})})},h.__docgenInfo={description:``,methods:[],displayName:`_SplitLayoutNested`},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`() => {
  const reverse = false;

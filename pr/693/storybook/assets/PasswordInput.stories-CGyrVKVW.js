import{i as e}from"./preload-helper-xPQekRTU.js";import{Ct as t,It as n,Lt as r,Pt as i,Wt as a,Y as o}from"./iframe-FLpC4IdY.js";var s,c,l,u,d,f;e((()=>{s=a(),t(),r(),c=i(),l=n.div`
    margin: 20px;
`,u={title:`Form/Input`,component:o,decorators:[]},d=()=>{let e=(0,s.text)(`Input Name`,`my_input`),t=(0,s.text)(`Label`,`My Input`),n=(0,s.text)(`Value`,`Test`),r=(0,s.text)(`Placeholder`,`Placeholder...`),i=(0,s.boolean)(`Required`,!1),a=(0,s.boolean)(`Show Feedback`,!1),u=(0,s.text)(`Feedback`,`This is a feedback message.`);return(0,c.jsx)(l,{children:(0,c.jsx)(o,{name:e,label:t,defaultValue:n,placeholder:r,fieldState:(0,s.select)(`State`,{Default:`default`,Disabled:`disabled`,Required:`required`,Valid:`valid`,Invalid:`invalid`,Processing:`processing`},`default`),showFeedback:a,feedbackMessage:u,required:i})})},d.__docgenInfo={description:``,methods:[],displayName:`PasswordInput`},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`() => {

import{a as e,n as t}from"./chunk-BneVvdWh.js";import{At as n,Lt as r,Ot as i,R as a,Rt as o,gt as s,jt as c,vt as l}from"./iframe-DoElEExu.js";import{h as u,i as d,k as f}from"./data_samples-BPpc5FO9.js";import{c as p,o as m,s as h}from"./sample_table_helpers-Brnvwuuw.js";var g,_,v,y,b,x,S,C;t((()=>{g=r(),_=e(o()),l(),c(),u(),m(),v=i(),y=n.div`
  padding: 100px;
`,b={title:`Tables/molecules`,component:s,decorators:[],parameters:{jsx:{skip:2}}},x=p(f,`deviceName`,!0),S=()=>{let[e,t]=(0,_.useState)(x),[n,r]=(0,_.useState)(h(x)),i=(0,g.boolean)(`Has Device Status`,!0),o=(0,g.boolean)(`Has Thumbnail`,!0),c=(0,g.text)(`Close Text`,`CLOSE`),l=(0,g.boolean)(`Has Device Type Icon`,!0),u=(0,g.boolean)(`Has Header Groups`,!0),f=(0,g.boolean)(`Selectable Rows`,!0),m=(0,g.object)(`Column Configuration`,d),b=(0,_.useCallback)((e,t)=>{let i=[...n],a=i.findIndex(e=>e.id===t);i[a]._checked=e,r(i)},[n]),S=(0,_.useCallback)(e=>{let t=[...n];t.forEach(t=>{t._checked=e}),r(t)},[n]),C=(0,_.useCallback)((n,r)=>{t(p([...e],r,n))},[e]);return(0,_.useEffect)(()=>{r(h(e))},[e]),(0,v.jsx)(y,{children:(0,v.jsx)(a,{children:(0,v.jsx)(s,{columnConfig:m,selectable:f,rows:n,hasStatus:i,hasThumbnail:o,closeText:c,hasTypeIcon:l,defaultAscending:!0,hasHeaderGroups:u,selectCallback:b,toggleAllCallback:S,sortCallback:C})})})},S.__docgenInfo={description:``,methods:[],displayName:`_TypeTable`},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`() => {

import{a as e,n as t}from"./chunk-BneVvdWh.js";import{E as n,Et as r,Ft as i,Lt as a,O as o,Pt as s,Rt as c,bt as l,xt as u}from"./iframe-l0RDpzCT.js";import{C as d,E as f,S as p,T as m,_ as h,b as g,g as _,h as v,m as y,n as b,t as x,v as S,w as C,x as w,y as T}from"./data_samples-BPpc5FO9.js";var E,D,O,k,A,j,M,N,P,F,I,L,R;t((()=>{E=e(c()),i(),D=s(),l(),v(),O=r(),{action:k}=__STORYBOOK_MODULE_ACTIONS__,A={title:`Filters/molecules`,component:`FilterInputs`,decorators:[]},j=a.div``,M=[{text:`Adipiscing`,value:`Adipiscing`},{text:`Amet`,value:`Amet`},{text:`Consectetur`,value:`Consectetur`},{text:`Dolor sit`,value:`Dolor sit`},{text:`Lorem ipsum`,value:`Lorem ipsum`},{text:`Vestibulum`,value:`Vestibulum`}],N=[{text:`Ramen`,value:0},{text:`Takoyaki`,value:1},{text:`Gyoza`,value:2},{text:`Tempura`,value:3},{text:`Sushi`,value:4}],P=[{text:`ラーメン`,value:0},{text:`蛸焼き`,value:1},{text:`餃子`,value:2},{text:`天婦羅`,value:3},{text:`すし`,value:4}],F=(e,t)=>{let n=[];return t.forEach(e=>{if(e.value!==``&&(typeof e.value==`string`||typeof e.value==`number`)){let t=typeof e.value==`number`?e.value.toString():e.value;n.push({filterId:e.id,item:{text:t,value:t},filterName:e.name,type:`search`})}}),e.forEach(e=>{if(e.selected!==null){if(u(e.selected)){n.push({filterId:e.id,item:e.selected,icon:e.buttonIcon,type:`dropdown`});return}Array.isArray(e.selected)&&e.selected.forEach(t=>{n.push({filterId:e.id,item:t,icon:e.buttonIcon,type:`dropdown`})})}}),n},I=(e,t)=>u(e)&&u(t)?t.value!==e.value:!0,L=()=>{let e=(0,D.select)(`Language`,{English:`english`,Japanese:`japanese`},`japanese`),t=(0,D.boolean)(`Has ShowMore`,!0),r=(0,D.number)(`Total Results`,6),i=k(`food selection`),[a,s]=(0,E.useState)(null),[c,l]=(0,E.useState)(null),[u,v]=(0,E.useState)(``),[A,L]=(0,E.useState)(``),[R,z]=(0,E.useState)(``),B=(0,E.useCallback)(e=>{i(e),s(e)},[i]),V=(0,E.useCallback)(e=>{l(e)},[]),H=(0,E.useCallback)((e,t)=>{let n=e===null?``:e;t===`search1`&&v(n),t===`search2`&&L(n),t===`search3`&&z(n)},[]),U=(0,E.useMemo)(()=>[{id:`category1`,buttonText:`Department`,buttonIcon:`MetaCategories`,list:M,loadingText:e===`english`?_:y,searchPlaceholder:e===`english`?T:g,searchResultText:e===`english`?w:p,onSelect:V,selected:c},{id:`food`,canHide:!0,buttonText:e===`english`?`Menu`:`メニュー`,buttonIcon:`Zone`,list:e===`english`?N:P,loadingText:e===`english`?_:y,searchPlaceholder:e===`english`?`Menu options...`:`メニュー...`,searchResultText:e===`english`?w:p,optionType:`checkbox`,onSelect:B,selected:a}],[c,V,B,e,a]),W=(0,E.useMemo)(()=>[{id:`search1`,placeholder:e===`english`?`Filter by name...`:`名前 フィルター`,value:u,name:e===`english`?`Name filter`:`名前 フィルター`,onChange:e=>{H(e.target.value,`search1`)}},{id:`search2`,placeholder:e===`english`?`Filter by food`:`食べ物 フィルター`,canHide:!0,showFieldText:`Search by food`,value:A,name:e===`english`?`Menu filter`:`メニュー  フィルター`,onChange:e=>{H(e.target.value,`search2`)}},{id:`search3`,placeholder:`Search by Item Id`,showFieldText:`Search Example String Field`,value:R,name:`Example`,onChange:e=>{H(e.target.value,`search3`)}}],[R,A,H,e,u]),G=F(U,W),K=(0,E.useCallback)(()=>{s(null),l(null),v(``),L(``),z(``)},[]),q=(0,E.useCallback)((e,t,n)=>{if(t===`dropdown`){let t=U.find(t=>t.id===e);if(t&&t.onSelect){let e=Array.isArray(t.selected)?t.selected.filter(e=>I(e,n)):null;t.onSelect(e)}}t===`search`&&W.find(t=>t.id===e)&&H(``,e)},[U,H,W]);return(0,O.jsxs)(j,{children:[(0,O.jsx)(n,{searchFilters:W,dropdownFilters:U,hasShowMore:t,showMoreText:e===`english`?m:f,showLessText:e===`english`?d:C}),(0,O.jsx)(o,{labelLists:G,totalResults:r,onClearAll:K,onRemoveFilter:q,resultTextTemplate:e===`english`?h:S,clearText:e===`english`?x:b})]})},L.__docgenInfo={description:``,methods:[],displayName:`_FilterInputs`},L.parameters={...L.parameters,docs:{...L.parameters?.docs,source:{originalSource:`() => {

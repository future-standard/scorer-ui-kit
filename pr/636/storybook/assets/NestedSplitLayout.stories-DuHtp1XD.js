import{n as e}from"./chunk-BneVvdWh.js";import{$ as t,Lt as n,Ot as r,h as i,j as a,jt as o,k as s,kt as c,vt as l}from"./iframe-DxcqKzfJ.js";var u,d,f,p,m,h,g;e((()=>{u=n(),l(),c(),d=r(),{action:f}=__STORYBOOK_MODULE_ACTIONS__,p={title:`Global/organisms`,component:a,decorators:[]},m=o.div`
  position: absolute;
  top: 0;
  bottom: 0;
  left: 0;
...
`,h=()=>{let e=(0,u.boolean)(`Side Area A - Default Collapsed`,!1),n=f(`Side Area A State`),r=(0,u.boolean)(`Side Area B - Default Collapsed`,!1),a=f(`Side Area B State`);return(0,d.jsx)(m,{children:(0,d.jsx)(i,{layout:`dashboard`,children:(0,d.jsx)(t,{layout:`horizontal`,persist:!0,persistenceKey:`my_unique_layout_key`,reverse:!1,mainArea:{content:(0,d.jsx)(t,{layout:`vertical`,persist:!0,persistenceKey:`my_nested_key`,reverse:!1,mainArea:{content:(0,d.jsx)(s,{title:`Main Area`}),minSize:120},sideArea:{content:(0,d.jsx)(s,{title:`Side Area A`}),collapsable:!0,minSize:200,onSideAreaStateChange:n,defaultCollapsed:e}}),minSize:120},sideArea:{content:(0,d.jsx)(s,{title:`Side Area B`}),collapsable:!0,minSize:200,onSideAreaStateChange:a,defaultCollapsed:r}})})})},h.__docgenInfo={description:``,methods:[],displayName:`_SplitLayoutNested`},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`() => {
  const reverse = false;

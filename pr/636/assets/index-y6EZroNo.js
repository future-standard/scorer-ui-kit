...
`,tm=B.div`
  ...
  padding: 15px 0;
`,nm=({loadingText:e})=>(0,V.jsxs)(em,{children:[(0,V.jsx)(gu,{size:`large`,styling:`primary`}),(0,V.jsx)(tm,{children:e})]}),rm=e=>e==null||e.value===void 0||e.value===null||e.text===null?!1:(typeof e.value==`number`||typeof e.value==`string`)&&typeof e.text==`string`,im=B.div`
  display: inline-block;
  position: relative;
`,am=B(zp)`
  letter-spacing: 0.2px;
...
`,C_=B.div`
  ...
  right: 0;
  input {width: 100%;}
`,w_=({children:e})=>{let t=(0,_.useRef)(null),[n,r]=(0,_.useState)(0);return(0,_.useEffect)(()=>{t?.current&&r(t.current.clientHeight)},[]),(0,V.jsx)(S_,{$contentHeight:n,children:(0,V.jsx)(C_,{ref:t,children:e})})},T_=B.div`
  display: flex;
  flex: 0 0 200px;
  justify-content: center;
  align-items: center;
...
`,A_=B.div`
  ...
  `}
`,j_=({state:e=`default`,layout:t=`horizontal`,arrowDirection:n})=>(0,V.jsx)(A_,{$layout:t,children:(0,V.jsxs)(T_,{children:[(0,V.jsx)(E_,{}),(0,V.jsx)(D_,{children:e===`default`?(0,V.jsxs)(O_,{$layout:t,width:`20`,height:`20`,viewBox:`0 0 20 20`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:[(0,V.jsx)(`path`,{d:`M13 14.875V5.125`,strokeLinecap:`round`,strokeLinejoin:`round`}),(0,V.jsx)(`path`,{d:`M10 14.875V5.125`,strokeLinecap:`round`,strokeLinejoin:`round`}),(0,V.jsx)(`path`,{d:`M7 14.875L7 5.125`,strokeLinecap:`round`,strokeLinejoin:`round`})]}):(0,V.jsx)(k_,{$direction:n,width:`20`,height:`20`,viewBox:`0 0 20 20`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:(0,V.jsx)(`path`,{d:`M7.25 4.375L12.61 9.735C12.6803 9.80525 12.7199 9.90058 12.7199 10C12.7199 10.0994 12.6803 10.1948 12.61 10.265L7.25 15.625`,stroke:`#9BA1A6`,strokeLinecap:`round`,strokeLinejoin:`round`})})}),(0,V.jsx)(E_,{})]})}),M_=B.div`
  position: absolute;
  z-index: 10;
  bottom: 20px;
  left: 20px;
...
`,W_=B.button`
  ...
  `}
`,G_=({show:e=!0,link:t,label:n=`Back`,$showDivider:r,$iconInGutter:i,onClick:a})=>{let o=(0,_.useMemo)(()=>(0,V.jsxs)(_.Fragment,{children:[(0,V.jsx)(B_,{children:(0,V.jsx)(Z,{icon:`Back`,size:16,color:`grey-10`})}),n]}),[n]);return e?(0,V.jsx)(_.Fragment,{children:a?(0,V.jsx)(W_,{$showDivider:r,$iconInGutter:i,onClick:a,children:o}):t&&(0,V.jsx)(U_,{to:t,$showDivider:r,$iconInGutter:i,children:o})}):null},K_=B.div`
  display: flex;
  width: 16px;
  height: 16px;
  justify-content: center;
...
`,J_=({show:e,link:t,label:n=`Share`,copiedLabel:r=`Copied`})=>{let[i,a]=(0,_.useState)(n),{copyToClipboard:o}=Ud(),s=(0,_.useCallback)(()=>{o(t||window.location.href),a(r),setTimeout(()=>a(i),2e3)},[t,r,i,o]);return(0,_.useEffect)(()=>{a(n)},[n]),e?(0,V.jsxs)(q_,{onClick:s,children:[(0,V.jsx)(K_,{children:(0,V.jsx)(Z,{icon:`Link`,size:16,color:`grey-10`})}),i]}):null},Y_=B.div`
...
`,sv=({showBreadcrumbs:e=!0,breadcrumbs:t=[],showHomeIcon:n=!0,back:r,share:i,$iconInGutter:a})=>{let{isLarge:o}=Vd(),s=a===void 0?o:a,c=e&&t.length>0;return(0,V.jsxs)(Y_,{children:[(0,V.jsxs)(X_,{children:[r&&(0,V.jsx)(G_,{$showDivider:c,$iconInGutter:s,...r}),c?(0,V.jsx)(Z_,{children:t.map((e,r)=>{let{text:i,href:a,onClick:o}=e,s=r===0,c=r===t.length-1,l=(0,V.jsxs)(_.Fragment,{children:[s&&n?(0,V.jsx)(ev,{children:(0,V.jsx)(Z,{icon:`Home`,size:11,color:`grey-10`})}):null,i]});return(0,V.jsx)(_.Fragment,{children:(0,V.jsxs)(Q_,{children:[o?(0,V.jsx)(iv,{onClick:o,type:`button`,children:l}):a?(0,V.jsx)(rv,{to:a,children:l}):(0,V.jsx)(av,{children:l}),c?null:(0,V.jsx)($_,{children:(0,V.jsx)(Z,{icon:`Right`,size:6,color:`grey-8`})})]})},r)})}):null]}),(0,V.jsx)(ov,{children:(0,V.jsx)(J_,{...i})})]})},cv=_.createContext({selected:``,setSelected:()=>{}}),lv=({children:e})=>{let[t,n]=(0,_.useState)(``);return(0,V.jsx)(cv.Provider,{value:{selected:t,setSelected:n},children:e})},uv=B.div`
  display: flex;
  align-items: center;
  flex-direction: column;
  position: relative;
...
`,mv=B.div`
  ...
  flex: 1;
  flex-direction: column;
`,hv=({layout:e=`default`,HeaderContent:t={},children:n})=>{let{PageHeaderArea:r,TabsElementArea:i,UtilityHeaderOptions:a}=t;return(0,V.jsxs)(uv,{className:`content-layout-${e}`,children:[a?(0,V.jsx)(sv,{...a}):null,r?(0,V.jsx)(dv,{children:r}):null,i?(0,V.jsxs)(lv,{children:[(0,V.jsx)(fv,{children:(0,V.jsx)(pv,{children:i})}),(0,V.jsx)(mv,{children:n})]}):(0,V.jsx)(mv,{children:n})]})},gv=B.div`
  display: flex;
`,_v=B.div``,vv=B.div`
  padding: 0;
  flex: 1;
...
`,_b=B.div`
  ...
  `}
`,vb=({tabFor:e,icon:t,closeId:n,counter:r,status:i,customComponent:a,...o})=>{let{selected:s,setSelected:c}=(0,_.useContext)(cv),l=(0,_.useCallback)(e=>{c(s===e?n:e)},[n,s,c]);return(0,V.jsx)(gb,{...o,onClick:()=>l(e),children:(0,V.jsx)(_b,{$isActive:s===e,children:(0,V.jsx)(mh,{icon:t,status:i,counter:r})})})},yb=B.div`
  margin-right: 39px;
  display: flex;
  align-items: center;
  line-height: 20px;
`,bb=B.label`
  ...
  flex-shrink: 0;
  user-select: none;
`,xb=({children:e,tabFor:t,onClick:n,...r})=>{let{selected:i,setSelected:a}=(0,_.useContext)(cv),o=(0,_.useCallback)(e=>{n?.(e),a(t)},[n,a,t]);return(0,V.jsx)(yb,{...r,onClick:o,children:(0,V.jsx)(bb,{$active:i===t,children:e})})};B.div`
  display: flex;
  align-items: center;
  margin-right: 22px;
  padding-bottom: 7px;
...
`,B.div`
  ...
  margin-right: 20px;
`;var Sb=B.div`
`,Cb=({children:e,tabId:t,...n})=>{let{selected:r}=(0,_.useContext)(cv);return r===t?(0,V.jsx)(Sb,{...n,children:e}):null},wb=B.div`
  display: flex;
  flex-direction: row;
`,Tb=({children:e,defaultTabId:t})=>{let{setSelected:n}=(0,_.useContext)(cv);return(0,_.useEffect)(()=>{n(t)},[t,n]),(0,V.jsx)(wb,{children:e})};B.div``,B.div`
  padding-top: 10px;
...
`,Ob=B.div`
  text-transform: uppercase;
`,kb=({closeId:e,closeText:t=`CLOSE MENU`,children:n,formAction:r,...i})=>{let{setSelected:a}=(0,_.useContext)(cv);return(0,V.jsxs)(Eb,{onClick:()=>a(e),...i,children:[(0,V.jsx)(Db,{children:(0,V.jsx)(Z,{icon:`CloseCompact`,color:`dimmed`,size:16})}),(0,V.jsx)(Ob,{children:t})]})},Ab=B(qc)`
  ${q};
  display: flex;
  flex-basis: 0;
  flex-grow: 1;
...
`,jb=B.div`
  margin-right: 15px;
`,Mb=B.object``,Nb=({home:e=`/`,logoMark:t,closeId:n})=>{let{setSelected:r}=(0,_.useContext)(cv);return(0,V.jsx)(Ab,{to:e,onClick:()=>r(n),children:(0,V.jsx)(jb,{children:t?(0,V.jsx)(Mb,{type:`image/svg+xml`,data:t}):(0,V.jsx)(Au,{})})})},Pb=B.div`
  position: relative;
...
@font-face {
  ...
  @font-face {
    font-family: "Lato";
    font-style: italic;
    src: url(${cT}) format("woff2 supports variations"),
        url(${cT}) format("woff2-variations");
    font-weight: 100 900;
  }

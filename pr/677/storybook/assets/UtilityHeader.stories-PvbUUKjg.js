import{i as e}from"./preload-helper-xPQekRTU.js";import{Mt as t,_t as n,jt as r,kt as i,vt as a,zt as o}from"./iframe-cNP1dtGl.js";var s,c,l,u,d,f,p;e((()=>{s=o(),a(),t(),c=i(),{action:l}=__STORYBOOK_MODULE_ACTIONS__,u={title:`Global/molecules`,component:n,decorators:[]},d=r.div`
  position: absolute;
  top: 0;
  bottom: 0;
  left: 0;
...
`,f=()=>{let e=(0,s.object)(`Back Link`,{label:`Back`,onClick:l(`Return action`)}),t=(0,s.boolean)(`Show Breadcrumbs`,!0),r=(0,s.boolean)(`Show Home Icon`,!0);return(0,c.jsx)(d,{children:(0,c.jsx)(n,{back:e,showBreadcrumbs:t,breadcrumbs:(0,s.object)(`breadcrumbs`,[{text:`Examples`,href:`/`},{text:`Two`,href:`#2`},{text:`Three`,href:`#3`},{text:`Four`,onClick:l(`The Breadcrumb is using a callback`)},{text:`Five`}]),showHomeIcon:r,share:(0,s.object)(`Share Link`,{show:!0,label:`Share`,link:`https://www.example.com`,copiedLabel:`Copied`})})})},f.__docgenInfo={description:``,methods:[],displayName:`_UtilityHeader`},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`() => {

import{n as e}from"./chunk-BneVvdWh.js";import{$ as t,Et as n,Ft as r,Lt as i,Pt as a,Rt as o,h as s,j as c,k as l,vt as u}from"./iframe-BHdSP_o9.js";var d,f,p,m,h,g,_;e((()=>{d=a(),o(),u(),r(),f=n(),{action:p}=__STORYBOOK_MODULE_ACTIONS__,m={title:`Global/organisms`,component:c,decorators:[]},h=i.div`
  position: absolute;
  top: 0;
  bottom: 0;
  left: 0;
...
`,g=()=>{let e=(0,d.boolean)(`Side Area A - Default Collapsed`,!1),n=p(`Side Area A State`),r=(0,d.boolean)(`Side Area B - Default Collapsed`,!1),i=p(`Side Area B State`);return(0,f.jsx)(h,{children:(0,f.jsx)(s,{layout:`dashboard`,children:(0,f.jsx)(t,{layout:`horizontal`,persist:!0,persistenceKey:`my_unique_layout_key`,reverse:!1,mainArea:{content:(0,f.jsx)(t,{layout:`vertical`,persist:!0,persistenceKey:`my_nested_key`,reverse:!1,mainArea:{content:(0,f.jsx)(l,{title:`Main Area`}),minSize:120},sideArea:{content:(0,f.jsx)(l,{title:`Side Area A`}),collapsable:!0,minSize:200,onSideAreaStateChange:n,defaultCollapsed:e}}),minSize:120},sideArea:{content:(0,f.jsx)(l,{title:`Side Area B`}),collapsable:!0,minSize:200,onSideAreaStateChange:i,defaultCollapsed:r}})})})},g.__docgenInfo={description:``,methods:[],displayName:`_SplitLayoutNested`},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`() => {
  const reverse = false;

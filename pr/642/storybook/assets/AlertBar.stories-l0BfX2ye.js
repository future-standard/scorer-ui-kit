import{n as e}from"./chunk-BneVvdWh.js";import{Et as t,Ft as n,Lt as r,Pt as i,Rt as a,r as o,vt as s}from"./iframe-BHdSP_o9.js";var c,l,u,d,f,p;e((()=>{a(),n(),c=i(),s(),l=t(),u=r.div`
  margin: 100px;
`,d={title:`Alerts/atoms`,component:o,decorators:[]},f=()=>(0,l.jsx)(u,{children:(0,l.jsx)(o,{message:(0,c.text)(`Message`,`Look Out!`),type:(0,c.select)(`Type`,{Error:`error`,Warning:`warning`,Info:`info`,Success:`success`,Neutral:`neutral`},`error`),hideCloseButton:(0,c.boolean)(`Hide close icon`,!1)})}),f.__docgenInfo={description:``,methods:[],displayName:`_AlertBar`},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`() => {

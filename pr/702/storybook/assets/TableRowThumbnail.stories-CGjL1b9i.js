import{Ft as e,Lt as t,Rt as n,W as r,Wt as i,ft as a,wt as o}from"./iframe-DTJIpfwE.js";import{n as s,t as c}from"./placeholder-Cf6rKdzI.js";import{n as l}from"./rolldown-runtime-DkW27tQK.js";var u,d,f,p,m,h,g,_,v;function y(){return(y=l((()=>{u=i(),o(),n(),c(),d=e(),{action:f}=__STORYBOOK_MODULE_ACTIONS__,p=`https://future-standard.github.io/scorer-ui-kit/traffic.mp4`,m={title:`Tables/atoms`,component:a,decorators:[]},h=t.div`
  height: 200px;
  width:  800px;
  display: flex;
...
`,g=t.div`
  flex: 0;
  height: 35px;
`,_=()=>{let e=(0,u.boolean)(`Zoom On Hover`,!0),t=(0,u.text)(`Image Src`,s),n=(0,u.text)(`Video Src`,p),i=(0,u.select)(`Media Type`,[`img`,`video`],`video`),o=(0,u.boolean)(`Retry Image`,!1),c=f(`Doing some other action than opening a modal`),l=(0,u.boolean)(`Custom onClickThumnail`,!1);return(0,d.jsx)(h,{children:(0,d.jsx)(r,{children:(0,d.jsx)(g,{children:(0,d.jsx)(a,{onClickThumbnail:l?c:void 0,hoverZoom:e,image:t,mediaUrl:n,mediaType:i,retryImageLoad:o})})})})},_.__docgenInfo={description:``,methods:[],displayName:`_RowThumbnail`},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`() => {

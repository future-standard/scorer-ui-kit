import{Ft as e,Lt as t,Rt as n,Wt as r,a as i,q as a,wt as o}from"./iframe-DTJIpfwE.js";import{n as s}from"./rolldown-runtime-DkW27tQK.js";var c,l,u,d,f,p,m,h,g;function _(){return(_=s((()=>{c=r(),o(),n(),l=e(),{action:u}=__STORYBOOK_MODULE_ACTIONS__,d={title:`Form/File Management`,component:i,decorators:[]},f=t.div`
  margin: 20px
`,p=[`MonitoringProfile`,`RetryJob`],m=[`image/jpeg`,`image/png`,`text/csv`],h=()=>{let e=(0,c.boolean)(`Show Custom Component`,!1),t=(0,c.text)(`Title`,`Select Files`),n=(0,c.text)(`Select Files Text`,`Select Files`),r=(0,c.text)(`Description`,`To begin, drop your CSV and Images files here to continue or click Select Files below.`),o=(0,c.text)(`Add More Files Text`,`Add More files`),s=(0,c.object)(`File Icons`,p),d=u(`Input Callback`),h=(0,c.text)(`Message`,`Cleared all selected files`),g=u(`Action was clicked`),_=(0,c.object)(`Allowed File Types`,m),v=u(`Begin Upload Button Click`);return(0,l.jsx)(f,{children:(0,l.jsx)(i,{selectFilesText:n,title:t,fileIcons:s,description:r,allowedFileTypes:_,addMoreFilesText:o,onChangeCallback:(e,t)=>{console.debug(`good Files`,e),console.debug(`rejected`,t),d({goodFiles:e,rejectedFiles:t})},clearFilesCallback:()=>{g(h)},beginUploadCallback:v,customComponent:e?(0,l.jsx)(a,{title:`CustomComponent Example`,introductionText:`This is a page header component that was sent as an example of a custom component. Select multiple files`}):void 0})})},h.__docgenInfo={description:``,methods:[],displayName:`_AreaUploadManager`},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`() => {
...
}`,...h.parameters?.docs?.source}}},g=[`_AreaUploadManager`]})))()}_();export{h as _AreaUploadManager,g as __namedExportsOrder,d as default};
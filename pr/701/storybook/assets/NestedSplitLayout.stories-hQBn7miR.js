import{F as e,Ft as t,L as n,Lt as r,Rt as i,Wt as a,at as o,b as s,wt as c}from"./iframe-CH2zgN-8.js";import{n as l}from"./rolldown-runtime-DkW27tQK.js";var u,d,f,p,m,h,g;function _(){return(_=l((()=>{u=a(),c(),i(),d=t(),{action:f}=__STORYBOOK_MODULE_ACTIONS__,p={title:`Global/organisms`,component:n,decorators:[]},m=r.div`
  position: absolute;
  top: 0;
  bottom: 0;
  left: 0;
...
`,h=()=>{let t=(0,u.boolean)(`Side Area A - Default Collapsed`,!1),n=f(`Side Area A State`),r=(0,u.boolean)(`Side Area B - Default Collapsed`,!1),i=f(`Side Area B State`);return(0,d.jsx)(m,{children:(0,d.jsx)(s,{layout:`dashboard`,children:(0,d.jsx)(o,{layout:`horizontal`,persist:!0,persistenceKey:`my_unique_layout_key`,reverse:!1,mainArea:{content:(0,d.jsx)(o,{layout:`vertical`,persist:!0,persistenceKey:`my_nested_key`,reverse:!1,mainArea:{content:(0,d.jsx)(e,{title:`Main Area`}),minSize:120},sideArea:{content:(0,d.jsx)(e,{title:`Side Area A`}),collapsable:!0,minSize:200,onSideAreaStateChange:n,defaultCollapsed:t}}),minSize:120},sideArea:{content:(0,d.jsx)(e,{title:`Side Area B`}),collapsable:!0,minSize:200,onSideAreaStateChange:i,defaultCollapsed:r}})})})},h.__docgenInfo={description:``,methods:[],displayName:`_SplitLayoutNested`},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`() => {
  const reverse = false;
...
}`,...h.parameters?.docs?.source}}},g=[`_SplitLayoutNested`]})))()}_();export{h as _SplitLayoutNested,g as __namedExportsOrder,p as default};
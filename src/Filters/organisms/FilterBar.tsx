...
const createLabelResults = (
  ...
  if(filterByMinMaxProps && filterByMinMaxProps.selected && (filterByMinMaxProps.selected.isMaxSelected || filterByMinMaxProps.selected.isMinSelected)){
    ...
    let minMaxText='';
    if(selectedMinMax.isMinSelected && !selectedMinMax.isMaxSelected) minMaxText=` ( Min- ${selectedMinMax.min} )`;
    if(selectedMinMax.isMaxSelected && selectedMinMax.isMinSelected) minMaxText=` ( Min- ${selectedMinMax.min}, Max- ${selectedMinMax.max} )`;
    if(!selectedMinMax.isMinSelected && selectedMinMax.isMaxSelected) minMaxText=` ( Max- ${selectedMinMax.max} )`;
    const newLabel: IFilterLabel = {
      filterId: 'kmpost',

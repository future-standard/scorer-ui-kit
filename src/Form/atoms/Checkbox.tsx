...
const Container = styled.label<{visualState?: CheckboxState, disabled?: boolean, parentHover?: boolean}>`
  user-select: none;


  ${({visualState, disabled, parentHover, theme: { styles }}) => visualState === CheckboxState.Off && css`
    ${CheckboxOuter}{
  ...
  ${({visualState, disabled, parentHover, theme: { styles }}) => visualState === CheckboxState.On && css`
    ${CheckboxOuter}{
...
const Checkbox : React.FC<IProps> = ({ indeterminate = false, disabled, checked = false, parentHover, onChangeCallback }) => {
  ...
  return (
    <Container onChange={customOnChange} {...{indeterminate, disabled, visualState, parentHover}}>
      <CheckboxOuter>
        <CheckboxInner>
